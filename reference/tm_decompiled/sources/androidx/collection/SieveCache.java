...
public final class SieveCache<K, V> {
    ...
    private final void moveNodeToHead(int index) {
        ...
        if (i != Integer.MAX_VALUE) {
            jArr[i] = ((SieveCacheKt.NodeLinkMask & index) << 31) | (jArr[i] & SieveCacheKt.NodeMetaAndNextMask);
        }
        this.head = index;
        if (this.tail == Integer.MAX_VALUE) {
            this.tail = index;
    ...
    private final V removeValueAt(int index) {
        ...
        if (i5 != Integer.MAX_VALUE) {
            jArr2[i5] = ((SieveCacheKt.NodeLinkMask & i4) << 31) | (jArr2[i5] & SieveCacheKt.NodeMetaAndNextMask);
        } else {
            this.tail = i4;
        }
        if (this.hand == index) {
    ...
    private final void removeNode(int index) {
        ...
        if (i2 != Integer.MAX_VALUE) {
            jArr[i2] = ((SieveCacheKt.NodeLinkMask & i) << 31) | (jArr[i2] & SieveCacheKt.NodeMetaAndNextMask);
        } else {
            this.tail = i;
        }
        if (this.hand == index) {
    ...
    public final void adjustStorage$collection() {
        int compare;
        if (this._capacity > 8) {
            compare = Long.compare(ULong.m8252constructorimpl(ULong.m8252constructorimpl(get_count()) * 32) ^ Long.MIN_VALUE, ULong.m8252constructorimpl(ULong.m8252constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE);
            if (compare <= 0) {
        ...
        while (i7 != i2) {
            ...
            if (j3 != 128 && j3 == 254) {
                ...
                if (((findFirstAvailableSlot - i11) & i2) / 8 == ((i7 - i11) & i2) / 8) {
                    int i12 = i3;
                    int i13 = i7;
                    jArr[i8] = ((r12 & WorkQueueKt.MASK) << i9) | ((~(255 << i9)) & jArr[i8]);
                    if (jArr3[i13] == j4) {
                        long j5 = i13;
                        jArr3[i13] = j5 | (j5 << 32);
                    }
                    ...
                    if (((j6 >> i16) & 255) == 128) {
                        i = i2;
                        objArr = objArr2;
                        jArr[i15] = (j6 & (~(255 << i16))) | ((r12 & WorkQueueKt.MASK) << i16);
                        ...
                        i = i2;
                        objArr = objArr2;
                        jArr[i15] = ((r12 & WorkQueueKt.MASK) << i16) | (j6 & (~(255 << i16)));
    ...
    private final void fixupNodes(long[] mapping) {
        ...
        while (true) {
            ...
            int i4 = (int) (SieveCacheKt.NodeLinkMask & j);
