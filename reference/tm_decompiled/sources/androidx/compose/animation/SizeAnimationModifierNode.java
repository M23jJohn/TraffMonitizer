...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m159setLookaheadConstraintsBRTryo0(long j) {
        this.lookaheadConstraints = j;
        this.lookaheadConstraintsAvailable = true;
    }

    /* renamed from: targetConstraints-ZezNO4M, reason: not valid java name */
    private final long m160targetConstraintsZezNO4M(long r2) {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m162copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m164copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m164copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m7572equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m7575hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m7577toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m165getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m166setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo108measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        long m7356constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m159setLookaheadConstraintsBRTryo0(j);
            mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(j);
        } else {
            mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(m160targetConstraintsZezNO4M(j));
        }
        final Placeable placeable = mo6055measureBRTryo0;
        final long m7569constructorimpl = IntSize.m7569constructorimpl((placeable.getWidth() << 32) | (placeable.getHeight() & 4294967295L));
        if (measureScope.isLookingAhead()) {
            this.lookaheadSize = m7569constructorimpl;
            m7356constrain4WqzIAM = m7569constructorimpl;
        } else {
            m7356constrain4WqzIAM = ConstraintsKt.m7356constrain4WqzIAM(j, m161animateTomzRDjE0(AnimationModifierKt.m112isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : m7569constructorimpl));
        }
        final int i = (int) (m7356constrain4WqzIAM >> 32);
        final int i2 = (int) (m7356constrain4WqzIAM & 4294967295L);
        return MeasureScope.CC.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m6126place70tqf50$default(placementScope, placeable, SizeAnimationModifierNode.this.getAlignment().mo4066alignKFBX0sM(m7569constructorimpl, IntSize.m7569constructorimpl((i << 32) | (i2 & 4294967295L)), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m161animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m7572equalsimpl0(targetSize, animData.getAnim().getValue().m7578unboximpl()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m7572equalsimpl0(targetSize, animData.getAnim().getTargetValue().m7578unboximpl()) || z) {
                animData.m166setStartSizeozmzZPI(animData.getAnim().getValue().m7578unboximpl());
            ...
            long j = 1;
            animData = new AnimData(new Animatable(IntSize.m7566boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m7566boximpl(IntSize.m7569constructorimpl((j & 4294967295L) | (j << 32))), null, 8, null), targetSize, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m7578unboximpl();
    }
}
