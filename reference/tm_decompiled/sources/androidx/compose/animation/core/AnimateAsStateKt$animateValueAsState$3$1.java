    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (((Boolean) obj).booleanValue()) {
                Object next = it.next();
                Object m9644getOrNullimpl = ChannelResult.m9644getOrNullimpl(this.$channel.mo9633tryReceivePtdJZtk());
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(m9644getOrNullimpl == null ? next : m9644getOrNullimpl, this.$animatable, this.$animSpec$delegate, this.$listener$delegate, null), 3, null);
                this.L$0 = coroutineScope;
                this.L$1 = it;
                this.label = 1;
                obj = it.hasNext(this);
