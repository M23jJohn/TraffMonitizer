...
public final class ArcMode {
    ...
    private static final int ArcAbove = m194constructorimpl(5);
    private static final int ArcBelow = m194constructorimpl(4);
    private static final int ArcLinear = m194constructorimpl(0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ArcMode m193boximpl(int i) {
    ...
    public static int m197hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m198toStringimpl(int i) {
        return "ArcMode(value=" + i + ')';
    }

    public boolean equals(Object other) {
        return m195equalsimpl(this.value, other);
    }
