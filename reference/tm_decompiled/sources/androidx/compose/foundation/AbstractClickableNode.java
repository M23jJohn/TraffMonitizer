...
public abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode, SemanticsModifierNode, TraversableNode, CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    protected abstract boolean mo264onClickKeyDownEventZmokQxo(KeyEvent event);

    /* renamed from: onClickKeyUpEvent-ZmokQxo, reason: not valid java name */
    protected abstract boolean mo265onClickKeyUpEventZmokQxo(KeyEvent event);
    ...
    public final boolean mo268onPreKeyEventZmokQxo(KeyEvent event) {
        return false;
    }
    ...
    private AbstractClickableNode(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, boolean z2, String str, Role role, Function0<Unit> function0) {
        ...
        this.focusableNode = new FocusableNode(this.interactionSource, Focusability.INSTANCE.m4279getSystemDefinedLCbbffg(), new AbstractClickableNode$focusableNode$1(this), null);
        this.currentKeyPressInteractions = LongObjectMapKt.mutableLongObjectMapOf();
        this.centerOffset = Offset.INSTANCE.m4359getZeroF1C5BW0();
    ...
    */
    protected final void m269updateCommonO2vRcR0(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean useLocalIndication, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        boolean z;
        boolean z2 = true;
    ...
    public void mo267onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        long m7580getCenterozmzZPI = IntSizeKt.m7580getCenterozmzZPI(bounds);
        this.centerOffset = Offset.m4335constructorimpl((Float.floatToRawIntBits(IntOffset.m7531getXimpl(m7580getCenterozmzZPI)) << 32) | (Float.floatToRawIntBits(IntOffset.m7532getYimpl(m7580getCenterozmzZPI)) & 4294967295L));
        initializeIndicationAndInteractionSourceIfNeeded();
        if (this.enabled && pass == PointerEventPass.Main) {
            int type = pointerEvent.getType();
            if (PointerEventType.m5874equalsimpl0(type, PointerEventType.INSTANCE.m5878getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m5874equalsimpl0(type, PointerEventType.INSTANCE.m5879getExit7fucELk())) {
    ...
    public final boolean mo266onKeyEventZmokQxo(KeyEvent event) {
        boolean m349isClickZmokQxo;
        boolean m351isPressZmokQxo;
        boolean z;
        initializeIndicationAndInteractionSourceIfNeeded();
        long m5776getKeyZmokQxo = KeyEvent_androidKt.m5776getKeyZmokQxo(event);
        if (this.enabled) {
            m351isPressZmokQxo = ClickableKt.m351isPressZmokQxo(event);
            if (m351isPressZmokQxo) {
                if (this.currentKeyPressInteractions.containsKey(m5776getKeyZmokQxo)) {
                    z = false;
                } else {
                    PressInteraction.Press press = new PressInteraction.Press(this.centerOffset, null);
                    this.currentKeyPressInteractions.set(m5776getKeyZmokQxo, press);
                    if (this.interactionSource != null) {
                ...
                return mo264onClickKeyDownEventZmokQxo(event) || z;
            }
        }
        if (this.enabled) {
            m349isClickZmokQxo = ClickableKt.m349isClickZmokQxo(event);
            if (m349isClickZmokQxo) {
                PressInteraction.Press remove = this.currentKeyPressInteractions.remove(m5776getKeyZmokQxo);
                if (remove != null) {
                    if (this.interactionSource != null) {
                    ...
                    mo265onClickKeyUpEventZmokQxo(event);
                }
                if (remove != null) {
                    return true;
                }
    ...
    public final void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (role != null) {
            ...
            SemanticsPropertiesKt.m6615setRolekuIjeqM(semanticsPropertyReceiver, role.getValue());
        }
    ...
    protected final void m263handlePressInteractionStartk4lQ0M(long offset) {
        Job launch$default;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        if (mutableInteractionSource != null) {
    ...
    protected final void m262handlePressInteractionReleasek4lQ0M(long offset) {
    ...
    protected final Object m261handlePressInteractiond4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
