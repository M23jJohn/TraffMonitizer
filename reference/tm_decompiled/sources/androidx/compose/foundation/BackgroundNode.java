...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, SemanticsModifierNode {
    ...
    public final void m299setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private BackgroundNode(long j, Brush brush, float f, Shape shape) {
        ...
        this.alpha = f;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m4420getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m4616equalsimpl0(this.color, Color.INSTANCE.m4651getUnspecified0d7_KjU())) {
            DrawScope.CC.m5206drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.CC.m5205drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m4616equalsimpl0(this.color, Color.INSTANCE.m4651getUnspecified0d7_KjU())) {
            OutlineKt.m4895drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m4893drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }

    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        Outline outline;
        if (Size.m4408equalsimpl0(contentDrawScope.mo5121getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
        ...
        this.lastSize = contentDrawScope.mo5121getSizeNHjbRc();
    ...
    public static final Unit getOutline$lambda$2(BackgroundNode backgroundNode, ContentDrawScope contentDrawScope) {
        backgroundNode.tmpOutline = backgroundNode.shape.mo361createOutlinePq9zytI(contentDrawScope.mo5121getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
