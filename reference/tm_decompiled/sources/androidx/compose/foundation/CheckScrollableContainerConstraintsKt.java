...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m329checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m7341getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
            ...
            if (Constraints.m7342getMaxWidthimpl(j) != Integer.MAX_VALUE) {
                return;
            }
