...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m355update2tQrsxU(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int m6593hashCodeimpl = (((hashCode3 + (role != null ? Role.m6593hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int hashCode4 = (m6593hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
        Function0<Unit> function0 = this.onLongClick;
        int hashCode5 = (hashCode4 + (function0 != null ? function0.hashCode() : 0)) * 31;
        Function0<Unit> function02 = this.onDoubleClick;
        return ((hashCode5 + (function02 != null ? function02.hashCode() : 0)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.hapticFeedbackEnabled);
    }
}
