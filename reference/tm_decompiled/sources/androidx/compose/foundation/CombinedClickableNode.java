...
final class CombinedClickableNode extends AbstractClickableNode implements CompositionLocalConsumerModifierNode {
    ...
    public final void m355update2tQrsxU(Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick, Function0<Unit> onDoubleClick, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean useLocalIndication, boolean enabled, String onClickLabel, Role role) {
        boolean z;
    ...
    protected boolean mo264onClickKeyDownEventZmokQxo(KeyEvent event) {
        boolean z;
        Job launch$default;
        long m5776getKeyZmokQxo = KeyEvent_androidKt.m5776getKeyZmokQxo(event);
        if (this.onLongClick == null || this.longKeyPressJobs.get(m5776getKeyZmokQxo) != null) {
            z = false;
        } else {
            ...
            mutableLongObjectMap.set(m5776getKeyZmokQxo, launch$default);
            z = true;
        }
        DoubleKeyClickState doubleKeyClickState = this.doubleKeyClickStates.get(m5776getKeyZmokQxo);
        if (doubleKeyClickState != null) {
            if (doubleKeyClickState.getJob().isActive()) {
                ...
                if (!doubleKeyClickState.getDoubleTapMinTimeMillisElapsed()) {
                    getOnClick().invoke();
                    this.doubleKeyClickStates.remove(m5776getKeyZmokQxo);
                    return z;
                }
            } else {
                this.doubleKeyClickStates.remove(m5776getKeyZmokQxo);
    ...
    protected boolean mo265onClickKeyUpEventZmokQxo(KeyEvent event) {
        Function0<Unit> function0;
        Job launch$default;
        long m5776getKeyZmokQxo = KeyEvent_androidKt.m5776getKeyZmokQxo(event);
        boolean z = false;
        if (this.longKeyPressJobs.get(m5776getKeyZmokQxo) != null) {
            Job job = this.longKeyPressJobs.get(m5776getKeyZmokQxo);
            if (job != null) {
                if (job.isActive()) {
            ...
            this.longKeyPressJobs.remove(m5776getKeyZmokQxo);
        }
        if (this.onDoubleClick != null) {
            if (this.doubleKeyClickStates.get(m5776getKeyZmokQxo) != null) {
                ...
                launch$default = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new CombinedClickableNode$onClickKeyUpEvent$2(this, m5776getKeyZmokQxo, null), 3, null);
                mutableLongObjectMap.set(m5776getKeyZmokQxo, new DoubleKeyClickState(launch$default));
            }
        } else if (!z) {
            getOnClick().invoke();
        }
