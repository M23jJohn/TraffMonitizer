...
final class HorizontalScrollableClipShape implements Shape {
    ...
    public Outline mo361createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float mo453roundToPx0680j_4 = density.mo453roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        return new Outline.Rectangle(new Rect(0.0f, -mo453roundToPx0680j_4, Float.intBitsToFloat((int) (size >> 32)), Float.intBitsToFloat((int) (size & 4294967295L)) + mo453roundToPx0680j_4));
    }
}
