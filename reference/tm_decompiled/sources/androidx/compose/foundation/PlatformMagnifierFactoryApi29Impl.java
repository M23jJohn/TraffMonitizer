...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo401createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        if (useTextDefault) {
            return new PlatformMagnifierImpl(new Magnifier(view));
        }
        long mo460toSizeXkaWNTQ = density.mo460toSizeXkaWNTQ(size);
        float mo459toPx0680j_4 = density.mo459toPx0680j_4(cornerRadius);
        float mo459toPx0680j_42 = density.mo459toPx0680j_4(elevation);
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo460toSizeXkaWNTQ != InlineClassHelperKt.UnspecifiedPackedFloats) {
            builder.setSize(MathKt.roundToInt(Float.intBitsToFloat((int) (mo460toSizeXkaWNTQ >> 32))), MathKt.roundToInt(Float.intBitsToFloat((int) (mo460toSizeXkaWNTQ & 4294967295L))));
        }
        if (!Float.isNaN(mo459toPx0680j_4)) {
            builder.setCornerRadius(mo459toPx0680j_4);
        }
        if (!Float.isNaN(mo459toPx0680j_42)) {
            builder.setElevation(mo459toPx0680j_42);
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo400updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
