...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public Object mo275applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object invoke = function2.invoke(Velocity.m7632boximpl(j), continuation);
    ...
    public int hashCode() {
        return (((UByte$$ExternalSyntheticBackport0.m(this.attachNode) * 31) + UByte$$ExternalSyntheticBackport0.m(this.eventHandlingEnabled)) * 31) + this.innerOverscrollEffect.hashCode();
    }
}
