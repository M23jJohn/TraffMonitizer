...
public final class ContextMenuColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.backgroundColor, contextMenuColors.backgroundColor) && Color.m4616equalsimpl0(this.textColor, contextMenuColors.textColor) && Color.m4616equalsimpl0(this.iconColor, contextMenuColors.iconColor) && Color.m4616equalsimpl0(this.disabledTextColor, contextMenuColors.disabledTextColor) && Color.m4616equalsimpl0(this.disabledIconColor, contextMenuColors.disabledIconColor);
    }

    public int hashCode() {
        return (((((((Color.m4622hashCodeimpl(this.backgroundColor) * 31) + Color.m4622hashCodeimpl(this.textColor)) * 31) + Color.m4622hashCodeimpl(this.iconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4622hashCodeimpl(this.disabledIconColor);
    }

    public String toString() {
        return "ContextMenuColors(backgroundColor=" + ((Object) Color.m4623toStringimpl(this.backgroundColor)) + ", textColor=" + ((Object) Color.m4623toStringimpl(this.textColor)) + ", iconColor=" + ((Object) Color.m4623toStringimpl(this.iconColor)) + ", disabledTextColor=" + ((Object) Color.m4623toStringimpl(this.disabledTextColor)) + ", disabledIconColor=" + ((Object) Color.m4623toStringimpl(this.disabledIconColor)) + ')';
    }
}
