...
final class DefaultScrollable2DState implements Scrollable2DState {
    ...
    private final Scroll2DScope scrollScope = new Scroll2DScope() { // from class: androidx.compose.foundation.gestures.DefaultScrollable2DState$scrollScope$1
        ...
        public long mo503scrollByMKHz9U(long delta) {
            ...
            return DefaultScrollable2DState.this.getOnDelta().invoke(Offset.m4332boximpl(delta)).m4353unboximpl();
        }
    };
    ...
    public boolean mo501canScrollk4lQ0M(long offset) {
        return true;
    }
    ...
    public long mo502dispatchRawDeltaMKHz9U(long delta) {
        return this.onDelta.invoke(Offset.m4332boximpl(delta)).m4353unboximpl();
    }
