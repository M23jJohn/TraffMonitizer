...
public final class Draggable2DNode extends DragGestureNode {
    ...
    public void mo478onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStarted.invoke(Offset.m4332boximpl(startedPosition));
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    /* renamed from: onDragStopped-TH1AsA0 */
    public void mo479onDragStoppedTH1AsA0(long velocity) {
        this.onDragStopped.invoke(Velocity.m7632boximpl(velocity));
    }
    ...
    private final long m539reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m4335constructorimpl(j ^ (-9223372034707292160L)) : j;
    }
}
