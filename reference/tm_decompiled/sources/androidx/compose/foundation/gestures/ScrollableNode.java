...
public final class ScrollableNode extends DragGestureNode implements KeyInputModifierNode, SemanticsModifierNode, CompositionLocalConsumerModifierNode, OnScrollChangedDispatcher {
    ...
    public void mo478onDragStartedk4lQ0M(long startedPosition) {
    }
    ...
    public ScrollableNode(ScrollableState scrollableState, OverscrollEffect overscrollEffect, FlingBehavior flingBehavior, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, BringIntoViewSpec bringIntoViewSpec) {
        ...
        delegate(FocusTargetModifierNodeKt.m4257FocusTargetModifierNodePYyLHbc$default(Focusability.INSTANCE.m4278getNeverLCbbffg(), null, 2, null));
    ...
    public void mo565dispatchScrollDeltaInfok4lQ0M(long delta) {
        if (getIsAttached()) {
            DelegatableNodeKt.m6205dispatchOnScrollChangedUv8p0NA(this, delta);
        }
    }
    ...
    public void mo479onDragStoppedTH1AsA0(long velocity) {
    ...
    private final void m610onWheelScrollStoppedTH1AsA0(long velocity) {
    ...
    public static final /* synthetic */ Object ensureMouseWheelScrollNodeInitialized$onWheelScrollStopped(ScrollableNode scrollableNode, long j, Continuation continuation) {
        scrollableNode.m610onWheelScrollStoppedTH1AsA0(j);
        return Unit.INSTANCE;
    }
    ...
    public boolean mo266onKeyEventZmokQxo(KeyEvent event) {
        ...
        if ((!Key.m5468equalsimpl0(KeyEvent_androidKt.m5776getKeyZmokQxo(event), Key.INSTANCE.m5656getPageDownEK5gGoQ()) && !Key.m5468equalsimpl0(KeyEvent_androidKt.m5776getKeyZmokQxo(event), Key.INSTANCE.m5657getPageUpEK5gGoQ())) || !KeyEventType.m5769equalsimpl0(KeyEvent_androidKt.m5777getTypeZmokQxo(event), KeyEventType.INSTANCE.m5773getKeyDownCS__XNY()) || KeyEvent_androidKt.m5780isCtrlPressedZmokQxo(event)) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int viewportSize = (int) (this.contentInViewNode.getViewportSize() & 4294967295L);
            m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (4294967295L & Float.floatToRawIntBits(Key.m5468equalsimpl0(KeyEvent_androidKt.m5776getKeyZmokQxo(event), Key.INSTANCE.m5657getPageUpEK5gGoQ()) ? viewportSize : -viewportSize)));
        } else {
            int viewportSize2 = (int) (this.contentInViewNode.getViewportSize() >> 32);
            m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(0.0f) & 4294967295L) | (Float.floatToRawIntBits(Key.m5468equalsimpl0(KeyEvent_androidKt.m5776getKeyZmokQxo(event), Key.INSTANCE.m5657getPageUpEK5gGoQ()) ? viewportSize2 : -viewportSize2) << 32));
        }
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$onKeyEvent$1(this, m4335constructorimpl, null), 3, null);
        return true;
    }
    ...
    public void mo267onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (getEnabled()) {
            if (pass == PointerEventPass.Initial && PointerEventType.m5874equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5883getScroll7fucELk())) {
                ensureMouseWheelScrollNodeInitialized();
            }
            MouseWheelScrollingLogic mouseWheelScrollingLogic = this.mouseWheelScrollingLogic;
            if (mouseWheelScrollingLogic != null) {
                mouseWheelScrollingLogic.m556onPointerEventH0pRuoY(pointerEvent, pass, bounds);
            }
        }
    }
