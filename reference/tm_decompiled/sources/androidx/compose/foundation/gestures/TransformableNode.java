...
final class TransformableNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode {
                        ...
                        if (i == 0) {
                            ...
                            if (!(this.$event.element instanceof TransformEvent.TransformStopped)) {
                                ...
                                if (transformDelta != null) {
                                    transformScope.mo504transformByd4ec7I(transformDelta.getZoomChange(), transformDelta.getPanChange(), transformDelta.getRotationChange());
                                }
            ...
            static final class AnonymousClass2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    try {
                        ...
                        channel = this.this$0.channel;
                        channel.mo9628trySendJP2dKIU(TransformEvent.TransformStopped.INSTANCE);
                    }
                }
            }
        }
    ...
    public void mo267onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pointerInputModifierNode != null) {
            pointerInputModifierNode.mo267onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        }
    }
