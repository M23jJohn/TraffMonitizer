...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m658constructorimpl(0);
    private static final int NextItem = m658constructorimpl(1);
    private static final int PreviousItem = m658constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FinalSnappingItem m657boximpl(int i) {
        return new FinalSnappingItem(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m658constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m659equalsimpl(int i, Object obj) {
        return (obj instanceof FinalSnappingItem) && i == ((FinalSnappingItem) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m660equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m661hashCodeimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m659equalsimpl(this.value, other);
    }
