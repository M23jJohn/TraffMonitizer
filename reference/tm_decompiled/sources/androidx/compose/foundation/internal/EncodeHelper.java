...
public final class EncodeHelper {
    ...
    public final void encode(SpanStyle spanStyle) {
        ...
        if (fontStyle != null) {
            ...
            encode((byte) 4);
            m682encodenzbMABs(m6967unboximpl);
        }
        FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
        if (fontSynthesis != null) {
            int value = fontSynthesis.getValue();
            encode((byte) 5);
            m679encode6p3vJLY(value);
        }
        ...
        if (!TextUnit.m7594equalsimpl0(spanStyle.getLetterSpacing(), TextUnit.INSTANCE.m7608getUnspecifiedXSAIIZE())) {
            encode((byte) 7);
            m677encodeR2X_6o(spanStyle.getLetterSpacing());
        }
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        if (baselineShift != null) {
            float m7151unboximpl = baselineShift.m7151unboximpl();
            encode((byte) 8);
            m678encode4Dl_Bck(m7151unboximpl);
        }
        ...
        if (!Color.m4616equalsimpl0(spanStyle.getBackground(), Color.INSTANCE.m4651getUnspecified0d7_KjU())) {
            encode((byte) 10);
            m680encode8_81llA(spanStyle.getBackground());
        }
    ...
    public final void m680encode8_81llA(long color) {
        m681encodeVKZWuLQ(color);
    }

    /* renamed from: encode--R2X_6o, reason: not valid java name */
    public final void m677encodeR2X_6o(long textUnit) {
    ...
    public final void m682encodenzbMABs(int fontStyle) {
        byte b = 0;
    ...
    public final void m679encode6p3vJLY(int fontSynthesis) {
        byte b = 0;
    ...
    public final void m678encode4Dl_Bck(float baselineShift) {
    ...
    public final void encode(Shadow shadow) {
        m680encode8_81llA(shadow.getColor());
    ...
    public final void m681encodeVKZWuLQ(long uLong) {
