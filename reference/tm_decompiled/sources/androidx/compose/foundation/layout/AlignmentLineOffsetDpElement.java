...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m712setBefore0680j_4(this.before);
        node.m711setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetDpElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m7404equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m7404equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m7405hashCodeimpl(this.before)) * 31) + Dp.m7405hashCodeimpl(this.after);
    }
}
