...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m712setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m711setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        m698alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m698alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, this.before, this.after, measurable, j);
