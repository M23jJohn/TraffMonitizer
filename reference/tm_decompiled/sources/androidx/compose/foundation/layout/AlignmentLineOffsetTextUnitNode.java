...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m718setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m717setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m698alignmentLineOffsetMeasuretjqqzMA;
        m698alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m698alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, TextUnit.m7595getRawTypeimpl(this.before) == 0 ? Dp.INSTANCE.m7419getUnspecifiedD9Ej5fM() : measureScope.mo454toDpGaN1DYA(this.before), TextUnit.m7595getRawTypeimpl(this.after) == 0 ? Dp.INSTANCE.m7419getUnspecifiedD9Ej5fM() : measureScope.mo454toDpGaN1DYA(this.after), measurable, j);
        return m698alignmentLineOffsetMeasuretjqqzMA;
    }
}
