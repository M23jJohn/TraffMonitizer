...
final class AndroidFlingSpline {
    ...
    public final long m719flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m721constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m720boximpl(long j) {
            return new FlingResult(j);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static long m721constructorimpl(long j) {
            return j;
        }
        ...
        public static String m727toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m722equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m726hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m727toStringimpl(this.packedValue);
        }
        ...
        public static final float m724getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m725getVelocityCoefficientimpl(long j) {
