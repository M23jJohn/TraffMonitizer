...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m768copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m770copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m770copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m7335equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m7345hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m7347toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo767getMinWidthD9Ej5fM() {
        return this.density.mo456toDpu2uoSUM(Constraints.m7344getMinWidthimpl(mo763getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo765getMaxWidthD9Ej5fM() {
        return Constraints.m7338getHasBoundedWidthimpl(mo763getConstraintsmsEJaDk()) ? this.density.mo456toDpu2uoSUM(Constraints.m7342getMaxWidthimpl(mo763getConstraintsmsEJaDk())) : Dp.INSTANCE.m7418getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo766getMinHeightD9Ej5fM() {
        return this.density.mo456toDpu2uoSUM(Constraints.m7343getMinHeightimpl(mo763getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo764getMaxHeightD9Ej5fM() {
        return Constraints.m7337getHasBoundedHeightimpl(mo763getConstraintsmsEJaDk()) ? this.density.mo456toDpu2uoSUM(Constraints.m7341getMaxHeightimpl(mo763getConstraintsmsEJaDk())) : Dp.INSTANCE.m7418getInfinityD9Ej5fM();
    }
}
