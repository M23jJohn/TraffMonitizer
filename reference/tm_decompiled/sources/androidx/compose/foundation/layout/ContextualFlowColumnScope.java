...
public interface ContextualFlowColumnScope extends ColumnScope {
    ...
    float mo774getMaxHeightInLineD9Ej5fM();

    /* renamed from: getMaxWidth-D9Ej5fM, reason: not valid java name */
    float mo775getMaxWidthD9Ej5fM();

    /* compiled from: ContextualFlowLayout.kt */
    /* renamed from: androidx.compose.foundation.layout.ContextualFlowColumnScope$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static /* synthetic */ Modifier fillMaxColumnWidth$default(ContextualFlowColumnScope contextualFlowColumnScope, Modifier modifier, float f, int i, Object obj) {
            if (obj != null) {
