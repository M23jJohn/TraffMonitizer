...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo783measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (intValue == 0) {
            return MeasureScope.CC.layout$default(measureScope, 0, 0, null, new Function1() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$$ExternalSyntheticLambda0
        ...
        final Placeable mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(Constraints.m7332copyZbe2FdA$default(j, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.CC.layout$default(measureScope, mo6055measureBRTryo0.getWidth(), intValue, null, new Function1() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
