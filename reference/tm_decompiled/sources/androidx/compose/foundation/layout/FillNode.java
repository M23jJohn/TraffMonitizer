...
final class FillNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int i;
        if (!Constraints.m7338getHasBoundedWidthimpl(j) || this.direction == Direction.Vertical) {
            m7344getMinWidthimpl = Constraints.m7344getMinWidthimpl(j);
            m7342getMaxWidthimpl = Constraints.m7342getMaxWidthimpl(j);
        } else {
            int round = Math.round(Constraints.m7342getMaxWidthimpl(j) * this.fraction);
            int m7344getMinWidthimpl2 = Constraints.m7344getMinWidthimpl(j);
            m7344getMinWidthimpl = Constraints.m7342getMaxWidthimpl(j);
            if (round < m7344getMinWidthimpl2) {
                round = m7344getMinWidthimpl2;
            }
            if (round <= m7344getMinWidthimpl) {
                m7344getMinWidthimpl = round;
            }
            m7342getMaxWidthimpl = m7344getMinWidthimpl;
        }
        if (!Constraints.m7337getHasBoundedHeightimpl(j) || this.direction == Direction.Horizontal) {
            ...
            int round2 = Math.round(Constraints.m7341getMaxHeightimpl(j) * this.fraction);
            int m7343getMinHeightimpl2 = Constraints.m7343getMinHeightimpl(j);
            i = Constraints.m7341getMaxHeightimpl(j);
            if (round2 < m7343getMinHeightimpl2) {
                round2 = m7343getMinHeightimpl2;
            }
            if (round2 <= i) {
                i = round2;
            }
            m7341getMaxHeightimpl = i;
        }
        final Placeable mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(ConstraintsKt.Constraints(m7344getMinWidthimpl, m7342getMaxWidthimpl, i, m7341getMaxHeightimpl));
        return MeasureScope.CC.layout$default(measureScope, mo6055measureBRTryo0.getWidth(), mo6055measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.FillNode$$ExternalSyntheticLambda0
