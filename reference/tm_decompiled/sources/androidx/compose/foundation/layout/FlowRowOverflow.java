...
public final class FlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final FlowRowOverflow expandIndicator(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> content) {
            return new FlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandIndicator, 0, 0, new Function1() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$$ExternalSyntheticLambda2
        ...
        public final FlowRowOverflow m818expandOrCollapseIndicatorjt2gSs(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int i, float f, Composer composer, int i2, int i3) {
            ...
            boolean z = true;
            int i4 = (i3 & 4) != 0 ? 1 : i;
            float m7399constructorimpl = (i3 & 8) != 0 ? Dp.m7399constructorimpl(0) : f;
            if (ComposerKt.isTraceInProgress()) {
            ...
            int mo453roundToPx0680j_4 = ((Density) consume).mo453roundToPx0680j_4(m7399constructorimpl);
            ComposerKt.sourceInformationMarkerStart(composer, -2046539951, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            boolean changed = ((((i2 & 896) ^ 384) > 256 && composer.changed(i4)) || (i2 & 384) == 256) | composer.changed(mo453roundToPx0680j_4) | ((((i2 & 14) ^ 6) > 4 && composer.changed(function3)) || (i2 & 6) == 4);
            ...
            if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                FlowRowOverflow flowRowOverflow = new FlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, i4, mo453roundToPx0680j_4, new Function1() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
