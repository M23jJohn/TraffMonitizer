...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public long mo825calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.width == IntrinsicSize.Min) {
            maxIntrinsicWidth = measurable.minIntrinsicWidth(Constraints.m7341getMaxHeightimpl(j));
        } else {
            maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m7341getMaxHeightimpl(j));
        }
        if (maxIntrinsicWidth < 0) {
            maxIntrinsicWidth = 0;
        }
        return Constraints.INSTANCE.m7354fixedWidthOenEA2s(maxIntrinsicWidth);
    }
