...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m837setX0680j_4(float f) {
        this.x = f;
    }

    /* renamed from: setY-0680j_4, reason: not valid java name */
    public final void m838setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public final void m839updateMdfbLM(float x, float y, boolean rtlAware) {
        if (!Dp.m7404equalsimpl0(this.x, x) || !Dp.m7404equalsimpl0(this.y, y) || this.rtlAware != rtlAware) {
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measureScope, mo6055measureBRTryo0.getWidth(), mo6055measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = OffsetNode.measure_3p2s80s$lambda$0(OffsetNode.this, mo6055measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetNode offsetNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        if (offsetNode.rtlAware) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, placementScope.mo453roundToPx0680j_4(offsetNode.x), placementScope.mo453roundToPx0680j_4(offsetNode.y), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default(placementScope, placeable, placementScope.mo453roundToPx0680j_4(offsetNode.x), placementScope.mo453roundToPx0680j_4(offsetNode.y), 0.0f, 4, null);
        }
