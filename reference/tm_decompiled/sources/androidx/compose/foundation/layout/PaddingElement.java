...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final void m866setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m867setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m865setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m864setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public void update(PaddingNode node) {
        node.m890setStart0680j_4(this.start);
        node.m891setTop0680j_4(this.top);
        node.m889setEnd0680j_4(this.end);
        node.m888setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m7405hashCodeimpl(this.start) * 31) + Dp.m7405hashCodeimpl(this.top)) * 31) + Dp.m7405hashCodeimpl(this.end)) * 31) + Dp.m7405hashCodeimpl(this.bottom)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement paddingElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return paddingElement != null && Dp.m7404equalsimpl0(this.start, paddingElement.start) && Dp.m7404equalsimpl0(this.top, paddingElement.top) && Dp.m7404equalsimpl0(this.end, paddingElement.end) && Dp.m7404equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7399constructorimpl(0) : f, (i & 2) != 0 ? Dp.m7399constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m7399constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m7399constructorimpl(0) : f4, z, function1, null);
    }
}
