...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m890setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m891setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m889setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m888setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        int i = measureScope.mo453roundToPx0680j_4(this.start) + measureScope.mo453roundToPx0680j_4(this.end);
        int i2 = measureScope.mo453roundToPx0680j_4(this.top) + measureScope.mo453roundToPx0680j_4(this.bottom);
        final Placeable mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(ConstraintsKt.m7361offsetNN6EwU(j, -i, -i2));
        return MeasureScope.CC.layout$default(measureScope, ConstraintsKt.m7359constrainWidthK40F9xA(j, mo6055measureBRTryo0.getWidth() + i), ConstraintsKt.m7358constrainHeightK40F9xA(j, mo6055measureBRTryo0.getHeight() + i2), null, new Function1() { // from class: androidx.compose.foundation.layout.PaddingNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = PaddingNode.measure_3p2s80s$lambda$0(PaddingNode.this, mo6055measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(PaddingNode paddingNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        if (paddingNode.rtlAware) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, placementScope.mo453roundToPx0680j_4(paddingNode.start), placementScope.mo453roundToPx0680j_4(paddingNode.top), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default(placementScope, placeable, placementScope.mo453roundToPx0680j_4(paddingNode.start), placementScope.mo453roundToPx0680j_4(paddingNode.top), 0.0f, 4, null);
        }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7399constructorimpl(0) : f, (i & 2) != 0 ? Dp.m7399constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m7399constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m7399constructorimpl(0) : f4, z, null);
    }
}
