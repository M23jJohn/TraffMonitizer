...
final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m7419getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m7419getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.INSTANCE.m7419getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.INSTANCE.m7419getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public void update(SizeNode node) {
        node.m947setMinWidth0680j_4(this.minWidth);
        node.m946setMinHeight0680j_4(this.minHeight);
        node.m945setMaxWidth0680j_4(this.maxWidth);
        node.m944setMaxHeight0680j_4(this.maxHeight);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.minWidth, sizeElement.minWidth) && Dp.m7404equalsimpl0(this.minHeight, sizeElement.minHeight) && Dp.m7404equalsimpl0(this.maxWidth, sizeElement.maxWidth) && Dp.m7404equalsimpl0(this.maxHeight, sizeElement.maxHeight) && this.enforceIncoming == sizeElement.enforceIncoming;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m7405hashCodeimpl(this.minWidth) * 31) + Dp.m7405hashCodeimpl(this.minHeight)) * 31) + Dp.m7405hashCodeimpl(this.maxWidth)) * 31) + Dp.m7405hashCodeimpl(this.maxHeight)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.enforceIncoming);
    }
}
