...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m954setMinWidth0680j_4(this.minWidth);
        node.m953setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m7397boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m7397boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m7404equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m7405hashCodeimpl(this.minWidth) * 31) + Dp.m7405hashCodeimpl(this.minHeight);
    }
}
