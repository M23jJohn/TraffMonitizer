...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo108measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m7344getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m7342getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m7343getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m7341getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int coerceIn = RangesKt.coerceIn(mo6055measureBRTryo0.getWidth(), Constraints.m7344getMinWidthimpl(j), Constraints.m7342getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo6055measureBRTryo0.getHeight(), Constraints.m7343getMinHeightimpl(j), Constraints.m7341getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measureScope, coerceIn, coerceIn2, null, new Function1() { // from class: androidx.compose.foundation.layout.WrapContentNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = WrapContentNode.measure_3p2s80s$lambda$0(WrapContentNode.this, coerceIn, mo6055measureBRTryo0, coerceIn2, measureScope, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(WrapContentNode wrapContentNode, int i, Placeable placeable, int i2, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m6126place70tqf50$default(placementScope, placeable, wrapContentNode.alignmentCallback.invoke(IntSize.m7566boximpl(IntSize.m7569constructorimpl(((i - placeable.getWidth()) << 32) | ((i2 - placeable.getHeight()) & 4294967295L))), measureScope.getLayoutDirection()).m7540unboximpl(), 0.0f, 2, null);
