...
public abstract class LazyListMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo994createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m7342getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m7341getMaxHeightimpl(j), 5, null);
    }
    ...
    public LazyListMeasuredItem mo1008getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1009getAndMeasure0kLqBqw(index, constraints);
    }

    /* renamed from: getAndMeasure-0kLqBqw$default, reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m1007getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m1009getAndMeasure0kLqBqw(i, j);
    }

    /* renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m1009getAndMeasure0kLqBqw(int index, long constraints) {
        return mo994createItemX9ElhV4(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), m1087getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
