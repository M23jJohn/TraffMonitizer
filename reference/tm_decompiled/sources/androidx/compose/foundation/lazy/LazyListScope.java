...
public interface LazyListScope {
    ...
    /* synthetic */ void stickyHeader(Object key, Object contentType, Function3 content);

    void stickyHeader(Object key, Object contentType, Function4<? super LazyItemScope, ? super Integer, ? super Composer, ? super Integer, Unit> content);

    /* compiled from: LazyDsl.kt */
    /* renamed from: androidx.compose.foundation.lazy.LazyListScope$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static Object items$lambda$0(int i) {
            return null;
        }
        ...
        public static /* synthetic */ void $default$items(LazyListScope _this, int i, Function1 function1, Function4 function4) {
            _this.items(i, function1, new Function1() { // from class: androidx.compose.foundation.lazy.LazyListScope$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return LazyListScope.CC.items$lambda$0(((Integer) obj).intValue());
                }
            }, function4);
        }
        ...
        @Deprecated(level = DeprecationLevel.HIDDEN, message = "Please use the overload with indexing capabilities.", replaceWith = @ReplaceWith(expression = "stickyHeader(key, contentType, { _ -> content() })", imports = {}))
        public static /* synthetic */ void $default$stickyHeader(LazyListScope _this, Object obj, Object obj2, final Function3 function3) {
            _this.stickyHeader(obj, obj2, (Function4<? super LazyItemScope, ? super Integer, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambdaInstance(-764088514, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListScope$stickyHeader$1
        ...
        public static /* synthetic */ void stickyHeader$default(LazyListScope lazyListScope, Object obj, Object obj2, Function4 function4, int i, Object obj3) {
            if (obj3 != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: stickyHeader");
            }
            if ((i & 1) != 0) {
        ...
        public static void $default$stickyHeader(LazyListScope _this, Object obj, Object obj2, final Function4 function4) {
            _this.item(obj, obj2, ComposableLambdaKt.composableLambdaInstance(1691919627, true, new Function3<LazyItemScope, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListScope$stickyHeader$2
    ...
    public static final class DefaultImpls {
        ...
        public static void stickyHeader(LazyListScope lazyListScope, Object obj, Object obj2, Function4<? super LazyItemScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4) {
            CC.$default$stickyHeader(lazyListScope, obj, obj2, function4);
        }
    }
}
