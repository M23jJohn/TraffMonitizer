...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo1025invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m7329boximpl(constraints));
