...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m1046childConstraintsJhjzzOo$foundation_release(int startSlot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m7354fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.INSTANCE.m7353fixedHeightOenEA2s(coerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int m1021getCurrentLineSpanimpl = GridItemSpan.m1021getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem m1045getAndMeasurem8Kt_7k = this.measuredItemProvider.m1045getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i3, m1046childConstraintsJhjzzOo$foundation_release(i2, m1021getCurrentLineSpanimpl), i2, m1021getCurrentLineSpanimpl, i);
            i2 += m1021getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = m1045getAndMeasurem8Kt_7k;
        }
