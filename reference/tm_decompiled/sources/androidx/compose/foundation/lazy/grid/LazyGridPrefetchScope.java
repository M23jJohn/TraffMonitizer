...
public interface LazyGridPrefetchScope {
    ...
    List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex, Function1<? super LazyGridPrefetchResultScope, Unit> onPrefetchFinished);

    /* compiled from: LazyGridPrefetchStrategy.kt */
    /* renamed from: androidx.compose.foundation.lazy.grid.LazyGridPrefetchScope$-CC, reason: invalid class name */
