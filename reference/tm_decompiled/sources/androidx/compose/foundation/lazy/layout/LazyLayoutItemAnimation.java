...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m7542getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        String str = null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m7522boximpl(IntOffset.INSTANCE.m7542getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, str, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m7522boximpl(IntOffset.INSTANCE.m7542getZeronOccac()), null, 2, null);
    ...
    public final void m1072setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m1070setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m1064setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m7522boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m1068getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta.getValue()).m7540unboximpl();
    }
    ...
    public final void m1071setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m1065animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long m7534minusqkQi6aY = IntOffset.m7534minusqkQi6aY(m1068getPlacementDeltanOccac(), delta);
        m1064setPlacementDeltagyyYBs(m7534minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, m7534minusqkQi6aY, null), 3, null);
    }
    ...
    public final void release() {
        ...
        m1064setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7542getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m1073getNotInitializednOccac() {
    ...
    static {
        ...
        NotInitialized = IntOffset.m7525constructorimpl((j & 4294967295L) | (j << 32));
    }
}
