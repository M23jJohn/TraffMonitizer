...
public final class LazyLayoutPrefetchState {
    ...
    public interface PrefetchResultScope {
        ...
        long mo1098getSizeYEO4UFw(int placeableIndex);
    }
    ...
    public static /* synthetic */ PrefetchHandle m1092schedulePrecompositionAndPremeasureVKLhPVY$default(LazyLayoutPrefetchState lazyLayoutPrefetchState, int i, long j, Function1 function1, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            function1 = null;
        }
        return lazyLayoutPrefetchState.m1094schedulePrecompositionAndPremeasureVKLhPVY(i, j, function1);
    }

    /* renamed from: schedulePrecompositionAndPremeasure-VKLhPVY, reason: not valid java name */
    public final PrefetchHandle m1094schedulePrecompositionAndPremeasureVKLhPVY(int index, long constraints, Function1<? super PrefetchResultScope, Unit> onItemPremeasured) {
        return m1095schedulePrecompositionAndPremeasure_EkL_Y$foundation_release(index, constraints, true, onItemPremeasured);
    }

    /* renamed from: schedulePrecompositionAndPremeasure-_EkL_-Y$foundation_release$default, reason: not valid java name */
    public static /* synthetic */ PrefetchHandle m1093xe6b2911(LazyLayoutPrefetchState lazyLayoutPrefetchState, int i, long j, boolean z, Function1 function1, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            function1 = null;
        }
        return lazyLayoutPrefetchState.m1095schedulePrecompositionAndPremeasure_EkL_Y$foundation_release(i, j, z, function1);
    }

    /* renamed from: schedulePrecompositionAndPremeasure-_EkL_-Y$foundation_release, reason: not valid java name */
    public final PrefetchHandle m1095schedulePrecompositionAndPremeasure_EkL_Y$foundation_release(int index, long constraints, boolean isHighPriority, Function1<? super PrefetchResultScope, Unit> onItemPremeasured) {
        PrefetchHandle m1118schedulePremeasurem8Kt_7k;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        return (prefetchHandleProvider == null || (m1118schedulePremeasurem8Kt_7k = prefetchHandleProvider.m1118schedulePremeasurem8Kt_7k(index, constraints, this.prefetchMetrics, isHighPriority, onItemPremeasured)) == null) ? DummyHandle.INSTANCE : m1118schedulePremeasurem8Kt_7k;
    }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public /* synthetic */ void mo1097schedulePrefetch0kLqBqw(int i, long j) {
            mo1096schedulePrecompositionAndPremeasure0kLqBqw(i, j);
        }
        ...
        public void mo1096schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints) {
            PrefetchHandleProvider prefetchHandleProvider = LazyLayoutPrefetchState.this.getPrefetchHandleProvider();
            if (prefetchHandleProvider == null) {
                return;
            }
            this._requests.add(prefetchHandleProvider.m1117createNestedPrefetchRequestVKLhPVY(index, constraints, LazyLayoutPrefetchState.this.prefetchMetrics));
        }
    }
}
