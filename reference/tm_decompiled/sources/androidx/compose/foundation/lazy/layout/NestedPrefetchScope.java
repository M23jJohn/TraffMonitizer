...
public interface NestedPrefetchScope {
    int getNestedPrefetchItemCount();

    void schedulePrecomposition(int index);

    /* renamed from: schedulePrecompositionAndPremeasure-0kLqBqw */
    void mo1096schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints);
    ...
    void mo1097schedulePrefetch0kLqBqw(int index, long constraints);

    /* compiled from: LazyLayoutPrefetchState.kt */
    /* renamed from: androidx.compose.foundation.lazy.layout.NestedPrefetchScope$-CC, reason: invalid class name */
    public final /* synthetic */ class CC {
        public static int $default$getNestedPrefetchItemCount(NestedPrefetchScope _this) {
            return -1;
        }
    }
}
