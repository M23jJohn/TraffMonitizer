...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1118schedulePremeasurem8Kt_7k(int index, long constraints, PrefetchMetrics prefetchMetrics, boolean isHighPriority, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> onItemPremeasured) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    public final PrefetchRequest m1117createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest, LazyLayoutPrefetchState.PrefetchResultScope {
        ...
        public HandleAndRequestImpl(int i, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.startTime = TimeSource.Monotonic.INSTANCE.m9588markNowz9LOYto();
        }
        ...
        private HandleAndRequestImpl(PrefetchHandleProvider prefetchHandleProvider, int i, long j, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.premeasureConstraints = Constraints.m7329boximpl(j);
        }
        ...
        public long mo1098getSizeYEO4UFw(int placeableIndex) {
            SubcomposeLayoutState.PrecomposedSlotHandle precomposedSlotHandle = this.precomposeHandle;
            return precomposedSlotHandle != null ? precomposedSlotHandle.mo6086getSizeYEO4UFw(placeableIndex) : IntSize.INSTANCE.m7579getZeroYbymL2g();
        }
        ...
        private final void updateElapsedAndAvailableTime() {
            long m9588markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m9588markNowz9LOYto();
            long m9488getInWholeNanosecondsimpl = Duration.m9488getInWholeNanosecondsimpl(TimeSource.Monotonic.ValueTimeMark.m9599minus6eNON_k(m9588markNowz9LOYto, this.startTime));
            this.elapsedTimeNanos = m9488getInWholeNanosecondsimpl;
            long j = this.availableTimeNanos - m9488getInWholeNanosecondsimpl;
            this.availableTimeNanos = j;
            this.startTime = m9588markNowz9LOYto;
            ...
            if (!this.isCanceled) {
                ...
                if (index >= 0 && index < itemCount) {
                    ...
                    if (!this.isMeasured && constraints != null) {
                        ...
                        try {
                            m1119performMeasureBRTryo0(constraints.getValue());
        ...
        private final void m1119performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            if (precomposedSlotHandle != null) {
                ...
                for (int i = 0; i < placeablesCount; i++) {
                    precomposedSlotHandle.mo6087premeasure0kLqBqw(i, constraints);
                }
                return;
            }
