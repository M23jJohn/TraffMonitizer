...
public abstract class LazyStaggeredGridMeasureProvider extends LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1144createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1149childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m7354fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m7353fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1150getAndMeasurejy6DScQ(int index, long span) {
        ...
        long m1149childConstraintsJhjzzOo = m1149childConstraintsJhjzzOo(coerceAtMost, coerceAtMost2);
        return mo1144createItempitSLOA(index, coerceAtMost, coerceAtMost2, key, contentType, m1087getPlaceables3p2s80s(this.measureScope, index, m1149childConstraintsJhjzzOo), m1149childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc, reason: avoid collision after fix types in other method */
    public LazyStaggeredGridMeasuredItem mo1008getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1144createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), m1087getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
