...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyStaggeredGridMeasuredItem(int i, Object obj, List<? extends Placeable> list, boolean z, int i2, int i3, int i4, int i5, int i6, Object obj2, LazyLayoutItemAnimator<LazyStaggeredGridMeasuredItem> lazyLayoutItemAnimator, long j) {
        ...
        if (getIsVertical()) {
            m7569constructorimpl = IntSize.m7569constructorimpl((4294967295L & this.mainAxisSize) | (i8 << 32));
        } else {
            m7569constructorimpl = IntSize.m7569constructorimpl((4294967295L & i8) | (this.mainAxisSize << 32));
        }
    ...
    public final void position(int mainAxis, int crossAxis, int mainAxisLayoutSize) {
        ...
        if (getIsVertical()) {
            m7525constructorimpl = IntOffset.m7525constructorimpl((crossAxis << 32) | (4294967295L & mainAxis));
        } else {
            m7525constructorimpl = IntOffset.m7525constructorimpl((crossAxis & 4294967295L) | (mainAxis << 32));
        }
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m7531getXimpl(getOffset()) : IntOffset.m7532getYimpl(getOffset());
    }
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (animation != null) {
                if (isLookingAhead) {
                    ...
                    if ((m1152getMainAxisgyyYBs(offset) <= height && m1152getMainAxisgyyYBs(m7535plusqkQi6aY) <= height) || (m1152getMainAxisgyyYBs(offset) >= i2 && m1152getMainAxisgyyYBs(m7535plusqkQi6aY) >= i2)) {
            ...
            if (context.getReverseLayout()) {
                if (getIsVertical()) {
                    m7531getXimpl = IntOffset.m7531getXimpl(offset);
                } else {
                    m7531getXimpl = (this.mainAxisLayoutSize - IntOffset.m7531getXimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (!getIsVertical()) {
                    m7532getYimpl = IntOffset.m7532getYimpl(offset);
                } else {
                    m7532getYimpl = (this.mainAxisLayoutSize - IntOffset.m7532getYimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                offset = IntOffset.m7525constructorimpl((m7532getYimpl & 4294967295L) | (m7531getXimpl << 32));
            }
            long m7535plusqkQi6aY2 = IntOffset.m7535plusqkQi6aY(offset, context.getContentOffset());
            if (!isLookingAhead && animation != null) {
                animation.m1070setFinalOffsetgyyYBs(m7535plusqkQi6aY2);
            }
            if (graphicsLayer != null) {
                Placeable.PlacementScope.m6129placeRelativeWithLayeraW9wM$default(scope, placeable, m7535plusqkQi6aY2, graphicsLayer, 0.0f, 4, (Object) null);
            } else {
                Placeable.PlacementScope.m6128placeRelativeWithLayeraW9wM$default(scope, placeable, m7535plusqkQi6aY2, 0.0f, (Function1) null, 6, (Object) null);
            }
        }
    }
    ...
    private final int m1152getMainAxisgyyYBs(long j) {
    ...
    private final long m1151copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
