...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1127invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m7335equalsimpl0(this.cachedConstraints, constraints) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m7329boximpl(constraints));
