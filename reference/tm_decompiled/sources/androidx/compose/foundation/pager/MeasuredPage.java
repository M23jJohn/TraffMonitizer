...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i < size) {
            ...
            long m1176getOffsetBjo55l4 = m1176getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int m7531getXimpl = this.isVertical ? IntOffset.m7531getXimpl(m1176getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m7531getXimpl(m1176getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m7532getYimpl = (this.mainAxisLayoutSize - IntOffset.m7532getYimpl(m1176getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m7532getYimpl = IntOffset.m7532getYimpl(m1176getOffsetBjo55l4);
                }
                m1176getOffsetBjo55l4 = IntOffset.m7525constructorimpl((m7531getXimpl << 32) | (m7532getYimpl & 4294967295L));
            }
            long m7535plusqkQi6aY = IntOffset.m7535plusqkQi6aY(m1176getOffsetBjo55l4, this.visualOffset);
            if (this.isVertical) {
                placementScope = scope;
                Placeable.PlacementScope.m6130placeWithLayeraW9wM$default(placementScope, placeable, m7535plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            } else {
                placementScope = scope;
                Placeable.PlacementScope.m6128placeRelativeWithLayeraW9wM$default(placementScope, placeable, m7535plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            }
            i++;
    ...
    private final long m1176getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
        return IntOffset.m7525constructorimpl((iArr[i] << 32) | (iArr[i + 1] & 4294967295L));
    }
    ...
    private final long m1175copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int m7531getXimpl = this.isVertical ? IntOffset.m7531getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m7531getXimpl(j))).intValue();
        boolean z = this.isVertical;
