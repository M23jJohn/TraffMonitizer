...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public void update(SelectableNode node) {
        node.m1211updateO2vRcR0(this.selected, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode2 + (role != null ? Role.m6593hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
