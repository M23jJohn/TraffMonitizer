...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    public void update(TriStateToggleableNode node) {
        node.m1225updateO2vRcR0(this.state, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        int hashCode3 = (((((hashCode2 + (indicationNodeFactory != null ? indicationNodeFactory.hashCode() : 0)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.useLocalIndication)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.enabled)) * 31;
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.m6593hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
