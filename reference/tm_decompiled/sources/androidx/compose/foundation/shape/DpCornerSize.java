...
final /* data */ class DpCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ DpCornerSize m1240copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m1241copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final DpCornerSize m1241copy0680j_4(float size) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DpCornerSize) && Dp.m7404equalsimpl0(this.size, ((DpCornerSize) other).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m7397boximpl(m1242getValueOverrideD9Ej5fM());
    }

    @Override // androidx.compose.foundation.shape.CornerSize
    /* renamed from: toPx-TmRCtEA */
    public float mo1234toPxTmRCtEA(long shapeSize, Density density) {
        return density.mo459toPx0680j_4(this.size);
    }
    ...
    public float m1242getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
