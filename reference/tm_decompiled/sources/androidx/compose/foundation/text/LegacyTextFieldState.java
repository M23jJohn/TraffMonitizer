...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m7397boximpl(Dp.m7399constructorimpl(0)), null, 2, null);
    ...
    private long selectionBackgroundColor = Color.INSTANCE.m4651getUnspecified0d7_KjU();

    /* renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6836boximpl(TextRange.INSTANCE.m6853getZerod9O1mEE()), null, 2, null);

    /* renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6836boximpl(TextRange.INSTANCE.m6853getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1323getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m7413unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1327setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(Dp.m7397boximpl(f));
    }
    ...
    public static final Unit onValueChange$lambda$2(LegacyTextFieldState legacyTextFieldState, TextFieldValue textFieldValue) {
        ...
        legacyTextFieldState.m1329setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6853getZerod9O1mEE());
    ...
    public static final Unit onImeActionPerformed$lambda$3(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        legacyTextFieldState.keyboardActionRunner.m1307runActionKlQnJC8(imeAction.getValue());
        return Unit.INSTANCE;
    }
    ...
    public static final boolean onImeActionPerformedWithResult$lambda$4(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        return legacyTextFieldState.keyboardActionRunner.m1307runActionKlQnJC8(imeAction.getValue());
    }
    ...
    public final void m1328setSelectionBackgroundColor8_81llA(long j) {
        this.selectionBackgroundColor = j;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getSelectionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1325getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1329setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m6836boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1322getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1326setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m6836boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m6842getCollapsedimpl(m1325getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m6842getCollapsedimpl(m1322getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1330updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate m1382updateTextDelegaterm0N8CA$default = TextDelegateKt.m1382updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != m1382updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m1382updateTextDelegaterm0N8CA$default;
    }
}
