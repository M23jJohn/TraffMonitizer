...
public final class AndroidTextContextMenuToolbarProvider implements TextContextMenuProvider {
    ...
    public final Rect calculateBoundsInRoot(TextContextMenuDataProvider dataProvider) {
        ...
        return dataProvider.contentBounds(invoke).m4380translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(invoke));
    }
    ...
    static final class TextContextMenuSessionImpl implements TextContextMenuSession {
        ...
        public void close() {
            this.channel.mo9628trySendJP2dKIU(Unit.INSTANCE);
        }
