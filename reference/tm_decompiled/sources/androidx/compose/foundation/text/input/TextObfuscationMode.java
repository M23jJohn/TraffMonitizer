...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1498constructorimpl(0);
    private static final int RevealLastTyped = m1498constructorimpl(1);
    private static final int Hidden = m1498constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1497boximpl(int i) {
        return new TextObfuscationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1498constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1499equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1503unboximpl();
    }
    ...
    public static int m1501hashCodeimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m1499equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m1501hashCodeimpl(this.value);
    }

    public String toString() {
        return m1502toStringimpl(this.value);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m1503unboximpl() {
        return this.value;
    }
