...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long mo1477getOriginalRangejx7JFs = changeList.mo1477getOriginalRangejx7JFs(0);
            long mo1478getRangejx7JFs = changeList.mo1478getRangejx7JFs(0);
            if (TextRange.m6842getCollapsedimpl(mo1477getOriginalRangejx7JFs) && TextRange.m6842getCollapsedimpl(mo1478getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m6846getMinimpl(mo1477getOriginalRangejx7JFs), TextRangeKt.m6855substringFDrldGo(textFieldCharSequence, mo1477getOriginalRangejx7JFs), TextRangeKt.m6855substringFDrldGo(textFieldCharSequence2, mo1478getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
