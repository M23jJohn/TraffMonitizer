...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4866constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4875resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo6065transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m4456setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1531buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m4380translatek4lQ0M(textLayoutNodeCoordinates.mo6058localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m4359getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m4380translatek4lQ0M(textLayoutNodeCoordinates.mo6058localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m4359getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
