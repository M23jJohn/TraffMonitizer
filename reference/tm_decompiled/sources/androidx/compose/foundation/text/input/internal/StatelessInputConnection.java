...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        String obj = TextRange.m6842getCollapsedimpl(getText().getSelection()) ? null : TextFieldCharSequenceKt.getSelectedText(getText()).toString();
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m6846getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    */
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1515onImeActionKlQnJC8(m7033getDefaulteUduSuo);
        return true;
    }
