...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final void updateNonMeasureInputs(TransformedTextFieldState textFieldState, TextStyle textStyle, boolean singleLine, boolean softWrap, KeyboardOptions keyboardOptions) {
        setNonMeasureInputs(new NonMeasureInputs(textFieldState, textStyle, singleLine, softWrap, KeyboardType.m7073equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m7093getPhonePjHm6EE())));
    }

    /* renamed from: layoutWithNewMeasureInputs--hBUhpc, reason: not valid java name */
    public final TextLayoutResult m1609layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        ...
        if (!Intrinsics.areEqual(computeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.m1612setCompositionOEnZFl4(visualText2.getComposition());
                    ...
                    cacheRecord3.m1613setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    private final TextLayoutResult computeLayout(TextFieldCharSequence visualText, List<AnnotatedString.Range<AnnotatedString.Annotation>> annotations, NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) {
        ...
        return TextMeasurer.m6822measurexDpz5zY$default(obtainTextMeasurer, new AnnotatedString(visualText.toString(), annotations == null ? CollectionsKt.emptyList() : annotations), textStyle, 0, nonMeasureInputs.getSoftWrap(), nonMeasureInputs.getSingleLine() ? 1 : Integer.MAX_VALUE, null, measureInputs.getConstraints(), measureInputs.getLayoutDirection(), measureInputs.getDensity(), measureInputs.getFontFamilyResolver(), false, 1060, null);
    }
    ...
    private static final class CacheRecord extends StateRecord {
        ...
        public final void m1612setCompositionOEnZFl4(TextRange textRange) {
        ...
        public final void m1613setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                return a.getDensityValue() == b.getDensityValue() && a.getFontScale() == b.getFontScale() && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m7335equalsimpl0(a.getConstraints(), b.getConstraints());
            }
        };
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m7347toStringimpl(this.constraints)) + ')';
        }
