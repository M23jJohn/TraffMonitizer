...
public final class TextFieldTextLayoutModifier extends ModifierNodeElement<TextFieldTextLayoutModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int m = ((((((UByte$$ExternalSyntheticBackport0.m(this.singleLine) * 31) + this.textLayoutState.hashCode()) * 31) + this.textFieldState.hashCode()) * 31) + this.textStyle.hashCode()) * 31;
        Function2<Density, Function0<TextLayoutResult>, Unit> function2 = this.onTextLayout;
        return ((m + (function2 != null ? function2.hashCode() : 0)) * 31) + this.keyboardOptions.hashCode();
    }
}
