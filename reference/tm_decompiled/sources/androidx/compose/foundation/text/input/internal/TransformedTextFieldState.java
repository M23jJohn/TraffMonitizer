...
public final class TransformedTextFieldState {
    ...
    private static final long m1629mapFromTransformedxdX6G0(long j, OffsetMappingCalculator offsetMappingCalculator) {
        return Companion.m1642mapFromTransformedxdX6G0(j, offsetMappingCalculator);
    }

    @JvmStatic
    /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
    private static final long m1630mapToTransformedXGyztTk(long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity) {
        return Companion.m1643mapToTransformedXGyztTk(j, offsetMappingCalculator, selectionWedgeAffinity);
    }
    ...
    public final void placeCursorBeforeCharAt(int transformedOffset) {
        m1638selectCharsIn5zctL8(TextRangeKt.TextRange(transformedOffset));
    }

    /* renamed from: selectCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1638selectCharsIn5zctL8(long transformedRange) {
        m1639selectUntransformedCharsIn5zctL8(m1634mapFromTransformedGEjPoXI(transformedRange));
    }

    /* renamed from: selectUntransformedCharsIn-5zc-tL8, reason: not valid java name */
    public final void m1639selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        TextFieldBufferKt.setSelectionCoerced(textFieldState.getMainBuffer(), TextRange.m6848getStartimpl(untransformedRange), TextRange.m6843getEndimpl(untransformedRange));
    ...
    public final void m1632highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long m1634mapFromTransformedGEjPoXI = m1634mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        TextFieldEditUndoBehavior textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        textFieldState.getMainBuffer().getChangeTracker$foundation_release().clearChanges();
        textFieldState.getMainBuffer().m1474setHighlightK7f2yys$foundation_release(type, TextRange.m6848getStartimpl(m1634mapFromTransformedGEjPoXI), TextRange.m6843getEndimpl(m1634mapFromTransformedGEjPoXI));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void deleteSelectedText() {
        ...
        textFieldState.getMainBuffer().getChangeTracker$foundation_release().clearChanges();
        TextFieldBuffer mainBuffer = textFieldState.getMainBuffer();
        TextFieldBufferKt.delete(mainBuffer, TextRange.m6846getMinimpl(mainBuffer.getSelectionInChars()), TextRange.m6845getMaximpl(mainBuffer.getSelectionInChars()));
        TextFieldBufferKt.setSelectionCoerced$default(mainBuffer, TextRange.m6846getMinimpl(mainBuffer.getSelectionInChars()), 0, 2, null);
        updateWedgeAffinity(mainBuffer);
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }

    /* renamed from: replaceText-M8tDOmk$default, reason: not valid java name */
    public static /* synthetic */ void m1631replaceTextM8tDOmk$default(TransformedTextFieldState transformedTextFieldState, CharSequence charSequence, long j, TextFieldEditUndoBehavior textFieldEditUndoBehavior, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        transformedTextFieldState.m1637replaceTextM8tDOmk(charSequence, j, textFieldEditUndoBehavior2, z);
    }

    /* renamed from: replaceText-M8tDOmk, reason: not valid java name */
    public final void m1637replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        textFieldState.getMainBuffer().getChangeTracker$foundation_release().clearChanges();
        TextFieldBuffer mainBuffer = textFieldState.getMainBuffer();
        long m1634mapFromTransformedGEjPoXI = m1634mapFromTransformedGEjPoXI(range);
        mainBuffer.replace(TextRange.m6846getMinimpl(m1634mapFromTransformedGEjPoXI), TextRange.m6845getMaximpl(m1634mapFromTransformedGEjPoXI), newText);
        TextFieldBufferKt.setSelectionCoerced$default(mainBuffer, TextRange.m6846getMinimpl(m1634mapFromTransformedGEjPoXI) + newText.length(), 0, 2, null);
        updateWedgeAffinity(mainBuffer);
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        ...
        mainBuffer.replace(TextRange.m6846getMinimpl(selectionInChars), TextRange.m6845getMaximpl(selectionInChars), newText);
        TextFieldBufferKt.setSelectionCoerced$default(mainBuffer, TextRange.m6846getMinimpl(selectionInChars) + newText.length(), 0, 2, null);
        updateWedgeAffinity(mainBuffer);
        textFieldState.commitEditAsUser(inputTransformation, restartImeIfContentChanges, undoBehavior);
    }
    ...
    public final void collapseSelectionToMax() {
        ...
        textFieldState.getMainBuffer().getChangeTracker$foundation_release().clearChanges();
        TextFieldBuffer mainBuffer = textFieldState.getMainBuffer();
        TextFieldBufferKt.setSelectionCoerced$default(mainBuffer, TextRange.m6845getMaximpl(mainBuffer.getSelectionInChars()), 0, 2, null);
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        textFieldState.getMainBuffer().getChangeTracker$foundation_release().clearChanges();
        TextFieldBuffer mainBuffer = textFieldState.getMainBuffer();
        TextFieldBufferKt.setSelectionCoerced$default(mainBuffer, TextRange.m6843getEndimpl(mainBuffer.getSelectionInChars()), 0, 2, null);
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void updateWedgeAffinity(TextFieldBuffer textFieldBuffer) {
        if (textFieldBuffer.getChangeTracker$foundation_release().getChangeCount() <= 0 || !TextRange.m6842getCollapsedimpl(textFieldBuffer.getSelectionInChars())) {
            return;
        }
    ...
    public final long m1635mapToTransformedjx7JFs(int offset) {
        TransformedText value;
        ...
        long m1570mapFromSourcejx7JFs = offsetMapping != null ? offsetMapping.m1570mapFromSourcejx7JFs(offset) : TextRangeKt.TextRange(offset);
        return offsetMappingCalculator != null ? Companion.m1643mapToTransformedXGyztTk(m1570mapFromSourcejx7JFs, offsetMappingCalculator, getSelectionWedgeAffinity()) : m1570mapFromSourcejx7JFs;
    }

    /* renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public final long m1636mapToTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMappingCalculator = null;
        ...
        if (offsetMapping != null) {
            range = Companion.m1644mapToTransformedXGyztTk$default(Companion, range, offsetMapping, null, 4, null);
        }
        return offsetMappingCalculator != null ? Companion.m1643mapToTransformedXGyztTk(range, offsetMappingCalculator, getSelectionWedgeAffinity()) : range;
    }

    /* renamed from: mapFromTransformed--jx7JFs, reason: not valid java name */
    public final long m1633mapFromTransformedjx7JFs(int offset) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMappingCalculator = null;
        ...
        long m1569mapFromDestjx7JFs = offsetMappingCalculator != null ? offsetMappingCalculator.m1569mapFromDestjx7JFs(offset) : TextRangeKt.TextRange(offset);
        return offsetMapping != null ? Companion.m1642mapFromTransformedxdX6G0(m1569mapFromDestjx7JFs, offsetMapping) : m1569mapFromDestjx7JFs;
    }

    /* renamed from: mapFromTransformed-GEjPoXI, reason: not valid java name */
    public final long m1634mapFromTransformedGEjPoXI(long range) {
        TransformedText value;
        TransformedText value2;
        State<TransformedText> state = this.outputTransformedText;
        OffsetMappingCalculator offsetMappingCalculator = null;
        ...
        if (offsetMappingCalculator != null) {
            range = Companion.m1642mapFromTransformedxdX6G0(range, offsetMappingCalculator);
        }
        return offsetMapping != null ? Companion.m1642mapFromTransformedxdX6G0(range, offsetMapping) : range;
    }
    ...
    */
    ...
    private static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            long m1643mapToTransformedXGyztTk = m1643mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange composition = untransformedValue.getComposition();
            return new TransformedText(TextFieldBuffer.m1470toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldBuffer, m1643mapToTransformedXGyztTk, composition != null ? TextRange.m6836boximpl(TransformedTextFieldState.Companion.m1643mapToTransformedXGyztTk(composition.getPackedValue(), offsetMappingCalculator, wedgeAffinity)) : null, null, outputTransformationAnnotations$foundation_release, 4, null), offsetMappingCalculator);
        }
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            TextRange composition = untransformedValue.getComposition();
            if (composition != null) {
                textRange = TextRange.m6836boximpl(TransformedTextFieldState.Companion.m1643mapToTransformedXGyztTk(composition.getPackedValue(), offsetMappingCalculator, wedgeAffinity));
            }
            return new TransformedText(new TextFieldCharSequence(visualText, m1643mapToTransformedXGyztTk, textRange, null, null, null, 56, null), offsetMappingCalculator);
        }

        /* renamed from: mapToTransformed-XGyztTk$default, reason: not valid java name */
        static /* synthetic */ long m1644mapToTransformedXGyztTk$default(Companion companion, long j, OffsetMappingCalculator offsetMappingCalculator, SelectionWedgeAffinity selectionWedgeAffinity, int i, Object obj) {
            if ((i & 4) != 0) {
        ...
        @JvmStatic
        /* renamed from: mapToTransformed-XGyztTk, reason: not valid java name */
        public final long m1643mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity selectionWedgeAffinity) {
            long TextRange;
            long m1570mapFromSourcejx7JFs = mapping.m1570mapFromSourcejx7JFs(TextRange.m6848getStartimpl(range));
            long m1570mapFromSourcejx7JFs2 = TextRange.m6842getCollapsedimpl(range) ? m1570mapFromSourcejx7JFs : mapping.m1570mapFromSourcejx7JFs(TextRange.m6843getEndimpl(range));
            ...
            if (startAffinity != null && !TextRange.m6842getCollapsedimpl(m1570mapFromSourcejx7JFs)) {
                int i = WhenMappings.$EnumSwitchMapping$0[startAffinity.ordinal()];
                if (i == 1) {
                    m1570mapFromSourcejx7JFs = TextRangeKt.TextRange(TextRange.m6848getStartimpl(m1570mapFromSourcejx7JFs));
                } else {
                    if (i != 2) {
                        throw new NoWhenBranchMatchedException();
                    }
                    m1570mapFromSourcejx7JFs = TextRangeKt.TextRange(TextRange.m6843getEndimpl(m1570mapFromSourcejx7JFs));
                }
            }
            if (wedgeAffinity != null && !TextRange.m6842getCollapsedimpl(m1570mapFromSourcejx7JFs2)) {
                int i2 = WhenMappings.$EnumSwitchMapping$0[wedgeAffinity.ordinal()];
                if (i2 == 1) {
                    TextRange = TextRangeKt.TextRange(TextRange.m6848getStartimpl(m1570mapFromSourcejx7JFs2));
                } else {
                    if (i2 != 2) {
                        throw new NoWhenBranchMatchedException();
                    }
                    TextRange = TextRangeKt.TextRange(TextRange.m6843getEndimpl(m1570mapFromSourcejx7JFs2));
                }
                m1570mapFromSourcejx7JFs2 = TextRange;
            }
            int min = Math.min(TextRange.m6846getMinimpl(m1570mapFromSourcejx7JFs), TextRange.m6846getMinimpl(m1570mapFromSourcejx7JFs2));
            int max = Math.max(TextRange.m6845getMaximpl(m1570mapFromSourcejx7JFs), TextRange.m6845getMaximpl(m1570mapFromSourcejx7JFs2));
            if (TextRange.m6847getReversedimpl(range)) {
        ...
        @JvmStatic
        /* renamed from: mapFromTransformed-xdX6-G0, reason: not valid java name */
        public final long m1642mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long m1569mapFromDestjx7JFs = mapping.m1569mapFromDestjx7JFs(TextRange.m6848getStartimpl(range));
            long m1569mapFromDestjx7JFs2 = TextRange.m6842getCollapsedimpl(range) ? m1569mapFromDestjx7JFs : mapping.m1569mapFromDestjx7JFs(TextRange.m6843getEndimpl(range));
            int min = Math.min(TextRange.m6846getMinimpl(m1569mapFromDestjx7JFs), TextRange.m6846getMinimpl(m1569mapFromDestjx7JFs2));
            int max = Math.max(TextRange.m6845getMaximpl(m1569mapFromDestjx7JFs), TextRange.m6845getMaximpl(m1569mapFromDestjx7JFs2));
            if (TextRange.m6847getReversedimpl(range)) {
                return TextRangeKt.TextRange(max, min);
            }
            return TextRangeKt.TextRange(min, max);
