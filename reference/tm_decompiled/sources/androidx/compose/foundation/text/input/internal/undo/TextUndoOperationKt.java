...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer, TextRange.m6848getStartimpl(textUndoOperation.getPreSelection()), TextRange.m6843getEndimpl(textUndoOperation.getPreSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), TextFieldBuffer.m1470toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldState.getMainBuffer(), 0L, null, null, null, 15, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer, TextRange.m6848getStartimpl(textUndoOperation.getPostSelection()), TextRange.m6843getEndimpl(textUndoOperation.getPostSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), TextFieldBuffer.m1470toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldState.getMainBuffer(), 0L, null, null, null, 15, null), true);
    }
}
