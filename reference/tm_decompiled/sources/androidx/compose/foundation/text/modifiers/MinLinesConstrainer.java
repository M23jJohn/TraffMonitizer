...
public final class MinLinesConstrainer {
    ...
    public final long m1735coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        Paragraph m6708ParagraphUl8oQg4;
        String str2;
        Paragraph m6708ParagraphUl8oQg42;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            m6708ParagraphUl8oQg4 = ParagraphKt.m6708ParagraphUl8oQg4(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? TextOverflow.INSTANCE.m7324getClipgIe3tQ8() : TextOverflow.INSTANCE.m7324getClipgIe3tQ8());
            f = m6708ParagraphUl8oQg4.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m6708ParagraphUl8oQg42 = ParagraphKt.m6708ParagraphUl8oQg4(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? TextOverflow.INSTANCE.m7324getClipgIe3tQ8() : TextOverflow.INSTANCE.m7324getClipgIe3tQ8());
            f2 = m6708ParagraphUl8oQg42.getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (minLines != 1) {
            m7343getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(f + (f2 * (minLines - 1))), 0), Constraints.m7341getMaxHeightimpl(inConstraints));
        } else {
            m7343getMinHeightimpl = Constraints.m7343getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m7344getMinWidthimpl(inConstraints), Constraints.m7342getMaxWidthimpl(inConstraints), m7343getMinHeightimpl, Constraints.m7341getMaxHeightimpl(inConstraints));
    }
}
