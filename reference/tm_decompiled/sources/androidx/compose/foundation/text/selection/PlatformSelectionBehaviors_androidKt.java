...
public final class PlatformSelectionBehaviors_androidKt {
    ...
    public static final boolean m1789canReuseh5sm0ck(TextClassificationResult textClassificationResult, CharSequence charSequence, long j) {
        return TextRange.m6841equalsimpl0(j, textClassificationResult.m1854getSelectiond9O1mEE()) && Intrinsics.areEqual(charSequence, textClassificationResult.getText());
    }

    /* renamed from: addPlatformTextContextMenuItems-71BSaZU, reason: not valid java name */
    public static final void m1788addPlatformTextContextMenuItems71BSaZU(TextContextMenuBuilderScope textContextMenuBuilderScope, Context context, boolean z, CharSequence charSequence, TextRange textRange, PlatformSelectionBehaviors platformSelectionBehaviors, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        if (Build.VERSION.SDK_INT < 28 || charSequence == null || textRange == null || platformSelectionBehaviors == null || !(platformSelectionBehaviors instanceof PlatformSelectionBehaviorsImpl)) {
            ...
            ProcessText_androidKt.m1437addProcessedTextContextMenuItemsUAq72N0(textContextMenuBuilderScope, context, z, charSequence, textRange.getPackedValue());
            return;
        }
        ((PlatformSelectionBehaviorsImpl) platformSelectionBehaviors).m1784addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation_release(textContextMenuBuilderScope, charSequence, textRange.getPackedValue(), function1);
        ProcessText_androidKt.m1437addProcessedTextContextMenuItemsUAq72N0(textContextMenuBuilderScope, context, z, charSequence, textRange.getPackedValue());
    }
}
