...
public final /* data */ class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m1798copyubNVwUQ$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m1800copyubNVwUQ(handle, j, selectionHandleAnchor, z);
    }
    ...
    public final SelectionHandleInfo m1800copyubNVwUQ(Handle handle, long position, SelectionHandleAnchor anchor, boolean visible) {
    ...
    public boolean equals(Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m4340equalsimpl0(this.position, selectionHandleInfo.position) && this.anchor == selectionHandleInfo.anchor && this.visible == selectionHandleInfo.visible;
    }

    public int hashCode() {
        return (((((this.handle.hashCode() * 31) + Offset.m4345hashCodeimpl(this.position)) * 31) + this.anchor.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.visible);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m4351toStringimpl(this.position)) + ", anchor=" + this.anchor + ", visible=" + this.visible + ')';
    }
    ...
    public final long m1801getPositionF1C5BW0() {
        return this.position;
    }
