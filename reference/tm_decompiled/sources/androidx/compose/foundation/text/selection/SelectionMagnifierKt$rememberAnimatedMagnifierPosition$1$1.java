...
final class SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            if (snapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m1809emit3MmeM6k(((Offset) obj2).m4353unboximpl(), continuation);
                }

                /* renamed from: emit-3MmeM6k, reason: not valid java name */
                public final Object m1809emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if ((animatable.getValue().m4353unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats && (j & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats && Float.intBitsToFloat((int) (animatable.getValue().m4353unboximpl() & 4294967295L)) != Float.intBitsToFloat((int) (4294967295L & j))) {
                        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(animatable, j, null), 3, null);
                        return Unit.INSTANCE;
                    }
                    Object snapTo = animatable.snapTo(Offset.m4332boximpl(j), continuation);
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ResultKt.throwOnFailure(obj);
                            this.label = 1;
                            if (Animatable.animateTo$default(this.$animatable, Offset.m4332boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
    ...
    public static final Offset invokeSuspend$lambda$0(State state) {
        ...
        return Offset.m4332boximpl(rememberAnimatedMagnifierPosition$lambda$3);
    }
}
