...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    public static final int sort$lambda$2(LayoutCoordinates layoutCoordinates, Selectable selectable, Selectable selectable2) {
        ...
        if (layoutCoordinates2 != null) {
            m4359getZeroF1C5BW0 = layoutCoordinates.mo6058localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m4359getZeroF1C5BW0());
        } else {
            m4359getZeroF1C5BW0 = Offset.INSTANCE.m4359getZeroF1C5BW0();
        }
        if (layoutCoordinates3 != null) {
            m4359getZeroF1C5BW02 = layoutCoordinates.mo6058localPositionOfR5De75A(layoutCoordinates3, Offset.INSTANCE.m4359getZeroF1C5BW0());
        } else {
            m4359getZeroF1C5BW02 = Offset.INSTANCE.m4359getZeroF1C5BW0();
        }
        int i = (int) (m4359getZeroF1C5BW0 & 4294967295L);
        int i2 = (int) (4294967295L & m4359getZeroF1C5BW02);
        if (Float.intBitsToFloat(i) == Float.intBitsToFloat(i2)) {
            return ComparisonsKt.compareValues(Float.valueOf(Float.intBitsToFloat((int) (m4359getZeroF1C5BW0 >> 32))), Float.valueOf(Float.intBitsToFloat((int) (m4359getZeroF1C5BW02 >> 32))));
        }
    ...
    public void mo1847notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4332boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1846notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4332boximpl(newPosition), Offset.m4332boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
