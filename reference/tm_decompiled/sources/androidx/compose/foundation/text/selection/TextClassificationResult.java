...
final /* data */ class TextClassificationResult {
    ...
    public static /* synthetic */ TextClassificationResult m1851copySbBc2M$default(TextClassificationResult textClassificationResult, CharSequence charSequence, long j, TextClassification textClassification, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textClassificationResult.m1853copySbBc2M(charSequence, j, textClassification);
    }
    ...
    public final TextClassificationResult m1853copySbBc2M(CharSequence text, long selection, TextClassification textClassification) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.text, textClassificationResult.text) && TextRange.m6841equalsimpl0(this.selection, textClassificationResult.selection) && Intrinsics.areEqual(this.textClassification, textClassificationResult.textClassification);
    }

    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.text.hashCode() * 31) + TextRange.m6849hashCodeimpl(this.selection)) * 31;
        hashCode = this.textClassification.hashCode();
        return hashCode2 + hashCode;
    }

    public String toString() {
        return "TextClassificationResult(text=" + ((Object) this.text) + ", selection=" + ((Object) TextRange.m6851toStringimpl(this.selection)) + ", textClassification=" + this.textClassification + ')';
    }
    ...
    public final long m1854getSelectiond9O1mEE() {
        return this.selection;
    }
