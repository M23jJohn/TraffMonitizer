...
final class TextFieldSelectionManager$maybeSuggestSelection$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = this.$platformSelectionBehaviors.mo1781suggestSelectionForLongPressOrDoubleClickpYaCww(this.$text, this.$transformedSelection, this);
        ...
        if (textRange != null) {
            ...
            long TextRange = TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextRange.m6848getStartimpl(packedValue)), offsetMapping.transformedToOriginal(TextRange.m6843getEndimpl(packedValue)));
            if (!TextRange.m6840equalsimpl(TextRange, this.$selection) && Intrinsics.areEqual(this.this$0.getValue$foundation_release().getText(), this.$text) && this.$offsetMapping == this.this$0.getOffsetMapping()) {
                ...
                m1860createTextFieldValueFDrldGo = textFieldSelectionManager.m1860createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRange);
                onValueChange$foundation_release.invoke(m1860createTextFieldValueFDrldGo);
                this.this$0.m1872setLatestSelectionOEnZFl4$foundation_release(TextRange.m6836boximpl(TextRange));
            }
