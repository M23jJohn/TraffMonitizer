...
public final class IconsKt {
    ...
    public static final ImageVector materialIcon(String str, boolean z, Function1<? super ImageVector.Builder, ImageVector.Builder> function1) {
        return function1.invoke(new ImageVector.Builder(str, Dp.m7399constructorimpl(24.0f), Dp.m7399constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, z, 96, null)).build();
    }
    ...
    public static /* synthetic */ ImageVector materialIcon$default(String str, boolean z, Function1 function1, int i, Object obj) {
        ...
        return ((ImageVector.Builder) function1.invoke(new ImageVector.Builder(str, Dp.m7399constructorimpl(24.0f), Dp.m7399constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, z, 96, null))).build();
    }

    /* renamed from: materialPath-YwgOQQI$default, reason: not valid java name */
    public static /* synthetic */ ImageVector.Builder m1887materialPathYwgOQQI$default(ImageVector.Builder builder, float f, float f2, int i, Function1 function1, int i2, Object obj) {
        ...
        return ImageVector.Builder.m5366addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, f3, null, f4, 1.0f, m4995getButtKaPHkGw, m5005getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* renamed from: materialPath-YwgOQQI, reason: not valid java name */
    public static final ImageVector.Builder m1886materialPathYwgOQQI(ImageVector.Builder builder, float f, float f2, int i, Function1<? super PathBuilder, Unit> function1) {
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m4641getBlack0d7_KjU(), null);
        int m4995getButtKaPHkGw = StrokeCap.INSTANCE.m4995getButtKaPHkGw();
        int m5005getBevelLxFBmk8 = StrokeJoin.INSTANCE.m5005getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        function1.invoke(pathBuilder);
        return ImageVector.Builder.m5366addPathoIyEayM$default(builder, pathBuilder.getNodes(), i, "", solidColor, f, null, f2, 1.0f, m4995getButtKaPHkGw, m5005getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}
