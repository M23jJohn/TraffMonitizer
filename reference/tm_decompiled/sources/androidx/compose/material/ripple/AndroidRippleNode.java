...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo1888addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m1896addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m1902getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0() { // from class: androidx.compose.material.ripple.AndroidRippleNode$$ExternalSyntheticLambda0
    ...
    public static final Unit addRipple_12SF9DM$lambda$4$lambda$3$lambda$2(AndroidRippleNode androidRippleNode) {
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m1897setRipplePropertiesbiQXAtU(getRippleSize(), MathKt.roundToInt(getTargetRadius()), m1902getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
