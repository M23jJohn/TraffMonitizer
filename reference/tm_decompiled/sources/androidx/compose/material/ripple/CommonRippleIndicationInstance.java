...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        if (Float.isNaN(this.radius)) {
            f = RippleAnimationKt.m1893getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo5121getSizeNHjbRc());
        } else {
            f = contentDrawScope.mo459toPx0680j_4(this.radius);
        }
        this.targetRadius = f;
        ...
        m1890drawRipples4WTKRHQ(contentDrawScope2, m4625unboximpl);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m4332boximpl(interaction.getPressPosition()) : null, this.targetRadius, this.bounded, null);
    ...
    private final void m1890drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        long j2;
        Iterator<Map.Entry<PressInteraction.Press, RippleAnimation>> it = this.ripples.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (pressedAlpha == 0.0f) {
                ...
                j2 = j;
                value.m1892draw4WTKRHQ(drawScope, Color.m4614copywmQWz5c$default(j2, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
            j = j2;
        }
    }
