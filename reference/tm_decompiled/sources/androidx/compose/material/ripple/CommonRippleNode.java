...
public final class CommonRippleNode extends RippleNode {
    ...
    public void mo1888addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(getBounded() ? Offset.m4332boximpl(interaction.getPressPosition()) : null, targetRadius, getBounded(), null);
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i7 < i6) {
                    if ((j2 & 255) < 128) {
                        ...
                        i3 = i5;
                        f2 = pressedAlpha;
                        ((RippleAnimation) objArr2[i8]).m1892draw4WTKRHQ(drawScope, Color.m4614copywmQWz5c$default(m1902getRippleColor0d7_KjU(), pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
                    } else {
                        i = i7;
                        i2 = i6;
                        i3 = i5;
