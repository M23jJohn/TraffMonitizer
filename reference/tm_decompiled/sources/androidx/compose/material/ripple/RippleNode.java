...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo1888addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    private RippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.rippleSize = Size.INSTANCE.m4421getZeroNHjbRc();
    ...
    public final long m1902getRippleColor0d7_KjU() {
        return this.color.mo2216invoke0d7_KjU();
    }
    ...
    public void mo448onRemeasuredozmzZPI(long size) {
        ...
        this.rippleSize = IntSizeKt.m7586toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            mo459toPx0680j_4 = RippleAnimationKt.m1893getRippleEndRadiuscSwnlzA(requireDensity, this.bounded, this.rippleSize);
        } else {
            mo459toPx0680j_4 = requireDensity.mo459toPx0680j_4(this.radius);
        }
        this.targetRadius = mo459toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo1888addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m1907drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m1902getRippleColor0d7_KjU());
        }
