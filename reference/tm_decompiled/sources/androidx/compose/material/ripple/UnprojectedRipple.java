...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1909setColorDxMtmZc(long color, float alpha) {
        long m1908calculateRippleColor5vOe2sY = m1908calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m4616equalsimpl0(color2.m4625unboximpl(), m1908calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m4605boximpl(m1908calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m4669toArgb8_81llA(m1908calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1908calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m4614copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
