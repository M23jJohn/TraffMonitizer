...
final class AppBarKt$TwoRowsTopAppBar$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            AppBarKt.m1929TopAppBarLayoutkXwM9vE(SizeKt.m918heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, windowInsets)), 0.0f, f, 1, null), new ScrolledOffset() { // from class: androidx.compose.material3.AppBarKt$TwoRowsTopAppBar$6$$ExternalSyntheticLambda0
            ...
            Modifier m918heightInVpY3zN4$default = SizeKt.m918heightInVpY3zN4$default(ClipKt.clipToBounds(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.INSTANCE, WindowInsetsKt.m958onlybOOhFvg(windowInsets, WindowInsetsSides.INSTANCE.m980getHorizontalJoeWqyM()))), 0.0f, Dp.m7399constructorimpl(f3 - f), 1, null);
            ...
            AppBarKt.m1929TopAppBarLayoutkXwM9vE(m918heightInVpY3zN4$default, (ScrolledOffset) rememberedValue, topAppBarColors.getNavigationIconContentColor(), topAppBarColors.getTitleContentColor(), topAppBarColors.getActionIconContentColor(), function24, textStyle2, f4, Arrangement.INSTANCE.getBottom(), Arrangement.INSTANCE.getStart(), intRef.element, z2, ComposableSingletons$AppBarKt.INSTANCE.m2103getLambda17$material3_release(), ComposableSingletons$AppBarKt.INSTANCE.m2104getLambda18$material3_release(), composer, 905969664, 3456);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer);
