...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = Dp.m7399constructorimpl(0);
    ...
    public final float m1945getContainerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m958onlybOOhFvg = WindowInsetsKt.m958onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m970plusgK_yJZ4(WindowInsetsSides.INSTANCE.m980getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m978getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        ...
        ContentPadding = PaddingKt.m875PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }
}
