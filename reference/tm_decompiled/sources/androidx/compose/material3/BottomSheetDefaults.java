...
public final class BottomSheetDefaults {
    ...
    private static final float Elevation = SheetBottomTokens.INSTANCE.m3669getDockedModalContainerElevationD9Ej5fM();
    private static final float SheetPeekHeight = Dp.m7399constructorimpl(56);
    private static final float SheetMaxWidth = Dp.m7399constructorimpl(640);
    ...
    public final float m1947getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer composer, int i) {
        ...
        long m4614copywmQWz5c$default = Color.m4614copywmQWz5c$default(ColorSchemeKt.getValue(ScrimTokens.INSTANCE.getContainerColor(), composer, 6), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m4614copywmQWz5c$default;
    }

    /* renamed from: getSheetPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m1949getSheetPeekHeightD9Ej5fM() {
        return SheetPeekHeight;
    }

    /* renamed from: getSheetMaxWidth-D9Ej5fM, reason: not valid java name */
    public final float m1948getSheetMaxWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m958onlybOOhFvg = WindowInsetsKt.m958onlybOOhFvg(WindowInsets_androidKt.getSafeDrawing(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.INSTANCE.m978getBottomJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m958onlybOOhFvg;
    }
    ...
    */
    public final void m1946DragHandlelgZ2HuY(Modifier modifier, float f, float f2, Shape shape, long j, Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        final float f3;
        int i4;
        ...
        if (i8 != 0) {
            ...
            if (i4 == 0) {
                ...
                if ((i3 & 9363) == 9362 || !startRestartGroup.getSkipping()) {
                    ...
                    if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                        ...
                        if (i8 != 0) {
                            f3 = SheetBottomTokens.INSTANCE.m3668getDockedDragHandleWidthD9Ej5fM();
                        }
                        if (i4 != 0) {
                            f4 = SheetBottomTokens.INSTANCE.m3667getDockedDragHandleHeightD9Ej5fM();
                        }
                        if ((i2 & 8) != 0) {
                            i3 &= -7169;
                    ...
                    final String m3160getString2EP1pXo = Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(R.string.m3c_bottom_sheet_drag_handle_description), startRestartGroup, 0);
                    f5 = SheetDefaultsKt.DragHandleVerticalPadding;
                    Modifier m880paddingVpY3zN4$default = PaddingKt.m880paddingVpY3zN4$default(companion, 0.0f, f5, 1, null);
                    ...
                    SurfaceKt.m2699SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(m880paddingVpY3zN4$default, false, (Function1) rememberedValue, 1, null), shape2, j2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
                        ...
                        public final void invoke(Composer composer3, int i10) {
                            ...
                            BoxKt.Box(SizeKt.m932sizeVpY3zN4(Modifier.INSTANCE, f3, f7), composer3, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        }
                ...
                if (endRestartGroup != null) {
                    endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$3
                        ...
                        public final void invoke(Composer composer3, int i10) {
                            BottomSheetDefaults.this.m1946DragHandlelgZ2HuY(companion, f8, f6, shape3, j3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                        }
                    });
                    return;
                }
            ...
            final String m3160getString2EP1pXo2 = Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(R.string.m3c_bottom_sheet_drag_handle_description), startRestartGroup, 0);
            f5 = SheetDefaultsKt.DragHandleVerticalPadding;
            Modifier m880paddingVpY3zN4$default2 = PaddingKt.m880paddingVpY3zN4$default(companion, 0.0f, f5, 1, null);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1620989881, "CC(remember):SheetDefaults.kt#9igjgp");
            ...
            int i92 = i3 >> 6;
            composer2 = startRestartGroup;
            SurfaceKt.m2699SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(m880paddingVpY3zN4$default2, false, (Function1) rememberedValue, 1, null), shape2, j2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer composer3, int i10) {
                    ...
                    BoxKt.Box(SizeKt.m932sizeVpY3zN4(Modifier.INSTANCE, f3, f72), composer3, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
        ...
        final String m3160getString2EP1pXo22 = Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(R.string.m3c_bottom_sheet_drag_handle_description), startRestartGroup, 0);
        f5 = SheetDefaultsKt.DragHandleVerticalPadding;
        Modifier m880paddingVpY3zN4$default22 = PaddingKt.m880paddingVpY3zN4$default(companion, 0.0f, f5, 1, null);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1620989881, "CC(remember):SheetDefaults.kt#9igjgp");
        ...
        int i922 = i3 >> 6;
        composer2 = startRestartGroup;
        SurfaceKt.m2699SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(m880paddingVpY3zN4$default22, false, (Function1) rememberedValue, 1, null), shape2, j2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final void invoke(Composer composer3, int i10) {
                ...
                BoxKt.Box(SizeKt.m932sizeVpY3zN4(Modifier.INSTANCE, f3, f722), composer3, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
