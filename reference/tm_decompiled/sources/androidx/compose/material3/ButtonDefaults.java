...
public final class ButtonDefaults {
    ...
    public final float m1973getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m1972getMinHeightD9Ej5fM() {
        return MinHeight;
    }
    ...
    public final float m1971getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final ButtonColors m1964buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1959copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1959copyjRlVdoo(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1959copyjRlVdoo;
    }
    ...
    public final ButtonColors m1966elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1959copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1959copyjRlVdoo(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors m1968filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1959copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1959copyjRlVdoo(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultFilledTonalButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getLabelTextColor()), Color.m4614copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4614copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1974outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1959copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1959copyjRlVdoo(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m4650getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m4650getTransparent0d7_KjU(), Color.m4614copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1975textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1959copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1959copyjRlVdoo(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultTextButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m4650getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m4650getTransparent0d7_KjU(), Color.m4614copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        colorScheme.setDefaultTextButtonColorsCached$material3_release(buttonColors);
        return buttonColors;
    }

    /* renamed from: buttonElevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m1965buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilledButtonTokens.INSTANCE.m3425getContainerElevationD9Ej5fM();
        }
        float f6 = f;
        if ((i2 & 2) != 0) {
            f2 = FilledButtonTokens.INSTANCE.m3431getPressedContainerElevationD9Ej5fM();
        }
        float f7 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilledButtonTokens.INSTANCE.m3428getFocusContainerElevationD9Ej5fM();
        }
        float f8 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilledButtonTokens.INSTANCE.m3429getHoverContainerElevationD9Ej5fM();
        }
        float f9 = f4;
        if ((i2 & 16) != 0) {
            f5 = FilledButtonTokens.INSTANCE.m3427getDisabledContainerElevationD9Ej5fM();
        }
        float f10 = f5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1967elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = ElevatedButtonTokens.INSTANCE.m3344getContainerElevationD9Ej5fM();
        }
        float f6 = f;
        if ((i2 & 2) != 0) {
            f2 = ElevatedButtonTokens.INSTANCE.m3350getPressedContainerElevationD9Ej5fM();
        }
        float f7 = f2;
        if ((i2 & 4) != 0) {
            f3 = ElevatedButtonTokens.INSTANCE.m3347getFocusContainerElevationD9Ej5fM();
        }
        float f8 = f3;
        if ((i2 & 8) != 0) {
            f4 = ElevatedButtonTokens.INSTANCE.m3348getHoverContainerElevationD9Ej5fM();
        }
        float f9 = f4;
        if ((i2 & 16) != 0) {
            f5 = ElevatedButtonTokens.INSTANCE.m3346getDisabledContainerElevationD9Ej5fM();
        }
        float f10 = f5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1969filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilledTonalButtonTokens.INSTANCE.m3448getContainerElevationD9Ej5fM();
        }
        float f6 = f;
        if ((i2 & 2) != 0) {
            f2 = FilledTonalButtonTokens.INSTANCE.m3454getPressedContainerElevationD9Ej5fM();
        }
        float f7 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilledTonalButtonTokens.INSTANCE.m3451getFocusContainerElevationD9Ej5fM();
        }
        float f8 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilledTonalButtonTokens.INSTANCE.m3452getHoverContainerElevationD9Ej5fM();
        }
        float f9 = f4;
        if ((i2 & 16) != 0) {
            f5 = Dp.m7399constructorimpl(0);
        }
        float f10 = f5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke m327BorderStrokecXLIe8U = BorderStrokeKt.m327BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m3530getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke outlinedButtonBorder(boolean z, Composer composer, int i, int i2) {
        ...
        float m3530getOutlineWidthD9Ej5fM = OutlinedButtonTokens.INSTANCE.m3530getOutlineWidthD9Ej5fM();
        if (z) {
            composer.startReplaceGroup(-855870548);
            ComposerKt.sourceInformation(composer, "893@41926L5");
            m4614copywmQWz5c$default = ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-855783004);
            ComposerKt.sourceInformation(composer, "895@42011L5");
            m4614copywmQWz5c$default = Color.m4614copywmQWz5c$default(ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        BorderStroke m327BorderStrokecXLIe8U = BorderStrokeKt.m327BorderStrokecXLIe8U(m3530getOutlineWidthD9Ej5fM, m4614copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        float m7399constructorimpl = Dp.m7399constructorimpl(24);
        ButtonHorizontalPadding = m7399constructorimpl;
        float f = 8;
        float m7399constructorimpl2 = Dp.m7399constructorimpl(f);
        ButtonVerticalPadding = m7399constructorimpl2;
        PaddingValues m874PaddingValuesa9UjIt4 = PaddingKt.m874PaddingValuesa9UjIt4(m7399constructorimpl, m7399constructorimpl2, m7399constructorimpl, m7399constructorimpl2);
        ContentPadding = m874PaddingValuesa9UjIt4;
        float f2 = 16;
        float m7399constructorimpl3 = Dp.m7399constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = m7399constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m874PaddingValuesa9UjIt4(m7399constructorimpl3, m7399constructorimpl2, m7399constructorimpl, m7399constructorimpl2);
        float m7399constructorimpl4 = Dp.m7399constructorimpl(12);
        TextButtonHorizontalPadding = m7399constructorimpl4;
        TextButtonContentPadding = PaddingKt.m874PaddingValuesa9UjIt4(m7399constructorimpl4, m874PaddingValuesa9UjIt4.getTop(), m7399constructorimpl4, m874PaddingValuesa9UjIt4.getBottom());
        float m7399constructorimpl5 = Dp.m7399constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = m7399constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m874PaddingValuesa9UjIt4(m7399constructorimpl4, m874PaddingValuesa9UjIt4.getTop(), m7399constructorimpl5, m874PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m7399constructorimpl(58);
        MinHeight = Dp.m7399constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m3430getIconSizeD9Ej5fM();
        IconSpacing = Dp.m7399constructorimpl(f);
    }
}
