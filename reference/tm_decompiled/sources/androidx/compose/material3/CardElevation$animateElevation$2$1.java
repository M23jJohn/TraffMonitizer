...
final class CardElevation$animateElevation$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0048, code lost:
        ...
        if (r6.$animatable.snapTo(androidx.compose.ui.unit.Dp.m7397boximpl(r6.$target), r6) == r0) goto L31;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x00c1, code lost:
        ...
        if (androidx.compose.material3.internal.ElevationKt.m3057animateElevationrAjV9yQ(r6.$animatable, r6.$target, r3, r6.$interaction, r6) == r0) goto L31;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!Dp.m7404equalsimpl0(this.$animatable.getTargetValue().m7413unboximpl(), this.$target)) {
                if (this.$enabled) {
                    float m7413unboximpl = this.$animatable.getTargetValue().m7413unboximpl();
                    f = this.this$0.pressedElevation;
                    DragInteraction.Start start = null;
                    if (Dp.m7404equalsimpl0(m7413unboximpl, f)) {
                        start = new PressInteraction.Press(Offset.INSTANCE.m4359getZeroF1C5BW0(), null);
                    } else {
                        f2 = this.this$0.hoveredElevation;
                        if (Dp.m7404equalsimpl0(m7413unboximpl, f2)) {
                            start = new HoverInteraction.Enter();
                        } else {
                            f3 = this.this$0.focusedElevation;
                            if (Dp.m7404equalsimpl0(m7413unboximpl, f3)) {
                                start = new FocusInteraction.Focus();
                            } else {
                                f4 = this.this$0.draggedElevation;
                                if (Dp.m7404equalsimpl0(m7413unboximpl, f4)) {
