...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m7397boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            Object animatable2 = new Animatable(Dp.m7397boximpl(f), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
            composer.updateRememberedValue(animatable2);
            rememberedValue3 = animatable2;
        }
        Animatable animatable3 = (Animatable) rememberedValue3;
        ComposerKt.sourceInformationMarkerEnd(composer);
        Dp m7397boximpl = Dp.m7397boximpl(f);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m7397boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue4, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m7404equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m7404equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m7404equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m7404equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m7405hashCodeimpl(this.defaultElevation) * 31) + Dp.m7405hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7405hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7405hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7405hashCodeimpl(this.disabledElevation);
    }
}
