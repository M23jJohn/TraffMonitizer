...
public final class CheckboxColors {
    ...
    public static /* synthetic */ CheckboxColors m1990copy2qZNXz8$default(CheckboxColors checkboxColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState toggleableState, Composer composer, int i) {
        ...
        State<Color> m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean z, ToggleableState toggleableState, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer2, 0, 12);
            composer2.endReplaceGroup();
        } else {
            composer2 = composer;
            composer2.startReplaceGroup(-392031362);
            ComposerKt.sourceInformation(composer2, "523@23032L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4605boximpl(j2), composer2, 0);
            composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.checkedCheckmarkColor, checkboxColors.checkedCheckmarkColor) && Color.m4616equalsimpl0(this.uncheckedCheckmarkColor, checkboxColors.uncheckedCheckmarkColor) && Color.m4616equalsimpl0(this.checkedBoxColor, checkboxColors.checkedBoxColor) && Color.m4616equalsimpl0(this.uncheckedBoxColor, checkboxColors.uncheckedBoxColor) && Color.m4616equalsimpl0(this.disabledCheckedBoxColor, checkboxColors.disabledCheckedBoxColor) && Color.m4616equalsimpl0(this.disabledUncheckedBoxColor, checkboxColors.disabledUncheckedBoxColor) && Color.m4616equalsimpl0(this.disabledIndeterminateBoxColor, checkboxColors.disabledIndeterminateBoxColor) && Color.m4616equalsimpl0(this.checkedBorderColor, checkboxColors.checkedBorderColor) && Color.m4616equalsimpl0(this.uncheckedBorderColor, checkboxColors.uncheckedBorderColor) && Color.m4616equalsimpl0(this.disabledBorderColor, checkboxColors.disabledBorderColor) && Color.m4616equalsimpl0(this.disabledUncheckedBorderColor, checkboxColors.disabledUncheckedBorderColor) && Color.m4616equalsimpl0(this.disabledIndeterminateBorderColor, checkboxColors.disabledIndeterminateBorderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m4622hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m4622hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m4622hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m4622hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m4622hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m4622hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m4622hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
