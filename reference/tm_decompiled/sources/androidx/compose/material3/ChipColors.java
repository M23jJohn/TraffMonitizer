...
public final class ChipColors {
    ...
    public static /* synthetic */ ChipColors m2009copyFD3wquc$default(ChipColors chipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, int i, Object obj) {
        long j9;
        long j10;
        ...
        return chipColors.m2011copyFD3wquc(j10, j12, j13, j14, j15, j16, j17, j9);
    }

    /* renamed from: copy-FD3wquc, reason: not valid java name */
    public final ChipColors m2011copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m2010containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2020labelColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2021leadingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2022trailingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m4616equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m4616equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m4616equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m4616equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m4616equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m4616equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m4616equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.labelColor)) * 31) + Color.m4622hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4622hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4622hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
