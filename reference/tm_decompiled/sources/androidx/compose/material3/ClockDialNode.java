...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState analogTimePickerState, boolean z, int i) {
        ...
        this.selection = i;
        this.center = IntOffset.INSTANCE.m7542getZeronOccac();
    ...
    public final float getMaxDist() {
        ...
        return requireDensity.mo459toPx0680j_4(f);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo448onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m7580getCenterozmzZPI(size);
    }
    ...
    public final void m2038updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (TimePickerSelectionMode.m2903equalsimpl0(this.selection, selection)) {
            return;
        }
