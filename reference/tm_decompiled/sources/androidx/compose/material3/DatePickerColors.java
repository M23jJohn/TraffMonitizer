...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        ...
        if (z3) {
            ...
            m158animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m4605boximpl(j2), composer, 0);
            ...
            composer2 = composer;
            m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer2, 0, 12);
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            m4650getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m4650getTransparent0d7_KjU = Color.INSTANCE.m4650getTransparent0d7_KjU();
        }
        long j = m4650getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceGroup(-217363149);
            ComposerKt.sourceInformation(composer, "941@45516L88");
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer2, 0, 12);
            composer2.endReplaceGroup();
        } else {
            composer2 = composer;
            composer2.startReplaceGroup(-217247953);
            ComposerKt.sourceInformation(composer2, "943@45634L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4605boximpl(j), composer2, 0);
            composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        State<Color> m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            m4650getTransparent0d7_KjU = z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            m4650getTransparent0d7_KjU = Color.INSTANCE.m4650getTransparent0d7_KjU();
        }
        State<Color> m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(m4650getTransparent0d7_KjU, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m4616equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m4616equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m4616equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m4616equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m4616equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m4616equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m4616equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m4616equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m4616equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m4616equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m4616equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m4616equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m4616equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m4616equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m4616equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m4616equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m4616equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m4616equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m4616equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m4616equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m4616equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.titleContentColor)) * 31) + Color.m4622hashCodeimpl(this.headlineContentColor)) * 31) + Color.m4622hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m4622hashCodeimpl(this.subheadContentColor)) * 31) + Color.m4622hashCodeimpl(this.yearContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m4622hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m4622hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m4622hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m4622hashCodeimpl(this.dayContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m4622hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m4622hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m4622hashCodeimpl(this.todayContentColor)) * 31) + Color.m4622hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m4622hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m4622hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
