...
public final class DateRangeInputKt {
    private static final float TextFieldSpacing = Dp.m7399constructorimpl(8);
    ...
    public static final void DateRangeInputContent(final Long l, final Long l2, final Function2<? super Long, ? super Long, Unit> function2, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 4793491) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            String m3160getString2EP1pXo4 = Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(R.string.m3c_date_range_input_invalid_range_input), startRestartGroup, 0);
            ...
            if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue2 = new DateInputValidator(intRange2, selectableDates2, dateInputFormat, datePickerFormatter, m3160getString2EP1pXo, m3160getString2EP1pXo2, m3160getString2EP1pXo3, m3160getString2EP1pXo4, null, null, 768, null);
            ...
            Arrangement.HorizontalOrVertical m733spacedBy0680j_4 = Arrangement.INSTANCE.m733spacedBy0680j_4(TextFieldSpacing);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 693286680, "CC(Row)P(2,1,3)98@4939L58,99@5002L130:Row.kt#2w3rfo");
            MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(m733spacedBy0680j_4, Alignment.INSTANCE.getTop(), startRestartGroup, 6);
            ...
            final String m3160getString2EP1pXo5 = Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(R.string.m3c_date_range_picker_start_headline), startRestartGroup, 0);
            Modifier weight$default = RowScope.CC.weight$default(rowScopeInstance, Modifier.INSTANCE, 0.5f, false, 2, null);
            int m2332getStartDateInputJ2x2o4M = InputIdentifier.INSTANCE.m2332getStartDateInputJ2x2o4M();
            ...
            int i7 = i2;
            DateInputKt.m2148DateInputTextFieldtQNruF0(weight$default, l, (Function1) rememberedValue3, calendarModel, ComposableLambdaKt.rememberComposableLambda(801434508, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$2$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        String str = m3160getString2EP1pXo5;
                        Modifier.Companion companion6 = Modifier.INSTANCE;
                        ComposerKt.sourceInformationMarkerStart(composer2, -1505886067, "CC(remember):DateRangeInput.kt#9igjgp");
                        boolean changed3 = composer2.changed(m3160getString2EP1pXo5) | composer2.changed(upperCase);
                        final String str2 = m3160getString2EP1pXo5;
                        ...
                        TextKt.m2849Text4IGK_g(str, SemanticsModifierKt.semantics$default(companion6, false, (Function1) rememberedValue4, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131068);
                        if (ComposerKt.isTraceInProgress()) {
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    TextKt.m2849Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$2$3.1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        }
            ...
            }, startRestartGroup, 54), m2332getStartDateInputJ2x2o4M, dateInputValidator, dateInputFormat3, defaultLocale, datePickerColors, startRestartGroup, ((i2 << 3) & 112) | 1794048 | i5, i6);
            Strings.Companion companion6 = Strings.INSTANCE;
            final String m3160getString2EP1pXo6 = Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(R.string.m3c_date_range_picker_end_headline), startRestartGroup, 0);
            Modifier weight$default2 = RowScope.CC.weight$default(rowScopeInstance, Modifier.INSTANCE, 0.5f, false, 2, null);
            int m2330getEndDateInputJ2x2o4M = InputIdentifier.INSTANCE.m2330getEndDateInputJ2x2o4M();
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            DateInputKt.m2148DateInputTextFieldtQNruF0(weight$default2, l2, (Function1) rememberedValue4, calendarModel, ComposableLambdaKt.rememberComposableLambda(911487285, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$2$5
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        String str = m3160getString2EP1pXo6;
                        Modifier.Companion companion7 = Modifier.INSTANCE;
                        ComposerKt.sourceInformationMarkerStart(composer2, -1505852885, "CC(remember):DateRangeInput.kt#9igjgp");
                        boolean changed3 = composer2.changed(m3160getString2EP1pXo6) | composer2.changed(upperCase);
                        final String str2 = m3160getString2EP1pXo6;
                        final String str3 = upperCase;
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        TextKt.m2849Text4IGK_g(str, SemanticsModifierKt.semantics$default(companion7, false, (Function1) rememberedValue5, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131068);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    TextKt.m2849Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangeInputKt$DateRangeInputContent$2$6.1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        }
            ...
            }, startRestartGroup, 54), m2330getEndDateInputJ2x2o4M, dateInputValidator, dateInputFormat3, defaultLocale, datePickerColors, startRestartGroup, i4 | 1794048 | i5, i6);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
