...
public final class DisplayMode {
    ...
    private static final int Picker = m2218constructorimpl(0);
    private static final int Input = m2218constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m2217boximpl(int i) {
    ...
    public static String m2222toStringimpl(int i) {
        return m2220equalsimpl0(i, Picker) ? "Picker" : m2220equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
