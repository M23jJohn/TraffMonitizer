...
public final class DrawerDefaults {
    ...
    private static final float ModalDrawerElevation = ElevationTokens.INSTANCE.m3358getLevel0D9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m3513getStandardContainerElevationD9Ej5fM();
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m3513getStandardContainerElevationD9Ej5fM();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m3510getContainerWidthD9Ej5fM();
    ...
    public final float m2231getMaximumDrawerWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m958onlybOOhFvg = WindowInsetsKt.m958onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m970plusgK_yJZ4(WindowInsetsSides.INSTANCE.m985getVerticalJoeWqyM(), WindowInsetsSides.INSTANCE.m983getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
