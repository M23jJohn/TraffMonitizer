...
public final class EnterAlwaysScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo607onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if ((this.this$0.getState().getHeightOffset() == 0.0f || this.this$0.getState().getHeightOffset() == this.this$0.getState().getHeightOffsetLimit()) && Offset.m4344getYimpl(consumed) == 0.0f && Offset.m4344getYimpl(available) > 0.0f) {
    ...
    */
    public Object mo606onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof EnterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$1) {
            ...
            if ((enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    obj = NestedScrollConnection.CC.m5792onPostFlingRZ2iAVY$suspendImpl(this, j, j2, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                ...
                obj = AppBarKt.settleAppBar(state, m7642getYimpl, flingAnimationSpec, snapAnimationSpec, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                if (obj != coroutine_suspended) {
                    j4 = packedValue;
                    return Velocity.m7632boximpl(Velocity.m7645plusAH228Gc(j4, ((Velocity) obj).getPackedValue()));
                }
        ...
        obj = AppBarKt.settleAppBar(state2, m7642getYimpl2, flingAnimationSpec2, snapAnimationSpec2, enterAlwaysScrollBehavior$nestedScrollConnection$1$onPostFling$122);
        if (obj != coroutine_suspended) {
        }
        return coroutine_suspended;
    }
