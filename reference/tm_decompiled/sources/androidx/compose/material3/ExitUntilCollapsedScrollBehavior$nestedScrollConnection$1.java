...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public /* synthetic */ Object mo608onPreFlingQWom1Mo(long j, Continuation continuation) {
        return NestedScrollConnection.CC.m5793onPreFlingQWom1Mo$suspendImpl(this, j, continuation);
    }
    ...
    public long mo609onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m4344getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m4359getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m4344getYimpl(available));
        if (heightOffset != this.this$0.getState().getHeightOffset()) {
            return Offset.m4337copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m4359getZeroF1C5BW0();
    }
    ...
    public long mo607onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m4344getYimpl(consumed));
        if (Offset.m4344getYimpl(available) < 0.0f || Offset.m4344getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m4344getYimpl(consumed));
            return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
        }
        if (Offset.m4344getYimpl(consumed) == 0.0f && Offset.m4344getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m4344getYimpl(available) > 0.0f) {
    ...
    */
    public Object mo606onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1) {
            ...
            if ((exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    obj = NestedScrollConnection.CC.m5792onPostFlingRZ2iAVY$suspendImpl(this, j, j2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                ...
                if (i != 1) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    return Velocity.m7632boximpl(Velocity.m7645plusAH228Gc(j4, ((Velocity) obj).getPackedValue()));
                }
                ...
                float m7642getYimpl = Velocity.m7642getYimpl(j3);
                ...
                obj = AppBarKt.settleAppBar(state, m7642getYimpl, flingAnimationSpec, snapAnimationSpec, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$12);
                if (obj != coroutine_suspended) {
                    j4 = packedValue;
                    return Velocity.m7632boximpl(Velocity.m7645plusAH228Gc(j4, ((Velocity) obj).getPackedValue()));
                }
        ...
        float m7642getYimpl2 = Velocity.m7642getYimpl(j3);
        ...
        obj = AppBarKt.settleAppBar(state2, m7642getYimpl2, flingAnimationSpec2, snapAnimationSpec2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$122);
        if (obj != coroutine_suspended) {
        }
        return coroutine_suspended;
    }
