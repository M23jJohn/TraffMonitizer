...
public final class FabPosition {
    ...
    private static final int Start = m2254constructorimpl(0);
    private static final int Center = m2254constructorimpl(1);
    private static final int End = m2254constructorimpl(2);
    private static final int EndOverlay = m2254constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m2253boximpl(int i) {
    ...
    public static String m2258toStringimpl(int i) {
        return m2256equalsimpl0(i, Start) ? "FabPosition.Start" : m2256equalsimpl0(i, Center) ? "FabPosition.Center" : m2256equalsimpl0(i, End) ? "FabPosition.End" : "FabPosition.EndOverlay";
    }
}
