...
public final class FilterChipDefaults {
    ...
    private static final float Height = FilterChipTokens.INSTANCE.m3458getContainerHeightD9Ej5fM();
    private static final float IconSize = FilterChipTokens.INSTANCE.m3474getIconSizeD9Ej5fM();

    private FilterChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m2269getHeightD9Ej5fM() {
        return Height;
    }
    ...
    public final SelectableChipColors m2267filterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long m4651getUnspecified0d7_KjU11 = (i3 & 1024) != 0 ? Color.INSTANCE.m4651getUnspecified0d7_KjU() : j11;
        long m4651getUnspecified0d7_KjU12 = (i3 & 2048) != 0 ? Color.INSTANCE.m4651getUnspecified0d7_KjU() : j12;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1831479801, i, i2, "androidx.compose.material3.FilterChipDefaults.filterChipColors (Chip.kt:1308)");
        }
        SelectableChipColors m2616copydaRQuJA = getDefaultFilterChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2616copydaRQuJA(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4, m4651getUnspecified0d7_KjU5, m4651getUnspecified0d7_KjU6, m4651getUnspecified0d7_KjU7, m4651getUnspecified0d7_KjU8, m4651getUnspecified0d7_KjU9, m4651getUnspecified0d7_KjU10, m4651getUnspecified0d7_KjU11, m4651getUnspecified0d7_KjU12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2616copydaRQuJA;
    }
    ...
    public final SelectableChipElevation m2268filterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilterChipTokens.INSTANCE.m3465getFlatContainerElevationD9Ej5fM();
        }
        float f7 = f;
        if ((i2 & 2) != 0) {
            f2 = FilterChipTokens.INSTANCE.m3469getFlatSelectedPressedContainerElevationD9Ej5fM();
        }
        float f8 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilterChipTokens.INSTANCE.m3466getFlatSelectedFocusContainerElevationD9Ej5fM();
        }
        float f9 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilterChipTokens.INSTANCE.m3467getFlatSelectedHoverContainerElevationD9Ej5fM();
        }
        float f10 = f4;
        float m3459getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m3459getDraggedContainerElevationD9Ej5fM() : f5;
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(f7, f8, f9, f10, m3459getDraggedContainerElevationD9Ej5fM, f11, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke m2266filterChipBorder_7El2pE(boolean z, boolean z2, long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m4650getTransparent0d7_KjU = (i2 & 8) != 0 ? Color.INSTANCE.m4650getTransparent0d7_KjU() : j2;
        long m4614copywmQWz5c$default = (i2 & 16) != 0 ? Color.m4614copywmQWz5c$default(ColorSchemeKt.getValue(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), composer, 6), FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineOpacity(), 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m4650getTransparent0d7_KjU2 = (i2 & 32) != 0 ? Color.INSTANCE.m4650getTransparent0d7_KjU() : j4;
        float m3472getFlatUnselectedOutlineWidthD9Ej5fM = (i2 & 64) != 0 ? FilterChipTokens.INSTANCE.m3472getFlatUnselectedOutlineWidthD9Ej5fM() : f;
        float m3468getFlatSelectedOutlineWidthD9Ej5fM = (i2 & 128) != 0 ? FilterChipTokens.INSTANCE.m3468getFlatSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1138342447, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipBorder (Chip.kt:1415)");
        }
        if (!z) {
            value = z2 ? m4650getTransparent0d7_KjU2 : m4614copywmQWz5c$default;
        } else if (z2) {
            value = m4650getTransparent0d7_KjU;
        }
        if (z2) {
            m3472getFlatUnselectedOutlineWidthD9Ej5fM = m3468getFlatSelectedOutlineWidthD9Ej5fM;
        }
        BorderStroke m327BorderStrokecXLIe8U = BorderStrokeKt.m327BorderStrokecXLIe8U(m3472getFlatUnselectedOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final SelectableChipColors m2264elevatedFilterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        SelectableChipColors m2616copydaRQuJA = getDefaultElevatedFilterChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2616copydaRQuJA(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4, m4651getUnspecified0d7_KjU5, m4651getUnspecified0d7_KjU6, m4651getUnspecified0d7_KjU7, m4651getUnspecified0d7_KjU8, m4651getUnspecified0d7_KjU9, m4651getUnspecified0d7_KjU10, m4651getUnspecified0d7_KjU11, m4651getUnspecified0d7_KjU12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final SelectableChipElevation m2265elevatedFilterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilterChipTokens.INSTANCE.m3460getElevatedContainerElevationD9Ej5fM();
        }
        float f7 = f;
        if ((i2 & 2) != 0) {
            f2 = FilterChipTokens.INSTANCE.m3464getElevatedPressedContainerElevationD9Ej5fM();
        }
        float f8 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilterChipTokens.INSTANCE.m3462getElevatedFocusContainerElevationD9Ej5fM();
        }
        float f9 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilterChipTokens.INSTANCE.m3463getElevatedHoverContainerElevationD9Ej5fM();
        }
        float f10 = f4;
        float m3459getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m3459getDraggedContainerElevationD9Ej5fM() : f5;
        float m3461getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m3461getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(f7, f8, f9, f10, m3459getDraggedContainerElevationD9Ej5fM, m3461getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
