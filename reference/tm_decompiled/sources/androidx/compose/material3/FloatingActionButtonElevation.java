...
public class FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m7404equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m7404equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m7404equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation)) {
            return Dp.m7404equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m7405hashCodeimpl(this.defaultElevation) * 31) + Dp.m7405hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7405hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7405hashCodeimpl(this.hoveredElevation);
    }
}
