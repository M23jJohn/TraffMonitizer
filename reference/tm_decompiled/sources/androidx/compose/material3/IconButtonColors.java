...
public final class IconButtonColors {
    ...
    public static /* synthetic */ IconButtonColors m2284copyjRlVdoo$default(IconButtonColors iconButtonColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return iconButtonColors.m2287copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? iconButtonColors.disabledContentColor : j4);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final IconButtonColors m2287copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m2285containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2286contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, iconButtonColors.containerColor) && Color.m4616equalsimpl0(this.contentColor, iconButtonColors.contentColor) && Color.m4616equalsimpl0(this.disabledContainerColor, iconButtonColors.disabledContainerColor) && Color.m4616equalsimpl0(this.disabledContentColor, iconButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.contentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledContentColor);
    }
}
