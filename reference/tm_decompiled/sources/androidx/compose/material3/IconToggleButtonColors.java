...
public final class IconToggleButtonColors {
    ...
    public static /* synthetic */ IconToggleButtonColors m2309copytNS2XkQ$default(IconToggleButtonColors iconToggleButtonColors, long j, long j2, long j3, long j4, long j5, long j6, int i, Object obj) {
        if ((i & 1) != 0) {
            j = iconToggleButtonColors.containerColor;
        }
        return iconToggleButtonColors.m2310copytNS2XkQ(j, (i & 2) != 0 ? iconToggleButtonColors.contentColor : j2, (i & 4) != 0 ? iconToggleButtonColors.disabledContainerColor : j3, (i & 8) != 0 ? iconToggleButtonColors.disabledContentColor : j4, (i & 16) != 0 ? iconToggleButtonColors.checkedContainerColor : j5, (i & 32) != 0 ? iconToggleButtonColors.checkedContentColor : j6);
    }

    /* renamed from: copy-tNS2XkQ, reason: not valid java name */
    public final IconToggleButtonColors m2310copytNS2XkQ(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor) {
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4605boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m4616equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m4616equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m4616equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m4616equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m4616equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.contentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4622hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.checkedContentColor);
    }
}
