...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m2324constructorimpl(0);
    private static final int StartDateInput = m2324constructorimpl(1);
    private static final int EndDateInput = m2324constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m2323boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2324constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2325equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m2325equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2327hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2331getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m2332getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m2330getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    public String toString() {
        return m2328toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2328toStringimpl(int i) {
        return m2326equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m2326equalsimpl0(i, StartDateInput) ? "StartDateInput" : m2326equalsimpl0(i, EndDateInput) ? "EndDateInput" : "Unknown";
    }
}
