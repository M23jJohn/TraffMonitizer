...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m2362constructorimpl(1);
    private static final int TwoLine = m2362constructorimpl(2);
    private static final int ThreeLine = m2362constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m2360boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2362constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2363equalsimpl(int i, Object obj) {
    ...
    public static int m2365hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2366toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m2363equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m2365hashCodeimpl(this.lines);
    }

    public String toString() {
        return m2366toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m2367compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m2361compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m2367compareToyh95HIg(int i) {
        return m2361compareToyh95HIg(this.lines, i);
    }
