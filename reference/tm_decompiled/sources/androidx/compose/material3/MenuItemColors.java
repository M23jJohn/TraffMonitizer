...
public final class MenuItemColors {
    ...
    public static /* synthetic */ MenuItemColors m2386copytNS2XkQ$default(MenuItemColors menuItemColors, long j, long j2, long j3, long j4, long j5, long j6, int i, Object obj) {
        if ((i & 1) != 0) {
            j = menuItemColors.textColor;
        }
        return menuItemColors.m2387copytNS2XkQ(j, (i & 2) != 0 ? menuItemColors.leadingIconColor : j2, (i & 4) != 0 ? menuItemColors.trailingIconColor : j3, (i & 8) != 0 ? menuItemColors.disabledTextColor : j4, (i & 16) != 0 ? menuItemColors.disabledLeadingIconColor : j5, (i & 32) != 0 ? menuItemColors.disabledTrailingIconColor : j6);
    }

    /* renamed from: copy-tNS2XkQ, reason: not valid java name */
    public final MenuItemColors m2387copytNS2XkQ(long textColor, long leadingIconColor, long trailingIconColor, long disabledTextColor, long disabledLeadingIconColor, long disabledTrailingIconColor) {
    ...
    public final long m2395textColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2394leadingIconColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2396trailingIconColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.textColor, menuItemColors.textColor) && Color.m4616equalsimpl0(this.leadingIconColor, menuItemColors.leadingIconColor) && Color.m4616equalsimpl0(this.trailingIconColor, menuItemColors.trailingIconColor) && Color.m4616equalsimpl0(this.disabledTextColor, menuItemColors.disabledTextColor) && Color.m4616equalsimpl0(this.disabledLeadingIconColor, menuItemColors.disabledLeadingIconColor) && Color.m4616equalsimpl0(this.disabledTrailingIconColor, menuItemColors.disabledTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((Color.m4622hashCodeimpl(this.textColor) * 31) + Color.m4622hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4622hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4622hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledTrailingIconColor);
    }
}
