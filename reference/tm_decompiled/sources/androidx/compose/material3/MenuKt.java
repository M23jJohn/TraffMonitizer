...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m7399constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m7399constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m7399constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m7399constructorimpl(280);

    /* renamed from: DropdownMenuContent-Qj0Zi0g, reason: not valid java name */
    public static final void m2397DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long j, final float f, final float f2, final BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        int i2;
        boolean z;
        int i3;
        Object obj;
        ...
        if ((i2 & 306783379) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                obj = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        ...
                        graphicsLayerScope.mo4796setTransformOrigin__ExYCQ(mutableState.getValue().getPackedValue());
                    }
                };
            ...
            ComposableLambda rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1573559053, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m880paddingVpY3zN4$default(Modifier.this, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
            ...
            int i4 = i3 >> 9;
            int i5 = i3 >> 6;
            SurfaceKt.m2699SurfaceT9BRK9s(graphicsLayer, shape, j, 0L, f, f2, borderStroke, rememberComposableLambda, startRestartGroup, (i4 & 896) | (i4 & 112) | 12582912 | (57344 & i5) | (458752 & i5) | (i5 & 3670016), 8);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$3
                ...
                public final void invoke(Composer composer3, int i6) {
                    MenuKt.m2397DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getLabelLarge(), ComposableLambdaKt.rememberComposableLambda(1065051884, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            ProvidedValue<Color> provides = ContentColorKt.getLocalContentColor().provides(Color.m4605boximpl(menuItemColors.m2394leadingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides, ComposableLambdaKt.rememberComposableLambda(2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m915defaultMinSizeVpY3zN4$default = SizeKt.m915defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m3491getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer3, m915defaultMinSizeVpY3zN4$default);
                        ...
                        ProvidedValue<Color> provides2 = ContentColorKt.getLocalContentColor().provides(Color.m4605boximpl(menuItemColors.m2395textColorvNxB06k$material3_release(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(provides2, ComposableLambdaKt.rememberComposableLambda(-1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (function25 != null) {
                                        m7399constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m7399constructorimpl = Dp.m7399constructorimpl(0);
                                    }
                                    float f = m7399constructorimpl;
                                    if (function26 != null) {
                                        m7399constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m7399constructorimpl2 = Dp.m7399constructorimpl(0);
                                    }
                                    Modifier m882paddingqDBjuR0$default = PaddingKt.m882paddingqDBjuR0$default(weight$default, f, 0.0f, m7399constructorimpl2, 0.0f, 10, null);
                        ...
                        if (function23 != null) {
                            ProvidedValue<Color> provides3 = ContentColorKt.getLocalContentColor().provides(Color.m4605boximpl(menuItemColors.m2396trailingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides3, ComposableLambdaKt.rememberComposableLambda(580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m915defaultMinSizeVpY3zN4$default = SizeKt.m915defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m3499getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
    ...
    */
    ...
    static {
        float f = 48;
        MenuVerticalMargin = Dp.m7399constructorimpl(f);
        MenuListItemContainerHeight = Dp.m7399constructorimpl(f);
    }
}
