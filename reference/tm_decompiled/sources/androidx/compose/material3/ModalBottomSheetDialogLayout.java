...
final class ModalBottomSheetDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public ModalBottomSheetDialogLayout(Context context, Window window, boolean z, Function0<Unit> function0, Animatable<Float, AnimationVector1D> animatable, CoroutineScope coroutineScope) {
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2128getLambda2$material3_release(), null, 2, null);
    }
    ...
    private final void maybeRegisterBackCallback() {
        ...
        if (this.backCallback == null) {
            if (Build.VERSION.SDK_INT >= 34) {
                createBackCallback = Listener$$ExternalSyntheticApiModelOutline0.m3069m((Object) Api34Impl.createBackCallback(this.onDismissRequest, this.predictiveBackProgress, this.scope));
            } else {
