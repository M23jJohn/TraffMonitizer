...
public final class NavigationBarArrangement {
    ...
    private static final int EqualWeight = m2406constructorimpl(0);
    private static final int Centered = m2406constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NavigationBarArrangement m2405boximpl(int i) {
        return new NavigationBarArrangement(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2406constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2407equalsimpl(int i, Object obj) {
        return (obj instanceof NavigationBarArrangement) && i == ((NavigationBarArrangement) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2408equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2409hashCodeimpl(int i) {
        return i;
    }
    ...
    public String toString() {
        return m2410toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2410toStringimpl(int i) {
        return m2408equalsimpl0(i, EqualWeight) ? "EqualWeight" : m2408equalsimpl0(i, Centered) ? "Centered" : "Unknown";
    }
}
