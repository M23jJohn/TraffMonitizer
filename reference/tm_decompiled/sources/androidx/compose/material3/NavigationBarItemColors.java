...
public final class NavigationBarItemColors {
    ...
    public final long m2421getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationBarItemColors m2416copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2425iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m2426textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m4616equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m4616equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m4616equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m4616equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m4616equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m4616equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
