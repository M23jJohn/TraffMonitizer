...
public final class NavigationItemIconPosition {
    ...
    private static final int Top = m2459constructorimpl(0);
    private static final int Start = m2459constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NavigationItemIconPosition m2458boximpl(int i) {
        return new NavigationItemIconPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2459constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2460equalsimpl(int i, Object obj) {
        return (obj instanceof NavigationItemIconPosition) && i == ((NavigationItemIconPosition) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2461equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2462hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m2460equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2462hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m2463toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2463toStringimpl(int i) {
        return m2461equalsimpl0(i, Top) ? "Top" : m2461equalsimpl0(i, Start) ? "Start" : "Unknown";
    }
}
