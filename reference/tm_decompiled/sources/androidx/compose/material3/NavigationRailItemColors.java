...
public final class NavigationRailItemColors {
    ...
    public final long m2483getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationRailItemColors m2478copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2487iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m2488textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m4616equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m4616equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m4616equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m4616equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m4616equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m4616equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m4622hashCodeimpl(this.selectedIconColor) * 31) + Color.m4622hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m4622hashCodeimpl(this.selectedTextColor)) * 31) + Color.m4622hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m4622hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m4622hashCodeimpl(this.disabledIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledTextColor);
    }
}
