...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = ProgressIndicatorTokens.INSTANCE.m3653getTrackThicknessD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4996getRoundKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4996getRoundKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4996getRoundKaPHkGw();
    private static final float LinearTrackStopIndicatorSize = ProgressIndicatorTokens.INSTANCE.m3652getStopSizeD9Ej5fM();
    private static final float LinearIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3649getActiveTrackSpaceD9Ej5fM();
    private static final float CircularIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3649getActiveTrackSpaceD9Ej5fM();
    ...
    public static /* synthetic */ void m2509getCircularIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }
    ...
    public static /* synthetic */ void m2510getLinearIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }

    /* renamed from: getLinearTrackStopIndicatorSize-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m2511getLinearTrackStopIndicatorSizeD9Ej5fM$annotations() {
    }
    ...
    public final long getCircularTrackColor(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m4650getTransparent0d7_KjU;
    }
    ...
    public final void m2512drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float min = Math.min(drawScope.mo459toPx0680j_4(stopSize), Size.m4409getHeightimpl(drawScope.mo5121getSizeNHjbRc()));
        float m4409getHeightimpl = (Size.m4409getHeightimpl(drawScope.mo5121getSizeNHjbRc()) - min) / 2;
        if (StrokeCap.m4991equalsimpl0(strokeCap, StrokeCap.INSTANCE.m4996getRoundKaPHkGw())) {
            float f = min / 2.0f;
            DrawScope.CC.m5193drawCircleVaOC9Bg$default(drawScope, color, f, OffsetKt.Offset((Size.m4412getWidthimpl(drawScope.mo5121getSizeNHjbRc()) - f) - m4409getHeightimpl, Size.m4409getHeightimpl(drawScope.mo5121getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        } else {
            DrawScope.CC.m5206drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m4412getWidthimpl(drawScope.mo5121getSizeNHjbRc()) - min) - m4409getHeightimpl, (Size.m4409getHeightimpl(drawScope.mo5121getSizeNHjbRc()) - min) / 2.0f), SizeKt.Size(min, min), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
}
