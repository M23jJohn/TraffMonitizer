...
public final class RadioButtonColors {
    ...
    public static /* synthetic */ RadioButtonColors m2544copyjRlVdoo$default(RadioButtonColors radioButtonColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return radioButtonColors.m2545copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? radioButtonColors.disabledUnselectedColor : j4);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RadioButtonColors m2545copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer2, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m4616equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m4616equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m4616equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m4622hashCodeimpl(this.selectedColor) * 31) + Color.m4622hashCodeimpl(this.unselectedColor)) * 31) + Color.m4622hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUnselectedColor);
    }
}
