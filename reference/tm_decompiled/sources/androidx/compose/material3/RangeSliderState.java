...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long m2551scaleToUserValueowVgs5E = m2551scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), SliderRange);
        if (SliderRange.m2673equalsimpl0(m2551scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m2675getStartimpl(m2551scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m2674getEndInclusiveimpl(m2551scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m2670boximpl(m2551scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m2551scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        long m2663scaleziovWd0;
        m2663scaleziovWd0 = SliderKt.m2663scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
        return m2663scaleziovWd0;
    }
