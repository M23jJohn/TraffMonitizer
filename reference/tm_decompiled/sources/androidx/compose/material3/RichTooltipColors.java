...
public final class RichTooltipColors {
    ...
    public static /* synthetic */ RichTooltipColors m2552copyjRlVdoo$default(RichTooltipColors richTooltipColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return richTooltipColors.m2553copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? richTooltipColors.actionContentColor : j4);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RichTooltipColors m2553copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m4616equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m4616equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m4616equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.contentColor)) * 31) + Color.m4622hashCodeimpl(this.titleContentColor)) * 31) + Color.m4622hashCodeimpl(this.actionContentColor);
    }
}
