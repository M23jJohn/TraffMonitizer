...
public final class RippleConfiguration {
    ...
    public /* synthetic */ RippleConfiguration(long j, RippleAlpha rippleAlpha, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Color.INSTANCE.m4651getUnspecified0d7_KjU() : j, (i & 2) != 0 ? null : rippleAlpha, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.color, rippleConfiguration.color) && Intrinsics.areEqual(this.rippleAlpha, rippleConfiguration.rippleAlpha);
    }

    public int hashCode() {
        int m4622hashCodeimpl = Color.m4622hashCodeimpl(this.color) * 31;
        RippleAlpha rippleAlpha = this.rippleAlpha;
        return m4622hashCodeimpl + (rippleAlpha != null ? rippleAlpha.hashCode() : 0);
    }

    public String toString() {
        return "RippleConfiguration(color=" + ((Object) Color.m4623toStringimpl(this.color)) + ", rippleAlpha=" + this.rippleAlpha + ')';
    }
}
