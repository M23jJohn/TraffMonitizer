...
public final class SegmentedButtonColors {
    ...
    public static /* synthetic */ SegmentedButtonColors m2589copy2qZNXz8$default(SegmentedButtonColors segmentedButtonColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
    ...
    public final long m2590borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeBorderColor;
        }
        if (enabled && !active) {
    ...
    public final long m2592contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
        if (enabled && checked) {
            return this.activeContentColor;
        }
        if (enabled && !checked) {
    ...
    public final long m2591containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeContainerColor;
        }
        if (enabled && !active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.activeBorderColor, segmentedButtonColors.activeBorderColor) && Color.m4616equalsimpl0(this.activeContentColor, segmentedButtonColors.activeContentColor) && Color.m4616equalsimpl0(this.activeContainerColor, segmentedButtonColors.activeContainerColor) && Color.m4616equalsimpl0(this.inactiveBorderColor, segmentedButtonColors.inactiveBorderColor) && Color.m4616equalsimpl0(this.inactiveContentColor, segmentedButtonColors.inactiveContentColor) && Color.m4616equalsimpl0(this.inactiveContainerColor, segmentedButtonColors.inactiveContainerColor) && Color.m4616equalsimpl0(this.disabledActiveBorderColor, segmentedButtonColors.disabledActiveBorderColor) && Color.m4616equalsimpl0(this.disabledActiveContentColor, segmentedButtonColors.disabledActiveContentColor) && Color.m4616equalsimpl0(this.disabledActiveContainerColor, segmentedButtonColors.disabledActiveContainerColor) && Color.m4616equalsimpl0(this.disabledInactiveBorderColor, segmentedButtonColors.disabledInactiveBorderColor) && Color.m4616equalsimpl0(this.disabledInactiveContentColor, segmentedButtonColors.disabledInactiveContentColor) && Color.m4616equalsimpl0(this.disabledInactiveContainerColor, segmentedButtonColors.disabledInactiveContainerColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m4622hashCodeimpl(this.activeBorderColor) * 31) + Color.m4622hashCodeimpl(this.activeContentColor)) * 31) + Color.m4622hashCodeimpl(this.activeContainerColor)) * 31) + Color.m4622hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m4622hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m4622hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m4622hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
