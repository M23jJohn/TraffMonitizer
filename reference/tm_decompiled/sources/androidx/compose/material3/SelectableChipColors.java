...
public final class SelectableChipColors {
    ...
    public static /* synthetic */ SelectableChipColors m2614copydaRQuJA$default(SelectableChipColors selectableChipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, int i, Object obj) {
        long j14;
        long j15;
    ...
    public final long m2615containerColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2617labelColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2618leadingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2619trailingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m4616equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m4616equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m4616equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m4616equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m4616equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m4616equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m4616equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m4616equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m4616equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m4616equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m4616equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m4616equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.labelColor)) * 31) + Color.m4622hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4622hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4622hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4622hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m4622hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m4622hashCodeimpl(this.selectedTrailingIconColor);
    }
}
