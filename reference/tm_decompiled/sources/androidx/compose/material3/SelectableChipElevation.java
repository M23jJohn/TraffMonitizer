...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m7397boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m7404equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m7404equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m7404equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m7404equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m7405hashCodeimpl(this.elevation) * 31) + Dp.m7405hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7405hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7405hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7405hashCodeimpl(this.disabledElevation);
    }
}
