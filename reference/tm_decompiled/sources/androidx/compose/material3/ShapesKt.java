...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), null, null, CornerSizeKt.m1235CornerSize0680j_4(Dp.m7399constructorimpl(f)), 6, null);
    }
}
