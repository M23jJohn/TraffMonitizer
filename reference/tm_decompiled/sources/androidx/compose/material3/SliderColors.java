...
public final class SliderColors {
    ...
    public static /* synthetic */ SliderColors m2628copyK518z4$default(SliderColors sliderColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, int i, Object obj) {
        long j11;
        long j12;
        ...
        return sliderColors.m2629copyK518z4(j20, j14, j15, j16, j17, j18, j19, j21, j12, j11);
    }

    /* renamed from: copy--K518z4, reason: not valid java name */
    public final SliderColors m2629copyK518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
    ...
    public final long m2640thumbColorvNxB06k$material3_release(boolean enabled) {
        return enabled ? this.thumbColor : this.disabledThumbColor;
    }

    /* renamed from: trackColor-WaAFU9c$material3_release, reason: not valid java name */
    public final long m2642trackColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m2641tickColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m4616equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m4616equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m4616equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m4616equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m4616equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m4616equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m4616equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m4616equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m4616equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m4622hashCodeimpl(this.thumbColor) * 31) + Color.m4622hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4622hashCodeimpl(this.activeTickColor)) * 31) + Color.m4622hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4622hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4622hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4622hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4622hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4622hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4622hashCodeimpl(this.disabledInactiveTickColor);
    }
}
