...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m2670boximpl(long j) {
    ...
    public static boolean m2672equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m2678unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2673equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m2676hashCodeimpl(long j) {
    ...
    public final /* synthetic */ long m2678unboximpl() {
    ...
    public static final float m2675getStartimpl(long j) {
        if (j == Unspecified) {
    ...
    public static final float m2674getEndInclusiveimpl(long j) {
        if (j == Unspecified) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2679getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m2680getUnspecifiedFYbKRX4() {
    ...
    public static String m2677toStringimpl(long j) {
        if (SliderKt.m2661isSpecifiedIf1S1O4(j)) {
            return m2675getStartimpl(j) + ".." + m2674getEndInclusiveimpl(j);
        }
