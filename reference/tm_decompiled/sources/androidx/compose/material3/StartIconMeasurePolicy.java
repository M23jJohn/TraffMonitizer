...
final class StartIconMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo80measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureResult m2474placeLabelAndStartIconnru01g4;
        ...
        float f = 2;
        long m7361offsetNN6EwU = ConstraintsKt.m7361offsetNN6EwU(m7332copyZbe2FdA$default, -measureScope2.mo453roundToPx0680j_4(Dp.m7399constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope2.mo453roundToPx0680j_4(Dp.m7399constructorimpl(this.indicatorVerticalPadding * f)));
        int size = list.size();
        int i = 0;
        while (i < size) {
            Measurable measurable = list.get(i);
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                Placeable mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(m7361offsetNN6EwU);
                int size2 = list.size();
                int i2 = 0;
                while (i2 < size2) {
                    Measurable measurable2 = list.get(i2);
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "label")) {
                        Placeable mo6055measureBRTryo02 = measurable2.mo6055measureBRTryo0(ConstraintsKt.m7362offsetNN6EwU$default(m7361offsetNN6EwU, -(mo6055measureBRTryo0.getWidth() + measureScope2.mo453roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, null));
                        int width = mo6055measureBRTryo0.getWidth() + mo6055measureBRTryo02.getWidth() + measureScope2.mo453roundToPx0680j_4(Dp.m7399constructorimpl(this.startIconToLabelHorizontalPadding + Dp.m7399constructorimpl(this.indicatorHorizontalPadding * f)));
                        int max = Math.max(mo6055measureBRTryo0.getHeight(), mo6055measureBRTryo02.getHeight()) + measureScope2.mo453roundToPx0680j_4(Dp.m7399constructorimpl(this.indicatorVerticalPadding * f));
                        ...
                        while (i3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                Placeable mo6055measureBRTryo03 = measurable3.mo6055measureBRTryo0(ConstraintsKt.m7357constrainN9IONVI(m7332copyZbe2FdA$default, Constraints.INSTANCE.m7352fixedJhjzzOo(width, max)));
                                int size4 = list.size();
                                int i4 = 0;
                                while (i4 < size4) {
                                    Measurable measurable4 = list.get(i4);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "indicator")) {
                                        m2474placeLabelAndStartIconnru01g4 = NavigationItemKt.m2474placeLabelAndStartIconnru01g4(measureScope2, mo6055measureBRTryo02, mo6055measureBRTryo0, mo6055measureBRTryo03, measurable4.mo6055measureBRTryo0(ConstraintsKt.m7357constrainN9IONVI(m7332copyZbe2FdA$default, Constraints.INSTANCE.m7352fixedJhjzzOo(roundToInt, max))), j, this.startIconToLabelHorizontalPadding);
                                        return m2474placeLabelAndStartIconnru01g4;
                                    }
                                    i4++;
                                    mo6055measureBRTryo0 = mo6055measureBRTryo0;
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return maxIntrinsicWidth + intrinsicMeasurable2.maxIntrinsicWidth(i) + intrinsicMeasureScope.mo453roundToPx0680j_4(Dp.m7399constructorimpl(Dp.m7399constructorimpl(this.indicatorHorizontalPadding * 2) + this.startIconToLabelHorizontalPadding));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    IntrinsicMeasurable intrinsicMeasurable2 = list.get(i3);
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "label")) {
                        return Math.max(maxIntrinsicHeight, intrinsicMeasurable2.maxIntrinsicHeight(i)) + intrinsicMeasureScope.mo453roundToPx0680j_4(Dp.m7399constructorimpl(this.indicatorVerticalPadding * 2));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
