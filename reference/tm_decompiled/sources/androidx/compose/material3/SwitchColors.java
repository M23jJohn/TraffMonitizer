...
public final class SwitchColors {
    ...
    public static /* synthetic */ SwitchColors m2709copyQ_H9qLU$default(SwitchColors switchColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, int i, Object obj) {
        long j17;
        long j18;
        long j19;
        long j20;
    ...
    public final long m2729thumbColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2730trackColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2710borderColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2728iconColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.checkedThumbColor, switchColors.checkedThumbColor) && Color.m4616equalsimpl0(this.checkedTrackColor, switchColors.checkedTrackColor) && Color.m4616equalsimpl0(this.checkedBorderColor, switchColors.checkedBorderColor) && Color.m4616equalsimpl0(this.checkedIconColor, switchColors.checkedIconColor) && Color.m4616equalsimpl0(this.uncheckedThumbColor, switchColors.uncheckedThumbColor) && Color.m4616equalsimpl0(this.uncheckedTrackColor, switchColors.uncheckedTrackColor) && Color.m4616equalsimpl0(this.uncheckedBorderColor, switchColors.uncheckedBorderColor) && Color.m4616equalsimpl0(this.uncheckedIconColor, switchColors.uncheckedIconColor) && Color.m4616equalsimpl0(this.disabledCheckedThumbColor, switchColors.disabledCheckedThumbColor) && Color.m4616equalsimpl0(this.disabledCheckedTrackColor, switchColors.disabledCheckedTrackColor) && Color.m4616equalsimpl0(this.disabledCheckedBorderColor, switchColors.disabledCheckedBorderColor) && Color.m4616equalsimpl0(this.disabledCheckedIconColor, switchColors.disabledCheckedIconColor) && Color.m4616equalsimpl0(this.disabledUncheckedThumbColor, switchColors.disabledUncheckedThumbColor) && Color.m4616equalsimpl0(this.disabledUncheckedTrackColor, switchColors.disabledUncheckedTrackColor) && Color.m4616equalsimpl0(this.disabledUncheckedBorderColor, switchColors.disabledUncheckedBorderColor) && Color.m4616equalsimpl0(this.disabledUncheckedIconColor, switchColors.disabledUncheckedIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((Color.m4622hashCodeimpl(this.checkedThumbColor) * 31) + Color.m4622hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m4622hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.checkedIconColor)) * 31) + Color.m4622hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m4622hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m4622hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.uncheckedIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m4622hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m4622hashCodeimpl(this.disabledCheckedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledCheckedIconColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUncheckedTrackColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m4622hashCodeimpl(this.disabledUncheckedIconColor);
    }
}
