...
public final class TabPosition {
    ...
    public final float m2740getRightD9Ej5fM() {
        return Dp.m7399constructorimpl(this.left + this.width);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.left, tabPosition.left) && Dp.m7404equalsimpl0(this.width, tabPosition.width) && Dp.m7404equalsimpl0(this.contentWidth, tabPosition.contentWidth);
    }

    public int hashCode() {
        return (((Dp.m7405hashCodeimpl(this.left) * 31) + Dp.m7405hashCodeimpl(this.width)) * 31) + Dp.m7405hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m7410toStringimpl(this.left)) + ", right=" + ((Object) Dp.m7410toStringimpl(m2740getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m7410toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m7410toStringimpl(this.contentWidth)) + ')';
    }
}
