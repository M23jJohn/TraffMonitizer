...
public final class TextFieldKt {
    private static final float TextFieldWithLabelVerticalPadding = Dp.m7399constructorimpl(8);
                                        ...
                                        if ((i3 & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                                            ...
                                            if ((i6 & 4194304) != 0) {
                                                ...
                                                if (m6878getColor0d7_KjU == 16) {
                                                    m6878getColor0d7_KjU = textFieldColors2.m2818textColorXeAY9LY$material3_release(z10, z9, FocusInteractionKt.collectIsFocusedAsState(mutableInteractionSource3, startRestartGroup, 0).getValue().booleanValue());
                                                }
                                                startRestartGroup.endReplaceGroup();
                                                ...
                                                CompositionLocalKt.CompositionLocalProvider(TextSelectionColorsKt.getLocalTextSelectionColors().provides(textFieldColors2.getTextSelectionColors()), ComposableLambdaKt.rememberComposableLambda(1859145987, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$1
                                                    ...
                                                    public final void invoke(Composer composer3, int i49) {
                                                        ...
                                                        if ((i49 & 3) != 2 || !composer3.getSkipping()) {
                                                            ...
                                                            Modifier m914defaultMinSizeVpY3zN4 = SizeKt.m914defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(modifier4, z17, Strings_androidKt.m3160getString2EP1pXo(Strings.m3090constructorimpl(androidx.compose.ui.R.string.default_error_message), composer3, 0)), TextFieldDefaults.INSTANCE.m2836getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m2835getMinHeightD9Ej5fM());
                                                            SolidColor solidColor = new SolidColor(textFieldColors2.m2768cursorColorvNxB06k$material3_release(z9), null);
                                                            String str3 = str2;
                                                            ...
                                                            BasicTextFieldKt.BasicTextField(str3, function13, m914defaultMinSizeVpY3zN4, z18, z19, textStyle5, keyboardOptions5, keyboardActions5, z20, i50, i51, visualTransformation4, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource7, solidColor2, ComposableLambdaKt.rememberComposableLambda(-288211827, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$1.1
                                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                                /* JADX WARN: Multi-variable type inference failed */
                                                                {
                                                                    super(3);
                                                                ...
                                                                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function235, Composer composer4, int i52) {
                                                                    int i53;
                                                                    ComposerKt.sourceInformation(composer4, "C255@13115L811:TextField.kt#uh7d8r");
                                                                    if ((i52 & 6) == 0) {
                                                                        i53 = i52 | (composer4.changedInstance(function235) ? 4 : 2);
                                                                    } else {
                                                                        i53 = i52;
                                                                    }
    ...
    */
                                                ...
                                                CompositionLocalKt.CompositionLocalProvider(TextSelectionColorsKt.getLocalTextSelectionColors().provides(textFieldColors2.getTextSelectionColors()), ComposableLambdaKt.rememberComposableLambda(-1163788208, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$3
                                                    ...
                                                    public final void invoke(Composer composer3, int i49) {
                                                        ...
                                                        if ((i49 & 3) != 2 || !composer3.getSkipping()) {
                                                            ...
                                                            final Shape shape5 = shape2;
                                                            final TextFieldColors textFieldColors4 = textFieldColors2;
                                                            BasicTextFieldKt.BasicTextField(textFieldValue3, function13, m914defaultMinSizeVpY3zN4, z18, z19, textStyle5, keyboardOptions5, keyboardActions5, z20, i50, i51, visualTransformation4, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource7, solidColor2, ComposableLambdaKt.rememberComposableLambda(1751957978, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldKt$TextField$3.1
                                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                                /* JADX WARN: Multi-variable type inference failed */
                                                                {
                                                                    super(3);
    ...
    public static final void TextFieldLayout(final Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final Function2<? super Composer, ? super Integer, Unit> function26, final boolean z, float f, final Function2<? super Composer, ? super Integer, Unit> function27, Function2<? super Composer, ? super Integer, Unit> function28, PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 306783379) != 306783378 || (i7 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m3912setimpl(m3905constructorimpl, textFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            if (function22 != null) {
                f3 = f;
                Modifier m882paddingqDBjuR0$default3 = PaddingKt.m882paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m918heightInVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.LabelId), DpKt.m7442lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f3), 0.0f, 2, null), null, false, 3, null), f4, 0.0f, f2, 0.0f, 10, null);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                ...
                Modifier materializeModifier6 = ComposedModifierKt.materializeModifier(startRestartGroup, m882paddingqDBjuR0$default3);
            ...
            Modifier m882paddingqDBjuR0$default4 = PaddingKt.m882paddingqDBjuR0$default(wrapContentHeight$default, f4, 0.0f, function26 == null ? f2 : Dp.m7399constructorimpl(0), 0.0f, 10, null);
            startRestartGroup.startReplaceGroup(1341611627);
            ComposerKt.sourceInformation(startRestartGroup, "548@26778L63");
            if (function3 != null) {
                function32 = function3;
                function32.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.PlaceholderId).then(m882paddingqDBjuR0$default4), startRestartGroup, Integer.valueOf((i6 >> 6) & 112));
            } else {
                function32 = function3;
            }
            startRestartGroup.endReplaceGroup();
            Modifier then3 = LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.TextFieldId).then(m882paddingqDBjuR0$default4);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
    ...
    public static final int m2847calculateWidthyeHjK3Y(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2, Constraints.m7344getMinWidthimpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    public static final int m2846calculateHeightmKXJcVc(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, long j, float f2, PaddingValues paddingValues) {
        boolean z = i2 > 0;
        float m7399constructorimpl = Dp.m7399constructorimpl(paddingValues.getTop() + paddingValues.getBottom()) * f2;
        if (z) {
            m7399constructorimpl = MathHelpersKt.lerp(Dp.m7399constructorimpl(TextFieldImplKt.getTextFieldPadding() * 2) * f2, m7399constructorimpl, f);
        }
        return Math.max(Constraints.m7343getMinHeightimpl(j), Math.max(i3, Math.max(i4, MathKt.roundToInt(m7399constructorimpl + MathHelpersKt.lerp(0, i2, f) + ComparisonsKt.maxOf(i, i7, i5, i6, MathHelpersKt.lerp(i2, 0, f))))) + i8);
    }
    ...
    public static final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, boolean z, float f, PaddingValues paddingValues) {
        Placeable.PlacementScope.m6126place70tqf50$default(placementScope, placeable7, IntOffset.INSTANCE.m7542getZeronOccac(), 0.0f, 2, null);
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, final State<BorderStroke> state) {
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TextFieldKt$drawIndicatorLine$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                ...
                float f = contentDrawScope.mo459toPx0680j_4(state.getValue().getWidth());
                float m4409getHeightimpl = Size.m4409getHeightimpl(contentDrawScope.mo5121getSizeNHjbRc()) - (f / 2);
                DrawScope.CC.m5197drawLine1RTmtNc$default(contentDrawScope, state.getValue().getBrush(), OffsetKt.Offset(0.0f, m4409getHeightimpl), OffsetKt.Offset(Size.m4412getWidthimpl(contentDrawScope.mo5121getSizeNHjbRc()), m4409getHeightimpl), f, 0, null, 0.0f, null, 0, 496, null);
            }
        });
    }
