...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        float f2;
        float f3;
        boolean z = (measurable.maxIntrinsicHeight(Constraints.m7342getMaxWidthimpl(j)) == 0 || measurable.maxIntrinsicWidth(Constraints.m7341getMaxHeightimpl(j)) == 0) ? false : true;
        if (this.isPressed) {
            thumbDiameter = SwitchTokens.INSTANCE.m3704getPressedHandleWidthD9Ej5fM();
        } else if (z || this.checked) {
            thumbDiameter = SwitchKt.getThumbDiameter();
        } else {
            thumbDiameter = SwitchKt.getUncheckedThumbDiameter();
        }
        float f4 = measureScope.mo459toPx0680j_4(thumbDiameter);
        ...
        final Placeable mo6055measureBRTryo0 = measurable.mo6055measureBRTryo0(Constraints.INSTANCE.m7352fixedJhjzzOo(floatValue, floatValue));
        f = SwitchKt.SwitchHeight;
        final float f5 = measureScope.mo459toPx0680j_4(Dp.m7399constructorimpl(Dp.m7399constructorimpl(f - measureScope.mo455toDpu2uoSUM(f4)) / 2.0f));
        f2 = SwitchKt.SwitchWidth;
        float m7399constructorimpl = Dp.m7399constructorimpl(f2 - SwitchKt.getThumbDiameter());
        f3 = SwitchKt.ThumbPadding;
        float f6 = measureScope.mo459toPx0680j_4(Dp.m7399constructorimpl(m7399constructorimpl - f3));
        boolean z2 = this.isPressed;
        if (z2 && this.checked) {
            f5 = f6 - measureScope.mo459toPx0680j_4(SwitchTokens.INSTANCE.m3710getTrackOutlineWidthD9Ej5fM());
        } else if (z2 && !this.checked) {
            f5 = measureScope.mo459toPx0680j_4(SwitchTokens.INSTANCE.m3710getTrackOutlineWidthD9Ej5fM());
        ...
        return MeasureScope.CC.layout$default(measureScope, floatValue, floatValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ThumbNode$measure$3
