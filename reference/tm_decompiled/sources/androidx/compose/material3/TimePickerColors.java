...
public final class TimePickerColors {
    ...
    public static /* synthetic */ TimePickerColors m2852copydVHXu7A$default(TimePickerColors timePickerColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, int i, Object obj) {
        long j15;
        long j16;
    ...
    public final long m2869periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m2870periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m2871timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m2872timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m2853clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m4616equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m4616equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m4616equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m4616equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m4616equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m4616equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m4616equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m4616equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m4616equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m4616equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m4616equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m4622hashCodeimpl(this.clockDialColor) * 31) + Color.m4622hashCodeimpl(this.selectorColor)) * 31) + Color.m4622hashCodeimpl(this.containerColor)) * 31) + Color.m4622hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m4622hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m4622hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m4622hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m4622hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m4622hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
