...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m2892constructorimpl(0);
    private static final int Vertical = m2892constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m2891boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2892constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2893equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2894equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2895hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m2893equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2895hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2898getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE, reason: not valid java name */
        public final int m2899getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    public String toString() {
        return m2896toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2896toStringimpl(int i) {
        return m2894equalsimpl0(i, Horizontal) ? "Horizontal" : m2894equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}
