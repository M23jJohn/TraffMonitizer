...
public final class TimePickerSelectionMode {
    ...
    private static final int Hour = m2901constructorimpl(0);
    private static final int Minute = m2901constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerSelectionMode m2900boximpl(int i) {
        return new TimePickerSelectionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2901constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2902equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerSelectionMode) && i == ((TimePickerSelectionMode) obj).m2906unboximpl();
    }
    ...
    public static String m2905toStringimpl(int i) {
        return m2903equalsimpl0(i, Hour) ? "Hour" : m2903equalsimpl0(i, Minute) ? "Minute" : "";
    }
}
