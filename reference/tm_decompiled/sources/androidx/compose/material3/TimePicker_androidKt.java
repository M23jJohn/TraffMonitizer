...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m2899getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2898getHorizontalQJTpgSE();
        } else {
            m2899getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2899getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2899getVerticalQJTpgSE;
    }
}
