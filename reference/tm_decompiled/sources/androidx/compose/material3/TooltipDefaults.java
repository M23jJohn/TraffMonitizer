...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m7421DpSizeYgX7TsA(Dp.m7399constructorimpl(16), Dp.m7399constructorimpl(8));
    ...
    public final long m2996getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m2999richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors m2553copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2553copyjRlVdoo(m4651getUnspecified0d7_KjU, m4651getUnspecified0d7_KjU2, m4651getUnspecified0d7_KjU3, m4651getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2553copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m2997rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        final int mo453roundToPx0680j_4 = ((Density) consume).mo453roundToPx0680j_4(f);
        ComposerKt.sourceInformationMarkerStart(composer, 1994502237, "CC(remember):Tooltip.kt#9igjgp");
        boolean changed = composer.changed(mo453roundToPx0680j_4);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo423calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7574getWidthimpl(popupContentSize)) / 2);
                    int top = (anchorBounds.getTop() - IntSize.m7573getHeightimpl(popupContentSize)) - mo453roundToPx0680j_4;
                    if (top < 0) {
                        top = mo453roundToPx0680j_4 + anchorBounds.getBottom();
                    }
    ...
    public final PopupPositionProvider m2998rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo423calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m7574getWidthimpl(popupContentSize) + left > IntSize.m7574getWidthimpl(windowSize) && (left = anchorBounds.getRight() - IntSize.m7574getWidthimpl(popupContentSize)) < 0) {
                        left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7574getWidthimpl(popupContentSize)) / 2);
                    }
                    int top = (anchorBounds.getTop() - IntSize.m7573getHeightimpl(popupContentSize)) - mo453roundToPx0680j_4;
                    if (top < 0) {
                        top = mo453roundToPx0680j_4 + anchorBounds.getBottom();
