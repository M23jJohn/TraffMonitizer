...
public final class TopAppBarColors {
    ...
    public static /* synthetic */ TopAppBarColors m3004copyt635Npw$default(TopAppBarColors topAppBarColors, long j, long j2, long j3, long j4, long j5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return topAppBarColors.m3006copyt635Npw(j6, j2, (i & 4) != 0 ? topAppBarColors.navigationIconContentColor : j3, (i & 8) != 0 ? topAppBarColors.titleContentColor : j4, (i & 16) != 0 ? topAppBarColors.actionIconContentColor : j5);
    }

    /* renamed from: copy-t635Npw, reason: not valid java name */
    public final TopAppBarColors m3006copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m3005containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4666lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m4616equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m4616equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m4616equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m4616equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m4622hashCodeimpl(this.containerColor) * 31) + Color.m4622hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4622hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4622hashCodeimpl(this.titleContentColor)) * 31) + Color.m4622hashCodeimpl(this.actionIconContentColor);
    }
}
