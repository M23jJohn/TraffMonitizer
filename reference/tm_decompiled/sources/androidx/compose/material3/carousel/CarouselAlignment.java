...
public final class CarouselAlignment {
    ...
    private static final int Start = m3026constructorimpl(-1);
    private static final int Center = m3026constructorimpl(0);
    private static final int End = m3026constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CarouselAlignment m3025boximpl(int i) {
        return new CarouselAlignment(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3026constructorimpl(int i) {
        return i;
    }
