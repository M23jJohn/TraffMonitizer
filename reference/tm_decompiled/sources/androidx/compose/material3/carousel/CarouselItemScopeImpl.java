...
public final class CarouselItemScopeImpl implements CarouselItemScope {
    ...
    public Modifier maskClip(Modifier modifier, Shape shape, Composer composer, int i) {
        ...
        Modifier clip = ClipKt.clip(modifier, rememberMaskShape(shape, composer, (i >> 3) & 126));
        if (ComposerKt.isTraceInProgress()) {
    ...
    public Modifier maskBorder(Modifier modifier, BorderStroke borderStroke, Shape shape, Composer composer, int i) {
        ...
        Modifier border = BorderKt.border(modifier, borderStroke, rememberMaskShape(shape, composer, (i >> 6) & 126));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$rememberMaskShape$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                    m3038invoke12SF9DM(path, size.m4417unboximpl(), layoutDirection);
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-12SF9DM, reason: not valid java name */
                public final void m3038invoke12SF9DM(Path path, long j, LayoutDirection layoutDirection) {
                    Rect intersect = CarouselItemScopeImpl.this.getItemInfo().getMaskRect().intersect(SizeKt.m4433toRectuvyYCjk(j));
                    OutlineKt.addOutline(path, shape.mo361createOutlinePq9zytI(intersect.m4376getSizeNHjbRc(), layoutDirection, density));
                    path.mo4481translatek4lQ0M(OffsetKt.Offset(intersect.getLeft(), intersect.getTop()));
                }
            });
