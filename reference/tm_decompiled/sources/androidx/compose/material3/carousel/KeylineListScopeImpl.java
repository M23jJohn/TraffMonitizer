...
final class KeylineListScopeImpl implements KeylineListScope {
    ...
    public final KeylineList m3044createWithAlignmentwaks0t8(float carouselMainAxisSize, float itemSpacing, int carouselAlignment) {
        float f;
        int findLastFocalIndex = findLastFocalIndex();
        int i = this.firstFocalIndex;
        int i2 = findLastFocalIndex - i;
        this.pivotIndex = i;
        if (CarouselAlignment.m3028equalsimpl0(carouselAlignment, CarouselAlignment.INSTANCE.m3032getCenterNUL3oTo())) {
            float f2 = 0.0f;
            if (itemSpacing != 0.0f) {
                int i3 = i2 % 2;
            ...
            f = CarouselAlignment.m3028equalsimpl0(carouselAlignment, CarouselAlignment.INSTANCE.m3033getEndNUL3oTo()) ? carouselMainAxisSize - (this.focalItemSize / 2) : this.focalItemSize / 2;
        }
        this.pivotOffset = f;
