...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m3053copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m3055copyuVxBXkw(j2, density2, i3, function2);
    }
    ...
    public final DropdownMenuPositionProvider m3055copyuVxBXkw(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m7459equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((((DpOffset.m7464hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + this.verticalMargin) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m7467toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int mo453roundToPx0680j_4 = density.mo453roundToPx0680j_4(DpOffset.m7460getXD9Ej5fM(j));
        this.startToAnchorStart = MenuPosition.INSTANCE.startToAnchorStart(mo453roundToPx0680j_4);
        this.endToAnchorEnd = MenuPosition.INSTANCE.endToAnchorEnd(mo453roundToPx0680j_4);
        ...
        int mo453roundToPx0680j_42 = density.mo453roundToPx0680j_4(DpOffset.m7462getYD9Ej5fM(j));
        this.topToAnchorBottom = MenuPosition.INSTANCE.topToAnchorBottom(mo453roundToPx0680j_42);
        this.bottomToAnchorTop = MenuPosition.INSTANCE.bottomToAnchorTop(mo453roundToPx0680j_42);
        this.centerToAnchorTop = MenuPosition.INSTANCE.centerToAnchorTop(mo453roundToPx0680j_42);
    ...
    public final long m3056getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density density, int i, AnonymousClass2 anonymousClass2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, density, (i2 & 4) != 0 ? density.mo453roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i, (i2 & 8) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.internal.DropdownMenuPositionProvider.2
    ...
    public long mo423calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (IntOffset.m7531getXimpl(anchorBounds.m7555getCenternOccac()) < IntSize.m7574getWidthimpl(windowSize) / 2) {
        ...
        while (true) {
            ...
            i = ((MenuPosition.Horizontal) listOf.get(i3)).mo3047position95KtPRI(anchorBounds, windowSize, IntSize.m7574getWidthimpl(popupContentSize), layoutDirection);
            if (i3 == CollectionsKt.getLastIndex(listOf) || (i >= 0 && IntSize.m7574getWidthimpl(popupContentSize) + i <= IntSize.m7574getWidthimpl(windowSize))) {
                break;
            }
            i3++;
        }
        ...
        if (IntOffset.m7532getYimpl(anchorBounds.m7555getCenternOccac()) < IntSize.m7573getHeightimpl(windowSize) / 2) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            int mo3048positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i4)).mo3048positionJVtK1S4(anchorBounds, windowSize, IntSize.m7573getHeightimpl(popupContentSize));
            if (i4 == CollectionsKt.getLastIndex(listOf2) || (mo3048positionJVtK1S4 >= this.verticalMargin && IntSize.m7573getHeightimpl(popupContentSize) + mo3048positionJVtK1S4 <= IntSize.m7573getHeightimpl(windowSize) - this.verticalMargin)) {
                i2 = mo3048positionJVtK1S4;
                break;
            }
        }
        long IntOffset = IntOffsetKt.IntOffset(i, i2);
        this.onPositionCalculated.invoke(anchorBounds, IntRectKt.m7564IntRectVbeCjmY(IntOffset, popupContentSize));
        return IntOffset;
    }
}
