...
public final class MenuPosition {
    ...
    public interface Horizontal {
        ...
        int mo3047position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection);
    }
    ...
    public interface Vertical {
        ...
        int mo3048positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight);
    }
