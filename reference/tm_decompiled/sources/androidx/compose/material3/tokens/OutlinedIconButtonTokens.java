...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m7399constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m7399constructorimpl((float) 24.0d);
    ...
    public final float m3539getContainerSizeD9Ej5fM() {
    ...
    public final float m3540getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3541getUnselectedOutlineWidthD9Ej5fM() {
