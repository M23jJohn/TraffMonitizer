...
public final class ProgressIndicatorTokens {
    ...
    private static final float Size = Dp.m7399constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveThickness = Dp.m7399constructorimpl(f);
        ActiveTrackSpace = Dp.m7399constructorimpl(f);
        StopShape = Dp.m7399constructorimpl(f);
        StopSize = Dp.m7399constructorimpl(f);
        TrackThickness = Dp.m7399constructorimpl(f);
    }
    ...
    public final float m3648getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* renamed from: getActiveTrackSpace-D9Ej5fM, reason: not valid java name */
    public final float m3649getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3651getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* renamed from: getStopSize-D9Ej5fM, reason: not valid java name */
    public final float m3652getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3653getTrackThicknessD9Ej5fM() {
