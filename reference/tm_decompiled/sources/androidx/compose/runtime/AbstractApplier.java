...
public abstract class AbstractApplier<T> implements Applier<T> {
    ...
    private final ArrayList<T> stack = Stack.m3889constructorimpl$default(null, 1, null);
    ...
    public void down(T node) {
        Stack.m3899pushimpl(this.stack, getCurrent());
        setCurrent(node);
    }
    ...
    @Override // androidx.compose.runtime.Applier
    public void up() {
        setCurrent(Stack.m3898popimpl(this.stack));
    }

    @Override // androidx.compose.runtime.Applier
    public final void clear() {
        Stack.m3887clearimpl(this.stack);
