...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    public BroadcastFrameClock(Function0<Unit> function0) {
        ...
        this.pendingAwaitersCountUnlocked = AtomicAwaitersCount.m3806constructorimpl();
    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                m8075constructorimpl = Result.m8075constructorimpl(function1.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
            }
            cancellableContinuation.resumeWith(m8075constructorimpl);
        }
        ...
        public final void resumeWithException(Throwable exception) {
            ...
            if (cancellableContinuation != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(exception)));
            }
        }
    }
    ...
    public final void sendFrame(long timeNanos) {
        ...
        synchronized (this.lock) {
            ...
            do {
                i = atomicInt.get();
            } while (!atomicInt.compareAndSet(i, AtomicAwaitersCount.m3817packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
    ...
    private static final class AtomicAwaitersCount {
        ...
        public static final /* synthetic */ AtomicAwaitersCount m3805boximpl(AtomicInt atomicInt) {
            return new AtomicAwaitersCount(atomicInt);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static AtomicInt m3807constructorimpl(AtomicInt atomicInt) {
            return atomicInt;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m3809equalsimpl(AtomicInt atomicInt, Object obj) {
            return (obj instanceof AtomicAwaitersCount) && Intrinsics.areEqual(atomicInt, ((AtomicAwaitersCount) obj).getValue());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m3810equalsimpl0(AtomicInt atomicInt, AtomicInt atomicInt2) {
            return Intrinsics.areEqual(atomicInt, atomicInt2);
        }

        /* renamed from: getCount-impl, reason: not valid java name */
        private static final int m3811getCountimpl(AtomicInt atomicInt, int i) {
            return 134217727 & i;
        }

        /* renamed from: getVersion-impl, reason: not valid java name */
        private static final int m3812getVersionimpl(AtomicInt atomicInt, int i) {
            return (i >>> 27) & 15;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m3814hashCodeimpl(AtomicInt atomicInt) {
            return atomicInt.hashCode();
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: pack-impl, reason: not valid java name */
        public static final int m3817packimpl(AtomicInt atomicInt, int i, int i2) {
            return ((i & 15) << 27) | (134217727 & i2);
        }

        public boolean equals(Object other) {
            return m3809equalsimpl(this.value, other);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static AtomicInt m3806constructorimpl() {
            return m3807constructorimpl(new AtomicInt(0));
        }

        /* renamed from: hasAwaiters-impl, reason: not valid java name */
        public static final boolean m3813hasAwaitersimpl(AtomicInt atomicInt) {
            return (atomicInt.get() & 134217727) > 0;
        }

        /* renamed from: update-impl, reason: not valid java name */
        private static final int m3819updateimpl(AtomicInt atomicInt, Function1<? super Integer, Integer> function1) {
            int i;
            int intValue;
            do {
                i = atomicInt.get();
        ...
        public String toString() {
            return m3818toStringimpl(this.value);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m3818toStringimpl(AtomicInt atomicInt) {
            int i = atomicInt.get();
        ...
        public static final void m3816incrementVersionAndResetCountimpl(AtomicInt atomicInt) {
            int i;
            do {
                i = atomicInt.get();
            } while (!atomicInt.compareAndSet(i, m3817packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
        }

        /* renamed from: incrementCountAndGetVersion-impl, reason: not valid java name */
        public static final int m3815incrementCountAndGetVersionimpl(AtomicInt atomicInt, Function0<Unit> function0) {
            int i;
            int i2;
            do {
                i = atomicInt.get();
        ...
        public static final void m3808decrementCountimpl(AtomicInt atomicInt, int i) {
            int i2;
            do {
                i2 = atomicInt.get();
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th == null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(th)));
            }
        }
