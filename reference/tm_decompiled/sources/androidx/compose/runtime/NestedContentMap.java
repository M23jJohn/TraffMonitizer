...
final class NestedContentMap {
    private final MutableScatterMap<Object, Object> contentMap = MultiValueMap.m3985constructorimpl$default(null, 1, null);
    private final MutableScatterMap<Object, Object> containerMap = MultiValueMap.m3985constructorimpl$default(null, 1, null);

    public final void add(MovableContent<Object> content, NestedMovableContent nestedContent) {
        MultiValueMap.m3981addimpl(this.contentMap, content, nestedContent);
        MultiValueMap.m3981addimpl(this.containerMap, nestedContent.getContainer(), content);
    }

    public final void clear() {
        MultiValueMap.m3983clearimpl(this.contentMap);
        MultiValueMap.m3983clearimpl(this.containerMap);
    }

    public final NestedMovableContent removeLast(MovableContent<Object> key) {
        NestedMovableContent nestedMovableContent = (NestedMovableContent) MultiValueMap.m3995removeLastimpl(this.contentMap, key);
        if (MultiValueMap.m3992isEmptyimpl(this.contentMap)) {
            MultiValueMap.m3983clearimpl(this.containerMap);
        }
    ...
    public final boolean contains(MovableContent<Object> key) {
        return MultiValueMap.m3986containsimpl(this.contentMap, key);
    }
        ...
        if (obj != null) {
            if (obj instanceof MutableObjectList) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    MultiValueMap.m3996removeValueIfimpl(this.contentMap, (MovableContent) obj2, new Function1() { // from class: androidx.compose.runtime.NestedContentMap$$ExternalSyntheticLambda0
            ...
            MultiValueMap.m3996removeValueIfimpl(this.contentMap, (MovableContent) obj, new Function1() { // from class: androidx.compose.runtime.NestedContentMap$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj3) {
                    boolean usedContainer$lambda$2$lambda$1;
                    usedContainer$lambda$2$lambda$1 = NestedContentMap.usedContainer$lambda$2$lambda$1(MovableContentStateReference.this, (NestedMovableContent) obj3);
