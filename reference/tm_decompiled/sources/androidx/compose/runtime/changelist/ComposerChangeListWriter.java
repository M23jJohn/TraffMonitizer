...
public final class ComposerChangeListWriter {
    ...
    private final ArrayList<T> pendingDownNodes = Stack.m3889constructorimpl$default(null, 1, null);
    ...
    public final void moveUp() {
        realizeNodeMovementOperations();
        if (Stack.m3895isNotEmptyimpl(this.pendingDownNodes)) {
            Stack.m3898popimpl(this.pendingDownNodes);
            return;
        }
    ...
    public final void moveDown(Object node) {
        realizeNodeMovementOperations();
        Stack.m3899pushimpl(this.pendingDownNodes, node);
    }
    ...
    private final void pushPendingUpsAndDowns() {
        ...
        if (Stack.m3895isNotEmptyimpl(this.pendingDownNodes)) {
            this.changeList.pushDowns(Stack.m3900toArrayimpl(this.pendingDownNodes));
            Stack.m3887clearimpl(this.pendingDownNodes);
        }
    }
