...
public final class RememberSerializableKt {
    ...
    public static final /* synthetic */ <T> T m4034rememberSerializable(Object[] objArr, SavedStateConfiguration savedStateConfiguration, Function0<? extends T> function0, Composer composer, int i, int i2) {
        ...
        T t = (T) m4035rememberSerializable(copyOf, (KSerializer) SerializersKt.serializer(serializersModule, (KType) null), savedStateConfiguration2, (Function0) function0, composer, (i << 3) & 8064, 0);
        ComposerKt.sourceInformationMarkerEnd(composer);
        return t;
    }

    /* renamed from: rememberSerializable, reason: collision with other method in class */
    public static final <T> T m4035rememberSerializable(Object[] objArr, KSerializer<T> kSerializer, SavedStateConfiguration savedStateConfiguration, Function0<? extends T> function0, Composer composer, int i, int i2) {
        ...
        T t = (T) RememberSaveableKt.m4032rememberSaveable(Arrays.copyOf(objArr, objArr.length), SerializableSaverKt.serializableSaver(kSerializer, savedStateConfiguration), (String) null, (Function0) function0, composer, (i & 7168) | 384, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final <T> MutableState<T> rememberSerializable(Object[] objArr, KSerializer<T> kSerializer, SavedStateConfiguration savedStateConfiguration, Function0<? extends MutableState<T>> function0, Composer composer, int i, int i2) {
        ...
        MutableState<T> mutableState = (MutableState) RememberSaveableKt.m4032rememberSaveable(Arrays.copyOf(objArr, objArr.length), RememberSaveableKt.mutableStateSaver(SerializableSaverKt.serializableSaver(kSerializer, savedStateConfiguration)), (String) null, (Function0) function0, composer, (i & 7168) | 384, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
