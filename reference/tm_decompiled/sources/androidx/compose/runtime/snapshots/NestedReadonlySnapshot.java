...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot(long j, SnapshotIdSet snapshotIdSet, Function1<Object, Unit> function1, Snapshot snapshot) {
        ...
        snapshot.mo4042nestedActivated$runtime(this);
    }
    ...
    public void dispose() {
        ...
        this.parent.mo4043nestedDeactivated$runtime(nestedReadonlySnapshot);
        super.dispose();
    ...
    public Void mo4044recordModified$runtime(StateObject state) {
    ...
    public Void mo4043nestedDeactivated$runtime(Snapshot snapshot) {
    ...
    public Void mo4042nestedActivated$runtime(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
