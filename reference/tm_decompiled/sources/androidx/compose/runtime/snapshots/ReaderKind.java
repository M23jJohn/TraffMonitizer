...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m4045boximpl(int i) {
    ...
    public static boolean m4048equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m4054unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4049equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4050hashCodeimpl(int i) {
        return i;
    }

    /* renamed from: isReadIn-h_f27i8, reason: not valid java name */
    public static final boolean m4051isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public boolean equals(Object other) {
        return m4048equalsimpl(this.mask, other);
    }

    public int hashCode() {
        return m4050hashCodeimpl(this.mask);
    }

    public String toString() {
        return m4052toStringimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m4047constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m4046constructorimpl(i);
    }
    ...
    public static final int m4053withReadIn3QSx2Dw(int i, int i2) {
        return m4046constructorimpl(i | i2);
    }
    ...
    public static final class Companion {
        ...
        public final int m4055getComposition6f8NoZ8() {
            return ReaderKind.m4046constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8, reason: not valid java name */
        public final int m4057getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m4046constructorimpl(2);
        }

        /* renamed from: getSnapshotFlow-6f8NoZ8, reason: not valid java name */
        public final int m4056getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m4046constructorimpl(4);
        }
    }
}
