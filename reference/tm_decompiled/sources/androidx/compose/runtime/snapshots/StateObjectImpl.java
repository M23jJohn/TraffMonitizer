...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m4064recordReadInh_f27i8$runtime(int reader) {
        int m4046constructorimpl;
        do {
            m4046constructorimpl = ReaderKind.m4046constructorimpl(this.readerKind.get());
            if ((m4046constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(m4046constructorimpl, ReaderKind.m4046constructorimpl(m4046constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime, reason: not valid java name */
    public final boolean m4063isReadInh_f27i8$runtime(int reader) {
        return (reader & ReaderKind.m4046constructorimpl(this.readerKind.get())) != 0;
    }
}
