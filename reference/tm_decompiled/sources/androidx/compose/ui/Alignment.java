...
public interface Alignment {
    ...
    long mo4066alignKFBX0sM(long size, long space, LayoutDirection layoutDirection);
    ...
    public interface Horizontal {
        ...
        Alignment plus(Vertical other);

        /* compiled from: Alignment.kt */
        /* renamed from: androidx.compose.ui.Alignment$Horizontal$-CC, reason: invalid class name */
        public final /* synthetic */ class CC {
            public static Alignment $default$plus(Horizontal _this, Vertical vertical) {
                return new CombinedAlignment(_this, vertical);
            }
        }
    }
    ...
    public interface Vertical {
        ...
        Alignment plus(Horizontal other);

        /* compiled from: Alignment.kt */
        /* renamed from: androidx.compose.ui.Alignment$Vertical$-CC, reason: invalid class name */
        public final /* synthetic */ class CC {
            public static Alignment $default$plus(Vertical _this, Horizontal horizontal) {
                return new CombinedAlignment(horizontal, _this);
            }
        }
    }
