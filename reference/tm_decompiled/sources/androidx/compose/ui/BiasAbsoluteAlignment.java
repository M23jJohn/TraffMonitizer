...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public static final /* data */ class Horizontal implements Alignment.Horizontal {
        ...
        public Alignment plus(Alignment.Vertical other) {
            return other instanceof BiasAlignment.Vertical ? new BiasAbsoluteAlignment(this.bias, ((BiasAlignment.Vertical) other).getBias()) : Alignment.Horizontal.CC.$default$plus(this, other);
        }
    }

    @Override // androidx.compose.ui.Alignment
    /* renamed from: align-KFBX0sM */
    public long mo4066alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long m7569constructorimpl = IntSize.m7569constructorimpl(((((int) (space >> 32)) - ((int) (size >> 32))) << 32) | ((((int) (space & 4294967295L)) - ((int) (size & 4294967295L))) & 4294967295L));
        float f = 1;
        float f2 = (((int) (m7569constructorimpl >> 32)) / 2.0f) * (this.horizontalBias + f);
        float f3 = (((int) (m7569constructorimpl & 4294967295L)) / 2.0f) * (f + this.verticalBias);
        return IntOffset.m7525constructorimpl((Math.round(f2) << 32) | (Math.round(f3) & 4294967295L));
    }
}
