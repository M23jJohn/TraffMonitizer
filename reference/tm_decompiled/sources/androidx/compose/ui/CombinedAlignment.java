...
final class CombinedAlignment implements Alignment {
    ...
    public long mo4066alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        return IntOffset.m7525constructorimpl((this.horizontal.align((int) (size >> 32), (int) (space >> 32), layoutDirection) << 32) | (this.vertical.align((int) (size & 4294967295L), (int) (space & 4294967295L)) & 4294967295L));
    }
}
