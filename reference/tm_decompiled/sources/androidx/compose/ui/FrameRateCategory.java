...
public final class FrameRateCategory {
    ...
    private static final float Default = m4068constructorimpl(Float.NaN);
    private static final float Normal = m4068constructorimpl(-3.0f);
    private static final float High = m4068constructorimpl(-4.0f);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FrameRateCategory m4067boximpl(float f) {
        return new FrameRateCategory(f);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static float m4068constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4069equalsimpl(float f, Object obj) {
        return (obj instanceof FrameRateCategory) && Float.compare(f, ((FrameRateCategory) obj).getValue()) == 0;
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4070equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4071hashCodeimpl(float f) {
        return Float.floatToIntBits(f);
    }

    public boolean equals(Object other) {
        return m4069equalsimpl(this.value, other);
    }
    ...
    public String toString() {
        return m4072toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4072toStringimpl(float f) {
        if (f == -3.0f) {
            return "Normal";
        }
        if (f == -4.0f) {
