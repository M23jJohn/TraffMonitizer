...
public final class SessionMutex<T> {
    ...
    public static final /* synthetic */ SessionMutex m4079boximpl(AtomicReference atomicReference) {
        return new SessionMutex(atomicReference);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static <T> AtomicReference<Session<T>> m4081constructorimpl(AtomicReference<Session<T>> atomicReference) {
        return atomicReference;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4082equalsimpl(AtomicReference<Session<T>> atomicReference, Object obj) {
    ...
    public static final boolean m4083equalsimpl0(AtomicReference<Session<T>> atomicReference, AtomicReference<Session<T>> atomicReference2) {
        return Intrinsics.areEqual(atomicReference, atomicReference2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4085hashCodeimpl(AtomicReference<Session<T>> atomicReference) {
        return atomicReference.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4086toStringimpl(AtomicReference<Session<T>> atomicReference) {
        return "SessionMutex(currentSessionHolder=" + atomicReference + ')';
    }

    public boolean equals(Object other) {
        return m4082equalsimpl(this.currentSessionHolder, other);
    }

    public int hashCode() {
        return m4085hashCodeimpl(this.currentSessionHolder);
    }

    public String toString() {
        return m4086toStringimpl(this.currentSessionHolder);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> AtomicReference<Session<T>> m4080constructorimpl() {
        return m4081constructorimpl(new AtomicReference(null));
    }

    /* renamed from: getCurrentSession-impl, reason: not valid java name */
    public static final T m4084getCurrentSessionimpl(AtomicReference<Session<T>> atomicReference) {
    ...
    public static final <R> Object m4087withSessionCancellingPreviousimpl(AtomicReference<Session<T>> atomicReference, Function1<? super CoroutineScope, ? extends T> function1, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
