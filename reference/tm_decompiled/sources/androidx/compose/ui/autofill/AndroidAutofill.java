...
public final class AndroidAutofill implements Autofill {
    ...
    public AndroidAutofill(View view, AutofillTree autofillTree) {
        ...
        android.view.autofill.AutofillManager m3061m = Listener$$ExternalSyntheticApiModelOutline0.m3061m(view.getContext().getSystemService(Listener$$ExternalSyntheticApiModelOutline0.m$1()));
        if (m3061m == null) {
            throw new IllegalStateException("Autofill service could not be located.".toString());
        }
        this.autofillManager = m3061m;
