...
final /* data */ class ContentCaptureEvent {
    ...
    public int hashCode() {
        int m = ((((this.id * 31) + UByte$$ExternalSyntheticBackport0.m(this.timestamp)) * 31) + this.type.hashCode()) * 31;
        ViewStructureCompat viewStructureCompat = this.structureCompat;
        return m + (viewStructureCompat == null ? 0 : viewStructureCompat.hashCode());
    }
