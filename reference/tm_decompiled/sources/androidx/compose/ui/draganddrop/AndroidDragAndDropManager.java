...
public final class AndroidDragAndDropManager implements View.OnDragListener, DragAndDropManager {
    ...
    public void mo4096requestDragAndDropTransferUv8p0NA(DragAndDropNode node, long offset) {
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        node.m4102startDragAndDropTransferd4ec7I(new DragAndDropStartTransferScope() { // from class: androidx.compose.ui.draganddrop.AndroidDragAndDropManager$requestDragAndDropTransfer$dragAndDropSourceScope$1
            ...
            public boolean mo4097startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                Function3 function3;
                Ref.BooleanRef booleanRef2 = Ref.BooleanRef.this;
                function3 = this.startDrag;
                booleanRef2.element = ((Boolean) function3.invoke(transferData, Size.m4400boximpl(decorationSize), drawDragDecoration)).booleanValue();
