...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode, DragAndDropSourceModifierNode, DragAndDropTargetModifierNode, DragAndDropTarget {
    ...
    public final void m4101setSizeozmzZPI$ui_release(long j) {
        this.size = j;
    }
    ...
    public void mo4100requestDragAndDropTransferk4lQ0M(long offset) {
        if (!(this.onStartTransfer != null)) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        getDragAndDropManager().mo4096requestDragAndDropTransferUv8p0NA(this, offset);
    }

    /* renamed from: startDragAndDropTransfer-d-4ec7I, reason: not valid java name */
    public final void m4102startDragAndDropTransferd4ec7I(final DragAndDropStartTransferScope dragAndDropStartTransferScope, final long j, final Function0<Boolean> function0) {
        ...
        DragAndDropNodeKt.traverseSelfAndDescendants(this, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$startDragAndDropTransfer$1
            ...
            public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode) {
                ...
                if (dragAndDropNode.getIsAttached()) {
                    ...
                    if (!Offset.m4340equalsimpl0(j, Offset.INSTANCE.m4358getUnspecifiedF1C5BW0())) {
                        long mo6058localPositionOfR5De75A = DelegatableNodeKt.requireLayoutNode(dragAndDropNode).getCoordinates().mo6058localPositionOfR5De75A(coordinates, j);
                        if (!SizeKt.m4433toRectuvyYCjk(IntSizeKt.m7586toSizeozmzZPI(dragAndDropNode.getSize())).m4369containsk4lQ0M(mo6058localPositionOfR5De75A)) {
                            return TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal;
                        }
                        function2.invoke(dragAndDropStartTransferScope, Offset.m4332boximpl(mo6058localPositionOfR5De75A));
                    } else {
                        function2.invoke(dragAndDropStartTransferScope, Offset.m4332boximpl(Offset.INSTANCE.m4358getUnspecifiedF1C5BW0()));
                    }
    ...
    public void mo4098drag12SF9DM(final DragAndDropTransferData transferData, final long decorationSize, final Function1<? super DrawScope, Unit> drawDragDecoration) {
        if (!(this.onStartTransfer == null)) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        this.onStartTransfer = new Function2<DragAndDropStartTransferScope, Offset, Unit>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$drag$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
                m4103invokeUv8p0NA(dragAndDropStartTransferScope, offset.m4353unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m4103invokeUv8p0NA(DragAndDropStartTransferScope dragAndDropStartTransferScope, long j) {
                dragAndDropStartTransferScope.mo4097startDragAndDropTransfer12SF9DM(DragAndDropTransferData.this, decorationSize, drawDragDecoration);
            }
        };
        getDragAndDropManager().mo4096requestDragAndDropTransferUv8p0NA(this, Offset.INSTANCE.m4358getUnspecifiedF1C5BW0());
    ...
    */
    public void onMoved(final DragAndDropEvent event) {
        ...
        boolean m4105containsUv8p0NA;
        DragAndDropNode dragAndDropNode2 = this.lastChildDragAndDropModifierNode;
        if (dragAndDropNode2 != null) {
            m4105containsUv8p0NA = DragAndDropNodeKt.m4105containsUv8p0NA(dragAndDropNode2, DragAndDrop_androidKt.getPositionInRoot(event));
            if (m4105containsUv8p0NA) {
        ...
        if (dragAndDropNode3.getNode().getIsAttached()) {
            ...
            TraversableNodeKt.traverseDescendants(dragAndDropNode3, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                ...
                public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode4) {
                    DragAndDropManager dragAndDropManager;
                    boolean m4105containsUv8p0NA2;
                    DragAndDropNode dragAndDropNode5 = dragAndDropNode4;
                    dragAndDropManager = this.getDragAndDropManager();
                    if (dragAndDropManager.isInterestedTarget(dragAndDropNode5)) {
                        m4105containsUv8p0NA2 = DragAndDropNodeKt.m4105containsUv8p0NA(dragAndDropNode5, DragAndDrop_androidKt.getPositionInRoot(event));
                        if (m4105containsUv8p0NA2) {
