...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    private long offset = Offset.INSTANCE.m4359getZeroF1C5BW0();
    private long color = Color.INSTANCE.m4641getBlack0d7_KjU();
    private float alpha = 1.0f;
    private int blendMode = BlendMode.INSTANCE.m4556getSrcOver0nO6VwU();
    ...
    public void mo4111setOffsetk4lQ0M(long j) {
        if (Offset.m4340equalsimpl0(this.offset, j)) {
            return;
        }
        this.offset = j;
        DrawModifierNodeKt.invalidateDraw(this);
    ...
    public void mo4110setColor8_81llA(long j) {
        if (j == 16) {
            j = Color.INSTANCE.m4641getBlack0d7_KjU();
        }
        if (Color.m4616equalsimpl0(this.color, j)) {
            return;
        }
        this.color = j;
        invalidateShadow();
    ...
    public void mo4109setBlendModes9anfk8(int i) {
        if (BlendMode.m4525equalsimpl0(this.blendMode, i)) {
            return;
        }
        this.blendMode = i;
        invalidateShadow();
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        Painter.m5334drawx_KDEd0$default(obtainPainter(), contentDrawScope, contentDrawScope.mo5121getSizeNHjbRc(), 0.0f, null, 6, null);
    ...
    private final DropShadowPainter obtainPainter() {
        ...
        float mo455toDpu2uoSUM = mo455toDpu2uoSUM(getRadius());
        float mo455toDpu2uoSUM2 = mo455toDpu2uoSUM(getSpread());
        float mo455toDpu2uoSUM3 = mo455toDpu2uoSUM(Float.intBitsToFloat((int) (getOffset() >> 32)));
        float mo455toDpu2uoSUM4 = mo455toDpu2uoSUM(Float.intBitsToFloat((int) (getOffset() & 4294967295L)));
        long m7455constructorimpl = DpOffset.m7455constructorimpl((Float.floatToRawIntBits(mo455toDpu2uoSUM4) & 4294967295L) | (Float.floatToRawIntBits(mo455toDpu2uoSUM3) << 32));
        if (dropShadowPainter != null && shadow2 != null && Dp.m7404equalsimpl0(shadow2.getRadius(), mo455toDpu2uoSUM) && Dp.m7404equalsimpl0(shadow2.getSpread(), mo455toDpu2uoSUM2) && Color.m4616equalsimpl0(shadow2.getColor(), getColor()) && Intrinsics.areEqual(shadow2.getBrush(), brush) && shadow2.getAlpha() == getAlpha() && BlendMode.m4525equalsimpl0(shadow2.getBlendMode(), getBlendMode()) && DpOffset.m7459equalsimpl0(shadow2.getOffset(), m7455constructorimpl)) {
            return dropShadowPainter;
        }
        if (brush != null) {
            shadow = new Shadow(mo455toDpu2uoSUM, brush, mo455toDpu2uoSUM2, m7455constructorimpl, getAlpha(), getBlendMode(), (DefaultConstructorMarker) null);
        } else {
            shadow = new Shadow(mo455toDpu2uoSUM, getColor(), mo455toDpu2uoSUM2, m7455constructorimpl, getAlpha(), getBlendMode(), (DefaultConstructorMarker) null);
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof BlockDropShadowNode)) {
            ...
            return getAlpha() == blockDropShadowNode.getAlpha() && Intrinsics.areEqual(this.shape, blockDropShadowNode.shape) && this.block == blockDropShadowNode.block && getRadius() == blockDropShadowNode.getRadius() && getSpread() == blockDropShadowNode.getSpread() && Offset.m4340equalsimpl0(getOffset(), blockDropShadowNode.getOffset()) && Color.m4616equalsimpl0(getColor(), blockDropShadowNode.getColor()) && Intrinsics.areEqual(getBrush(), blockDropShadowNode.getBrush()) && BlendMode.m4525equalsimpl0(getBlendMode(), blockDropShadowNode.getBlendMode());
        }
        return false;
    }

    public int hashCode() {
        int floatToIntBits = ((((((((((((Float.floatToIntBits(getAlpha()) * 31) + this.shape.hashCode()) * 31) + this.block.hashCode()) * 31) + Float.floatToIntBits(getRadius())) * 31) + Float.floatToIntBits(getSpread())) * 31) + Offset.m4345hashCodeimpl(getOffset())) * 31) + Color.m4622hashCodeimpl(getColor())) * 31;
        Brush brush = getBrush();
        return ((floatToIntBits + (brush != null ? brush.hashCode() : 0)) * 31) + BlendMode.m4526hashCodeimpl(getBlendMode());
    }
}
