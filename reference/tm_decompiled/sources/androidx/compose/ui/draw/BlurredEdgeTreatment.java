...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m4117constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m4117constructorimpl(null);
    private final Shape shape;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ BlurredEdgeTreatment m4116boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Shape m4117constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4118equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m4122unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4119equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4120hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m4121toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object other) {
        return m4118equalsimpl(this.shape, other);
    }

    public int hashCode() {
        return m4120hashCodeimpl(this.shape);
    }

    public String toString() {
        return m4121toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Shape m4122unboximpl() {
        return this.shape;
    }
