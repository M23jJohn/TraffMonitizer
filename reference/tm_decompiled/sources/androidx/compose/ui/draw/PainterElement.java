...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int hashCode = ((((((((this.painter.hashCode() * 31) + UByte$$ExternalSyntheticBackport0.m(this.sizeToIntrinsics)) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.floatToIntBits(this.alpha)) * 31;
    ...
    public void update(PainterNode node) {
        ...
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m4408equalsimpl0(node.getPainter().mo5329getIntrinsicSizeNHjbRc(), this.painter.mo5329getIntrinsicSizeNHjbRc()));
