...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public static /* synthetic */ ShadowGraphicsLayerElement m4181copygNMxBKI$default(ShadowGraphicsLayerElement shadowGraphicsLayerElement, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        long j3 = j2;
        boolean z2 = z;
        return shadowGraphicsLayerElement.m4185copygNMxBKI(f, shape, z2, j, j3);
    }
    ...
    public final ShadowGraphicsLayerElement m4185copygNMxBKI(float elevation, Shape shape, boolean clip, long ambientColor, long spotColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m4616equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m4616equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m7405hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m(this.clip)) * 31) + Color.m4622hashCodeimpl(this.ambientColor)) * 31) + Color.m4622hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m7410toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m4623toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m4623toStringimpl(this.spotColor)) + ')';
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m4187getElevationD9Ej5fM() {
        return this.elevation;
    }
    ...
    public final long m4186getAmbientColor0d7_KjU() {
        return this.ambientColor;
    }

    /* renamed from: getSpotColor-0d7_KjU, reason: not valid java name */
    public final long m4188getSpotColor0d7_KjU() {
        return this.spotColor;
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement$createBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo459toPx0680j_4(ShadowGraphicsLayerElement.this.m4187getElevationD9Ej5fM()));
                ...
                graphicsLayerScope.mo4792setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.m4186getAmbientColor0d7_KjU());
                graphicsLayerScope.mo4795setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.m4188getSpotColor0d7_KjU());
            }
        };
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m7397boximpl(this.elevation));
        inspectorInfo.getProperties().set("shape", this.shape);
        inspectorInfo.getProperties().set("clip", Boolean.valueOf(this.clip));
        inspectorInfo.getProperties().set("ambientColor", Color.m4605boximpl(this.ambientColor));
        inspectorInfo.getProperties().set("spotColor", Color.m4605boximpl(this.spotColor));
    }
}
