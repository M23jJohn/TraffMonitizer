...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo4237clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection);
    ...
    boolean mo4238dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w, reason: not valid java name */
    boolean mo4239dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem);
    ...
    Boolean mo4240focusSearchULY8qGw(int focusDirection, Rect focusedRect, Function1<? super FocusTargetNode, Boolean> onFound);
    ...
    boolean mo4241requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
    ...
    boolean mo4242takeFocusaToIllA(int focusDirection, Rect previouslyFocusedRect);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ boolean m4243dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
            if (obj != null) {
            ...
            return focusOwner.mo4239dispatchKeyEventYhN2O0w(keyEvent, function0);
        }

        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ boolean dispatchRotaryEvent$default(FocusOwner focusOwner, RotaryScrollEvent rotaryScrollEvent, Function0 function0, int i, Object obj) {
            if (obj != null) {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ boolean dispatchIndirectTouchEvent$default(FocusOwner focusOwner, IndirectTouchEvent indirectTouchEvent, Function0 function0, int i, Object obj) {
            if (obj != null) {
