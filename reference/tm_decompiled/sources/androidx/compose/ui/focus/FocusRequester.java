...
public final class FocusRequester {
    ...
    public final /* synthetic */ void requestFocus() {
        m4251requestFocus3ESFkO8(FocusDirection.INSTANCE.m4227getEnterdhqQ8s());
    }

    /* renamed from: requestFocus-3ESFkO8$default, reason: not valid java name */
    public static /* synthetic */ boolean m4250requestFocus3ESFkO8$default(FocusRequester focusRequester, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = FocusDirection.INSTANCE.m4227getEnterdhqQ8s();
        }
        return focusRequester.m4251requestFocus3ESFkO8(i);
    }

    /* renamed from: requestFocus-3ESFkO8, reason: not valid java name */
    public final boolean m4251requestFocus3ESFkO8(final int focusDirection) {
    ...
    */
    public final boolean findFocusTargetNode$ui_release(Function1<? super FocusTargetNode, Boolean> onFound) {
        boolean m4289findChildCorrespondingToFocusEnterOMvw8;
        Companion companion = INSTANCE;
        if (this == companion.getDefault()) {
            throw new IllegalStateException("\n    Please check whether the focusRequester is FocusRequester.Cancel or FocusRequester.Default\n    before invoking any functions on the focusRequester.\n".toString());
        }
                                ...
                                while (node != null) {
                                    if (node instanceof FocusTargetNode) {
                                        ...
                                        if (focusTargetNode.fetchFocusProperties$ui_release().getCanFocus()) {
                                            m4289findChildCorrespondingToFocusEnterOMvw8 = onFound.invoke(focusTargetNode).booleanValue();
                                        } else {
                                            m4289findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m4289findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.INSTANCE.m4227getEnterdhqQ8s(), onFound);
                                        }
                                        if (m4289findChildCorrespondingToFocusEnterOMvw8) {
                                            z = true;
                                            break;
                                        }
                                    } else if ((node.getKindSet() & m6355constructorimpl) != 0 && (node instanceof DelegatingNode)) {
