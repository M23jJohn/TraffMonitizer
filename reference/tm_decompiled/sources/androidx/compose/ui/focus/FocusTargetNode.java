...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public /* synthetic */ FocusTargetNode(int i, Function2 function2, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Focusability.INSTANCE.m4277getAlwaysLCbbffg() : i, (i2 & 2) != 0 ? null : function2, (i2 & 4) != 0 ? null : function1, null);
    }
    ...
    public /* synthetic */ boolean requestFocus() {
        return mo4253requestFocus3ESFkO8(FocusDirection.INSTANCE.m4227getEnterdhqQ8s());
    }

    @Override // androidx.compose.ui.focus.FocusTargetModifierNode
    /* renamed from: requestFocus-3ESFkO8 */
    public boolean mo4253requestFocus3ESFkO8(int focusDirection) {
        ...
        try {
            ...
            int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m4264performCustomRequestFocusMxy_nc0(this, focusDirection).ordinal()];
            if (i == 1) {
    ...
    public void mo4254setFocusabilityjosRg5g(int i) {
        if (Focusability.m4273equalsimpl0(this.focusability, i)) {
            return;
        }
        this.focusability = i;
        if (getIsAttached() && this == DelegatableNodeKt.requireOwner(this).getFocusOwner().getActiveFocusTargetNode() && !Focusability.m4270canFocusimpl$ui_release(this.focusability, this)) {
    ...
    public void onReset() {
        if (ComposeUiFlags.isClearFocusOnResetEnabled && getFocusState().isFocused()) {
            DelegatableNodeKt.requireOwner(this).getFocusOwner().mo4237clearFocusI7lrPNg(true, true, true, FocusDirection.INSTANCE.m4228getExitdhqQ8s());
        }
    }
    ...
    public void onDetach() {
        ...
        if (i == 1 || i == 2) {
            ...
            focusOwner.mo4237clearFocusI7lrPNg(true, true, false, FocusDirection.INSTANCE.m4228getExitdhqQ8s());
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        focusPropertiesImpl.setCanFocus(Focusability.m4270canFocusimpl$ui_release(getFocusability(), this));
        FocusTargetNode focusTargetNode = this;
        int m6355constructorimpl = NodeKind.m6355constructorimpl(2048);
        int m6355constructorimpl2 = NodeKind.m6355constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = m6355constructorimpl | m6355constructorimpl2;
        if (!focusTargetNode.getNode().getIsAttached()) {
            InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
        }
            ...
            if ((requireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & m6355constructorimpl2) != 0) {
                            break loop0;
                        }
    ...
    private final void m4258fetchCustomEnterOrExitULY8qGw(int focusDirection, Function1<? super FocusRequester, Unit> block, Function2<? super FocusProperties, ? super FocusEnterExitScope, Unit> enterOrExit) {
    ...
    public final void m4259fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
    ...
    public final void m4260fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
    ...
    public final void dispatchFocusCallbacks$ui_release(FocusState previousState, FocusState newState) {
        ...
        int m6355constructorimpl = NodeKind.m6355constructorimpl(4096);
        int m6355constructorimpl2 = NodeKind.m6355constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = m6355constructorimpl | m6355constructorimpl2;
        if (!focusTargetNode.getNode().getIsAttached()) {
