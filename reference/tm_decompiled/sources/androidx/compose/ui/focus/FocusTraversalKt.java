...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m4267customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4231getPreviousdhqQ8s())) {
        ...
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4227getEnterdhqQ8s()) || FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4228getExitdhqQ8s())) {
    ...
    public static final Boolean m4268focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int m4232getRightdhqQ8s;
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4230getNextdhqQ8s()) || FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4231getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m4282oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4229getLeftdhqQ8s()) || FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4232getRightdhqQ8s()) || FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4233getUpdhqQ8s()) || FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4226getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m4293twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4227getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m4232getRightdhqQ8s = FocusDirection.INSTANCE.m4232getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                m4232getRightdhqQ8s = FocusDirection.INSTANCE.m4229getLeftdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (findActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m4293twoDimensionalFocusSearchsMXa3k8(findActiveFocusNode, m4232getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4228getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m4224toStringimpl(i))).toString());
    }
