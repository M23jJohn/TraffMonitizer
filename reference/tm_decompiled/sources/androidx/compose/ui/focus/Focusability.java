...
public final class Focusability {
    ...
    private static final int Always = m4271constructorimpl(1);
    private static final int SystemDefined = m4271constructorimpl(0);
    private static final int Never = m4271constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Focusability m4269boximpl(int i) {
        return new Focusability(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4271constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m4272equalsimpl(this.value, other);
    }
    ...
    public static String m4275toStringimpl(int i) {
        if (m4273equalsimpl0(i, Always)) {
            return "Always";
        }
        if (m4273equalsimpl0(i, SystemDefined)) {
            return "SystemDefined";
        }
        if (m4273equalsimpl0(i, Never)) {
            return "Never";
        }
    ...
    public static final boolean m4270canFocusimpl$ui_release(int i, CompositionLocalConsumerModifierNode compositionLocalConsumerModifierNode) {
        if (m4273equalsimpl0(i, Always)) {
            return true;
        }
        if (m4273equalsimpl0(i, SystemDefined)) {
            return !InputMode.m5441equalsimpl0(((InputModeManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(compositionLocalConsumerModifierNode, CompositionLocalsKt.getLocalInputModeManager())).mo5447getInputModeaOaMEAU(), InputMode.INSTANCE.m5446getTouchaOaMEAU());
        }
        if (m4273equalsimpl0(i, Never)) {
            return false;
        }
