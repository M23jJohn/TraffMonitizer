...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m4282oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m4281generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4230getNextdhqQ8s(), function1);
            }
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i2 == 1) {
            return backwardFocusSearch(activeChild, function1) || m4281generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4231getPreviousdhqQ8s(), function1) || (activeChild.fetchFocusProperties$ui_release().getCanFocus() && function1.invoke(activeChild).booleanValue());
        }
        if (i2 == 2 || i2 == 3) {
            return m4281generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4231getPreviousdhqQ8s(), function1);
        }
        if (i2 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    ...
    private static final boolean m4281generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m4283searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m4217searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean m4283searchChildren4C6V_qg;
                if (FocusTargetNode.this == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode()) {
                    m4283searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m4283searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1);
                    Boolean valueOf = Boolean.valueOf(m4283searchChildren4C6V_qg);
                    valueOf.getClass();
                    if (m4283searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
                        return valueOf;
                    }
                    return null;
                }
    ...
    public static final boolean m4283searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m4222equalsimpl0(i, FocusDirection.INSTANCE.m4230getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
        return function1.invoke(focusTargetNode).booleanValue();
    }
                ...
                while (parent != null) {
                    if ((parent.getKindSet() & m6355constructorimpl) != 0) {
                        ...
                        while (node2 != null) {
                            ...
                            if ((node2.getKindSet() & m6355constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                int i = 0;
