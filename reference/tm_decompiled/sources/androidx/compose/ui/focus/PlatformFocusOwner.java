...
public interface PlatformFocusOwner {
    ...
    boolean mo4284moveFocusInChildren3ESFkO8(int focusDirection);

    /* renamed from: requestOwnerFocus-7o62pno, reason: not valid java name */
    boolean mo4285requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
}
