...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4556getSrcOver0nO6VwU();
    }
    ...
    public long mo4459getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo4465setColor8_81llA(long j) {
        AndroidPaint_androidKt.m4471setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo4464setBlendModes9anfk8(int i) {
        if (BlendMode.m4525equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m4470setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4463getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo4469setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m4475setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo4461getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo4467setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m4473setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4462getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo4468setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m4474setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo4460getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo4466setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m4472setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
