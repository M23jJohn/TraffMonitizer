...
public final class AndroidPaint_androidKt {
    ...
    public static final void m4470setNativeBlendModeGB0RdKg(android.graphics.Paint paint, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m5046setBlendModeGB0RdKg(paint, i);
        } else {
            paint.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4436toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m4471setNativeColor4WTKRHQ(android.graphics.Paint paint, long j) {
        paint.setColor(ColorKt.m4669toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m4475setNativeStyle5YerkU(android.graphics.Paint paint, int i) {
        paint.setStyle(PaintingStyle.m4899equalsimpl0(i, PaintingStyle.INSTANCE.m4904getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.INSTANCE.m4904getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m4903getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m4997getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4995getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m4473setNativeStrokeCapCSYIeUk(android.graphics.Paint paint, int i) {
        Paint.Cap cap;
        if (StrokeCap.m4991equalsimpl0(i, StrokeCap.INSTANCE.m4997getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m4991equalsimpl0(i, StrokeCap.INSTANCE.m4996getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m4991equalsimpl0(i, StrokeCap.INSTANCE.m4995getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m5005getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m4474setNativeStrokeJoinkLtJ_vA(android.graphics.Paint paint, int i) {
        Paint.Join join;
        if (StrokeJoin.m5001equalsimpl0(i, StrokeJoin.INSTANCE.m5006getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m5001equalsimpl0(i, StrokeJoin.INSTANCE.m5005getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m5001equalsimpl0(i, StrokeJoin.INSTANCE.m5007getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m4718getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m4716getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m4472setNativeFilterQuality50PEsBU(android.graphics.Paint paint, int i) {
        paint.setFilterBitmap(!FilterQuality.m4711equalsimpl0(i, FilterQuality.INSTANCE.m4718getNonefv9h1I()));
    }
