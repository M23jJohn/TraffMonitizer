...
public final class AndroidPath implements Path {
    ...
    public int mo4477getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4919getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4920getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo4479setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4915equalsimpl0(i, PathFillType.INSTANCE.m4919getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = Float.intBitsToFloat((int) (roundRect.m4393getTopLeftCornerRadiuskKHJgLs() >> 32));
        fArr[1] = Float.intBitsToFloat((int) (roundRect.m4393getTopLeftCornerRadiuskKHJgLs() & 4294967295L));
        fArr[2] = Float.intBitsToFloat((int) (roundRect.m4394getTopRightCornerRadiuskKHJgLs() >> 32));
        fArr[3] = Float.intBitsToFloat((int) (roundRect.m4394getTopRightCornerRadiuskKHJgLs() & 4294967295L));
        fArr[4] = Float.intBitsToFloat((int) (roundRect.m4392getBottomRightCornerRadiuskKHJgLs() >> 32));
        fArr[5] = Float.intBitsToFloat((int) (roundRect.m4392getBottomRightCornerRadiuskKHJgLs() & 4294967295L));
        fArr[6] = Float.intBitsToFloat((int) (roundRect.m4391getBottomLeftCornerRadiuskKHJgLs() >> 32));
        fArr[7] = Float.intBitsToFloat((int) (roundRect.m4391getBottomLeftCornerRadiuskKHJgLs() & 4294967295L));
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo4476addPathUv8p0NA(Path path, long offset) {
    ...
    public void mo4481translatek4lQ0M(long offset) {
    ...
    public void mo4480transform58bKbWc(float[] matrix) {
    ...
    public boolean mo4478opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4925equalsimpl0(operation, PathOperation.INSTANCE.m4929getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4925equalsimpl0(operation, PathOperation.INSTANCE.m4930getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4925equalsimpl0(operation, PathOperation.INSTANCE.m4931getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4925equalsimpl0(operation, PathOperation.INSTANCE.m4932getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
