...
public final class BrushKt {
    public static final ShaderBrush toShaderBrush(Brush brush) {
        ...
        Brush m4571verticalGradient8A3gB4$default = Brush.Companion.m4571verticalGradient8A3gB4$default(Brush.INSTANCE, CollectionsKt.listOf((Object[]) new Color[]{Color.m4605boximpl(solidColor.getValue()), Color.m4605boximpl(solidColor.getValue())}), 0.0f, 0.0f, 0, 14, (Object) null);
        Intrinsics.checkNotNull(m4571verticalGradient8A3gB4$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.ShaderBrush");
        return (ShaderBrush) m4571verticalGradient8A3gB4$default;
    }
