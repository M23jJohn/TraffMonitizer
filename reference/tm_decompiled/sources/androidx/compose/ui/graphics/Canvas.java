...
public interface Canvas {
    ...
    void mo4437clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo4438clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: clipRect-mtrdD-E */
    void mo4439clipRectmtrdDE(Rect rect, int clipOp);

    /* renamed from: concat-58bKbWc */
    void mo4440concat58bKbWc(float[] matrix);
    ...
    void mo4441drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo4442drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo4443drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo4444drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo4445drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo4446drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo4447drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m4589clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo4439clipRectmtrdDE(rect, i);
        }

        /* renamed from: $default$clipRect-mtrdD-E, reason: not valid java name */
        public static void m4585$default$clipRectmtrdDE(Canvas _this, Rect rect, int i) {
            _this.mo4438clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
        public static /* synthetic */ void m4588clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo4438clipRectN_I0leg(f, f2, f3, f4, i);
        }

        /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
        public static /* synthetic */ void m4587clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo4437clipPathmtrdDE(path, i);
        }
        ...
        public static /* synthetic */ void m4590drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
            }
            long m7542getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m7542getZeronOccac() : j;
            long m7569constructorimpl = (i & 4) != 0 ? IntSize.m7569constructorimpl((imageBitmap.getHeight() & 4294967295L) | (imageBitmap.getWidth() << 32)) : j2;
            canvas.mo4443drawImageRectHPBpro0(imageBitmap, m7542getZeronOccac, m7569constructorimpl, (i & 8) != 0 ? IntOffset.INSTANCE.m7542getZeronOccac() : j3, (i & 16) != 0 ? m7569constructorimpl : j4, paint);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static void m4593clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            CC.m4585$default$clipRectmtrdDE(canvas, rect, i);
        }
