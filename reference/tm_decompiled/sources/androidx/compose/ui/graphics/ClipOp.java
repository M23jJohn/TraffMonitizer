...
public final class ClipOp {
    ...
    private static final int Difference = m4597constructorimpl(0);
    private static final int Intersect = m4597constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m4596boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public boolean equals(Object other) {
        return m4598equalsimpl(this.value, other);
    }
    ...
    public static String m4601toStringimpl(int i) {
        return m4599equalsimpl0(i, Difference) ? "Difference" : m4599equalsimpl0(i, Intersect) ? "Intersect" : "Unknown";
    }
}
