...
public final class ColorMatrixColorFilter extends ColorFilter {
    ...
    private ColorMatrixColorFilter(float[] fArr) {
        this(fArr, AndroidColorFilter_androidKt.m4449actualColorMatrixColorFilterjHGOpc(fArr), null);
    }

    /* renamed from: copyColorMatrix-gBh15pI$default, reason: not valid java name */
    public static /* synthetic */ float[] m4691copyColorMatrixgBh15pI$default(ColorMatrixColorFilter colorMatrixColorFilter, float[] fArr, int i, Object obj) {
        if ((i & 1) != 0) {
            fArr = ColorMatrix.m4672constructorimpl$default(null, 1, null);
        }
        return colorMatrixColorFilter.m4693copyColorMatrixgBh15pI(fArr);
    }

    /* renamed from: copyColorMatrix-gBh15pI, reason: not valid java name */
    public final float[] m4693copyColorMatrixgBh15pI(float[] targetColorMatrix) {
        ArraysKt.copyInto$default(m4692obtainColorMatrixp10uLo(), targetColorMatrix, 0, 0, 0, 14, (Object) null);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorMatrixColorFilter) && Arrays.equals(m4692obtainColorMatrixp10uLo(), ((ColorMatrixColorFilter) other).m4692obtainColorMatrixp10uLo());
    }

    /* renamed from: obtainColorMatrix-p10-uLo, reason: not valid java name */
    private final float[] m4692obtainColorMatrixp10uLo() {
    ...
    public int hashCode() {
        float[] fArr = this.colorMatrix;
        if (fArr != null) {
            return ColorMatrix.m4678hashCodeimpl(fArr);
        }
        return 0;
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        sb.append((Object) (fArr == null ? "null" : ColorMatrix.m4689toStringimpl(fArr)));
        sb.append(')');
        return sb.toString();
    }
}
