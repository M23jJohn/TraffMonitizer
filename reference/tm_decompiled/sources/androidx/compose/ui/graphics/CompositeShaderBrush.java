...
public final class CompositeShaderBrush extends ShaderBrush {
    ...
    public Shader mo4584createShaderuvyYCjk(long size) {
        return ShaderKt.m4952CompositeShader7EN7VTw(this.dstBrush.mo4584createShaderuvyYCjk(size), this.srcBrush.mo4584createShaderuvyYCjk(size), this.blendMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.dstBrush, compositeShaderBrush.dstBrush) && Intrinsics.areEqual(this.srcBrush, compositeShaderBrush.srcBrush) && BlendMode.m4525equalsimpl0(this.blendMode, compositeShaderBrush.blendMode);
    }

    public int hashCode() {
        return (((this.dstBrush.hashCode() * 31) + this.srcBrush.hashCode()) * 31) + BlendMode.m4526hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "CompositeShaderBrush(dstBrush=" + this.dstBrush + ", srcBrush=" + this.srcBrush + ", blendMode=" + ((Object) BlendMode.m4527toStringimpl(this.blendMode)) + ')';
    }
}
