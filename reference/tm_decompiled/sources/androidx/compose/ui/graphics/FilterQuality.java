...
public final class FilterQuality {
    ...
    private static final int None = m4709constructorimpl(0);
    private static final int Low = m4709constructorimpl(1);
    private static final int Medium = m4709constructorimpl(2);
    private static final int High = m4709constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FilterQuality m4708boximpl(int i) {
    ...
    public static boolean m4710equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m4714unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4718getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I, reason: not valid java name */
        public final int m4716getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I, reason: not valid java name */
        public final int m4717getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I, reason: not valid java name */
        public final int m4715getHighfv9h1I() {
    ...
    public static String m4713toStringimpl(int i) {
        return m4711equalsimpl0(i, None) ? "None" : m4711equalsimpl0(i, Low) ? "Low" : m4711equalsimpl0(i, Medium) ? "Medium" : m4711equalsimpl0(i, High) ? "High" : "Unknown";
    }
}
