...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m4725constructorimpl((short) 5120);
    private static final short LowestValue = m4725constructorimpl((short) -1025);
    private static final short MaxValue = m4725constructorimpl((short) 31743);
    private static final short MinNormal = m4725constructorimpl((short) 1024);
    private static final short MinValue = m4725constructorimpl((short) 1);
    private static final short NaN = m4725constructorimpl((short) 32256);
    private static final short NegativeInfinity = m4725constructorimpl((short) -1024);
    private static final short NegativeZero = m4725constructorimpl(ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m4725constructorimpl((short) 31744);
    private static final short PositiveZero = m4725constructorimpl((short) 0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Float16 m4720boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m4725constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4726equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m4751unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4727equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: getExponent-impl, reason: not valid java name */
    public static final int m4729getExponentimpl(short s) {
        return ((s >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl, reason: not valid java name */
    public static final int m4731getSignificandimpl(short s) {
        return s & 1023;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4732hashCodeimpl(short s) {
        return s;
    }

    /* renamed from: isFinite-impl, reason: not valid java name */
    public static final boolean m4733isFiniteimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) != 31744;
    }

    /* renamed from: isInfinite-impl, reason: not valid java name */
    public static final boolean m4734isInfiniteimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) == 31744;
    }

    /* renamed from: isNaN-impl, reason: not valid java name */
    public static final boolean m4735isNaNimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) > 31744;
    }

    /* renamed from: isNormalized-impl, reason: not valid java name */
    public static final boolean m4736isNormalizedimpl(short s) {
        int i = s & 31744;
        return (i != 0) & (i != 31744);
    }

    /* renamed from: toRawBits-impl, reason: not valid java name */
    public static final int m4745toRawBitsimpl(short s) {
        return s & UShort.MAX_VALUE;
    }

    public boolean equals(Object other) {
        return m4726equalsimpl(this.halfValue, other);
    }

    public int hashCode() {
        return m4732hashCodeimpl(this.halfValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ short m4751unboximpl() {
        return this.halfValue;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m4750compareTo41bOqos(float16.m4751unboximpl());
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m4723constructorimpl(double d) {
        return m4724constructorimpl((float) d);
    }

    /* renamed from: toByte-impl, reason: not valid java name */
    public static final byte m4739toByteimpl(short s) {
        return (byte) m4741toFloatimpl(s);
    }

    /* renamed from: toShort-impl, reason: not valid java name */
    public static final short m4746toShortimpl(short s) {
        return (short) m4741toFloatimpl(s);
    }

    /* renamed from: toInt-impl, reason: not valid java name */
    public static final int m4743toIntimpl(short s) {
        return (int) m4741toFloatimpl(s);
    }

    /* renamed from: toLong-impl, reason: not valid java name */
    public static final long m4744toLongimpl(short s) {
        return (long) m4741toFloatimpl(s);
    }

    /* renamed from: toDouble-impl, reason: not valid java name */
    public static final double m4740toDoubleimpl(short s) {
        return m4741toFloatimpl(s);
    }

    /* renamed from: toBits-impl, reason: not valid java name */
    public static final int m4738toBitsimpl(short s) {
        if (m4735isNaNimpl(s)) {
            return 32256;
        }
        return s & UShort.MAX_VALUE;
    ...
    public static String m4747toStringimpl(short s) {
        return String.valueOf(m4741toFloatimpl(s));
    }

    public String toString() {
        return m4747toStringimpl(this.halfValue);
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public int m4750compareTo41bOqos(short s) {
        return m4722compareTo41bOqos(this.halfValue, s);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public static int m4722compareTo41bOqos(short s, short s2) {
        if (m4735isNaNimpl(s)) {
            return !m4735isNaNimpl(s2) ? 1 : 0;
        }
        if (m4735isNaNimpl(s2)) {
            return -1;
        }
    ...
    public static final short m4730getSignslo4al4(short s) {
        int i = s & ShortCompanionObject.MAX_VALUE;
        if (!((i > 31744) | (i == 0))) {
            i = (s & ShortCompanionObject.MIN_VALUE) | 15360;
        }
        return m4725constructorimpl((short) i);
    }

    /* renamed from: withSign-qCeQghg, reason: not valid java name */
    public static final short m4749withSignqCeQghg(short s, short s2) {
        return m4725constructorimpl((short) ((s & ShortCompanionObject.MAX_VALUE) | (s2 & ShortCompanionObject.MIN_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4, reason: not valid java name */
    public static final short m4719absoluteValueslo4al4(short s) {
        return m4725constructorimpl((short) (s & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4, reason: not valid java name */
    public static final short m4737roundslo4al4(short s) {
        ...
        return m4725constructorimpl((short) i2);
    }

    /* renamed from: ceil-slo4al4, reason: not valid java name */
    public static final short m4721ceilslo4al4(short s) {
        int i = 65535 & s;
    ...
    public static final short m4728floorslo4al4(short s) {
        int i = SupportMenu.USER_MASK;
        int i2 = s & UShort.MAX_VALUE;
        int i3 = s & ShortCompanionObject.MAX_VALUE;
        if (i3 < 15360) {
    ...
    public static final short m4748truncslo4al4(short s) {
        int i = 65535 & s;
        int i2 = s & ShortCompanionObject.MAX_VALUE;
        if (i2 < 15360) {
            i = 32768 & s;
    ...
    public static final String m4742toHexStringimpl(short s) {
    ...
    public static final float m4741toFloatimpl(short s) {
        int i;
        int i2;
        int i3;
        int i4 = 32768 & s;
