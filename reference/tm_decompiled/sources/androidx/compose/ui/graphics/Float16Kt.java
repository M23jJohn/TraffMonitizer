...
public final class Float16Kt {
    ...
    public static final short m4763minAoSsdG0(short s, short s2) {
        if (Float16.m4735isNaNimpl(s) || Float16.m4735isNaNimpl(s2)) {
            return Float16.Companion.m4757getNaNslo4al4();
        }
        return Float16.m4722compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4762maxAoSsdG0(short s, short s2) {
        if (Float16.m4735isNaNimpl(s) || Float16.m4735isNaNimpl(s2)) {
            return Float16.Companion.m4757getNaNslo4al4();
        }
        return Float16.m4722compareTo41bOqos(s, s2) >= 0 ? s : s2;
