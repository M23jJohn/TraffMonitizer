...
public final class LightingColorFilter extends ColorFilter {
    ...
    private LightingColorFilter(long j, long j2) {
        this(j, j2, AndroidColorFilter_androidKt.m4450actualLightingColorFilterOWjLjI(j, j2), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4616equalsimpl0(this.multiply, lightingColorFilter.multiply) && Color.m4616equalsimpl0(this.add, lightingColorFilter.add);
    }

    public int hashCode() {
        return (Color.m4622hashCodeimpl(this.multiply) * 31) + Color.m4622hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m4623toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m4623toStringimpl(this.add)) + ')';
    }
}
