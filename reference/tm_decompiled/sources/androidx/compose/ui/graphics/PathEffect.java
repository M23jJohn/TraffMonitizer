...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m4911stampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
            return AndroidPathEffect_androidKt.m4482actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
