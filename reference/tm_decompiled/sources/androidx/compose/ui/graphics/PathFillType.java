...
public final class PathFillType {
    ...
    private static final int NonZero = m4913constructorimpl(0);
    private static final int EvenOdd = m4913constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m4912boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m4914equalsimpl(this.value, other);
    }
    ...
    public static final class Companion {
        ...
        public final int m4920getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m4919getEvenOddRgk1Os() {
    ...
    public static String m4917toStringimpl(int i) {
        return m4915equalsimpl0(i, NonZero) ? "NonZero" : m4915equalsimpl0(i, EvenOdd) ? "EvenOdd" : "Unknown";
    }
}
