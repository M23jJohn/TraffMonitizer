...
public final class PathHitTester {
    ...
    public final boolean m4921containsk4lQ0M(long position) {
        int i;
        int lineWinding;
        if (!this.path.isEmpty() && this.bounds.m4369containsk4lQ0M(position)) {
            ...
            if (PathFillType.m4915equalsimpl0(this.path.mo4477getFillTypeRgk1Os(), PathFillType.INSTANCE.m4919getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
