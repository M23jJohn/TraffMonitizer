...
public final class PathOperation {
    ...
    private static final int Difference = m4923constructorimpl(0);
    private static final int Intersect = m4923constructorimpl(1);
    private static final int Union = m4923constructorimpl(2);
    private static final int Xor = m4923constructorimpl(3);
    private static final int ReverseDifference = m4923constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m4922boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4929getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c, reason: not valid java name */
        public final int m4930getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c, reason: not valid java name */
        public final int m4932getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c, reason: not valid java name */
        public final int m4933getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c, reason: not valid java name */
        public final int m4931getReverseDifferenceb3I0S0c() {
    ...
    public static String m4927toStringimpl(int i) {
        return m4925equalsimpl0(i, Difference) ? "Difference" : m4925equalsimpl0(i, Intersect) ? "Intersect" : m4925equalsimpl0(i, Union) ? "Union" : m4925equalsimpl0(i, Xor) ? "Xor" : m4925equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
}
