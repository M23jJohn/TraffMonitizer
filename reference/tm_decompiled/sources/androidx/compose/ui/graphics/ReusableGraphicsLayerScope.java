...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4705getAutoNrFUSI();
    private long size = Size.INSTANCE.m4420getUnspecifiedNHjbRc();
    ...
    public void mo4792setAmbientShadowColor8_81llA(long j) {
        if (Color.m4616equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo4795setSpotShadowColor8_81llA(long j) {
        if (Color.m4616equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo4796setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m5027equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo4794setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4701equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m4949setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void mo4793setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo4792setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4795setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4796setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m5033getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo4793setBlendModes9anfk8(BlendMode.INSTANCE.m4556getSrcOver0nO6VwU());
        mo4794setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4705getAutoNrFUSI());
        m4949setSizeuvyYCjk(Size.INSTANCE.m4420getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo361createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
