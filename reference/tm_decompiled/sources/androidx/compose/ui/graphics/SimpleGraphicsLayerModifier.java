...
final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public final void m4976setTransformOrigin__ExYCQ(long j) {
    ...
    public final void m4972setAmbientShadowColor8_81llA(long j) {
    ...
    public final void m4975setSpotShadowColor8_81llA(long j) {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape, z, renderEffect, j2, j3, (i3 & 65536) != 0 ? CompositingStrategy.INSTANCE.m4705getAutoNrFUSI() : i, (i3 & 131072) != 0 ? BlendMode.INSTANCE.m4556getSrcOver0nO6VwU() : i2, (i3 & 262144) != 0 ? null : colorFilter, null);
    }
    ...
    public final void m4974setCompositingStrategyaDBOjCE(int i) {
    ...
    public final void m4973setBlendModes9anfk8(int i) {
        this.blendMode = i;
    }
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                ...
                graphicsLayerScope.mo4796setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.getTransformOrigin());
                ...
                graphicsLayerScope.mo4792setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.getAmbientShadowColor());
                graphicsLayerScope.mo4795setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.getSpotShadowColor());
                graphicsLayerScope.mo4794setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.getCompositingStrategy());
                graphicsLayerScope.mo4793setBlendModes9anfk8(SimpleGraphicsLayerModifier.this.getBlendMode());
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measureScope, mo6055measureBRTryo0.getWidth(), mo6055measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
