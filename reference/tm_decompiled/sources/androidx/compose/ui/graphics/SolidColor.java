...
public final class SolidColor extends Brush {
    ...
    public void mo4561applyToPq9zytI(long size, Paint p, float alpha) {
        long m4614copywmQWz5c$default;
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            long j = this.value;
            m4614copywmQWz5c$default = Color.m4614copywmQWz5c$default(j, Color.m4617getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            m4614copywmQWz5c$default = this.value;
        }
        p.mo4465setColor8_81llA(m4614copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m4616equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m4623toStringimpl(this.value)) + ')';
    }
}
