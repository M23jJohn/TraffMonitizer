...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo4584createShaderuvyYCjk(long size) {
        ...
        if ((9223372034707292159L & j) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            m4335constructorimpl = SizeKt.m4422getCenteruvyYCjk(size);
        } else {
            ...
            m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (size & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat) << 32));
        }
        return ShaderKt.m4959SweepGradientShader9KIMszo(m4335constructorimpl, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m4340equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int m4345hashCodeimpl = ((Offset.m4345hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m4345hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
