...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m4995getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m5006getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m5280getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m5281getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4991equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m5001equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int floatToIntBits = ((((((Float.floatToIntBits(this.width) * 31) + Float.floatToIntBits(this.miter)) * 31) + StrokeCap.m4992hashCodeimpl(this.cap)) * 31) + StrokeJoin.m5002hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return floatToIntBits + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m4993toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m5003toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
