...
public final class GraphicsLayerKt {
    ...
    public static final void setOutline(GraphicsLayer graphicsLayer, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            ...
            long m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(left) << 32) | (Float.floatToRawIntBits(top) & 4294967295L));
            ...
            graphicsLayer.m5308setRectOutlinetz77jQw(m4335constructorimpl, Size.m4403constructorimpl((4294967295L & Float.floatToRawIntBits(bottom)) | (Float.floatToRawIntBits(right) << 32)));
            return;
        }
        ...
        long m4335constructorimpl2 = Offset.m4335constructorimpl((Float.floatToRawIntBits(left2) << 32) | (Float.floatToRawIntBits(top2) & 4294967295L));
        float width = roundRect.getWidth();
        float height = roundRect.getHeight();
        graphicsLayer.m5309setRoundRectOutlineTNW_H78(m4335constructorimpl2, Size.m4403constructorimpl((4294967295L & Float.floatToRawIntBits(height)) | (Float.floatToRawIntBits(width) << 32)), Float.intBitsToFloat((int) (roundRect.m4391getBottomLeftCornerRadiuskKHJgLs() >> 32)));
    }
