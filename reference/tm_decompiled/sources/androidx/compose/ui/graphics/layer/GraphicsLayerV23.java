...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m7579getZeroYbymL2g();
        ...
        create.setClipToBounds(false);
        m5324applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m5289getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m5289getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m4556getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m4358getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m4641getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m4641getBlack0d7_KjU();
    ...
    public void mo5319setCompositingStrategyWpw9cng(int i) {
        this.compositingStrategy = i;
        updateLayerProperties();
    }

    /* renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m5324applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m5285equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5291getOffscreenke2Ky5w())) {
            renderNode.setLayerType(2);
            renderNode.setLayerPaint(this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5285equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5290getModulateAlphake2Ky5w())) {
    ...
    public void mo5318setBlendModes9anfk8(int i) {
        if (BlendMode.m4525equalsimpl0(this.blendMode, i)) {
            return;
        }
        this.blendMode = i;
        obtainLayerPaint().setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4436toPorterDuffModes9anfk8(i)));
        updateLayerProperties();
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m5285equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5291getOffscreenke2Ky5w()) && BlendMode.m4525equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4556getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5324applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m5291getOffscreenke2Ky5w());
        } else {
            m5324applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo5321setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
    ...
    public void mo5317setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.ambientShadowColor = j;
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m4669toArgb8_81llA(j));
        }
    }
    ...
    public void mo5323setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.spotShadowColor = j;
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m4669toArgb8_81llA(j));
        }
    }
    ...
    public void mo5322setPositionH0pRuoY(int x, int y, long size) {
        int i = (int) (size >> 32);
        int i2 = (int) (4294967295L & size);
        this.renderNode.setLeftTopRightBottom(x, y, x + i, y + i2);
        if (IntSize.m7572equalsimpl0(this.size, size)) {
            return;
        }
    ...
    public void mo5320setOutlineO0kMr_c(Outline outline, long outlineSize) {
