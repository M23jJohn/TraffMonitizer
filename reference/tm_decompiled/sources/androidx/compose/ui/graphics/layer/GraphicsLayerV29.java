...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.renderNode = m;
        this.size = Size.INSTANCE.m4421getZeroNHjbRc();
        m.setClipToBounds(false);
        m5325applyCompositingStrategyZ1X6vPc(m, CompositingStrategy.INSTANCE.m5289getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo5318setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m4435toAndroidBlendModes9anfk8(i));
    ...
    public void mo5317setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4669toArgb8_81llA(j));
    }
    ...
    public void mo5323setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4669toArgb8_81llA(j));
    }
    ...
    private final void m5325applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m5285equalsimpl0(i, CompositingStrategy.INSTANCE.m5291getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5285equalsimpl0(i, CompositingStrategy.INSTANCE.m5290getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5325applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m5291getOffscreenke2Ky5w());
        } else {
            m5325applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo5322setPositionH0pRuoY(int x, int y, long size) {
        ...
        this.size = IntSizeKt.m7586toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo5129setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5285equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5291getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
