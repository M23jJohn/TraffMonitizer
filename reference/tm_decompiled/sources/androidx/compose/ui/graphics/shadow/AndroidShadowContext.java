...
final class AndroidShadowContext implements PlatformShadowContext, DropShadowRendererProvider, InnerShadowRendererProvider {
    ...
    public static final /* data */ class ShadowKey {
        ...
        public static /* synthetic */ ShadowKey m5338copyeZhPAX0$default(ShadowKey shadowKey, Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return shadowKey.m5340copyeZhPAX0(shape, j, layoutDirection2, f, shadow2);
        }
        ...
        public final ShadowKey m5340copyeZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, float density, Shadow shadow) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.shape, shadowKey.shape) && Size.m4408equalsimpl0(this.size, shadowKey.size) && this.layoutDirection == shadowKey.layoutDirection && Float.compare(this.density, shadowKey.density) == 0 && Intrinsics.areEqual(this.shadow, shadowKey.shadow);
        }

        public int hashCode() {
            int hashCode = ((((((this.shape.hashCode() * 31) + Size.m4413hashCodeimpl(this.size)) * 31) + this.layoutDirection.hashCode()) * 31) + Float.floatToIntBits(this.density)) * 31;
            Shadow shadow = this.shadow;
            return hashCode + (shadow == null ? 0 : shadow.hashCode());
        }

        public String toString() {
            return "ShadowKey(shape=" + this.shape + ", size=" + ((Object) Size.m4416toStringimpl(this.size)) + ", layoutDirection=" + this.layoutDirection + ", density=" + this.density + ", shadow=" + this.shadow + ')';
        }
        ...
        public /* synthetic */ ShadowKey(Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (i & 2) != 0 ? Size.INSTANCE.m4421getZeroNHjbRc() : j, (i & 4) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 8) != 0 ? 1.0f : f, (i & 16) != 0 ? null : shadow, null);
        }
        ...
        public final long m5341getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m5342setSizeuvyYCjk(long j) {
            this.size = j;
        }
    ...
    public DropShadowRenderer mo5336obtainDropShadowRenderereZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, Density density, Shadow shadow) {
        DropShadowRenderer dropShadowRenderer;
        synchronized (this) {
            ShadowKey obtainShadowKey = obtainShadowKey();
            obtainShadowKey.setShape(shape);
            obtainShadowKey.m5342setSizeuvyYCjk(size);
            ...
            if (dropShadowRenderer == null) {
                DropShadowRenderer dropShadowRenderer2 = new DropShadowRenderer(shadow, shape.mo361createOutlinePq9zytI(size, layoutDirection, density));
                obtainDropShadowCache().set(ShadowKey.m5338copyeZhPAX0$default(obtainShadowKey, null, 0L, null, 0.0f, null, 31, null), dropShadowRenderer2);
    ...
    public InnerShadowRenderer mo5337obtainInnerShadowRenderereZhPAX0(Shape shape, long size, LayoutDirection layoutDirection, Density density, Shadow shadow) {
        ...
        synchronized (this) {
            ...
            if (innerShadowRenderer == null) {
                InnerShadowRenderer innerShadowRenderer2 = new InnerShadowRenderer(shadow, shape.mo361createOutlinePq9zytI(size, layoutDirection, density));
                obtainInnerShadowCache().set(ShadowKey.m5338copyeZhPAX0$default(obtainShadowKey, null, 0L, null, 0.0f, null, 31, null), innerShadowRenderer2);
