...
public final class DropShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        DropShadowRenderer mo5336obtainDropShadowRenderereZhPAX0 = this.renderCreator.mo5336obtainDropShadowRenderereZhPAX0(this.shape, drawScope.mo5121getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow);
        float f = drawScope.mo459toPx0680j_4(DpOffset.m7460getXD9Ej5fM(this.shadow.getOffset()));
        float f2 = drawScope.mo459toPx0680j_4(DpOffset.m7462getYD9Ej5fM(this.shadow.getOffset()));
        drawScope.getDrawContext().getTransform().translate(f, f2);
        try {
            mo5336obtainDropShadowRenderereZhPAX0.m5358drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo5121getSizeNHjbRc(), mo5336obtainDropShadowRenderereZhPAX0.getShadow().getColor(), mo5336obtainDropShadowRenderereZhPAX0.getShadow().getBrush(), RangesKt.coerceIn(this.alpha * mo5336obtainDropShadowRenderereZhPAX0.getShadow().getAlpha(), 0.0f, 1.0f), mo5336obtainDropShadowRenderereZhPAX0.getShadow().getBlendMode());
        } finally {
            drawScope.getDrawContext().getTransform().translate(-f, -f2);
        }
    }
