...
public final class DropShadowRenderer extends ShadowRenderer {
    ...
    protected void mo5347buildShadow_SMYjrA(DrawScope drawScope, long j, long j2, Path path) {
        ...
        ImageBitmap m5346createOuterShadowBitmapD_oqF2M;
        ...
        if (path != null) {
            ...
            m5346createOuterShadowBitmapD_oqF2M = dropShadowRenderer.m5345createOuterShadowBitmapCqks5Fs(j, path, f, f2);
        } else {
            dropShadowRenderer = this;
            m5346createOuterShadowBitmapD_oqF2M = dropShadowRenderer.m5346createOuterShadowBitmapD_oqF2M(j, f, f2, j2);
        }
        dropShadowRenderer.shadowBitmap = m5346createOuterShadowBitmapD_oqF2M;
    }
    ...
    private final Brush obtainCompositeBrush(ImageBitmap shadowBitmap, Brush brush) {
        ...
        if (compositeShaderBrush == null || !Intrinsics.areEqual(compositeShaderBrush.getSrcBrush(), brush)) {
            ...
            ShaderBrush ShaderBrush = BrushKt.ShaderBrush(ShaderKt.m4954ImageShaderF49vj9s$default(shadowBitmap, 0, 0, 6, null));
            if (brush instanceof ShaderBrush) {
                float width = shadowBitmap.getWidth();
                float height = shadowBitmap.getHeight();
                brush = BrushKt.ShaderBrush(((ShaderBrush) brush).mo4584createShaderuvyYCjk(Size.m4403constructorimpl((Float.floatToRawIntBits(width) << 32) | (Float.floatToRawIntBits(height) & 4294967295L))));
            }
            Brush m4573composite7EN7VTw = companion.m4573composite7EN7VTw(ShaderBrush, brush, BlendMode.INSTANCE.m4554getSrcIn0nO6VwU());
            Intrinsics.checkNotNull(m4573composite7EN7VTw, "null cannot be cast to non-null type androidx.compose.ui.graphics.CompositeShaderBrush");
            compositeShaderBrush = (CompositeShaderBrush) m4573composite7EN7VTw;
    ...
    protected void mo5348onDrawShadowMLmccfk(DrawScope drawScope, long j, long j2, Path path, float f, ColorFilter colorFilter, Brush brush, int i) {
        ...
        if (imageBitmap != null) {
            float f2 = -(drawScope.mo459toPx0680j_4(this.shadow.getRadius()) + drawScope.mo459toPx0680j_4(this.shadow.getSpread()));
            if (brush != null && colorFilter == null) {
                ...
                try {
                    ...
                    DrawScope.CC.m5205drawRectAsUm42w$default(drawScope, obtainCompositeBrush, 0L, Size.m4403constructorimpl((4294967295L & Float.floatToRawIntBits(height)) | (Float.floatToRawIntBits(width) << 32)), f, null, null, i, 50, null);
                    return;
                } finally {
                    float f3 = -f2;
            ...
            DrawScope.CC.m5196drawImagegbVJVH8$default(drawScope, imageBitmap, Offset.m4335constructorimpl((4294967295L & Float.floatToRawIntBits(f2)) | (Float.floatToRawIntBits(f2) << 32)), f, null, colorFilter, i, 8, null);
        }
    }

    /* renamed from: createOuterShadowBitmap-Cqks5Fs, reason: not valid java name */
    private final ImageBitmap m5345createOuterShadowBitmapCqks5Fs(long size, Path path, float radius, float spread) {
        float f = 2;
        float f2 = (radius * f) + (f * spread);
        ImageBitmap m4861ImageBitmapx__hDU$default = ImageBitmapKt.m4861ImageBitmapx__hDU$default((int) Math.ceil(Float.intBitsToFloat((int) (size >> 32)) + f2), (int) Math.ceil(Float.intBitsToFloat((int) (size & 4294967295L)) + f2), ImageBitmapConfig.INSTANCE.m4855getAlpha8_sVssgQ(), false, null, 24, null);
        Canvas Canvas = CanvasKt.Canvas(m4861ImageBitmapx__hDU$default);
        if (spread > 0.0f) {
            float f3 = radius + spread;
            Canvas.translate(f3, f3);
            Canvas.drawPath(path, this.paint);
            Paint m5344configureShadowFoewPVk$default = BlurKt.m5344configureShadowFoewPVk$default(this.paint, 0L, 0, radius > 0.0f ? Blur_androidKt.BlurFilter(radius) : null, PaintingStyle.INSTANCE.m4904getStrokeTiuSbCo(), 3, null);
            ...
            return m4861ImageBitmapx__hDU$default;
        }
        BlurKt.m5344configureShadowFoewPVk$default(this.paint, 0L, 0, radius > 0.0f ? Blur_androidKt.BlurFilter(radius) : null, 0, 11, null);
    ...
    private final ImageBitmap m5346createOuterShadowBitmapD_oqF2M(long size, float shadowRadius, float spread, long cornerRadius) {
        float f = 2;
        ...
        ImageBitmap m4861ImageBitmapx__hDU$default = ImageBitmapKt.m4861ImageBitmapx__hDU$default((int) Math.ceil(intBitsToFloat), (int) Math.ceil(intBitsToFloat2), ImageBitmapConfig.INSTANCE.m4855getAlpha8_sVssgQ(), false, null, 24, null);
        CanvasKt.Canvas(m4861ImageBitmapx__hDU$default).drawRoundRect(shadowRadius, shadowRadius, intBitsToFloat - shadowRadius, intBitsToFloat2 - shadowRadius, Float.intBitsToFloat((int) (cornerRadius >> 32)), Float.intBitsToFloat((int) (cornerRadius & 4294967295L)), BlurKt.m5344configureShadowFoewPVk$default(this.paint, 0L, 0, shadowRadius > 0.0f ? Blur_androidKt.BlurFilter(shadowRadius) : null, 0, 11, null));
        return m4861ImageBitmapx__hDU$default;
    }
}
