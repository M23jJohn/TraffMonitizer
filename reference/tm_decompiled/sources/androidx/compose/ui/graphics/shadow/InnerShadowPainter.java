...
public final class InnerShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        this.renderCreator.mo5337obtainInnerShadowRenderereZhPAX0(this.shape, drawScope.mo5121getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow).m5358drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo5121getSizeNHjbRc(), this.shadow.getColor(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.getBlendMode());
    }
