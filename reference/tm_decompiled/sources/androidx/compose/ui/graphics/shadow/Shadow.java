...
public final class Shadow {
    ...
    private Shadow(float f, Brush brush, float f2, long j, float f3, int i) {
        this(f, f2, j, Color.INSTANCE.m4641getBlack0d7_KjU(), brush, f3, i);
    }
    ...
    public /* synthetic */ Shadow(float f, long j, float f2, long j2, float f3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, (i2 & 2) != 0 ? Color.INSTANCE.m4641getBlack0d7_KjU() : j, (i2 & 4) != 0 ? Dp.m7399constructorimpl(0) : f2, (i2 & 8) != 0 ? DpOffset.INSTANCE.m7470getZeroRKDOV3M() : j2, (i2 & 16) != 0 ? 1.0f : f3, (i2 & 32) != 0 ? DrawScope.INSTANCE.m5210getDefaultBlendMode0nO6VwU() : i, (DefaultConstructorMarker) null);
    }

    private Shadow(float f, long j, float f2, long j2, float f3, int i) {
        this(f, f2, j2, j == 16 ? Color.INSTANCE.m4641getBlack0d7_KjU() : j, (Brush) null, f3, i);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7404equalsimpl0(this.radius, shadow.radius) && Dp.m7404equalsimpl0(this.spread, shadow.spread) && DpOffset.m7459equalsimpl0(this.offset, shadow.offset) && this.alpha == shadow.alpha && BlendMode.m4525equalsimpl0(this.blendMode, shadow.blendMode) && Color.m4616equalsimpl0(this.color, shadow.color) && Intrinsics.areEqual(this.brush, shadow.brush);
    }

    public int hashCode() {
        int m7405hashCodeimpl = ((((((((((Dp.m7405hashCodeimpl(this.radius) * 31) + Dp.m7405hashCodeimpl(this.spread)) * 31) + DpOffset.m7464hashCodeimpl(this.offset)) * 31) + Float.floatToIntBits(this.alpha)) * 31) + BlendMode.m4526hashCodeimpl(this.blendMode)) * 31) + Color.m4622hashCodeimpl(this.color)) * 31;
        Brush brush = this.brush;
        return m7405hashCodeimpl + (brush != null ? brush.hashCode() : 0);
    }

    public String toString() {
        return "ShadowParams(radius=" + ((Object) Dp.m7410toStringimpl(this.radius)) + ", spread=" + ((Object) Dp.m7410toStringimpl(this.spread)) + ", offset=" + ((Object) DpOffset.m7467toStringimpl(this.offset)) + ", alpha=" + this.alpha + ", blendMode=" + ((Object) BlendMode.m4527toStringimpl(this.blendMode)) + ", color=" + ((Object) Color.m4623toStringimpl(this.color)) + ", brush=" + this.brush + ')';
    }

    public final Shadow copyWithoutOffset$ui_graphics_release() {
        return new Shadow(this.radius, this.spread, DpOffset.INSTANCE.m7470getZeroRKDOV3M(), this.color, this.brush, this.alpha, this.blendMode);
    }
    ...
    public /* synthetic */ Shadow(float f, Brush brush, float f2, long j, float f3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, brush, (i2 & 4) != 0 ? Dp.m7399constructorimpl(0) : f2, (i2 & 8) != 0 ? DpOffset.INSTANCE.m7470getZeroRKDOV3M() : j, (i2 & 16) != 0 ? 1.0f : f3, (i2 & 32) != 0 ? DrawScope.INSTANCE.m5210getDefaultBlendMode0nO6VwU() : i, (DefaultConstructorMarker) null);
    }
}
