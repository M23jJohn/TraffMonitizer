...
public final class DrawCache {
    ...
    private int config = ImageBitmapConfig.INSTANCE.m4856getArgb8888_sVssgQ();
    ...
    public final void m5359drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmap = this.mCachedImage;
        Canvas canvas = this.cachedCanvas;
        if (imageBitmap == null || canvas == null || ((int) (size >> 32)) > imageBitmap.getWidth() || ((int) (size & 4294967295L)) > imageBitmap.getHeight() || !ImageBitmapConfig.m4851equalsimpl0(this.config, config)) {
            imageBitmap = ImageBitmapKt.m4861ImageBitmapx__hDU$default((int) (size >> 32), (int) (4294967295L & size), config, false, null, 24, null);
        ...
        long m7586toSizeozmzZPI = IntSizeKt.m7586toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m5195drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.CC.m5206drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m4641getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m4529getClear0nO6VwU(), 62, null);
    }
}
