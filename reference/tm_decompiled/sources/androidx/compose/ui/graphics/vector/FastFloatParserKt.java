            ...
            if (i15 > 19) {
                ...
                if (i15 > i9) {
                    ...
                    while (true) {
                        ...
                        char c8 = charAt7;
                        i10 = i13;
                        compare4 = Long.compare(ULong.m8252constructorimpl(j8) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE);
                        if (compare4 >= 0) {
                            break;
                        }
                        j8 = (j8 * 10) + (c8 - '0');
                    ...
                    compare2 = Long.compare(ULong.m8252constructorimpl(j8) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE);
                    if (compare2 >= 0) {
                        i6 = (i10 - i3) + i8;
                    } else {
                        ...
                        int i23 = i5;
                        while (i23 != i4) {
                            compare3 = Long.compare(ULong.m8252constructorimpl(j8) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE);
                            if (compare3 >= 0) {
                                break;
                            }
                            j8 = (j8 * 10) + (charAt8 - '0');
                    ...
                    if (FloatMinExponent <= i6 && i6 < 11 && c5 == 0) {
                        compare = Long.compare(ULong.m8252constructorimpl(j2) ^ Long.MIN_VALUE, ULong.m8252constructorimpl(16777216L) ^ Long.MIN_VALUE);
                        if (compare <= 0) {
                            float f2 = j2;
                            if (i6 < 0) {
                                f = f2 / PowersOfTen[-i6];
                    ...
                    if (j2 != 0) {
                        ...
                        long m8312getsVKNKU = ULongArray.m8312getsVKNKU(Mantissa64, i6 + 325);
                        int numberOfLeadingZeros = Long.numberOfLeadingZeros(j2);
                        long j9 = j2 << numberOfLeadingZeros;
                        long j10 = j9 & j;
                        long j11 = j9 >>> c2;
                        long j12 = m8312getsVKNKU & j;
                        long j13 = m8312getsVKNKU >>> c2;
                        long j14 = j11 * j13;
                        long j15 = j13 * j10;
