...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m4651getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m5360markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m5360markTintForColor8_81llA(long color) {
        if (this.isTintable && color != 16) {
            long j = this.tintColor;
            if (j == 16) {
                this.tintColor = color;
            } else {
                if (VectorKt.m5383rgbEqualOWjLjI(j, color)) {
                    return;
                }
                markNotTintable();
            }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m5360markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        ...
        float[] fArr2 = fArr;
        Matrix.m4888translateimpl$default(fArr2, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m4880rotateZimpl(fArr2, this.rotation);
        Matrix.m4881scaleimpl(fArr2, this.scaleX, this.scaleY, 1.0f);
        Matrix.m4888translateimpl$default(fArr2, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            float[] fArr = this.groupMatrix;
            if (fArr != null) {
                transform.mo5136transform58bKbWc((fArr != null ? Matrix.m4864boximpl(fArr) : null).m4889unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.CC.m5265clipPathmtrdDE$default(transform, path, 0, 2, null);
            }
