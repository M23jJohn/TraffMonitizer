...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4995getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m5006getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4554getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4650getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4920getNonZeroRgk1Os();
    ...
    public static final boolean m5383rgbEqualOWjLjI(long j, long j2) {
        return Color.m4621getRedimpl(j) == Color.m4621getRedimpl(j2) && Color.m4620getGreenimpl(j) == Color.m4620getGreenimpl(j2) && Color.m4618getBlueimpl(j) == Color.m4618getBlueimpl(j2);
    }

    /* renamed from: toOpaque-8_81llA, reason: not valid java name */
    public static final long m5384toOpaque8_81llA(long j) {
        return Color.m4617getAlphaimpl(j) == 1.0f ? j : Color.m4614copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m4525equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4554getSrcIn0nO6VwU()) || BlendMode.m4525equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4556getSrcOver0nO6VwU());
    }
}
