...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m5395rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long m4651getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m4651getUnspecified0d7_KjU() : j;
        int m4554getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m4554getSrcIn0nO6VwU() : i;
        ...
        VectorPainter m5396rememberVectorPaintervIP8VLU = m5396rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, m4651getUnspecified0d7_KjU, m4554getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m5396rememberVectorPaintervIP8VLU;
    }
    ...
    */
    public static final VectorPainter m5396rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        Object obj;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m5393obtainSizePxVpY3zN4 = m5393obtainSizePxVpY3zN4((Density) consume, f, f2);
        final long m5394obtainViewportSizePq9zytI = m5394obtainViewportSizePq9zytI(m5393obtainSizePxVpY3zN4, f5, f6);
        ComposerKt.sourceInformationMarkerStart(composer, 789575591, "CC(remember):VectorPainter.kt#9igjgp");
        boolean z3 = z2;
        String str3 = str2;
        boolean z4 = ((((458752 & i2) ^ ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) > 131072 && composer.changed(m4651getUnspecified0d7_KjU)) || (i2 & ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE) == 131072) | ((((3670016 & i2) ^ 1572864) > 1048576 && composer.changed(m4554getSrcIn0nO6VwU)) || (i2 & 1572864) == 1048576);
        Object rememberedValue = composer.rememberedValue();
        if (z4 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m5392createColorFilterxETnrds(m4651getUnspecified0d7_KjU, m4554getSrcIn0nO6VwU);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        m5390configureVectorPainterT4PVSW8(vectorPainter, m5393obtainSizePxVpY3zN4, m5394obtainViewportSizePq9zytI, str3, colorFilter, z3);
        ...
        composition2.setContent(ComposableLambdaKt.composableLambdaInstance(1749374910, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt$rememberVectorPainter$2$composition$1$1
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                function4.invoke(Float.valueOf(Float.intBitsToFloat((int) (m5394obtainViewportSizePq9zytI >> 32))), Float.valueOf(Float.intBitsToFloat((int) (m5394obtainViewportSizePq9zytI & 4294967295L))), composer2, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
    ...
    private static final long m5393obtainSizePxVpY3zN4(Density density, float f, float f2) {
        float mo459toPx0680j_4 = density.mo459toPx0680j_4(f);
        float mo459toPx0680j_42 = density.mo459toPx0680j_4(f2);
        return Size.m4403constructorimpl((Float.floatToRawIntBits(mo459toPx0680j_4) << 32) | (Float.floatToRawIntBits(mo459toPx0680j_42) & 4294967295L));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m5394obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
        ...
        return Size.m4403constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L));
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m5392createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m4659tintxETnrds(j, i);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8$default, reason: not valid java name */
    public static /* synthetic */ VectorPainter m5391configureVectorPainterT4PVSW8$default(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            str = RootGroupName;
        }
        return m5390configureVectorPainterT4PVSW8(vectorPainter, j, j2, str, colorFilter, (i & 16) != 0 ? false : z);
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m5390configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m5388setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m5389setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long m5393obtainSizePxVpY3zN4 = m5393obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m5390configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), m5393obtainSizePxVpY3zN4, m5394obtainViewportSizePq9zytI(m5393obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m5392createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m5373setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m5374setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m5375setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
    ...
    */
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        ...
        try {
            drawContext.getTransform().mo5135scale0AR0LA0(-1.0f, 1.0f, mo5120getCenterF1C5BW0);
