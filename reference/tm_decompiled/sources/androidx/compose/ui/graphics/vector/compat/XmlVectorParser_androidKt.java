...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5401getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4995getButtKaPHkGw();
        }
        return m5400getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m5400getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m4995getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m4997getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4996getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m5403getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m5006getMiterLxFBmk8();
        }
        return m5402getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m5402getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m5006getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m5005getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m5007getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m4651getUnspecified0d7_KjU = Color.INSTANCE.m4651getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m4651getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m4651getUnspecified0d7_KjU = Color.INSTANCE.m4651getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m4651getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4554getSrcIn0nO6VwU();
        } else if (i == 3) {
            m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4556getSrcOver0nO6VwU();
        } else if (i == 5) {
            m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4554getSrcIn0nO6VwU();
        } else if (i == 9) {
            m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4553getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4545getModulate0nO6VwU();
                    break;
                case 15:
                    m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4550getScreen0nO6VwU();
                    break;
                case 16:
                    m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4548getPlus0nO6VwU();
                    break;
                default:
                    m4554getSrcIn0nO6VwU = BlendMode.INSTANCE.m4554getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m4554getSrcIn0nO6VwU;
        float m7399constructorimpl = Dp.m7399constructorimpl(dimension / resources.getDisplayMetrics().density);
        float m7399constructorimpl2 = Dp.m7399constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m7399constructorimpl, m7399constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m5400getStrokeLineCapCSYIeUk = m5400getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m4995getButtKaPHkGw());
        int m5402getStrokeLineJoinkLtJ_vA = m5402getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m5005getBevelLxFBmk8());
        ...
        obtainAttributes.recycle();
        builder.m5367addPathoIyEayM(list, namedInt == 0 ? PathFillType.INSTANCE.m4920getNonZeroRgk1Os() : PathFillType.INSTANCE.m4919getEvenOddRgk1Os(), str, obtainBrushFromComplexColor(namedComplexColor), namedFloat, obtainBrushFromComplexColor(namedComplexColor2), namedFloat3, namedFloat4, m5400getStrokeLineCapCSYIeUk, m5402getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
