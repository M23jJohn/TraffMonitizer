...
public final class AndroidIndirectTouchEvent_androidKt {
    ...
    public static final IndirectTouchEvent IndirectTouchEvent(MotionEvent motionEvent) {
        ...
        return new AndroidIndirectTouchEvent(Offset.m4335constructorimpl((Float.floatToRawIntBits(y) & 4294967295L) | (Float.floatToRawIntBits(x) << 32)), motionEvent.getEventTime(), convertActionToIndirectTouchEventType(motionEvent.getActionMasked()), motionEvent, null);
    }

    public static final int convertActionToIndirectTouchEventType(int i) {
        if (i == 0) {
            return IndirectTouchEventType.INSTANCE.m5460getPressLxEHWp8();
        }
        if (i == 1) {
            return IndirectTouchEventType.INSTANCE.m5461getReleaseLxEHWp8();
        }
        if (i == 2) {
            return IndirectTouchEventType.INSTANCE.m5459getMoveLxEHWp8();
        }
        return IndirectTouchEventType.INSTANCE.m5462getUnknownLxEHWp8();
    }
}
