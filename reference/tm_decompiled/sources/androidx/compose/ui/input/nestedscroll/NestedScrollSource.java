...
public final class NestedScrollSource {
    ...
    public static final /* synthetic */ NestedScrollSource m5802boximpl(int i) {
        return new NestedScrollSource(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5803constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5804equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5805equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5806hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object other) {
        return m5804equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m5806hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m5807toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5807toStringimpl(int i) {
        return m5805equalsimpl0(i, UserInput) ? "UserInput" : m5805equalsimpl0(i, SideEffect) ? "SideEffect" : m5805equalsimpl0(i, Relocate) ? "Relocate" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5809getDragWNlRxjI$annotations() {
        }
        ...
        public static /* synthetic */ void m5810getFlingWNlRxjI$annotations() {
        }

        @Deprecated(message = "Do not use. Will be removed in the future.")
        /* renamed from: getRelocate-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m5811getRelocateWNlRxjI$annotations() {
        }

        @Deprecated(message = "This has been replaced by UserInput.", replaceWith = @ReplaceWith(expression = "NestedScrollSource.UserInput", imports = {"import androidx.compose.ui.input.nestedscroll.NestedScrollSource.Companion.UserInput"}))
        /* renamed from: getWheel-WNlRxjI$annotations, reason: not valid java name */
        public static /* synthetic */ void m5812getWheelWNlRxjI$annotations() {
        }
        ...
        public final int m5817getUserInputWNlRxjI() {
            return NestedScrollSource.UserInput;
        }

        /* renamed from: getSideEffect-WNlRxjI, reason: not valid java name */
        public final int m5816getSideEffectWNlRxjI() {
            return NestedScrollSource.SideEffect;
        }

        /* renamed from: getDrag-WNlRxjI, reason: not valid java name */
        public final int m5813getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI, reason: not valid java name */
        public final int m5814getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI, reason: not valid java name */
        public final int m5815getRelocateWNlRxjI() {
            return NestedScrollSource.Relocate;
        }

        /* renamed from: getWheel-WNlRxjI, reason: not valid java name */
        public final int m5818getWheelWNlRxjI() {
            return NestedScrollSource.Wheel;
        }
    }

    static {
        int m5803constructorimpl = m5803constructorimpl(1);
        UserInput = m5803constructorimpl;
        int m5803constructorimpl2 = m5803constructorimpl(2);
        SideEffect = m5803constructorimpl2;
        Drag = m5803constructorimpl;
        Fling = m5803constructorimpl2;
        Relocate = m5803constructorimpl(3);
        Wheel = m5803constructorimpl;
    }
}
