...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m5850addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m5851addHitPathQJqDSyo(j, list, z);
    }

    /* renamed from: addHitPath-QJqDSyo, reason: not valid java name */
    public final void m5851addHitPathQJqDSyo(long pointerId, List<? extends Modifier.Node> pointerInputNodes, boolean prunePointerIdsAndChangesNotInNodesList) {
        Node node;
