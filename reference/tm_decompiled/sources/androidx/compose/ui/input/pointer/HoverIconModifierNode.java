...
public abstract class HoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public abstract boolean mo5852isRelevantPointerTypeuerMTgs(int pointerType);
    ...
    public void mo267onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            for (int i = 0; i < size; i++) {
                if (mo5852isRelevantPointerTypeuerMTgs(changes.get(i).getType())) {
                    if (PointerEventType.m5874equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5878getEnter7fucELk())) {
                        onEnter();
                        return;
                    } else {
                        if (PointerEventType.m5874equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5879getExit7fucELk())) {
                            onExit();
                            return;
                        }
                        return;
    ...
    public long mo260getTouchBoundsExpansionRZrCHBk() {
        ...
        return dpTouchBoundsExpansion != null ? dpTouchBoundsExpansion.m6244roundToTouchBoundsExpansionTW6G1oQ(DelegatableNodeKt.requireDensity(this)) : TouchBoundsExpansion.INSTANCE.m6454getNoneRZrCHBk();
    }
