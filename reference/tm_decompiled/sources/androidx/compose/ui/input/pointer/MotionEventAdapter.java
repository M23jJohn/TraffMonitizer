...
public final class MotionEventAdapter {
    ...
    private final long m5855getComposePointerId_I2yYro(int motionEventPointerId) {
        long j;
        ...
        return PointerId.m5905constructorimpl(j);
    }
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int index, boolean pressed) {
        long j;
        long j2;
        int m6005getUnknownT8wyACA;
        long m4359getZeroF1C5BW0;
        int i;
        long m5855getComposePointerId_I2yYro = m5855getComposePointerId_I2yYro(motionEvent.getPointerId(index));
        float pressure = motionEvent.getPressure(index);
        float x = motionEvent.getX(index);
        float y = motionEvent.getY(index);
        char c = ' ';
        long j3 = 4294967295L;
        long m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(y) & 4294967295L) | (Float.floatToRawIntBits(x) << 32));
        long m4337copydBAh8RU$default = Offset.m4337copydBAh8RU$default(m4335constructorimpl, 0.0f, 0.0f, 3, null);
        if (index == 0) {
            float rawX = motionEvent.getRawX();
            float rawY = motionEvent.getRawY();
            j2 = Offset.m4335constructorimpl((Float.floatToRawIntBits(rawY) & 4294967295L) | (Float.floatToRawIntBits(rawX) << 32));
            j = positionCalculator.mo6007screenToLocalMKHz9U(j2);
        } else if (Build.VERSION.SDK_INT >= 29) {
            j2 = MotionEventHelper.INSTANCE.m5856toRawOffsetdBAh8RU(motionEvent, index);
            j = positionCalculator.mo6007screenToLocalMKHz9U(j2);
        } else {
            long mo6006localToScreenMKHz9U = positionCalculator.mo6006localToScreenMKHz9U(m4335constructorimpl);
            j = m4335constructorimpl;
            j2 = mo6006localToScreenMKHz9U;
        }
        int toolType = motionEvent.getToolType(index);
        if (toolType == 0) {
            m6005getUnknownT8wyACA = PointerType.INSTANCE.m6005getUnknownT8wyACA();
        } else if (toolType == 1) {
            m6005getUnknownT8wyACA = PointerType.INSTANCE.m6004getTouchT8wyACA();
        } else if (toolType == 2) {
            m6005getUnknownT8wyACA = PointerType.INSTANCE.m6003getStylusT8wyACA();
        } else if (toolType == 3) {
            m6005getUnknownT8wyACA = PointerType.INSTANCE.m6002getMouseT8wyACA();
        } else if (toolType == 4) {
            m6005getUnknownT8wyACA = PointerType.INSTANCE.m6001getEraserT8wyACA();
        } else {
            m6005getUnknownT8wyACA = PointerType.INSTANCE.m6005getUnknownT8wyACA();
        }
        ...
        while (i2 < historySize) {
            ...
            if ((Float.floatToRawIntBits(historicalX) & Integer.MAX_VALUE) >= 2139095040 || (Float.floatToRawIntBits(historicalY) & Integer.MAX_VALUE) >= 2139095040) {
                ...
                long m4335constructorimpl2 = Offset.m4335constructorimpl((Float.floatToRawIntBits(historicalX) << c2) | (Float.floatToRawIntBits(historicalY) & j4));
                i = i2;
                arrayList.add(new HistoricalChange(motionEvent.getHistoricalEventTime(i), m4335constructorimpl2, m4335constructorimpl2, null));
            }
            i2 = i + 1;
            c = c2;
            j3 = j4;
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            m4359getZeroF1C5BW0 = Offset.m4335constructorimpl((Float.floatToRawIntBits(f) & j5) | (Float.floatToRawIntBits(axisValue) << c3));
        } else {
            m4359getZeroF1C5BW0 = Offset.INSTANCE.m4359getZeroF1C5BW0();
        }
        long j6 = m4359getZeroF1C5BW0;
        return new PointerInputEventData(m5855getComposePointerId_I2yYro, motionEvent.getEventTime(), j2, j, pressed, pressure, m6005getUnknownT8wyACA, this.activeHoverIds.get(motionEvent.getPointerId(index), false), arrayList, j6, m4337copydBAh8RU$default, null);
    }
}
