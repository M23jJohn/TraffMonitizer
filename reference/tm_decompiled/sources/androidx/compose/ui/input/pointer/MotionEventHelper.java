...
final class MotionEventHelper {
    ...
    public final long m5856toRawOffsetdBAh8RU(MotionEvent motionEvent, int index) {
        float rawX;
        float rawY;
        rawX = motionEvent.getRawX(index);
        rawY = motionEvent.getRawY(index);
        return Offset.m4335constructorimpl((Float.floatToRawIntBits(rawY) & 4294967295L) | (Float.floatToRawIntBits(rawX) << 32));
    }
}
