...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m5857boximpl(int i) {
        return new PointerButtons(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5858constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m5859equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m5861hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5862toStringimpl(this.packedValue);
    }
