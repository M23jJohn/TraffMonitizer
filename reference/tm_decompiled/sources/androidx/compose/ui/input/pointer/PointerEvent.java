...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m5858constructorimpl(motionEvent2 != null ? motionEvent2.getButtonState() : 0);
        MotionEvent motionEvent3 = getMotionEvent();
        this.keyboardModifiers = PointerKeyboardModifiers.m5988constructorimpl(motionEvent3 != null ? motionEvent3.getMetaState() : 0);
        this.type = m5864calculatePointerEventType7fucELk();
    }
    ...
    public final void m5868setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m5864calculatePointerEventType7fucELk() {
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.INSTANCE.m5883getScroll7fucELk();
                            case 9:
                                return PointerEventType.INSTANCE.m5878getEnter7fucELk();
                            case 10:
                                return PointerEventType.INSTANCE.m5879getExit7fucELk();
                            default:
                                return PointerEventType.INSTANCE.m5884getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.INSTANCE.m5880getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m5882getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m5881getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            int i2 = size;
            arrayList2.add(new PointerInputEventData(id, uptimeMillis, position, position2, pressed, pressure, type, internalPointerEvent != null && internalPointerEvent.m5853activeHoverEvent0FcD4WY(pointerInputChange.getId()), null, 0L, 0L, 1792, null));
            i++;
