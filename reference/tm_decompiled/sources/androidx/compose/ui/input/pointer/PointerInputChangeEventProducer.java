...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long mo6007screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(pointerInputEventData.m5939getIdJ3iCeTQ());
            if (pointerInputData == null) {
                down = false;
                uptime = pointerInputEventData.getUptime();
                mo6007screenToLocalMKHz9U = pointerInputEventData.m5941getPositionF1C5BW0();
            } else {
                uptime = pointerInputData.getUptime();
                down = pointerInputData.getDown();
                mo6007screenToLocalMKHz9U = positionCalculator.mo6007screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            longSparseArray.put(pointerInputEventData.m5939getIdJ3iCeTQ(), new PointerInputChange(pointerInputEventData.m5939getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m5941getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, mo6007screenToLocalMKHz9U, down, false, pointerInputEventData.m5944getTypeT8wyACA(), pointerInputEventData.getHistorical(), pointerInputEventData.m5943getScrollDeltaF1C5BW0(), pointerInputEventData.m5940getOriginalEventPositionF1C5BW0(), null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(pointerInputEventData.m5939getIdJ3iCeTQ(), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m5942getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), null));
            } else {
                this.previousPointerInputData.remove(pointerInputEventData.m5939getIdJ3iCeTQ());
            }
        }
