...
public final /* data */ class PointerInputEventData {
    ...
    public static /* synthetic */ PointerInputEventData m5931copyrc8HELY$default(PointerInputEventData pointerInputEventData, long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, Object obj) {
        long j7;
        long j8;
        long j9;
        long j10;
        ...
        return pointerInputEventData.m5938copyrc8HELY(j7, j12, j13, j14, z3, f2, i3, z4, list2, j10, j9);
    }
    ...
    public final PointerInputEventData m5938copyrc8HELY(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean activeHover, List<HistoricalChange> historical, long scrollDelta, long originalEventPosition) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m5907equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m4340equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m4340equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m5997equalsimpl0(this.type, pointerInputEventData.type) && this.activeHover == pointerInputEventData.activeHover && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m4340equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta) && Offset.m4340equalsimpl0(this.originalEventPosition, pointerInputEventData.originalEventPosition);
    }

    public int hashCode() {
        return (((((((((((((((((((PointerId.m5908hashCodeimpl(this.id) * 31) + UByte$$ExternalSyntheticBackport0.m(this.uptime)) * 31) + Offset.m4345hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m4345hashCodeimpl(this.position)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.down)) * 31) + Float.floatToIntBits(this.pressure)) * 31) + PointerType.m5998hashCodeimpl(this.type)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.activeHover)) * 31) + this.historical.hashCode()) * 31) + Offset.m4345hashCodeimpl(this.scrollDelta)) * 31) + Offset.m4345hashCodeimpl(this.originalEventPosition);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m5909toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m4351toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m4351toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m5999toStringimpl(this.type)) + ", activeHover=" + this.activeHover + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m4351toStringimpl(this.scrollDelta)) + ", originalEventPosition=" + ((Object) Offset.m4351toStringimpl(this.originalEventPosition)) + ')';
    }
    ...
    public final long m5939getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m5942getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m5941getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m5944getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m4359getZeroF1C5BW0() : j5, (i2 & 1024) != 0 ? Offset.INSTANCE.m4359getZeroF1C5BW0() : j6, null);
    }
    ...
    public final long m5943getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* renamed from: getOriginalEventPosition-F1C5BW0, reason: not valid java name */
    public final long m5940getOriginalEventPositionF1C5BW0() {
        return this.originalEventPosition;
    }
}
