...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m5945processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m5946processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* renamed from: process-BIzXfog, reason: not valid java name */
    public final int m5946processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z;
        boolean z2;
        ...
        try {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (z || PointerEventKt.changedToDownIgnoreConsumed(valueAt2)) {
                    LayoutNode.m6257hitTest6fMxITs$ui_release$default(this.root, valueAt2.getPosition(), this.hitResult, valueAt2.getType(), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m5851addHitPathQJqDSyo(valueAt2.getId(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(valueAt2));
