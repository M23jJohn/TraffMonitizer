...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Object obj, Object obj2, Object[] objArr, PointerInputEventHandler pointerInputEventHandler) {
        ...
        this.boundsSize = IntSize.INSTANCE.m7579getZeroYbymL2g();
    }
    ...
    public long mo449getExtendedTouchPaddingNHjbRc() {
        long mo460toSizeXkaWNTQ = mo460toSizeXkaWNTQ(getViewConfiguration().mo6271getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        float max = Math.max(0.0f, Float.intBitsToFloat((int) (mo460toSizeXkaWNTQ >> 32)) - ((int) (boundsSize >> 32))) / 2.0f;
        float max2 = Math.max(0.0f, Float.intBitsToFloat((int) (mo460toSizeXkaWNTQ & 4294967295L)) - ((int) (boundsSize & 4294967295L))) / 2.0f;
        return Size.m4403constructorimpl((Float.floatToRawIntBits(max) << 32) | (Float.floatToRawIntBits(max2) & 4294967295L));
    }
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public int mo452roundToPxR2X_6o(long j) {
            return this.$$delegate_0.mo452roundToPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: roundToPx-0680j_4 */
        public int mo453roundToPx0680j_4(float f) {
            return this.$$delegate_0.mo453roundToPx0680j_4(f);
        }

        @Override // androidx.compose.ui.unit.FontScaling
        /* renamed from: toDp-GaN1DYA */
        public float mo454toDpGaN1DYA(long j) {
            return this.$$delegate_0.mo454toDpGaN1DYA(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo455toDpu2uoSUM(float f) {
            return this.$$delegate_0.mo455toDpu2uoSUM(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo456toDpu2uoSUM(int i) {
            return this.$$delegate_0.mo456toDpu2uoSUM(i);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDpSize-k-rfVVM */
        public long mo457toDpSizekrfVVM(long j) {
            return this.$$delegate_0.mo457toDpSizekrfVVM(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx--R2X_6o */
        public float mo458toPxR2X_6o(long j) {
            return this.$$delegate_0.mo458toPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx-0680j_4 */
        public float mo459toPx0680j_4(float f) {
            return this.$$delegate_0.mo459toPx0680j_4(f);
        }
        ...
        public long mo460toSizeXkaWNTQ(long j) {
            return this.$$delegate_0.mo460toSizeXkaWNTQ(j);
        }

        @Override // androidx.compose.ui.unit.FontScaling
        /* renamed from: toSp-0xMU5do */
        public long mo461toSp0xMU5do(float f) {
            return this.$$delegate_0.mo461toSp0xMU5do(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo462toSpkPz2Gy4(float f) {
            return this.$$delegate_0.mo462toSpkPz2Gy4(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo463toSpkPz2Gy4(int i) {
            return this.$$delegate_0.mo463toSpkPz2Gy4(i);
        }
        ...
        public long mo5820getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo5819getExtendedTouchPaddingNHjbRc() {
            return SuspendingPointerInputModifierNodeImpl.this.mo449getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m8075constructorimpl(event));
        }
                    ...
                    if ((suspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine$withTimeout$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            if (j <= 0 && (cancellableContinuation = this.pointerAwaiter) != null) {
                                Result.Companion companion = Result.INSTANCE;
                                cancellableContinuation.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(new PointerEventTimeoutCancellationException(j))));
                            }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlersLock) {
            ...
            Result.Companion companion = Result.INSTANCE;
            createCoroutine.resumeWith(Result.m8075constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
