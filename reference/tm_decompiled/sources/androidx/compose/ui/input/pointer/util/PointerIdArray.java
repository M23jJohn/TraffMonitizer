...
public final class PointerIdArray {
    ...
    public final long m6020get_I2yYro(int index) {
        return PointerId.m5905constructorimpl(this.internalArray[index]);
    }

    /* renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m6021remove0FcD4WY(long pointerId) {
    ...
    public final boolean m6018add0FcD4WY(long pointerId) {
    ...
    public final void m6022setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m6019contains0FcD4WY(long pointerId) {
