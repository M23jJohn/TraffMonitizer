...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m4359getZeroF1C5BW0();
    }
    ...
    public final void m6027setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m6023addPositionUv8p0NA(long timeMillis, long position) {
    ...
    public final long m6024calculateVelocity9UxMQ8M() {
        return m6025calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m6025calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m7641getXimpl(maximumVelocity) > 0.0f && Velocity.m7642getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m7648toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m7641getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m7642getYimpl(maximumVelocity)));
    }
