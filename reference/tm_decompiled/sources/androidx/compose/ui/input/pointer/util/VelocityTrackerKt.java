...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        m6028addPointerInputChange0AR0LA0(velocityTracker, pointerInputChange, Offset.INSTANCE.m4359getZeroF1C5BW0());
    }

    /* renamed from: addPointerInputChange-0AR0LA0, reason: not valid java name */
    public static final void m6028addPointerInputChange0AR0LA0(VelocityTracker velocityTracker, PointerInputChange pointerInputChange, long j) {
        if (VelocityTrackerAddPointsFix) {
            m6030addPointerInputChangeWithFix0AR0LA0(velocityTracker, pointerInputChange, j);
        } else {
            m6029addPointerInputChangeLegacy0AR0LA0(velocityTracker, pointerInputChange, j);
        }
    }

    /* renamed from: addPointerInputChangeLegacy-0AR0LA0, reason: not valid java name */
    private static final void m6029addPointerInputChangeLegacy0AR0LA0(VelocityTracker velocityTracker, PointerInputChange pointerInputChange, long j) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m6027setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.getPosition());
        ...
        while (i < size) {
            ...
            long m4347minusMKHz9U = Offset.m4347minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m6027setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m4348plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), m4347minusMKHz9U));
            velocityTracker.m6023addPositionUv8p0NA(historicalChange.getUptimeMillis(), Offset.m4348plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), j));
            i++;
            previousPosition = position;
        }
        velocityTracker.m6027setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m4348plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m4347minusMKHz9U(pointerInputChange.getPosition(), previousPosition)));
        velocityTracker.m6023addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), Offset.m4348plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), j));
    }

    /* renamed from: addPointerInputChangeWithFix-0AR0LA0, reason: not valid java name */
    private static final void m6030addPointerInputChangeWithFix0AR0LA0(VelocityTracker velocityTracker, PointerInputChange pointerInputChange, long j) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.resetTracking();
        }
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            for (int i = 0; i < size; i++) {
                HistoricalChange historicalChange = historical.get(i);
                velocityTracker.m6023addPositionUv8p0NA(historicalChange.getUptimeMillis(), Offset.m4348plusMKHz9U(historicalChange.getOriginalEventPosition(), j));
            }
            velocityTracker.m6023addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), Offset.m4348plusMKHz9U(pointerInputChange.getOriginalEventPosition(), j));
        }
