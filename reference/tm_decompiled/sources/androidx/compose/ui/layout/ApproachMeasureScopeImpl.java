...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public /* synthetic */ long mo153localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        long m6091localLookaheadPositionOfFgt4K4Q;
        m6091localLookaheadPositionOfFgt4K4Q = LookaheadScopeKt.m6091localLookaheadPositionOfFgt4K4Q(this, layoutCoordinates, layoutCoordinates2, j, z);
        return m6091localLookaheadPositionOfFgt4K4Q;
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo452roundToPxR2X_6o(long j) {
        return this.coordinator.mo452roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo453roundToPx0680j_4(float f) {
        return this.coordinator.mo453roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo454toDpGaN1DYA(long j) {
        return this.coordinator.mo454toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo455toDpu2uoSUM(float f) {
        return this.coordinator.mo455toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo456toDpu2uoSUM(int i) {
        return this.coordinator.mo456toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo457toDpSizekrfVVM(long j) {
        return this.coordinator.mo457toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo458toPxR2X_6o(long j) {
        return this.coordinator.mo458toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo459toPx0680j_4(float f) {
        return this.coordinator.mo459toPx0680j_4(f);
    }
    ...
    public long mo460toSizeXkaWNTQ(long j) {
        return this.coordinator.mo460toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo461toSp0xMU5do(float f) {
        return this.coordinator.mo461toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo462toSpkPz2Gy4(float f) {
        return this.coordinator.mo462toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo463toSpkPz2Gy4(int i) {
        return this.coordinator.mo463toSpkPz2Gy4(i);
    }
    ...
    public long mo6031getLookaheadConstraintsmsEJaDk() {
    ...
    public long mo6032getLookaheadSizeYbymL2g() {
        ...
        return IntSize.m7569constructorimpl((measureResult$ui_release.getWidth() << 32) | (measureResult$ui_release.getHeight() & 4294967295L));
    }
