...
public interface BeyondBoundsLayout {
    ...
    <T> T mo1060layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m6036constructorimpl(1);
        private static final int After = m6036constructorimpl(2);
        private static final int Left = m6036constructorimpl(3);
        private static final int Right = m6036constructorimpl(4);
        private static final int Above = m6036constructorimpl(5);
        private static final int Below = m6036constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m6035boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m6036constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m6037equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m6038equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m6039hashCodeimpl(int i) {
            return i;
        }

        public boolean equals(Object other) {
            return m6037equalsimpl(this.value, other);
        }
        ...
        public static final class Companion {
            ...
            public final int m6044getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m6043getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m6046getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m6047getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m6042getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m6045getBelowhoxUOeE() {
        ...
        public static String m6040toStringimpl(int i) {
            return m6038equalsimpl0(i, Before) ? "Before" : m6038equalsimpl0(i, After) ? "After" : m6038equalsimpl0(i, Left) ? "Left" : m6038equalsimpl0(i, Right) ? "Right" : m6038equalsimpl0(i, Above) ? "Above" : m6038equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
