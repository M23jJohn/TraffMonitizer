...
public interface ContentScale {
    ...
    long mo6048computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo6048computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m6052computeFillMaxDimensioniLBOSCw;
                m6052computeFillMaxDimensioniLBOSCw = ContentScaleKt.m6052computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m6145constructorimpl((Float.floatToRawIntBits(m6052computeFillMaxDimensioniLBOSCw) << 32) | (4294967295L & Float.floatToRawIntBits(m6052computeFillMaxDimensioniLBOSCw)));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo6048computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m6053computeFillMinDimensioniLBOSCw;
                m6053computeFillMinDimensioniLBOSCw = ContentScaleKt.m6053computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m6145constructorimpl((Float.floatToRawIntBits(m6053computeFillMinDimensioniLBOSCw) << 32) | (4294967295L & Float.floatToRawIntBits(m6053computeFillMinDimensioniLBOSCw)));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo6048computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m6145constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & 4294967295L));
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo6048computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                if (Float.intBitsToFloat((int) (srcSize >> 32)) > Float.intBitsToFloat((int) (dstSize >> 32)) || Float.intBitsToFloat((int) (srcSize & 4294967295L)) > Float.intBitsToFloat((int) (dstSize & 4294967295L))) {
                    m6053computeFillMinDimensioniLBOSCw = ContentScaleKt.m6053computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactor.m6145constructorimpl((Float.floatToRawIntBits(m6053computeFillMinDimensioniLBOSCw) << 32) | (Float.floatToRawIntBits(m6053computeFillMinDimensioniLBOSCw) & 4294967295L));
                }
                return ScaleFactor.m6145constructorimpl((Float.floatToRawIntBits(1.0f) << 32) | (Float.floatToRawIntBits(1.0f) & 4294967295L));
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo6048computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m6145constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L));
            }
        };
