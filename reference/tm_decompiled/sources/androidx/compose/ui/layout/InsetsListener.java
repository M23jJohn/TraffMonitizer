...
public final class InsetsListener extends WindowInsetsAnimationCompat.Callback implements Runnable, OnApplyWindowInsetsListener, View.OnAttachStateChangeListener {
    ...
    public WindowInsetsAnimationCompat.BoundsCompat onStart(WindowInsetsAnimationCompat animation, WindowInsetsAnimationCompat.BoundsCompat bounds) {
        ...
        if (animation.getDurationMillis() > 0 && windowInsetsCompat != null) {
            ...
            if (windowInsetsRulers != null) {
                ...
                long m6171constructorimpl = ValueInsets.m6171constructorimpl(insets.bottom | (insets.left << 48) | (insets.top << 32) | (insets.right << 16));
                long current = windowWindowInsetsAnimationValues2.getCurrent();
                if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl, current)) {
                    windowWindowInsetsAnimationValues2.m6189setSourceValueInsetsYnlvx88(current);
                    windowWindowInsetsAnimationValues2.m6190setTargetValueInsetsYnlvx88(m6171constructorimpl);
    ...
    private final void stopAnimationForRuler(WindowWindowInsetsAnimationValues insetsValue) {
        ...
        insetsValue.m6189setSourceValueInsetsYnlvx88(ValueInsets_androidKt.getUnsetValueInsets());
        insetsValue.m6190setTargetValueInsetsYnlvx88(ValueInsets_androidKt.getUnsetValueInsets());
    }
    ...
    private final void updateInsets(WindowInsetsCompat insets) {
        ...
        boolean z3;
        MutableIntObjectMap mutableIntObjectMap;
        long m6171constructorimpl;
        long m6171constructorimpl2;
        long[] jArr;
        int[] iArr;
        long[] jArr2;
        int[] iArr2;
                ...
                if ((((~j5) << 7) & j5 & j4) != j4) {
                    ...
                    while (i8 < i7) {
                        if ((j5 & 255) < 128) {
                            ...
                            jArr4 = jArr5;
                            iArr4 = iArr5;
                            long m6171constructorimpl3 = ValueInsets.m6171constructorimpl((insets2.top << 32) | (insets2.left << 48) | (insets2.right << 16) | insets2.bottom);
                            WindowWindowInsetsAnimationValues windowWindowInsetsAnimationValues = this.insetsValues.get(windowInsetsRulers);
                            Intrinsics.checkNotNull(windowWindowInsetsAnimationValues);
                            WindowWindowInsetsAnimationValues windowWindowInsetsAnimationValues2 = windowWindowInsetsAnimationValues;
                            if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl3, windowWindowInsetsAnimationValues2.getCurrent())) {
                                windowWindowInsetsAnimationValues2.m6187setCurrentYnlvx88(m6171constructorimpl3);
                                z2 = true;
                                if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl3, ValueInsets_androidKt.getZeroValueInsets())) {
                                    z3 = true;
                                }
                            }
                        } else {
                    ...
                    while (i13 < i12) {
                        if ((j6 & j2) < 128) {
                            ...
                            if (i15 != WindowInsetsCompat.Type.ime()) {
                                ...
                                jArr2 = jArr6;
                                iArr2 = iArr6;
                                long m6171constructorimpl4 = ValueInsets.m6171constructorimpl((insetsIgnoringVisibility.top << c3) | (insetsIgnoringVisibility.left << c4) | (insetsIgnoringVisibility.right << c2) | insetsIgnoringVisibility.bottom);
                                if (!ValueInsets.m6173equalsimpl0(windowWindowInsetsAnimationValues4.getMaximum(), m6171constructorimpl4)) {
                                    windowWindowInsetsAnimationValues4.m6188setMaximumYnlvx88(m6171constructorimpl4);
                                    z2 = z;
                                    if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl4, ValueInsets_androidKt.getZeroValueInsets())) {
                                        z3 = z2;
                                    }
                                }
                            } else {
        ...
        if (displayCutout == null) {
            m6171constructorimpl = ValueInsets_androidKt.getZeroValueInsets();
        } else {
            Insets waterfallInsets = displayCutout.getWaterfallInsets();
            m6171constructorimpl = ValueInsets.m6171constructorimpl((waterfallInsets.left << c4) | (waterfallInsets.top << c3) | (waterfallInsets.right << c2) | waterfallInsets.bottom);
        }
        ...
        if (!ValueInsets.m6173equalsimpl0(windowWindowInsetsAnimationValues6.getCurrent(), m6171constructorimpl)) {
            windowWindowInsetsAnimationValues6.m6187setCurrentYnlvx88(m6171constructorimpl);
            windowWindowInsetsAnimationValues6.m6188setMaximumYnlvx88(m6171constructorimpl);
            z2 = z;
            if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl, ValueInsets_androidKt.getZeroValueInsets())) {
                z3 = z2;
            }
        }
        if (displayCutout == null) {
            m6171constructorimpl2 = ValueInsets_androidKt.getZeroValueInsets();
        } else {
            m6171constructorimpl2 = ValueInsets.m6171constructorimpl((displayCutout.getSafeInsetTop() << c3) | (displayCutout.getSafeInsetLeft() << c4) | (displayCutout.getSafeInsetRight() << c2) | displayCutout.getSafeInsetBottom());
        }
        ...
        if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl2, windowWindowInsetsAnimationValues8.getCurrent())) {
            windowWindowInsetsAnimationValues8.m6187setCurrentYnlvx88(m6171constructorimpl2);
            windowWindowInsetsAnimationValues8.m6188setMaximumYnlvx88(m6171constructorimpl2);
            z2 = z;
            if (!ValueInsets.m6173equalsimpl0(m6171constructorimpl2, ValueInsets_androidKt.getZeroValueInsets())) {
                z3 = z2;
            }
        }
        if (displayCutout == null) {
            ...
            if (boundingRects.size() < this.displayCutouts.getSize()) {
                ...
                while (i16 < size) {
                    ...
                    mutableObjectList.add(SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(boundingRects.get(mutableObjectList.getSize()), null, i, null));
