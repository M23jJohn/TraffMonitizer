...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult mo816measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(MultiContentMeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            ...
            return _this.mo816measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, ConstraintsKt.Constraints$default(0, 0, 0, i, 7, null)).getWidth();
        }
        ...
        public static int $default$minIntrinsicHeight(MultiContentMeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            ...
            return _this.mo816measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, ConstraintsKt.Constraints$default(0, i, 0, 0, 13, null)).getHeight();
        }
