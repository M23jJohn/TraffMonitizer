...
final class RulerProviderModifierNode extends Modifier.Node implements LayoutModifierNode, TraversableNode {
        ...
        this.rulerLambda = new Function1<RulerScope, Unit>() { // from class: androidx.compose.ui.layout.RulerProviderModifierNode$rulerLambda$1
            ...
            public final void invoke2(RulerScope rulerScope) {
                ...
                if (RulerProviderModifierNode.this.getPreviousGeneration() > 0) {
                    long mo6057getSizeYbymL2g = rulerScope.getCoordinates().mo6057getSizeYbymL2g();
                    ...
                    while (i3 < length) {
                        ...
                        WindowInsetsRulers_androidKt.m6182provideInsetsValuescytEWk0(rulerScope2, windowInsetsRulers.getCurrent(), windowWindowInsetsAnimationValues2.getCurrent(), i, i2);
                        if (windowWindowInsetsAnimationValues2.isAnimating()) {
                            WindowInsetsRulers_androidKt.m6182provideInsetsValuescytEWk0(rulerScope2, windowWindowInsetsAnimationValues2.getSource(), windowWindowInsetsAnimationValues2.getSourceValueInsets(), i, i2);
                            WindowInsetsRulers_androidKt.m6182provideInsetsValuescytEWk0(rulerScope2, windowWindowInsetsAnimationValues2.getTarget(), windowWindowInsetsAnimationValues2.getTargetValueInsets(), i, i2);
                        }
                        WindowInsetsRulers_androidKt.m6182provideInsetsValuescytEWk0(rulerScope2, windowInsetsRulers.getMaximum(), windowWindowInsetsAnimationValues2.getMaximum(), i, i2);
                        i3++;
                    ...
                    if (RulerProviderModifierNode.this.getCutoutRects().isNotEmpty()) {
                        ...
                        int i4 = cutoutRects._size;
                        for (int i5 = 0; i5 < i4; i5++) {
                            MutableState mutableState = (MutableState) objArr[i5];
                            RectRulers rectRulers = rulerProviderModifierNode2.getCutoutRulers().get(i5);
    ...
    public MeasureResult mo108measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measureScope, mo6055measureBRTryo0.getWidth(), mo6055measureBRTryo0.getHeight(), null, this.rulerLambda, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RulerProviderModifierNode$measure$1
            {
                super(1);
            }
