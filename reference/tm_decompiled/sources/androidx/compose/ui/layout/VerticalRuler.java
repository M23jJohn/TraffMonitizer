...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        float mo6057getSizeYbymL2g = ((int) (sourceCoordinates.mo6057getSizeYbymL2g() & 4294967295L)) / 2.0f;
        return Float.intBitsToFloat((int) (targetCoordinates.mo6058localPositionOfR5De75A(sourceCoordinates, Offset.m4335constructorimpl((Float.floatToRawIntBits(mo6057getSizeYbymL2g) & 4294967295L) | (Float.floatToRawIntBits(coordinate) << 32))) >> 32));
    }
