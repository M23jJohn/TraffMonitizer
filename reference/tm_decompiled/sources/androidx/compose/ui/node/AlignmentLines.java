...
public abstract class AlignmentLines {
    ...
    protected abstract long mo6192calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        long m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
        while (true) {
            m4335constructorimpl = mo6192calculatePositionInParentR5De75A(initialCoordinator, m4335constructorimpl);
            ...
            if (getAlignmentLinesMap(initialCoordinator).containsKey(alignmentLine)) {
                ...
                m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(positionFor) << 32) | (Float.floatToRawIntBits(positionFor) & 4294967295L));
            }
        }
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            intBitsToFloat = Float.intBitsToFloat((int) (m4335constructorimpl & 4294967295L));
        } else {
            intBitsToFloat = Float.intBitsToFloat((int) (m4335constructorimpl >> 32));
        }
