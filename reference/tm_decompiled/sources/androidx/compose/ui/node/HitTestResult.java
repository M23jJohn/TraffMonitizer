...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m6248removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m6249removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long m6247findBestHitDistancefn2tFes = m6247findBestHitDistancefn2tFes();
        return DistanceAndFlags.m6228getDistanceimpl(m6247findBestHitDistancefn2tFes) < 0.0f && DistanceAndFlags.m6231isInLayerimpl(m6247findBestHitDistancefn2tFes) && !DistanceAndFlags.m6230isInExpandedBoundsimpl(m6247findBestHitDistancefn2tFes);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndFlags.m6224compareTo9YPOF3E(m6247findBestHitDistancefn2tFes(), HitTestResultKt.DistanceAndFlags$default(distanceFromEdge, isInLayer, false, 4, null)) > 0;
    }

    /* renamed from: findBestHitDistance-fn2tFes, reason: not valid java name */
    private final long m6247findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long m6225constructorimpl = DistanceAndFlags.m6225constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                if (DistanceAndFlags.m6224compareTo9YPOF3E(m6225constructorimpl, DistanceAndFlags$default) < 0) {
                    DistanceAndFlags$default = m6225constructorimpl;
                }
                if ((DistanceAndFlags.m6228getDistanceimpl(DistanceAndFlags$default) < 0.0f && DistanceAndFlags.m6231isInLayerimpl(DistanceAndFlags$default)) || i == lastIndex) {
                    break;
                }
                i++;
            }
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (!DistanceAndFlags.m6230isInExpandedBoundsimpl(m6247findBestHitDistancefn2tFes)) {
            if (DistanceAndFlags.m6228getDistanceimpl(m6247findBestHitDistancefn2tFes) > 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(hitTestResult)) {
            ...
            childHitTest.invoke();
            this.hitDepth = i2;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(hitTestResult) || DistanceAndFlags.m6230isInExpandedBoundsimpl(m6247findBestHitDistancefn2tFes())) {
        ...
        childHitTest.invoke();
        this.hitDepth = i4;
        long m6247findBestHitDistancefn2tFes2 = m6247findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndFlags.m6224compareTo9YPOF3E(m6247findBestHitDistancefn2tFes, m6247findBestHitDistancefn2tFes2) > 0) {
            int i5 = i3 + 1;
            if (DistanceAndFlags.m6230isInExpandedBoundsimpl(m6247findBestHitDistancefn2tFes2)) {
                i = this.hitDepth + 2;
            } else {
                i = this.hitDepth + 1;
            }
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* renamed from: removeFirst, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m6250removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* renamed from: removeLast, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m6251removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
