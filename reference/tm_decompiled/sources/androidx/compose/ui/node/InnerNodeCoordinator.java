...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo6055measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m6125setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo80measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo6055measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m6291getConstraintsmsEJaDk$ui_release();
        }
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo80measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x0036, code lost:
        ...
        if ((java.lang.Float.floatToRawIntBits(m6337distanceInMinimumTouchTargettz77jQw(r12, m6340getMinimumTouchTargetSizeNHjbRc())) & Integer.MAX_VALUE) < 2139095040) goto L7;
     */
    ...
    */
    public void mo6252hitTestChildqzLsGqo(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        int i;
        boolean z;
        boolean z2;
        boolean z3 = false;
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            ...
            while (size >= 0) {
                ...
                if (layoutNode.isPlaced()) {
                    int i3 = i;
                    z2 = z3;
                    hitTestSource.mo6350childHitTestqzLsGqo(layoutNode, pointerPosition, hitTestResult, i3, z2);
    ...
    static {
        ...
        Paint.mo4465setColor8_81llA(Color.INSTANCE.m4649getRed0d7_KjU());
