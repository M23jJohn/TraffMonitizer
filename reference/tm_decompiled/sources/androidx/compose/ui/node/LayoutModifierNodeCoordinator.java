...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet() & NodeKind.m6355constructorimpl(512)) != 0) {
    ...
    public final void setLayoutModifierNode$ui_release(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet() & NodeKind.m6355constructorimpl(512)) != 0) {
                Intrinsics.checkNotNull(layoutModifierNode, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
    ...
    public final void m6256setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo6055measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m6125setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.m6256setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m7329boximpl(constraints));
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo108measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    */
    public Placeable mo6055measureBRTryo0(long constraints) {
        final MeasureResult mo108measure3p2s80s;
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            boolean z = false;
            approachMeasureScopeImpl.setApproachMeasureRequired$ui_release(approachNode.mo114isMeasurementApproachInProgressozmzZPI(approachMeasureScopeImpl.mo6032getLookaheadSizeYbymL2g()) || !Constraints.m7334equalsimpl(constraints, getLookaheadConstraints()));
            ...
            mo108measure3p2s80s = approachNode.mo113approachMeasure3p2s80s(approachMeasureScopeImpl, getWrappedNonNull(), constraints);
            getWrappedNonNull().setForceMeasureWithLookaheadConstraints$ui_release(false);
            int width = mo108measure3p2s80s.getWidth();
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            if (width == lookaheadDelegate.getWidth()) {
                int height = mo108measure3p2s80s.getHeight();
            ...
            if (!approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long mo6057getSizeYbymL2g = getWrappedNonNull().mo6057getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                if (IntSize.m7571equalsimpl(mo6057getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m7566boximpl(lookaheadDelegate3.m6292getSizeYbymL2g$ui_release()) : null) && !z) {
                    mo108measure3p2s80s = new MeasureResult(this) { // from class: androidx.compose.ui.node.LayoutModifierNodeCoordinator$measure$1$1$1$1
        ...
        mo108measure3p2s80s = getLayoutModifierNode().mo108measure3p2s80s(this, getWrappedNonNull(), constraints);
        setMeasureResult$ui_release(mo108measure3p2s80s);
    ...
    protected void mo6123placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        super.mo6123placeAtf8xVGno(position, zIndex, layer);
        onAfterPlaceAt();
    }
    ...
    protected void mo6056placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo6056placeAtf8xVGno(position, zIndex, layerBlock);
        onAfterPlaceAt();
    }
    ...
    private final void onAfterPlaceAt() {
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            if (!approachNode.isPlacementApproachInProgress(placementScope, lookaheadDelegate.getLookaheadLayoutCoordinates()) && !approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long j = mo6057getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate2 = getLookaheadDelegate();
                if (IntSize.m7571equalsimpl(j, lookaheadDelegate2 != null ? IntSize.m7566boximpl(lookaheadDelegate2.m6292getSizeYbymL2g$ui_release()) : null)) {
                    long mo6057getSizeYbymL2g = getWrappedNonNull().mo6057getSizeYbymL2g();
                    LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                    if (IntSize.m7571equalsimpl(mo6057getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m7566boximpl(lookaheadDelegate3.m6292getSizeYbymL2g$ui_release()) : null)) {
                        z = true;
    ...
    public void performDraw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        if (IntSize.m7572equalsimpl0(mo6057getSizeYbymL2g(), wrapped$ui_release.mo6057getSizeYbymL2g()) && IntOffset.m7530equalsimpl0(wrapped$ui_release.getPosition(), IntOffset.INSTANCE.m7542getZeronOccac())) {
            return;
        }
    ...
    static {
        ...
        Paint.mo4465setColor8_81llA(Color.INSTANCE.m4642getBlue0d7_KjU());
