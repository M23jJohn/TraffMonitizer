...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo5101drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5101drawArcillE91I(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5102drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5102drawArcyD3GUKo(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5103drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5103drawCircleV9BoPsw(brush, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5104drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5104drawCircleVaOC9Bg(color, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public /* synthetic */ void mo5105drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5105drawImage9jGpkUE(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5106drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.mo5106drawImageAZ2fEMs(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }
    ...
    public void mo5107drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5107drawImagegbVJVH8(image, topLeft, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5108drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5108drawLine1RTmtNc(brush, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo5109drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5109drawLineNGM6Ib0(color, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo5110drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5110drawOvalAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5111drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5111drawOvalnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5112drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5112drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5113drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5113drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5114drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5114drawPointsF8ZwMP8(points, pointMode, color, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo5115drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5115drawPointsGsft0Ws(points, pointMode, brush, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo5116drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5116drawRectAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5117drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5117drawRectnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5118drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5118drawRoundRectZuiqVtQ(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo5119drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo5119drawRoundRectuAw5IA(color, topLeft, size, cornerRadius, style, alpha, colorFilter, blendMode);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo5120getCenterF1C5BW0() {
        return this.canvasDrawScope.mo5120getCenterF1C5BW0();
    }
    ...
    public long mo5121getSizeNHjbRc() {
        return this.canvasDrawScope.mo5121getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo452roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo452roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo453roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo453roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo454toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo454toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo455toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo455toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo456toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo456toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo457toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo457toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo458toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo458toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo459toPx0680j_4(float f) {
        return this.canvasDrawScope.mo459toPx0680j_4(f);
    }
    ...
    public long mo460toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo460toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo461toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo461toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo462toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo462toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo463toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo463toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (drawModifierNode != null) {
            ...
            if (nextDrawNode == 0) {
                NodeCoordinator m6208requireCoordinator64DMado = DelegatableNodeKt.m6208requireCoordinator64DMado(drawModifierNode2, NodeKind.m6355constructorimpl(4));
                if (m6208requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                    m6208requireCoordinator64DMado = m6208requireCoordinator64DMado.getWrapped();
                    Intrinsics.checkNotNull(m6208requireCoordinator64DMado);
                }
                m6208requireCoordinator64DMado.performDraw(canvas, getDrawContext().getGraphicsLayer());
                return;
            }
            ...
            while (nextDrawNode != 0) {
                ...
                } else if ((nextDrawNode.getKindSet() & m6355constructorimpl) != 0 && (nextDrawNode instanceof DelegatingNode)) {
    ...
    public void mo5122recordJVtK1S4(GraphicsLayer graphicsLayer, long j, final Function1<? super DrawScope, Unit> function1) {
        final DrawModifierNode drawModifierNode = this.drawNode;
        graphicsLayer.m5303recordmLhObY(this, getLayoutDirection(), j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.node.LayoutNodeDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    ...
                    long mo5128getSizeNHjbRc2 = layoutNodeDrawScope.getDrawContext().mo5128getSizeNHjbRc();
                    ...
                    try {
                        ...
                        r2.setCanvas(canvas);
                        r2.mo5129setSizeuvyYCjk(mo5128getSizeNHjbRc);
                        ...
                        try {
                            ...
                            drawContext.mo5129setSizeuvyYCjk(mo5128getSizeNHjbRc2);
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas, GraphicsLayer graphicsLayer) {
        NodeCoordinator m6208requireCoordinator64DMado = DelegatableNodeKt.m6208requireCoordinator64DMado(drawModifierNode, NodeKind.m6355constructorimpl(4));
        m6208requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m6278drawDirecteZhPAX0$ui_release(canvas, IntSizeKt.m7586toSizeozmzZPI(m6208requireCoordinator64DMado.mo6057getSizeYbymL2g()), m6208requireCoordinator64DMado, drawModifierNode, graphicsLayer);
    }

    /* renamed from: drawDirect-eZhPAX0$ui_release, reason: not valid java name */
    public final void m6278drawDirecteZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode, GraphicsLayer layer) {
        DrawModifierNode drawModifierNode = this.drawNode;
        ...
        long mo5128getSizeNHjbRc = canvasDrawScope.getDrawContext().mo5128getSizeNHjbRc();
        ...
        drawContext.mo5129setSizeuvyYCjk(size);
        ...
        try {
            ...
            drawContext2.setLayoutDirection(layoutDirection2);
            drawContext2.setCanvas(canvas2);
            drawContext2.mo5129setSizeuvyYCjk(mo5128getSizeNHjbRc);
            ...
            drawContext3.mo5129setSizeuvyYCjk(mo5128getSizeNHjbRc);
    ...
    public final void m6277draweZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode, GraphicsLayer layer) {
        int m6355constructorimpl = NodeKind.m6355constructorimpl(4);
        DelegatingNode delegatingNode = drawNode;
        MutableVector mutableVector = null;
        while (delegatingNode != 0) {
            if (delegatingNode instanceof DrawModifierNode) {
                m6278drawDirecteZhPAX0$ui_release(canvas, size, coordinator, delegatingNode, layer);
