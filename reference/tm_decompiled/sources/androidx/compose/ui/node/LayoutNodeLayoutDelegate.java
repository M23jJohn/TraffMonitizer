...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m6279getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m6308getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m6280getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final void m6281performLookaheadMeasureBRTryo0$ui_release(long constraints) {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            lookaheadPassDelegate.m6299performMeasureBRTryo0$ui_release(constraints);
        }
    }
