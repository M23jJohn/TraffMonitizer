...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode, MotionReferencePlacementDelegate {
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof VerticalAlignmentLine) {
            m7532getYimpl = IntOffset.m7531getXimpl(getApparentToRealOffset());
        } else {
            m7532getYimpl = IntOffset.m7532getYimpl(getApparentToRealOffset());
        }
        return calculateAlignmentLine + m7532getYimpl;
    }
    ...
    */
    ...
    public final void captureRulersIfNeeded$ui_release(MeasureResult result) {
        ...
        if (result != null) {
            ...
            if (rulers != null) {
                ...
                long m7541getMaxnOccac = IntOffset.INSTANCE.m7541getMaxnOccac();
                ...
                if (!z && getRulerScope().getCoordinatesAccessed()) {
                    ...
                    m7541getMaxnOccac = IntOffsetKt.m7548roundk4lQ0M(LayoutCoordinatesKt.positionOnScreen(coordinates));
                    m7579getZeroYbymL2g = coordinates.mo6057getSizeYbymL2g();
                    z = (IntOffset.m7530equalsimpl0(m7541getMaxnOccac, getRulerScope().getPositionOnScreen()) && IntSize.m7572equalsimpl0(m7579getZeroYbymL2g, getRulerScope().getSize())) ? false : true;
                }
                long j = m7541getMaxnOccac;
                long j2 = m7579getZeroYbymL2g;
                if (z) {
                    ...
                    m6282captureRulersOSxE8f4(placeableResult, j, j2);
    ...
    static /* synthetic */ void m6283captureRulersOSxE8f4$default(LookaheadCapablePlaceable lookaheadCapablePlaceable, PlaceableResult placeableResult, long j, long j2, int i, Object obj) {
        if (obj != null) {
        ...
        if ((i & 2) != 0) {
            j = IntOffset.INSTANCE.m7541getMaxnOccac();
        }
        long j3 = j;
        if ((i & 4) != 0) {
            j2 = IntSize.INSTANCE.m7579getZeroYbymL2g();
        }
        lookaheadCapablePlaceable.m6282captureRulersOSxE8f4(placeableResult, j3, j2);
    }

    /* renamed from: captureRulers-OSxE8f4, reason: not valid java name */
    private final void m6282captureRulersOSxE8f4(final PlaceableResult placeableResult, final long positionOnScreen, final long size) {
        ...
        if (owner != null && (snapshotObserver = owner.getSnapshotObserver()) != null) {
            snapshotObserver.observeReads$ui_release(placeableResult, onCommitAffectingRuler, new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadCapablePlaceable$captureRulers$1
                ...
                public final void invoke2() {
                    ...
                    rulerScope2.m6287setPositionOnScreengyyYBs(positionOnScreen);
                    rulerScope3 = LookaheadCapablePlaceable.this.getRulerScope();
                    rulerScope3.m6288setSizeozmzZPI(size);
    ...
    public final void captureRulersIfNeeded(PlaceableResult placeableResult) {
        ...
        MutableScatterMap<Ruler, MutableScatterSet<WeakReference<LayoutNode>>> mutableScatterMap = this.rulerReaders;
        if (rulers != null) {
            m6283captureRulersOSxE8f4$default(this, placeableResult, 0L, 0L, 6, null);
    ...
    final class ResettableRulerScope implements RulerScope {
        ...
        private long positionOnScreen = IntOffset.INSTANCE.m7541getMaxnOccac();
        private long size = IntSize.INSTANCE.m7579getZeroYbymL2g();
        ...
        public final void m6287setPositionOnScreengyyYBs(long j) {
        ...
        public final void m6288setSizeozmzZPI(long j) {
            this.size = j;
        }
        ...
        public LayoutCoordinates getCoordinates() {
            ...
            if (IntOffset.m7530equalsimpl0(this.positionOnScreen, IntOffset.INSTANCE.m7541getMaxnOccac())) {
                this.positionOnScreen = IntOffsetKt.m7548roundk4lQ0M(LayoutCoordinatesKt.positionOnScreen(coordinates));
                this.size = coordinates.mo6057getSizeYbymL2g();
            }
