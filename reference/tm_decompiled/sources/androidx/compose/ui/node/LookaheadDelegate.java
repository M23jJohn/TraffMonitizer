...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m6296setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m6292getSizeYbymL2g$ui_release() {
    ...
    public final long m6291getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m6124setMeasuredSizeozmzZPI(IntSize.m7569constructorimpl((measureResult.getHeight() & 4294967295L) | (measureResult.getWidth() << 32)));
        } else {
            m6124setMeasuredSizeozmzZPI(IntSize.INSTANCE.m7579getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo6056placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo6056placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m6290placeSelfgyyYBs(position);
    ...
    private final void m6290placeSelfgyyYBs(long position) {
        if (!IntOffset.m7530equalsimpl0(getPosition(), position)) {
            m6296setPositiongyyYBs(position);
    ...
    public final void m6294placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m6290placeSelfgyyYBs(IntOffset.m7535plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m6293performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m6295positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long m7542getZeronOccac = IntOffset.INSTANCE.m7542getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                m7542getZeronOccac = IntOffset.m7535plusqkQi6aY(m7542getZeronOccac, lookaheadDelegate.getPosition());
            }
