...
public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    */
    public Placeable mo6055measureBRTryo0(long constraints) {
        ...
        m6300remeasureBRTryo0(constraints);
        return this;
    }
    ...
    public final void m6299performMeasureBRTryo0$ui_release(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(getLayoutNode()).getSnapshotObserver(), getLayoutNode(), false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$performMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo6055measureBRTryo0(constraints);
            }
        }, 2, null);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m6300remeasureBRTryo0(long constraints) {
        boolean z;
        ...
        try {
            ...
            if (!getLayoutNode().getCanMultiMeasure() && (parent$ui_release == null || !parent$ui_release.getCanMultiMeasure())) {
                ...
                if (!getLayoutNode().getLookaheadMeasurePending$ui_release()) {
                    ...
                    if (constraints2 == null ? false : Constraints.m7335equalsimpl0(constraints2.getValue(), constraints)) {
                ...
                this.lookaheadConstraints = Constraints.m7329boximpl(constraints);
                ...
                if (this.measuredOnce) {
                    ...
                    m7569constructorimpl = IntSize.m7569constructorimpl((j & 4294967295L) | (j << 32));
                } else {
                    m7569constructorimpl = getMeasuredSize();
                }
                ...
                this.layoutNodeLayoutDelegate.m6281performLookaheadMeasureBRTryo0$ui_release(constraints);
                m6124setMeasuredSizeozmzZPI(IntSize.m7569constructorimpl((lookaheadDelegate.getHeight() & 4294967295L) | (lookaheadDelegate.getWidth() << 32)));
                return ((int) (m7569constructorimpl >> 32)) == lookaheadDelegate.getWidth() || ((int) (m7569constructorimpl & 4294967295L)) != lookaheadDelegate.getHeight();
            }
            z = true;
            layoutNode2.setCanMultiMeasure$ui_release(z);
            if (!getLayoutNode().getLookaheadMeasurePending$ui_release()) {
            ...
            this.layoutNodeLayoutDelegate.m6281performLookaheadMeasureBRTryo0$ui_release(constraints);
            m6124setMeasuredSizeozmzZPI(IntSize.m7569constructorimpl((lookaheadDelegate.getHeight() & 4294967295L) | (lookaheadDelegate.getWidth() << 32)));
            if (((int) (m7569constructorimpl >> 32)) == lookaheadDelegate.getWidth()) {
            }
        } catch (Throwable th) {
    ...
    public void mo6056placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m6297placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    public void mo6123placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        m6297placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    private final void m6297placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        LayoutNode layoutNode = getLayoutNode();
        try {
            LayoutNode parent$ui_release = getLayoutNode().getParent$ui_release();
            ...
            if (!IntOffset.m7530equalsimpl0(position, this.lastPosition)) {
            ...
            if (!getLayoutPending() && getIsPlaced()) {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m6294placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                    ...
                    public final void invoke2() {
                        ...
                        if (!LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(layoutNode2)) {
                            ...
                            if (!layoutNodeLayoutDelegate.getDetachedFromParentLookaheadPlacement()) {
                                ...
                                Placeable.PlacementScope.m6126place70tqf50$default(placementScope, lookaheadDelegate3, j, 0.0f, 2, null);
                            }
                        }
                        outerCoordinator = LookaheadPassDelegate.this.getOuterCoordinator();
                        ...
                        Placeable.PlacementScope.m6126place70tqf50$default(placementScope, lookaheadDelegate32, j2, 0.0f, 2, null);
                    }
                }, 2, null);
            }
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release() && layoutNode.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                ...
                Intrinsics.checkNotNull(lookaheadPassDelegate);
                Constraints m6280getLastLookaheadConstraintsDWUhwKw = layoutNode.getLayoutDelegate().m6280getLastLookaheadConstraintsDWUhwKw();
                Intrinsics.checkNotNull(m6280getLastLookaheadConstraintsDWUhwKw);
                if (lookaheadPassDelegate.m6300remeasureBRTryo0(m6280getLastLookaheadConstraintsDWUhwKw.getValue())) {
                    LayoutNode.requestLookaheadRemeasure$ui_release$default(getLayoutNode(), false, false, false, 7, null);
                }
            }
        }
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                lookaheadPassDelegate.m6297placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
