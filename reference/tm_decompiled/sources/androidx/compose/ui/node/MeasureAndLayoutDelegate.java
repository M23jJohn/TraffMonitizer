...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m6304updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m7329boximpl(constraints);
    ...
    private final boolean m6301doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m6259lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m6259lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m6266lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m6259lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m6259lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m6259lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (parent$ui_release.getLookaheadRoot() == null) {
                ...
                return m6259lookaheadRemeasure_Sx5XlM$ui_release$default;
            }
    ...
    private final boolean m6302doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m6260remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m6260remeasure_Sx5XlM$ui_release$default = layoutNode.m6267remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m6260remeasure_Sx5XlM$ui_release$default = LayoutNode.m6260remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m6260remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui_release$default(parent$ui_release, false, false, false, 3, null);
                return m6260remeasure_Sx5XlM$ui_release$default;
            }
    ...
    public final void m6303measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m6301doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m7329boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m6302doRemeasuresdFAvZA(layoutNode, Constraints.m7329boximpl(constraints));
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        if (affectsLookahead) {
            z = layoutNode.getLookaheadMeasurePending$ui_release() ? m6301doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            boolean m6302doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m6302doRemeasuresdFAvZA(layoutNode, constraints) : false;
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m6301doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m6302doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
