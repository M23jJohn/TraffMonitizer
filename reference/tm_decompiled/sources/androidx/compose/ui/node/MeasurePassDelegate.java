...
public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private long lastPosition = IntOffset.INSTANCE.m7542getZeronOccac();
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            ...
            outerCoordinator.mo6055measureBRTryo0(j);
        }
    };
    ...
    private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m7542getZeronOccac();
    private final Function0<Unit> placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$placeOuterCoordinatorBlock$1
        ...
        public final void invoke2() {
            ...
            if (graphicsLayer != null) {
                ...
                placementScope2.m6141placeWithLayeraW9wM(outerCoordinator, j3, graphicsLayer, f3);
                return;
            }
            if (function1 == null) {
                ...
                placementScope2.m6132place70tqf50(outerCoordinator2, j2, f2);
                return;
            }
            ...
            placementScope2.m6140placeWithLayeraW9wM(outerCoordinator3, j, f, function1);
        }
    };
    ...
    public final Constraints m6308getLastConstraintsDWUhwKw() {
        if (this.measuredOnce) {
            return Constraints.m7329boximpl(getMeasurementConstraints());
        }
        return null;
    }
    ...
    public final void m6310performMeasureBRTryo0$ui_release(long constraints) {
    ...
    public Placeable mo6055measureBRTryo0(long constraints) {
        ...
        if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(getLayoutNode())) {
            ...
            lookaheadPassDelegate.mo6055measureBRTryo0(constraints);
        }
        trackMeasurementByParent(getLayoutNode());
        m6311remeasureBRTryo0(constraints);
        return this;
    }

    /* renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m6311remeasureBRTryo0(long constraints) {
        boolean z;
        long mo6057getSizeYbymL2g;
        LayoutNode layoutNode = getLayoutNode();
        try {
            ...
            if (!getLayoutNode().getCanMultiMeasure() && (parent$ui_release == null || !parent$ui_release.getCanMultiMeasure())) {
                ...
                if (!getLayoutNode().getMeasurePending$ui_release() && Constraints.m7335equalsimpl0(getMeasurementConstraints(), constraints)) {
                ...
                mo6057getSizeYbymL2g = getOuterCoordinator().mo6057getSizeYbymL2g();
                m6125setMeasurementConstraintsBRTryo0(constraints);
                m6310performMeasureBRTryo0$ui_release(constraints);
                if (IntSize.m7572equalsimpl0(getOuterCoordinator().mo6057getSizeYbymL2g(), mo6057getSizeYbymL2g) && getOuterCoordinator().getWidth() == getWidth() && getOuterCoordinator().getHeight() == getHeight()) {
                    z2 = false;
                }
                m6124setMeasuredSizeozmzZPI(IntSize.m7569constructorimpl((getOuterCoordinator().getHeight() & 4294967295L) | (getOuterCoordinator().getWidth() << 32)));
                return z2;
            }
            z = true;
            layoutNode2.setCanMultiMeasure$ui_release(z);
            ...
            m6125setMeasurementConstraintsBRTryo0(constraints);
            m6310performMeasureBRTryo0$ui_release(constraints);
            if (IntSize.m7572equalsimpl0(getOuterCoordinator().mo6057getSizeYbymL2g(), mo6057getSizeYbymL2g)) {
                z2 = false;
            }
            m6124setMeasuredSizeozmzZPI(IntSize.m7569constructorimpl((getOuterCoordinator().getHeight() & 4294967295L) | (getOuterCoordinator().getWidth() << 32)));
            return z2;
    ...
    public void mo6056placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m6307placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    public void mo6123placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        m6307placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x006c A[Catch: all -> 0x00a5, TryCatch #0 {all -> 0x00a5, blocks: (B:3:0x0005, B:5:0x0010, B:7:0x002f, B:9:0x0035, B:11:0x003b, B:13:0x0045, B:17:0x005b, B:19:0x006c, B:20:0x0073, B:21:0x004e, B:22:0x008a, B:24:0x0090, B:28:0x009a, B:29:0x009f, B:34:0x0014, B:36:0x001c, B:38:0x0024, B:40:0x002c, B:41:0x0028), top: B:2:0x0005 }] */
    /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final void m6307placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        Placeable.PlacementScope placementScope;
        ...
        try {
            ...
            if (!IntOffset.m7530equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (lookaheadPassDelegate != null && lookaheadPassDelegate.getNeedsToBePlacedInApproach()) {
                ...
                if (wrappedBy != null) {
                    ...
                    Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate2, IntOffset.m7531getXimpl(position), IntOffset.m7532getYimpl(position), 0.0f, 4, null);
                }
                ...
                Placeable.PlacementScope.place$default(placementScope22, lookaheadPassDelegate22, IntOffset.m7531getXimpl(position), IntOffset.m7532getYimpl(position), 0.0f, 4, null);
            }
            ...
            m6306placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
    ...
    private final void m6306placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        if (getLayoutNode().getIsDeactivated()) {
        ...
        if (!this.layoutPending && getIsPlaced()) {
            getOuterCoordinator().m6345placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                measurePassDelegate.m6306placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            LayoutNode layoutNode = layoutNodeArr[i];
            if (layoutNode.getMeasurePending$ui_release() && layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m6260remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null)) {
                LayoutNode.requestRemeasure$ui_release$default(getLayoutNode(), false, false, false, 7, null);
            }
        }
    }
