...
public interface OwnedLayer {
    ...
    float[] mo6408getUnderlyingMatrixsQKQjiQ();

    void invalidate();

    /* renamed from: inverseTransform-58bKbWc, reason: not valid java name */
    void mo6409inverseTransform58bKbWc(float[] matrix);

    /* renamed from: isFrameRateFromParent */
    boolean getIsFrameRateFromParent();

    /* renamed from: isInLayer-k-4lQ0M, reason: not valid java name */
    boolean mo6410isInLayerk4lQ0M(long position);

    void mapBounds(MutableRect rect, boolean inverse);

    /* renamed from: mapOffset-8S9VItk, reason: not valid java name */
    long mo6411mapOffset8S9VItk(long point, boolean inverse);

    /* renamed from: move--gyyYBs, reason: not valid java name */
    void mo6412movegyyYBs(long position);

    /* renamed from: resize-ozmzZPI, reason: not valid java name */
    void mo6413resizeozmzZPI(long size);
    ...
    void mo6414transform58bKbWc(float[] matrix);
