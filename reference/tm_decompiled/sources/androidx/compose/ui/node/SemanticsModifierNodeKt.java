...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m6208requireCoordinator64DMado(node, NodeKind.m6355constructorimpl(8)));
        }
        return DelegatableNodeKt.m6208requireCoordinator64DMado(node, NodeKind.m6355constructorimpl(8)).touchBoundsInRoot();
    }
}
