...
public final class TouchBoundsExpansion {
    ...
    public static final /* synthetic */ TouchBoundsExpansion m6438boximpl(long j) {
        return new TouchBoundsExpansion(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m6441constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6442equalsimpl(long j, Object obj) {
        return (obj instanceof TouchBoundsExpansion) && j == ((TouchBoundsExpansion) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6443equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6448hashCodeimpl(long j) {
        return UByte$$ExternalSyntheticBackport0.m(j);
    }

    /* renamed from: isLayoutDirectionAware-impl, reason: not valid java name */
    public static final boolean m6449isLayoutDirectionAwareimpl(long j) {
        return (j & Long.MIN_VALUE) != 0;
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6450toStringimpl(long j) {
        return "TouchBoundsExpansion(packedValue=" + j + ')';
    }

    public boolean equals(Object other) {
        return m6442equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m6448hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m6450toStringimpl(this.packedValue);
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ long m6452Absolutevsh68fg$default(Companion companion, int i, int i2, int i3, int i4, int i5, Object obj) {
            if ((i5 & 1) != 0) {
                i = 0;
            }
            if ((i5 & 2) != 0) {
            ...
            return companion.m6453Absolutevsh68fg(i, i2, i3, i4);
        }

        /* renamed from: Absolute-vsh68fg, reason: not valid java name */
        public final long m6453Absolutevsh68fg(int left, int top, int right, int bottom) {
            ...
            return TouchBoundsExpansion.m6441constructorimpl(pack$ui_release(left, top, right, bottom, false));
        }

        /* renamed from: getNone-RZrCHBk, reason: not valid java name */
        public final long m6454getNoneRZrCHBk() {
    ...
    public static final int m6446getStartimpl(long j) {
        return INSTANCE.unpack(j, 0);
    }

    /* renamed from: getTop-impl, reason: not valid java name */
    public static final int m6447getTopimpl(long j) {
        return INSTANCE.unpack(j, 1);
    }

    /* renamed from: getEnd-impl, reason: not valid java name */
    public static final int m6445getEndimpl(long j) {
        return INSTANCE.unpack(j, 2);
    }

    /* renamed from: getBottom-impl, reason: not valid java name */
    public static final int m6444getBottomimpl(long j) {
        return INSTANCE.unpack(j, 3);
    }

    /* renamed from: computeLeft-impl$ui_release, reason: not valid java name */
    public static final int m6439computeLeftimpl$ui_release(long j, LayoutDirection layoutDirection) {
        if (!m6449isLayoutDirectionAwareimpl(j) || layoutDirection == LayoutDirection.Ltr) {
            return m6446getStartimpl(j);
        }
        return m6445getEndimpl(j);
    }

    /* renamed from: computeRight-impl$ui_release, reason: not valid java name */
    public static final int m6440computeRightimpl$ui_release(long j, LayoutDirection layoutDirection) {
        if (!m6449isLayoutDirectionAwareimpl(j) || layoutDirection == LayoutDirection.Ltr) {
            return m6445getEndimpl(j);
        }
        return m6446getStartimpl(j);
