...
public final class AndroidComposeView extends ViewGroup implements Owner, PlatformFocusOwner, ViewRootForTest, MatrixPositionCalculator, DefaultLifecycleObserver, OutOfFrameExecutor {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = Offset.INSTANCE.m4358getUnspecifiedF1C5BW0();
        int i = 1;
        ...
        Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m6469invokeZmokQxo(keyEvent.m5765unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m6469invokeZmokQxo(android.view.KeyEvent keyEvent) {
                View findNextNonChildView;
                final FocusDirection m4235toFocusDirectionZmokQxo = FocusInteropUtils_androidKt.m4235toFocusDirectionZmokQxo(keyEvent);
                if (m4235toFocusDirectionZmokQxo == null || !KeyEventType.m5769equalsimpl0(KeyEvent_androidKt.m5777getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m5773getKeyDownCS__XNY())) {
                    return false;
                }
                Integer m4234toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m4234toAndroidFocusDirection3ESFkO8(m4235toFocusDirectionZmokQxo.getValue());
                if (ComposeUiFlags.isViewFocusFixEnabled && AndroidComposeView.this.hasFocus() && m4234toAndroidFocusDirection3ESFkO8 != null && AndroidComposeView.this.mo4284moveFocusInChildren3ESFkO8(m4235toFocusDirectionZmokQxo.getValue())) {
                    return true;
                }
                Rect embeddedViewFocusRect = AndroidComposeView.this.getEmbeddedViewFocusRect();
                Boolean mo4240focusSearchULY8qGw = AndroidComposeView.this.getFocusOwner().mo4240focusSearchULY8qGw(m4235toFocusDirectionZmokQxo.getValue(), embeddedViewFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                    {
                        super(1);
                    }
                    ...
                    public final Boolean invoke(FocusTargetNode focusTargetNode) {
                        return Boolean.valueOf(focusTargetNode.mo4253requestFocus3ESFkO8(FocusDirection.this.getValue()));
                    }
                });
                if (mo4240focusSearchULY8qGw != null ? mo4240focusSearchULY8qGw.booleanValue() : true) {
                    return true;
                }
                if (!FocusOwnerImplKt.m4247is1dFocusSearch3ESFkO8(m4235toFocusDirectionZmokQxo.getValue())) {
                    return false;
                }
                if (m4234toAndroidFocusDirection3ESFkO8 != null) {
                    findNextNonChildView = AndroidComposeView.this.findNextNonChildView(m4234toAndroidFocusDirection3ESFkO8.intValue());
                    ...
                    if (findNextNonChildView != null) {
                        ...
                        if (FocusInteropUtils_androidKt.requestInteropFocus(findNextNonChildView, m4234toAndroidFocusDirection3ESFkO8, androidRect)) {
                            return true;
                        }
                    }
                }
                if (!AndroidComposeView.this.getFocusOwner().mo4237clearFocusI7lrPNg(false, true, false, m4235toFocusDirectionZmokQxo.getValue())) {
                    return true;
                }
                Boolean mo4240focusSearchULY8qGw2 = AndroidComposeView.this.getFocusOwner().mo4240focusSearchULY8qGw(m4235toFocusDirectionZmokQxo.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                    {
                        super(1);
                    }
                ...
                return Boolean.valueOf(mo4240focusSearchULY8qGw2 != null ? mo4240focusSearchULY8qGw2.booleanValue() : true);
            }
        });
        ...
        if (ComposeUiFlags.areWindowInsetsRulersEnabled) {
            companion = WindowInsetsRulers_androidKt.applyWindowInsetsRulers(Modifier.INSTANCE, insetsListener);
        } else {
        ...
        if (autofillSupported()) {
            AutofillManager m3061m = Listener$$ExternalSyntheticApiModelOutline0.m3061m(context.getSystemService(Listener$$ExternalSyntheticApiModelOutline0.m$1()));
            if (m3061m != null) {
                androidAutofillManager = new AndroidAutofillManager(new PlatformAutofillManagerImpl(m3061m), getSemanticsOwner(), this, getRectManager(), context.getPackageName());
            } else {
        ...
        this.globalPosition = IntOffset.m7525constructorimpl((j & 4294967295L) | (j << 32));
        this.tmpPositionArray = new int[]{0, 0};
        float[] m4866constructorimpl$default = Matrix.m4866constructorimpl$default(null, 1, null);
        this.tmpMatrix = m4866constructorimpl$default;
        this.viewToWindowMatrix = Matrix.m4866constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m4866constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m4357getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m4080constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m5446getTouchaOaMEAU() : InputMode.INSTANCE.m5445getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m6467invokeiuPiT84(inputMode.getValue());
            }

            /* renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m6467invokeiuPiT84(int i2) {
                boolean requestFocusFromTouch;
                if (InputMode.m5441equalsimpl0(i2, InputMode.INSTANCE.m5446getTouchaOaMEAU())) {
                    requestFocusFromTouch = AndroidComposeView.this.isInTouchMode();
                } else {
                    requestFocusFromTouch = InputMode.m5441equalsimpl0(i2, InputMode.INSTANCE.m5445getKeyboardaOaMEAU()) ? AndroidComposeView.this.isInTouchMode() ? AndroidComposeView.this.requestFocusFromTouch() : true : false;
                }
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(m4866constructorimpl$default, null == true ? 1 : 0) : new CalculateMatrixToWindowApi29();
    ...
    public void setCoroutineContext(CoroutineContext coroutineContext) {
        ...
        while (mutableVector.getSize() != 0) {
            ...
            if ((node.getAggregateChildKindSet() & m6355constructorimpl) != 0) {
    ...
    public boolean mo4284moveFocusInChildren3ESFkO8(int focusDirection) {
        AndroidViewsHandler androidViewsHandler;
        View findNextFocusFromRect;
        if (!ComposeUiFlags.isViewFocusFixEnabled) {
            if (FocusDirection.m4222equalsimpl0(focusDirection, FocusDirection.INSTANCE.m4227getEnterdhqQ8s()) || FocusDirection.m4222equalsimpl0(focusDirection, FocusDirection.INSTANCE.m4228getExitdhqQ8s())) {
                return false;
            }
            Integer m4234toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m4234toAndroidFocusDirection3ESFkO8(focusDirection);
            if (m4234toAndroidFocusDirection3ESFkO8 == null) {
                throw new IllegalStateException("Invalid focus direction".toString());
            }
            int intValue = m4234toAndroidFocusDirection3ESFkO8.intValue();
        ...
        if (FocusDirection.m4222equalsimpl0(focusDirection, FocusDirection.INSTANCE.m4227getEnterdhqQ8s()) || FocusDirection.m4222equalsimpl0(focusDirection, FocusDirection.INSTANCE.m4228getExitdhqQ8s()) || !hasFocus() || (androidViewsHandler = this._androidViewsHandler) == null) {
            return false;
        }
        Integer m4234toAndroidFocusDirection3ESFkO82 = FocusInteropUtils_androidKt.m4234toAndroidFocusDirection3ESFkO8(focusDirection);
        if (m4234toAndroidFocusDirection3ESFkO82 == null) {
            throw new IllegalStateException("Invalid focus direction".toString());
        }
        int intValue2 = m4234toAndroidFocusDirection3ESFkO82.intValue();
        ...
        if (!FocusOwnerImplKt.m4247is1dFocusSearch3ESFkO8(focusDirection) || !androidViewsHandler.hasFocus()) {
    ...
    public static final void touchModeChangeListener$lambda$8(AndroidComposeView androidComposeView, boolean z) {
        androidComposeView._inputModeManager.m5449setInputModeiuPiT84(z ? InputMode.INSTANCE.m5446getTouchaOaMEAU() : InputMode.INSTANCE.m5445getKeyboardaOaMEAU());
    }
    ...
    */
        ...
        if (continuation instanceof AndroidComposeView$textInputSession$1) {
            ...
            if ((androidComposeView$textInputSession$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (SessionMutex.m4087withSessionCancellingPreviousimpl(atomicReference, function1, function2, androidComposeView$textInputSession$1) == coroutine_suspended) {
    ...
    public static final void sendHoverExitEvent$lambda$10(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m6464sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public void getFocusedRect(android.graphics.Rect rect) {
        ...
        if (!Intrinsics.areEqual((Object) getFocusOwner().mo4240focusSearchULY8qGw(FocusDirection.INSTANCE.m4226getDowndhqQ8s(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$getFocusedRect$1
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                return true;
            }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m4226getDowndhqQ8s();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        if (getFocusOwner().mo4240focusSearchULY8qGw(value, calculateBoundingRectRelativeTo, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusSearch$searchResult$1
            ...
            if (objectRef.element == 0) {
                ...
                if (FocusOwnerImplKt.m4247is1dFocusSearch3ESFkO8(value)) {
                    return super.focusSearch(focused, direction);
                }
                AndroidComposeView androidComposeView = this;
                if (TwoDimensionalFocusSearchKt.m4291isBetterCandidateI7lrPNg(FocusTraversalKt.focusRect((FocusTargetNode) objectRef.element), FocusInteropUtils_androidKt.calculateBoundingRectRelativeTo(findNextFocus, androidComposeView), calculateBoundingRectRelativeTo, value)) {
    ...
    public boolean requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        if (!ComposeUiFlags.isViewFocusFixEnabled) {
            ...
            FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
            final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m4227getEnterdhqQ8s();
            return Intrinsics.areEqual((Object) getFocusOwner().mo4240focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    return Boolean.valueOf(focusTargetNode.mo4253requestFocus3ESFkO8(value));
                }
            }), (Object) true);
        }
        if (isFocused()) {
        ...
        final int value2 = focusDirection2 != null ? focusDirection2.getValue() : FocusDirection.INSTANCE.m4227getEnterdhqQ8s();
        if (hasFocus() && mo4284moveFocusInChildren3ESFkO8(value2)) {
            return true;
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        Boolean mo4240focusSearchULY8qGw = getFocusOwner().mo4240focusSearchULY8qGw(value2, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$focusSearchResult$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                ...
                return Boolean.valueOf(focusTargetNode.mo4253requestFocus3ESFkO8(value2));
            }
        });
        if (mo4240focusSearchULY8qGw == null) {
            return false;
        }
        if (mo4240focusSearchULY8qGw.booleanValue()) {
            return true;
        }
        if (booleanRef.element) {
            return false;
        }
        if ((previouslyFocusedRect != null && !hasFocus() && Intrinsics.areEqual((Object) getFocusOwner().mo4240focusSearchULY8qGw(value2, null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$altFocus$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public boolean mo4285requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer m4234toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (m4234toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m4234toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : m4234toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
    ...
    public boolean mo6421sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo4238dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.CC.m4243dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }

    @Override // androidx.compose.ui.node.RootForTest
    public boolean sendIndirectTouchEvent(IndirectTouchEvent indirectTouchEvent) {
        return FocusOwner.CC.dispatchIndirectTouchEvent$default(getFocusOwner(), indirectTouchEvent, null, 2, null);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEvent(final android.view.KeyEvent event) {
        if (isFocused()) {
            this._windowInfo.m6541setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5988constructorimpl(event.getMetaState()));
            return FocusOwner.CC.m4243dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m5760constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo4239dispatchKeyEventYhN2O0w(KeyEvent.m5760constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$dispatchKeyEvent$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        return (isFocused() && getFocusOwner().mo4238dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m5760constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m6465startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                while (true) {
                    if (parent$ui_release == null) {
                        ...
                        break;
                    } else if (parent$ui_release.getNodes().m6316hasH91voCI$ui_release(NodeKind.m6355constructorimpl(8))) {
                        break;
                    } else {
    ...
    public void mo6418measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m6303measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long m6461convertMeasureSpecI7RO_PI = m6461convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int m8252constructorimpl = (int) ULong.m8252constructorimpl(m6461convertMeasureSpecI7RO_PI >>> 32);
            int m8252constructorimpl2 = (int) ULong.m8252constructorimpl(m6461convertMeasureSpecI7RO_PI & 4294967295L);
            long m6461convertMeasureSpecI7RO_PI2 = m6461convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long m7350fitPrioritizingHeightZbe2FdA = Constraints.INSTANCE.m7350fitPrioritizingHeightZbe2FdA(m8252constructorimpl, m8252constructorimpl2, (int) ULong.m8252constructorimpl(m6461convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m8252constructorimpl(4294967295L & m6461convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean z = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m7329boximpl(m7350fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    z = Constraints.m7335equalsimpl0(constraints.getValue(), m7350fitPrioritizingHeightZbe2FdA);
                }
                if (!z) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m6304updateRootConstraintsBRTryo0(m7350fitPrioritizingHeightZbe2FdA);
    ...
    private final int m6459component1VKZWuLQ(long j) {
        return (int) ULong.m8252constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m6460component2VKZWuLQ(long j) {
        return (int) ULong.m8252constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m6463packZIaKswc(int a, int b) {
        return ULong.m8252constructorimpl(ULong.m8252constructorimpl(b) | ULong.m8252constructorimpl(ULong.m8252constructorimpl(a) << 32));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m6461convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m6463packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m6463packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m6463packZIaKswc(size, size);
        }
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int m7531getXimpl = IntOffset.m7531getXimpl(j);
        int m7532getYimpl = IntOffset.m7532getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (m7531getXimpl != i || m7532getYimpl != iArr[1] || this.lastMatrixRecalculationAnimationTime < 0) {
            this.globalPosition = IntOffset.m7525constructorimpl((i << 32) | (iArr[1] & 4294967295L));
            if (m7531getXimpl != Integer.MAX_VALUE && m7532getYimpl != Integer.MAX_VALUE) {
        ...
        getRectManager().m6618updateOffsetsgTq6Wqs(this.globalPosition, IntOffsetKt.m7548roundk4lQ0M(this.windowPosition), this.viewToWindowMatrix, view.getWidth(), view.getHeight());
    ...
    protected void onAttachedToWindow() {
        ...
        this._windowInfo.setOnInitializeContainerSize(new Function0<IntSize>() { // from class: androidx.compose.ui.platform.AndroidComposeView$onAttachedToWindow$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke() {
                return IntSize.m7566boximpl(m6470invokeYbymL2g());
            }

            /* renamed from: invoke-YbymL2g, reason: not valid java name */
            public final long m6470invokeYbymL2g() {
        ...
        this._inputModeManager.m5449setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m5446getTouchaOaMEAU() : InputMode.INSTANCE.m5445getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return (m6462handleMotionEvent8iAsVTc(motionEvent) & 1) != 0;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int m6462handleMotionEvent8iAsVTc = m6462handleMotionEvent8iAsVTc(motionEvent);
        if ((m6462handleMotionEvent8iAsVTc & 2) != 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return (m6462handleMotionEvent8iAsVTc & 1) != 0;
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final int m6462handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                    ...
                    try {
                        if (hasChangedDevices(motionEvent, motionEvent5)) {
                            if (isDevicePressEvent(motionEvent5)) {
                                ...
                                int m6464sendMotionEvent8iAsVTc = m6464sendMotionEvent8iAsVTc(motionEvent);
                                Trace.endSection();
                                androidComposeView.forceUseMatrixCache = false;
                                return m6464sendMotionEvent8iAsVTc;
                            }
                        }
                    } catch (Throwable th) {
                        th = th;
                ...
                androidComposeView.previousMotionEvent = MotionEvent.obtainNoHistory(motionEvent);
                int m6464sendMotionEvent8iAsVTc2 = m6464sendMotionEvent8iAsVTc(motionEvent);
                Trace.endSection();
                androidComposeView.forceUseMatrixCache = false;
                return m6464sendMotionEvent8iAsVTc2;
            } catch (Throwable th2) {
                th = th2;
            }
        } catch (Throwable th3) {
    ...
    private final int m6464sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m6541setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m5988constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (convertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m5941getPositionF1C5BW0();
            }
            int m5946processBIzXfog = this.pointerInputEventProcessor.m5946processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            convertToPointerInputEvent$ui_release.setMotionEvent(null);
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked != 0 && actionMasked != 5) || (m5946processBIzXfog & 1) != 0) {
                return m5946processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i4 < pointerCount) {
            ...
            long mo6006localToScreenMKHz9U = mo6006localToScreenMKHz9U(Offset.m4335constructorimpl((Float.floatToRawIntBits(pointerCoords.y) & 4294967295L) | (Float.floatToRawIntBits(f) << 32)));
            pointerCoords.x = Float.intBitsToFloat((int) (mo6006localToScreenMKHz9U >> 32));
            pointerCoords.y = Float.intBitsToFloat((int) (mo6006localToScreenMKHz9U & 4294967295L));
            i4++;
        }
        ...
        this.pointerInputEventProcessor.m5946processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, true);
        obtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m6475canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m6475canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo6006localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long m4872mapMKHz9U = Matrix.m4872mapMKHz9U(this.viewToWindowMatrix, localPosition);
        float intBitsToFloat = Float.intBitsToFloat((int) (m4872mapMKHz9U >> 32)) + Float.intBitsToFloat((int) (this.windowPosition >> 32));
        float intBitsToFloat2 = Float.intBitsToFloat((int) (m4872mapMKHz9U & 4294967295L)) + Float.intBitsToFloat((int) (this.windowPosition & 4294967295L));
        return Offset.m4335constructorimpl((Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat) << 32));
    }

    @Override // androidx.compose.ui.input.pointer.MatrixPositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo5854localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m4885timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m6480preTranslatecG2Xzmc(localTransform, Float.intBitsToFloat((int) (this.windowPosition >> 32)), Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo6007screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        ...
        return Matrix.m4872mapMKHz9U(this.windowToViewMatrix, Offset.m4335constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (4294967295L & Float.floatToRawIntBits(intBitsToFloat2))));
    }
    ...
    private final void recalculateWindowPosition() {
        ...
        if (currentAnimationTimeMillis != this.lastMatrixRecalculationAnimationTime) {
            ...
            float f4 = f2 - r0[1];
            this.windowPosition = Offset.m4335constructorimpl((Float.floatToRawIntBits(f - f3) << 32) | (Float.floatToRawIntBits(f4) & 4294967295L));
        }
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX();
        float y = motionEvent.getY();
        long m4872mapMKHz9U = Matrix.m4872mapMKHz9U(fArr, Offset.m4335constructorimpl((Float.floatToRawIntBits(y) & 4294967295L) | (Float.floatToRawIntBits(x) << 32)));
        float rawX = motionEvent.getRawX() - Float.intBitsToFloat((int) (m4872mapMKHz9U >> 32));
        float rawY = motionEvent.getRawY() - Float.intBitsToFloat((int) (m4872mapMKHz9U & 4294967295L));
        this.windowPosition = Offset.m4335constructorimpl((Float.floatToRawIntBits(rawX) << 32) | (Float.floatToRawIntBits(rawY) & 4294967295L));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo6481calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m6533invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }

    private final void updateWindowMetrics() {
        MutableState mutableState = this._windowInfo._containerSize;
        if (mutableState != null) {
            mutableState.setValue(IntSize.m7566boximpl(AndroidWindowInfo_androidKt.calculateWindowSize(this)));
        }
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m4084getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo6415calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m4872mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo6416calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m4872mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        if (!isBadMotionEvent(event) && isAttachedToWindow()) {
            ...
            if ((m6462handleMotionEvent8iAsVTc(event) & 1) != 0) {
                return true;
            }
        }
        return false;
    ...
    public void mo6417dispatchOnScrollChangedk4lQ0M(long delta) {
