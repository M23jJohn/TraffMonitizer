...
public final class AndroidComposeViewAccessibilityDelegateCompat_androidKt {
    ...
    public static final String getInfoStateDescriptionOrNull(SemanticsNode semanticsNode, Resources resources) {
        ...
        if (toggleableState != null) {
            ...
            if (i2 == 1) {
                if ((role == null ? false : Role.m6592equalsimpl0(role.getValue(), Role.INSTANCE.m6602getSwitcho7Vup1c())) && orNull == null) {
        ...
        if (bool != null) {
            ...
            if (!(role == null ? false : Role.m6592equalsimpl0(role.getValue(), Role.INSTANCE.m6603getTabo7Vup1c())) && orNull == null) {
                if (booleanValue) {
    ...
    public static final boolean getInfoIsCheckable(SemanticsNode semanticsNode) {
        ...
        if (bool != null) {
            bool.booleanValue();
            if (!(role != null ? Role.m6592equalsimpl0(role.getValue(), Role.INSTANCE.m6603getTabo7Vup1c()) : false)) {
                return true;
            }
        }
        return z;
