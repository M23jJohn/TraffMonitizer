...
public final class LazyWindowInfo implements WindowInfo {
    ...
    public void m6541setKeyboardModifiers5xRPYO0(int i) {
        WindowInfoImpl.INSTANCE.getGlobalKeyboardModifiers$ui_release().setValue(PointerKeyboardModifiers.m5987boximpl(i));
    }
    ...
    public long mo6539getContainerSizeYbymL2g() {
        if (this._containerSize == null) {
            ...
            this._containerSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7566boximpl(function0 != null ? function0.invoke().m7578unboximpl() : IntSize.INSTANCE.m7579getZeroYbymL2g()), null, 2, null);
