...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m4705getAutoNrFUSI();
    ...
    public void mo6494setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().mo4464setBlendModes9anfk8(i);
    ...
    public void mo6495setCompositingStrategyaDBOjCE(int i) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6566applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.INSTANCE.m4707getOffscreenNrFUSI());
        } else {
            m6566applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4701equalsimpl0(getInternalCompositingStrategy(), CompositingStrategy.INSTANCE.m4707getOffscreenNrFUSI()) || requiresLayerPaint();
    }
    ...
    private final void m6566applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        if (CompositingStrategy.m4701equalsimpl0(i, CompositingStrategy.INSTANCE.m4707getOffscreenNrFUSI())) {
        ...
        if (CompositingStrategy.m4701equalsimpl0(i, CompositingStrategy.INSTANCE.m4706getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4701equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4707getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.CC.m4587clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
