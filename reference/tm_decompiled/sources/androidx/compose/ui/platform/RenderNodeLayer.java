...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m4669toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m4669toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m5028getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m5029getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & mutatedFields) != 0) {
            this.renderNode.mo6494setBlendModes9anfk8(scope.getBlendMode());
        }
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo6495setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
        boolean m6565updateS_szKao = this.outlineResolver.m6565updateS_szKao(scope.getOutline(), scope.getAlpha(), z3, scope.getShadowElevation(), scope.getSize());
    ...
    public void mo6413resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m5028getPivotFractionXimpl(this.transformOrigin) * i);
        this.renderNode.setPivotY(TransformOrigin.m5029getPivotFractionYimpl(this.transformOrigin) * i2);
    ...
    public void mo6412movegyyYBs(long position) {
        ...
        int m7531getXimpl = IntOffset.m7531getXimpl(position);
        int m7532getYimpl = IntOffset.m7532getYimpl(position);
        if (left == m7531getXimpl && top == m7532getYimpl) {
            return;
        }
        if (left != m7531getXimpl) {
            this.renderNode.offsetLeftAndRight(m7531getXimpl - left);
        }
        if (top != m7532getYimpl) {
            this.renderNode.offsetTopAndBottom(m7532getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo4440concat58bKbWc(this.matrixCache.m6536calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo6408getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m6536calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo6411mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return this.matrixCache.m6538mapInverseR5De75A(this.renderNode, point);
        }
        return this.matrixCache.m6537mapR5De75A(this.renderNode, point);
    }
    ...
    public void mo6414transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4885timesAssign58bKbWc(matrix, this.matrixCache.m6536calculateMatrixGrdbGEg(this.renderNode));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* renamed from: inverseTransform-58bKbWc */
    public void mo6409inverseTransform58bKbWc(float[] matrix) {
        float[] m6535calculateInverseMatrixbWbORWo = this.matrixCache.m6535calculateInverseMatrixbWbORWo(this.renderNode);
        if (m6535calculateInverseMatrixbWbORWo != null) {
            androidx.compose.ui.graphics.Matrix.m4885timesAssign58bKbWc(matrix, m6535calculateInverseMatrixbWbORWo);
        }
    }
    ...
    public boolean mo6410isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToOutline()) {
            return this.outlineResolver.m6564isInOutlinek4lQ0M(position);
        }
        return true;
    }
}
