...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m6568toLegacyClassNameV4PA4sw(int i) {
        if (Role.m6592equalsimpl0(i, Role.INSTANCE.m6596getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m6592equalsimpl0(i, Role.INSTANCE.m6598getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m6592equalsimpl0(i, Role.INSTANCE.m6601getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m6592equalsimpl0(i, Role.INSTANCE.m6600getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m6592equalsimpl0(i, Role.INSTANCE.m6599getDropdownListo7Vup1c())) {
            return "android.widget.Spinner";
        }
        if (Role.m6592equalsimpl0(i, Role.INSTANCE.m6604getValuePickero7Vup1c())) {
