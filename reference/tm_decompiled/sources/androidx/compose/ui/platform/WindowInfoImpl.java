...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m5987boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    private final MutableState<IntSize> _containerSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7566boximpl(IntSize.INSTANCE.m7579getZeroYbymL2g()), null, 2, null);
    ...
    public int mo6540getKeyboardModifiersk7X9c1A() {
        return GlobalKeyboardModifiers.getValue().getPackedValue();
    }

    /* renamed from: setKeyboardModifiers-5xRPYO0, reason: not valid java name */
    public void m6579setKeyboardModifiers5xRPYO0(int i) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m5987boximpl(i));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* renamed from: getContainerSize-YbymL2g */
    public long mo6539getContainerSizeYbymL2g() {
        return this._containerSize.getValue().m7578unboximpl();
    }

    /* renamed from: setContainerSize-ozmzZPI, reason: not valid java name */
    public void m6578setContainerSizeozmzZPI(long j) {
        this._containerSize.setValue(IntSize.m7566boximpl(j));
    }
