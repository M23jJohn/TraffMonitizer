...
public final class SemanticsNode {
    ...
    public final long m6609getSizeYbymL2g() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return findCoordinatorToGetBounds$ui_release != null ? findCoordinatorToGetBounds$ui_release.mo6057getSizeYbymL2g() : IntSize.INSTANCE.m7579getZeroYbymL2g();
    }
    ...
    public final long m6606getPositionInRootF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    public final long m6607getPositionInWindowF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    public final long m6608getPositionOnScreenF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    private final Rect boundsInImportantForBoundsAncestor(LayoutCoordinates nodeCoordinates) {
        ...
        NodeCoordinator m6208requireCoordinator64DMado = semanticsModifierNode != null ? DelegatableNodeKt.m6208requireCoordinator64DMado(semanticsModifierNode, NodeKind.m6355constructorimpl(8)) : null;
        if (m6208requireCoordinator64DMado == null) {
            return parent.boundsInImportantForBoundsAncestor(nodeCoordinates);
        }
        return LayoutCoordinates.CC.localBoundingBoxOf$default(m6208requireCoordinator64DMado, nodeCoordinates, false, 2, null);
    }
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode layoutNode, List<SemanticsNode> list, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode2.isAttached() && (z || !layoutNode2.getIsDeactivated())) {
                if (layoutNode2.getNodes().m6316hasH91voCI$ui_release(NodeKind.m6355constructorimpl(8))) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        NodeCoordinator m6208requireCoordinator64DMado;
        if (!this.isFake) {
            SemanticsModifierNode findSemanticsModifierNodeToGetBounds = findSemanticsModifierNodeToGetBounds();
            return (findSemanticsModifierNodeToGetBounds == null || (m6208requireCoordinator64DMado = DelegatableNodeKt.m6208requireCoordinator64DMado(findSemanticsModifierNodeToGetBounds, NodeKind.m6355constructorimpl(8))) == null) ? this.layoutNode.getInnerCoordinator$ui_release() : m6208requireCoordinator64DMado;
        }
        SemanticsNode parent = getParent();
        if (parent != null) {
    ...
    private final SemanticsModifierNode findSemanticsModifierNodeToGetBounds() {
        ...
        int m6355constructorimpl2 = NodeKind.m6355constructorimpl(8);
        if ((nodes2.getAggregateChildKindSet() & m6355constructorimpl2) != 0) {
            loop3: for (Modifier.Node head2 = nodes2.getHead(); head2 != null; head2 = head2.getChild()) {
                if ((head2.getKindSet() & m6355constructorimpl2) != 0) {
                    node = head2;
                    ...
                    while (node != null) {
                        ...
                        } else if ((node.getKindSet() & m6355constructorimpl2) != 0 && (node instanceof DelegatingNode)) {
                            int i2 = 0;
                ...
                if ((head2.getAggregateChildKindSet() & m6355constructorimpl2) == 0) {
                    break;
                }
            }
        }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (role != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && !unmergedChildren.isEmpty()) {
            unmergedChildren.add(m6605fakeSemanticsNodeypyhhiA(role, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    SemanticsPropertiesKt.m6615setRolekuIjeqM(semanticsPropertyReceiver, Role.this.getValue());
                }
            }));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !unmergedChildren.isEmpty() && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                unmergedChildren.add(0, m6605fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m6605fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {
