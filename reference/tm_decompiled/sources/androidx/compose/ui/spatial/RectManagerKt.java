...
public final class RectManagerKt {
    ...
    public static final boolean m6622isSetgyyYBs(long j) {
        return !IntOffset.m7530equalsimpl0(j, IntOffset.INSTANCE.m7541getMaxnOccac());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: analyzeComponents-58bKbWc, reason: not valid java name */
    public static final int m6621analyzeComponents58bKbWc(float[] fArr) {
        int i = 0;
        if (fArr.length < 16) {
            return 0;
        }
