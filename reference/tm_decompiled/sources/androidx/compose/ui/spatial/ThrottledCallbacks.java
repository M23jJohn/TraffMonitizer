...
public final class ThrottledCallbacks {
    ...
    private long windowOffset = IntOffset.INSTANCE.m7542getZeronOccac();
    private long screenOffset = IntOffset.INSTANCE.m7542getZeronOccac();
    ...
    public final class Entry implements DelegatableNode.RegistrationHandle {
        ...
        public final void m6636fire9b9wPM(long topLeft, long bottomRight, long windowOffset, long screenOffset, float[] viewToWindowMatrix) {
            RelativeLayoutBounds m6637rectInfoForDg36KO4 = ThrottledCallbacksKt.m6637rectInfoForDg36KO4(this.node, topLeft, bottomRight, windowOffset, screenOffset, ThrottledCallbacks.this.getWindowSize(), viewToWindowMatrix);
            if (m6637rectInfoForDg36KO4 == null) {
                return;
            }
            this.callback.invoke(m6637rectInfoForDg36KO4);
        }
    }
    ...
    public final void m6634setWindowOffsetgyyYBs(long j) {
        this.windowOffset = j;
    }
    ...
    public final void m6632setScreenOffsetgyyYBs(long j) {
        this.screenOffset = j;
    }
    ...
    public final void m6633setViewToWindowMatrixQ8lPUPs(float[] fArr) {
        this.viewToWindowMatrix = fArr;
    }

    /* renamed from: updateOffsets-LDcG7Xg, reason: not valid java name */
    public final boolean m6635updateOffsetsLDcG7Xg(long screen, long window, float[] matrix, int windowWidth, int windowHeight) {
        boolean z;
        if (IntOffset.m7530equalsimpl0(window, this.windowOffset)) {
            z = false;
        } else {
            this.windowOffset = window;
            z = true;
        }
        if (!IntOffset.m7530equalsimpl0(screen, this.screenOffset)) {
                ...
                while (i3 < i2) {
                    if ((j4 & 255) < 128) {
                        ...
                        while (entry != null) {
                            int i4 = i3;
                            Entry entry2 = entry;
                            throttledCallbacks.m6628fireWY9HvpM(entry2, j, j2, fArr, currentMillis);
    ...
    public final void fireGlobalChangeEntries(long currentMillis) {
        ...
        if (entry != null) {
            for (Entry entry2 = entry; entry2 != null; entry2 = entry2.getNext()) {
                ...
                entry2.setBottomRight(((IntOffset.m7531getXimpl(offsetFromRoot) + ((int) (lastSize >> 32))) << 32) | ((IntOffset.m7532getYimpl(offsetFromRoot) + ((int) (lastSize & 4294967295L))) & 4294967295L));
                m6628fireWY9HvpM(entry2, j, j2, fArr, currentMillis);
            }
        }
    }
    ...
    public final void triggerDebounced(long currentMillis) {
                    ...
                    while (i4 < i3) {
                        if ((j6 & 255) < 128) {
                            ...
                            while (entry != null) {
                                int i5 = i2;
                                Entry entry2 = entry;
                                j2 = m6627debounceEntryb8qMvQI(entry2, j3, j4, fArr, currentMillis, j2);
                                i4 = i4;
                                entry = entry2.getNext();
                                i2 = i5;
                            }
        ...
        if (entry3 != null) {
            long j7 = j2;
            while (entry3 != null) {
                j7 = m6627debounceEntryb8qMvQI(entry3, j3, j4, fArr, currentMillis, j7);
    ...
    public final void fireWithUpdatedRect$ui_release(Entry entry, long topLeft, long bottomRight, long currentMillis) {
        ...
        if (z && z4) {
            ...
            entry.m6636fire9b9wPM(topLeft, bottomRight, this.windowOffset, this.screenOffset, this.viewToWindowMatrix);
        } else {
            if (z2) {
                return;
            }
    ...
    private final void m6628fireWY9HvpM(Entry entry, long windowOffset, long screenOffset, float[] viewToWindowMatrix, long currentMillis) {
        long lastInvokeMillis = entry.getLastInvokeMillis();
        ...
        if (z && z2) {
            entry.setLastInvokeMillis(currentMillis);
            entry.m6636fire9b9wPM(entry.getTopLeft(), entry.getBottomRight(), windowOffset, screenOffset, viewToWindowMatrix);
        }
        if (z2) {
            return;
        }
    ...
    private final long m6627debounceEntryb8qMvQI(Entry entry, long windowOffset, long screenOffset, float[] viewToWindowMatrix, long currentMillis, long minDeadline) {
