...
public final class AnnotatedString implements CharSequence {
    ...
    */
    ...
    public final AnnotatedString m6660subSequence5zctL8(long range) {
        return subSequence(TextRange.m6846getMinimpl(range), TextRange.m6845getMaximpl(range));
    }
    ...
    public static final class Builder implements Appendable {
        ...
        public final void addStringAnnotation(String tag, String annotation, int start, int end) {
            this.annotations.add(new MutableRange<>(StringAnnotation.m6796boximpl(StringAnnotation.m6797constructorimpl(annotation)), start, end, tag));
        }
        ...
        public final void m6662addBulletr9BaKPg(Bullet bullet, long indentation, int start, int end) {
        ...
        public static /* synthetic */ Object m6661withBulletListo2QH7mI$default(Builder builder, long j, Bullet bullet, Function1 function1, int i, Object obj) {
            if ((i & 1) != 0) {
                j = Bullet.INSTANCE.m6672getDefaultIndentationXSAIIZE();
            }
            if ((i & 2) != 0) {
                bullet = Bullet.INSTANCE.getDefault();
            }
            return builder.m6663withBulletListo2QH7mI(j, bullet, function1);
        }

        /* renamed from: withBulletList-o2QH7mI, reason: not valid java name */
        public final <R> R m6663withBulletListo2QH7mI(long indentation, Bullet bullet, Function1<? super BulletScope, ? extends R> block) {
            long j;
            ...
            if (pair != null) {
                ...
                if (!TextUnitType.m7625equalsimpl0(TextUnit.m7596getTypeUIouoOA(packedValue), TextUnit.m7596getTypeUIouoOA(indentation))) {
                    InlineClassHelperKt.throwIllegalStateException("Indentation unit types of nested bullet lists must match. Current " + ((Object) TextUnit.m7604toStringimpl(packedValue)) + " and previous is " + ((Object) TextUnit.m7604toStringimpl(indentation)));
                }
                long m7596getTypeUIouoOA = TextUnit.m7596getTypeUIouoOA(indentation);
                j = TextUnitType.m7625equalsimpl0(m7596getTypeUIouoOA, TextUnitType.INSTANCE.m7630getSpUIouoOA()) ? TextUnitKt.getSp(TextUnit.m7597getValueimpl(indentation) + TextUnit.m7597getValueimpl(packedValue)) : TextUnitType.m7625equalsimpl0(m7596getTypeUIouoOA, TextUnitType.INSTANCE.m7629getEmUIouoOA()) ? TextUnitKt.getEm(TextUnit.m7597getValueimpl(indentation) + TextUnit.m7597getValueimpl(packedValue)) : indentation;
            } else {
                j = indentation;
            }
            ...
            this.bulletScope.getBulletListSettingStack$ui_text().add(new Pair<>(TextUnit.m7587boximpl(j), bullet));
            try {
        ...
        public final <R> R withBulletListItem(BulletScope bulletScope, Bullet bullet, Function1<? super Builder, ? extends R> function1) {
            ...
            long packedValue = pair != null ? ((TextUnit) pair.getFirst()).getPackedValue() : Bullet.INSTANCE.m6672getDefaultIndentationXSAIIZE();
            if (bullet != null) {
                bullet2 = bullet;
        ...
        public final int pushStringAnnotation(String tag, String annotation) {
            MutableRange<? extends Annotation> mutableRange = new MutableRange<>(StringAnnotation.m6796boximpl(StringAnnotation.m6797constructorimpl(annotation)), this.text.length(), 0, tag, 4, null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
