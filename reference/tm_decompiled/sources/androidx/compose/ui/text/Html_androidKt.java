...
public final class Html_androidKt {
    ...
    private static final void addSpans(AnnotatedString.Builder builder, Spanned spanned, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        for (Object obj : spanned.getSpans(0, builder.getLength(), Object.class)) {
            ...
            addSpan(builder, obj, TextRange.m6848getStartimpl(TextRange), TextRange.m6843getEndimpl(TextRange), textLinkStyles, linkInteractionListener);
        }
    }
    ...
    private static final void addSpan(AnnotatedString.Builder builder, Object obj, int i, int i2, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        ...
        if (obj instanceof BulletSpanWithLevel) {
            long m6672getDefaultIndentationXSAIIZE = Bullet.INSTANCE.m6672getDefaultIndentationXSAIIZE();
            ...
            TextUnitKt.m7610checkArithmeticR2X_6o(m6672getDefaultIndentationXSAIIZE);
            builder.m6662addBulletr9BaKPg(bulletSpanWithLevel.getBullet(), TextUnitKt.pack(TextUnit.m7595getRawTypeimpl(m6672getDefaultIndentationXSAIIZE), TextUnit.m7597getValueimpl(m6672getDefaultIndentationXSAIIZE) * indentationLevel), i, i2);
            return;
        }
        ...
        if (obj instanceof SubscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m7145boximpl(BaselineShift.INSTANCE.m7156getSubscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
        if (obj instanceof SuperscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m7145boximpl(BaselineShift.INSTANCE.m7157getSuperscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
    ...
    private static final ParagraphStyle toParagraphStyle(AlignmentSpan alignmentSpan) {
        int m7278getStarte0LSkKk;
        Layout.Alignment alignment = alignmentSpan.getAlignment();
        int i = alignment == null ? -1 : WhenMappings.$EnumSwitchMapping$0[alignment.ordinal()];
        if (i == 1) {
            m7278getStarte0LSkKk = TextAlign.INSTANCE.m7278getStarte0LSkKk();
        } else if (i == 2) {
            m7278getStarte0LSkKk = TextAlign.INSTANCE.m7273getCentere0LSkKk();
        } else if (i == 3) {
            m7278getStarte0LSkKk = TextAlign.INSTANCE.m7274getEnde0LSkKk();
        } else {
            m7278getStarte0LSkKk = TextAlign.INSTANCE.m7279getUnspecifiede0LSkKk();
        }
        return new ParagraphStyle(m7278getStarte0LSkKk, 0, 0L, (TextIndent) null, (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 510, (DefaultConstructorMarker) null);
    }
    ...
    private static final SpanStyle toSpanStyle(StyleSpan styleSpan) {
        ...
        if (style == 2) {
            return new SpanStyle(0L, 0L, (FontWeight) null, FontStyle.m6961boximpl(FontStyle.INSTANCE.m6970getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65527, (DefaultConstructorMarker) null);
        }
        if (style != 3) {
            return null;
        }
        return new SpanStyle(0L, 0L, FontWeight.INSTANCE.getBold(), FontStyle.m6961boximpl(FontStyle.INSTANCE.m6970getItalic_LCdwA()), (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65523, (DefaultConstructorMarker) null);
    }
