...
public interface Paragraph {
    ...
    void mo6639fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart);
    ...
    int mo6641getOffsetForPositionk4lQ0M(long position);
    ...
    long mo6643getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy);

    float getWidth();

    /* renamed from: getWordBoundary--jx7JFs */
    long mo6644getWordBoundaryjx7JFs(int offset);

    boolean isLineEllipsized(int lineIndex);

    /* renamed from: paint-LG529CI */
    void mo6645paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode);

    /* renamed from: paint-RPmYEkk */
    void mo6646paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration);

    /* renamed from: paint-hn5TExg */
    void mo6647painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m6697paintLG529CI$default(Paragraph paragraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: paint-LG529CI");
            }
            paragraph.mo6645paintLG529CI(canvas, (i2 & 2) != 0 ? Color.INSTANCE.m4651getUnspecified0d7_KjU() : j, (i2 & 4) != 0 ? null : shadow, (i2 & 8) != 0 ? null : textDecoration, (i2 & 16) == 0 ? drawStyle : null, (i2 & 32) != 0 ? DrawScope.INSTANCE.m5210getDefaultBlendMode0nO6VwU() : i);
        }

        /* renamed from: paint-RPmYEkk$default, reason: not valid java name */
        public static /* synthetic */ void m6698paintRPmYEkk$default(Paragraph paragraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
            if (obj != null) {
            ...
            paragraph.mo6646paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
        }

        /* renamed from: paint-hn5TExg$default, reason: not valid java name */
        public static /* synthetic */ void m6699painthn5TExg$default(Paragraph paragraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            paragraph.mo6647painthn5TExg(canvas, brush, f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.INSTANCE.m5210getDefaultBlendMode0nO6VwU() : i);
        }
    }
