...
public final /* data */ class ParagraphInfo {
    ...
    public final Rect toGlobal(Rect rect) {
        float f = this.top;
        return rect.m4380translatek4lQ0M(Offset.m4335constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
    }
    ...
    public final Path toGlobal(Path path) {
        float f = this.top;
        path.mo4481translatek4lQ0M(Offset.m4335constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m6703toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6704toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m6704toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m6841equalsimpl0(j, TextRange.INSTANCE.m6853getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6853getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6848getStartimpl(j)), toGlobalIndex(TextRange.m6843getEndimpl(j)));
    }

    /* renamed from: toLocal-MK-Hz9U, reason: not valid java name */
    public final long m6705toLocalMKHz9U(long j) {
