...
public final class Placeholder {
    ...
    public static /* synthetic */ Placeholder m6738copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m6739copyK8Q__8(j3, j4, i);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m6739copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m7594equalsimpl0(this.width, placeholder.width) && TextUnit.m7594equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m6746equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m7598hashCodeimpl(this.width) * 31) + TextUnit.m7598hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m6747hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m7604toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m7604toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m6748toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
