...
public final class TextStyleKt {
    ...
    public static final int m6894resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7287getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m7288getContentOrLtrs_7Xco();
            }
            if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.INSTANCE.m7289getContentOrRtls_7Xco();
        }
        if (!TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7292getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m7290getLtrs_7Xco();
        }
        if (i3 != 2) {
            throw new NoWhenBranchMatchedException();
        }
        return TextDirection.INSTANCE.m7291getRtls_7Xco();
    }
