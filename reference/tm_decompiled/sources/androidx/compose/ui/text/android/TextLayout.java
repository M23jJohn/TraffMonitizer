...
public final class TextLayout {
    ...
    public TextLayout(CharSequence charSequence, float f, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f2, float f3, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) {
        ...
        try {
            ...
            this.lineCount = min;
            int i10 = min - 1;
            this.didExceedMaxLines = (min >= i9 && (create.getEllipsisCount(i10) > 0 || create.getLineEnd(i10) != charSequence.length())) ? z3 : z4;
            ...
            this.topPadding = Math.max(VerticalPaddings.m6901getTopPaddingimpl(verticalPaddings), VerticalPaddings.m6901getTopPaddingimpl(lineHeightPaddings));
            this.bottomPadding = Math.max(VerticalPaddings.m6900getBottomPaddingimpl(verticalPaddings), VerticalPaddings.m6900getBottomPaddingimpl(lineHeightPaddings));
