...
public final class AsyncTypefaceCache {
    ...
    private final Object PermanentFailure = AsyncTypefaceResult.m6918constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m6917boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Object m6918constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m6919equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m6924unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m6920equalsimpl0(Object obj, Object obj2) {
        ...
        public static final boolean m6922isPermanentFailureimpl(Object obj) {
            return obj == null;
        }
        ...
        public boolean equals(Object other) {
            return m6919equalsimpl(this.result, other);
        }

        public int hashCode() {
            return m6921hashCodeimpl(this.result);
        }

        public String toString() {
            return m6923toStringimpl(this.result);
        }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (this.cacheLock) {
            try {
                if (result == null) {
                    this.permanentCache.set(key, AsyncTypefaceResult.m6917boximpl(this.PermanentFailure));
                    Unit unit = Unit.INSTANCE;
                } else if (forever) {
                    this.permanentCache.set(key, AsyncTypefaceResult.m6917boximpl(AsyncTypefaceResult.m6918constructorimpl(result)));
                    Unit unit2 = Unit.INSTANCE;
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m6917boximpl(AsyncTypefaceResult.m6918constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m6916get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
            ...
            if ((asyncTypefaceCache$runCached$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    synchronized (this.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            return asyncTypefaceResult.m6924unboximpl();
                        }
                        Unit unit = Unit.INSTANCE;
                ...
                synchronized (this.cacheLock) {
                    try {
                        if (obj == null) {
                            ...
                            this.permanentCache.set(key, AsyncTypefaceResult.m6917boximpl(AsyncTypefaceResult.m6918constructorimpl(obj)));
                        } else {
                            this.resultCache.put(key, AsyncTypefaceResult.m6917boximpl(AsyncTypefaceResult.m6918constructorimpl(obj)));
                        }
                        Unit unit2 = Unit.INSTANCE;
                    } catch (Throwable th) {
                        throw th;
