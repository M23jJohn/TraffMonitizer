...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface mo6992createDefaultFO1MlWM;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            mo6992createDefaultFO1MlWM = this.platformTypefaceResolver.mo6992createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m7010getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo6992createDefaultFO1MlWM = this.platformTypefaceResolver.mo6993createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m7010getFontStyle_LCdwA());
        } else {
            ...
            mo6992createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo7107getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m7010getFontStyle_LCdwA(), typefaceRequest.m7011getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo6992createDefaultFO1MlWM, false, 2, null);
    }
}
