...
public final class PlatformFontVariationSettings_androidKt {
    ...
    public static final FontVariationAxis[] toAndroidArray(FontVariation.Settings settings, Density density, int i) {
        ...
        if (i == 0) {
            ...
            while (i2 < size2) {
                ContextCompat$$ExternalSyntheticApiModelOutline0.m7680m$1();
                fontVariationAxisArr[i2] = ContextCompat$$ExternalSyntheticApiModelOutline0.m(settings.getSettings().get(i2).getAxisName(), settings.getSettings().get(i2).toVariationValue(density));
                i2++;
            }
        ...
        while (i2 < size) {
            if (i2 == settings.getSettings().size()) {
                ContextCompat$$ExternalSyntheticApiModelOutline0.m7680m$1();
                m = ContextCompat$$ExternalSyntheticApiModelOutline0.m("wght", coerceInWeight(i + 400.0f));
            } else if (Intrinsics.areEqual(settings.getSettings().get(i2).getAxisName(), "wght")) {
                ContextCompat$$ExternalSyntheticApiModelOutline0.m7680m$1();
                m = ContextCompat$$ExternalSyntheticApiModelOutline0.m("wght", coerceInWeight(settings.getSettings().get(i2).toVariationValue(density) + i));
            } else {
                ContextCompat$$ExternalSyntheticApiModelOutline0.m7680m$1();
                m = ContextCompat$$ExternalSyntheticApiModelOutline0.m(settings.getSettings().get(i2).getAxisName(), settings.getSettings().get(i2).toVariationValue(density));
            }
