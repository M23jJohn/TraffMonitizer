...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m7066getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m7094getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m7033getDefaulteUduSuo() : i3, (i4 & 32) != 0 ? null : platformImeOptions, (i4 & 64) != 0 ? LocaleList.INSTANCE.getEmpty() : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m7066getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m7094getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m7033getDefaulteUduSuo() : i3, (i4 & 32) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m7066getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m7094getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m7033getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ ImeOptions m7044copywBHncE4$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        int i5 = i3;
        boolean z3 = z2;
        return imeOptions.m7047copywBHncE4(z, i, z3, i2, i5, platformImeOptions2, localeList2);
    }

    /* renamed from: copy-wBHncE4, reason: not valid java name */
    public final ImeOptions m7047copywBHncE4(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, LocaleList hintLocales) {
    ...
    public static /* synthetic */ ImeOptions m7042copyYTHSh70$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i3;
        PlatformImeOptions platformImeOptions2 = platformImeOptions;
        return imeOptions.m7045copyYTHSh70(z, i, z2, i2, i5, platformImeOptions2);
    }
    ...
    public final /* synthetic */ ImeOptions m7045copyYTHSh70(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ ImeOptions m7043copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i3;
        boolean z3 = z2;
        return imeOptions.m7046copyuxg59PA(z, i, z3, i2, i5);
    }
    ...
    public final /* synthetic */ ImeOptions m7046copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m7056equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m7073equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m7020equalsimpl0(this.imeAction, imeOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, imeOptions.platformImeOptions) && Intrinsics.areEqual(this.hintLocales, imeOptions.hintLocales);
    }

    public int hashCode() {
        int m = ((((((((UByte$$ExternalSyntheticBackport0.m(this.singleLine) * 31) + KeyboardCapitalization.m7057hashCodeimpl(this.capitalization)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m7074hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m7021hashCodeimpl(this.imeAction)) * 31;
        PlatformImeOptions platformImeOptions = this.platformImeOptions;
        return ((m + (platformImeOptions != null ? platformImeOptions.hashCode() : 0)) * 31) + this.hintLocales.hashCode();
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m7058toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m7075toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m7022toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + ", hintLocales=" + this.hintLocales + ')';
    }
}
