...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString annotatedString, Density density, FontFamily.Resolver resolver, URLSpanCache uRLSpanCache) {
        ...
        if (spanStylesOrNull$ui_text != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                setSpanStyle(spannableString, SpanStyle.m6780copyGSF8kmg$default(range.component1(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null), range.getStart(), range.getEnd(), density, resolver);
            }
        }
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m7134setColorRPmYEkk(spannableString2, spanStyle.m6789getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m7135setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m6914getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m6967unboximpl() : FontStyle.INSTANCE.m6971getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.CC.m6936resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6981getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m7132setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
