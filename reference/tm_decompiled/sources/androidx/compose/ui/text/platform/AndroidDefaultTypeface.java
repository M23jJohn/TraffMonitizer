...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo7107getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m6914getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m6964equalsimpl0(fontStyle, FontStyle.INSTANCE.m6970getItalic_LCdwA()));
    }
}
