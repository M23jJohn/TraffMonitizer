...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo7107getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return m7108buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
    }

    /* renamed from: buildStyledTypeface-FO1MlWM, reason: not valid java name */
    private final Typeface m7108buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m6914getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m6964equalsimpl0(fontStyle, FontStyle.INSTANCE.m6970getItalic_LCdwA()));
    }
}
