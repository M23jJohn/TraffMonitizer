...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (z && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch m6675boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m6675boximpl(paragraphStyle.getEmojiSupportMatch());
            str2 = EmojiCompat.get().process(str, 0, str.length(), Integer.MAX_VALUE, m6675boximpl == null ? 0 : EmojiSupportMatch.m6678equalsimpl0(m6675boximpl.getValue(), EmojiSupportMatch.INSTANCE.m6682getAll_3YsG6Y()));
            Intrinsics.checkNotNull(str2);
        } else {
            str2 = str;
        }
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnit.m7595getRawTypeimpl(textStyle.m6887getLineHeightXSAIIZE()) == 0) {
            return str2;
        }
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m7137setLineHeightr9BaKPg(spannable, textStyle.m6887getLineHeightXSAIIZE(), f, density);
            f2 = f;
            density2 = density;
        } else {
            ...
            f2 = f;
            density2 = density;
            SpannableExtensions_androidKt.m7136setLineHeightKmRG4DE(spannable, textStyle.m6887getLineHeightXSAIIZE(), f2, density2, lineHeightStyle);
        }
