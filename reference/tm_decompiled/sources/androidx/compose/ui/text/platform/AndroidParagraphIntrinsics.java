...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m7112resolveTextDirectionHeuristicsHklW4sA(textStyle.m6891getTextDirections_7Xco(), textStyle.getLocaleList());
    ...
    public static final Typeface _init_$lambda$0(AndroidParagraphIntrinsics androidParagraphIntrinsics, FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
        State<Object> mo6935resolveDPcqOEQ = androidParagraphIntrinsics.fontFamilyResolver.mo6935resolveDPcqOEQ(fontFamily, fontWeight, fontStyle.m6967unboximpl(), fontSynthesis.getValue());
        if (!(mo6935resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
            TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(mo6935resolveDPcqOEQ, androidParagraphIntrinsics.resolvedTypefaces);
        ...
        Object value = ((TypefaceResult.Immutable) mo6935resolveDPcqOEQ).getValue();
