...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m7113resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m7112resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m7112resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale locale;
        if (TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7288getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7289getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7290getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7291getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7287getContents_7Xco()) || TextDirection.m7283equalsimpl0(i, TextDirection.INSTANCE.m7292getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m6675boximpl(paragraphStyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m6678equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m6684getNone_3YsG6Y()));
    }
}
