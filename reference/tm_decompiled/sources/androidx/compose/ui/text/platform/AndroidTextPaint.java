...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m7116getBrushSizeVsRJwc0$ui_text$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m5210getDefaultBlendMode0nO6VwU();
    ...
    public final void m7122setBrushSizeiaC8Vc4$ui_text(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Float.intBitsToFloat((int) (this.shadow.getOffset() >> 32)), Float.intBitsToFloat((int) (this.shadow.getOffset() & 4294967295L)), ColorKt.m4669toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m7123setColor8_81llA(long color) {
        Color color2 = this.lastColor;
        if (color2 == null ? false : Color.m4616equalsimpl0(color2.m4625unboximpl(), color)) {
            return;
        }
        if (color != 16) {
            this.lastColor = Color.m4605boximpl(color);
            setColor(ColorKt.m4669toArgb8_81llA(color));
            clearShader();
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m7117setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m7121setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:16:0x0032, code lost:
    
        if ((r0 == null ? false : androidx.compose.ui.geometry.Size.m4408equalsimpl0(r0.m4417unboximpl(), r4)) == false) goto L18;
     */
    /* renamed from: setBrush-12SF9DM, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m7121setBrush12SF9DM(final Brush brush, final long size, float alpha) {
        if (brush == null) {
            clearShader();
            return;
        }
        if (brush instanceof SolidColor) {
            m7123setColor8_81llA(TextDrawStyleKt.m7293modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            return;
        }
        ...
        if (size != InlineClassHelperKt.UnspecifiedPackedFloats) {
            this.brush = brush;
            this.brushSize = Size.m4400boximpl(size);
    ...
    public static final Shader setBrush_12SF9DM$lambda$1(Brush brush, long j) {
        return ((ShaderBrush) brush).mo4584createShaderuvyYCjk(j);
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        getComposePaint().mo4469setStylek9PVt8s(PaintingStyle.INSTANCE.m4904getStrokeTiuSbCo());
        Stroke stroke = (Stroke) drawStyle;
        getComposePaint().setStrokeWidth(stroke.getWidth());
        getComposePaint().setStrokeMiterLimit(stroke.getMiter());
        getComposePaint().mo4468setStrokeJoinWw9F2mQ(stroke.getJoin());
        getComposePaint().mo4467setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m7120setBlendModes9anfk8(int i) {
        if (BlendMode.m4525equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo4464setBlendModes9anfk8(i);
