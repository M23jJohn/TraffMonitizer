...
public final class CustomBulletSpan implements LeadingMarginSpan {
    ...
    public void drawLeadingMargin(final Canvas c, final Paint p, int x, final int dir, int top, int baseline, int bottom, CharSequence text, int start, int end, boolean first, Layout layout) {
        ...
        final long m4403constructorimpl = Size.m4403constructorimpl((Float.floatToRawIntBits(f3) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
        BulletSpan_androidKt.m7140setBrushAndDrawyzxVdVo(p, this.brush, this.alpha, m4403constructorimpl, new Function0() { // from class: androidx.compose.ui.text.platform.style.CustomBulletSpan$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit drawLeadingMargin$lambda$1$lambda$0;
                drawLeadingMargin$lambda$1$lambda$0 = CustomBulletSpan.drawLeadingMargin$lambda$1$lambda$0(CustomBulletSpan.this, m4403constructorimpl, dir, c, p, coerceAtLeast, f);
    ...
    public static final Unit drawLeadingMargin$lambda$1$lambda$0(CustomBulletSpan customBulletSpan, long j, int i, Canvas canvas, Paint paint, int i2, float f) {
        BulletSpan_androidKt.draw(customBulletSpan.shape.mo361createOutlinePq9zytI(j, i > 0 ? LayoutDirection.Ltr : LayoutDirection.Rtl, customBulletSpan.density), canvas, paint, i2, f, i);
