...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            textPaint.setStrokeJoin(DrawStyleSpan_androidKt.m7142toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
            textPaint.setStrokeCap(DrawStyleSpan_androidKt.m7141toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
