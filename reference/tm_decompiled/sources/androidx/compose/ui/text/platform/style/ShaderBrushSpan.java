...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4400boximpl(Size.INSTANCE.m4420getUnspecifiedNHjbRc()), null, 2, null);
    ...
    public final long m7143getSizeNHjbRc() {
        return ((Size) this.size.getValue()).m4417unboximpl();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m7144setSizeuvyYCjk(long j) {
    ...
    public static final Shader shaderState$lambda$0(ShaderBrushSpan shaderBrushSpan) {
        if (shaderBrushSpan.m7143getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m4414isEmptyimpl(shaderBrushSpan.m7143getSizeNHjbRc())) {
            return null;
        }
        return shaderBrushSpan.shaderBrush.mo4584createShaderuvyYCjk(shaderBrushSpan.m7143getSizeNHjbRc());
    }
