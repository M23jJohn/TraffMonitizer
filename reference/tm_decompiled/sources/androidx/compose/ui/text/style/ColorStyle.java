...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m7160copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m7162copy8_81llA(j);
    }
    ...
    public final ColorStyle m7162copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m4616equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public int hashCode() {
        return Color.m4622hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m4623toStringimpl(this.value)) + ')';
    }
    ...
    public final long m7163getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* renamed from: getColor-0d7_KjU */
    public long mo7159getColor0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    public float getAlpha() {
        return Color.m4617getAlphaimpl(mo7159getColor0d7_KjU());
    }
}
