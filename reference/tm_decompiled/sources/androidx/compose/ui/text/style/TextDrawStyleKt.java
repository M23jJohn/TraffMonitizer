...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m7294from8_81llA(ColorKt.m4666lerpjxsXWHM(textForegroundStyle.mo7159getColor0d7_KjU(), textForegroundStyle2.mo7159getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m7293modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m4614copywmQWz5c$default(j, Color.m4617getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
