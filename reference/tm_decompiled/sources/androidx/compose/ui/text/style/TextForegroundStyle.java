...
public interface TextForegroundStyle {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m7294from8_81llA(long color) {
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m7294from8_81llA(TextDrawStyleKt.m7293modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
