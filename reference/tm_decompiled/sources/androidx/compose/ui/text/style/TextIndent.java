...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m7295copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m7296copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m7296copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m7594equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m7594equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m7598hashCodeimpl(this.firstLine) * 31) + TextUnit.m7598hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m7604toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m7604toStringimpl(this.restLine)) + ')';
    }
}
