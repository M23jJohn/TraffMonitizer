...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m7309getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m7310getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* renamed from: copy-JdDtMQo$ui_text$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m7299copyJdDtMQo$ui_text$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m7300copyJdDtMQo$ui_text(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text, reason: not valid java name */
    public final TextMotion m7300copyJdDtMQo$ui_text(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return Linearity.m7305equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
    }

    public int hashCode() {
        return (Linearity.m7306hashCodeimpl(this.linearity) * 31) + UByte$$ExternalSyntheticBackport0.m(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        ...
        private static final int Linear = m7303constructorimpl(1);
        private static final int FontHinting = m7303constructorimpl(2);
        private static final int None = m7303constructorimpl(3);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Linearity m7302boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m7303constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m7304equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m7305equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m7306hashCodeimpl(int i) {
            return i;
        }

        public boolean equals(Object obj) {
            return m7304equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m7306hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m7310getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04, reason: not valid java name */
            public final int m7309getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04, reason: not valid java name */
            public final int m7311getNone4e0Vf04() {
        ...
        public String toString() {
            return m7307toStringimpl(this.value);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m7307toStringimpl(int i) {
            return m7305equalsimpl0(i, Linear) ? "Linearity.Linear" : m7305equalsimpl0(i, FontHinting) ? "Linearity.FontHinting" : m7305equalsimpl0(i, None) ? "Linearity.None" : "Invalid";
        }
    }
}
