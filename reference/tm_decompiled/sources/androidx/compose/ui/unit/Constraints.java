...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m7329boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m7330constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m7334equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m7335equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl, reason: not valid java name */
    private static final int m7336getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m7337getHasBoundedHeightimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m7338getHasBoundedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m7339getHasFixedHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int i3 = (1 << (18 - i2)) - 1;
    ...
    public static final boolean m7340getHasFixedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m7341getMaxHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m7342getMaxWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m7343getMinHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m7344getMinWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static int m7345hashCodeimpl(long j) {
    ...
    public static final boolean m7346isZeroimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public boolean equals(Object other) {
        return m7334equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m7345hashCodeimpl(this.value);
    }
    ...
    public static /* synthetic */ long m7332copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m7344getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m7342getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m7343getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m7341getMaxHeightimpl(j);
        }
        return m7331copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m7331copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
    ...
    public static final long m7333copyMaxDimensionsmsEJaDk(long j) {
        return m7330constructorimpl(j & ConstraintsKt.MaxDimensionsAndFocusMask);
    }
    ...
    public static String m7347toStringimpl(long j) {
        int m7342getMaxWidthimpl = m7342getMaxWidthimpl(j);
        String str = "Infinity";
        String valueOf = m7342getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m7342getMaxWidthimpl);
        int m7341getMaxHeightimpl = m7341getMaxHeightimpl(j);
        if (m7341getMaxHeightimpl != Integer.MAX_VALUE) {
            str = String.valueOf(m7341getMaxHeightimpl);
        }
        return "Constraints(minWidth = " + m7344getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m7343getMinHeightimpl(j) + ", maxHeight = " + str + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m7352fixedJhjzzOo(int width, int height) {
            if (!((height >= 0) & (width >= 0))) {
        ...
        public final long m7354fixedWidthOenEA2s(int width) {
            if (!(width >= 0)) {
        ...
        public final long m7353fixedHeightOenEA2s(int height) {
            if (!(height >= 0)) {
        ...
        public static /* synthetic */ long m7349restrictConstraintsxF2OJ5Q$default(Companion companion, int i, int i2, int i3, int i4, boolean z, int i5, Object obj) {
            if ((i5 & 16) != 0) {
                z = true;
            }
            return companion.m7355restrictConstraintsxF2OJ5Q(i, i2, i3, i4, z);
        }
        ...
        public final long m7355restrictConstraintsxF2OJ5Q(int minWidth, int maxWidth, int minHeight, int maxHeight, boolean prioritizeWidth) {
            if (prioritizeWidth) {
                return m7351fitPrioritizingWidthZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
            }
            return m7350fitPrioritizingHeightZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
        }

        /* renamed from: fitPrioritizingWidth-Zbe2FdA, reason: not valid java name */
        public final long m7351fitPrioritizingWidthZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int i = 262142;
        ...
        public final long m7350fitPrioritizingHeightZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int i = 262142;
