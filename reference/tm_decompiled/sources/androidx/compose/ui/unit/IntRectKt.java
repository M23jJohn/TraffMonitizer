...
public final class IntRectKt {
    ...
    public static final IntRect m7564IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m7531getXimpl(j), IntOffset.m7532getYimpl(j), IntOffset.m7531getXimpl(j) + ((int) (j2 >> 32)), IntOffset.m7532getYimpl(j) + ((int) (j2 & 4294967295L)));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m7563IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m7531getXimpl(j), IntOffset.m7532getYimpl(j), IntOffset.m7531getXimpl(j2), IntOffset.m7532getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m7565IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m7531getXimpl(j) - i, IntOffset.m7532getYimpl(j) - i, IntOffset.m7531getXimpl(j) + i, IntOffset.m7532getYimpl(j) + i);
    }
