...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope, OnApplyWindowInsetsListener {
    ...
    public AndroidViewHolder(Context context, CompositionContext compositionContext, int i, NestedScrollDispatcher nestedScrollDispatcher, View view, Owner owner) {
        ...
        final Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(DrawModifierKt.drawBehind(PointerInteropFilter_androidKt.pointerInteropFilter(SemanticsModifierKt.semantics(NestedScrollModifierKt.nestedScroll(companion, androidViewHolder_androidKt$NoOpScrollConnection$1, this.dispatcher), true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$coreModifier$1
            ...
            public final void invoke2(LayoutCoordinates layoutCoordinates) {
                ...
                AndroidViewHolder.this.size = layoutCoordinates.mo6057getSizeYbymL2g();
                ...
                if (windowInsetsCompat != null) {
                    ...
                    if (i2 == iArr4[0]) {
                        ...
                        if (i3 == iArr5[1]) {
                            ...
                            if (IntSize.m7572equalsimpl0(j, j2)) {
                                return;
                            }
                        }
                    }
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo80measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.CC.layout$default(measureScope, Constraints.m7344getMinWidthimpl(j), Constraints.m7343getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                ...
                if (Constraints.m7344getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m7344getMinWidthimpl(j));
                }
                if (Constraints.m7343getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m7343getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder2 = AndroidViewHolder.this;
                ...
                obtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(m7344getMinWidthimpl, m7342getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder3 = AndroidViewHolder.this;
                ...
                obtainMeasureSpec2 = androidViewHolder3.obtainMeasureSpec(m7343getMinHeightimpl, m7341getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(composeOffset2) & 4294967295L) | (Float.floatToRawIntBits(composeOffset) << 32));
            ...
            long m4335constructorimpl2 = Offset.m4335constructorimpl((Float.floatToRawIntBits(composeOffset4) & 4294967295L) | (Float.floatToRawIntBits(composeOffset3) << 32));
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long m5799dispatchPostScrollDzOQY0M = nestedScrollDispatcher.m5799dispatchPostScrollDzOQY0M(m4335constructorimpl, m4335constructorimpl2, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5799dispatchPostScrollDzOQY0M >> 32)));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5799dispatchPostScrollDzOQY0M & 4294967295L)));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m4335constructorimpl2 = Offset.m4335constructorimpl((Float.floatToRawIntBits(composeOffset4) & 4294967295L) | (Float.floatToRawIntBits(composeOffset3) << 32));
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m5799dispatchPostScrollDzOQY0M(m4335constructorimpl, m4335constructorimpl2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m4335constructorimpl = Offset.m4335constructorimpl((Float.floatToRawIntBits(composeOffset2) & 4294967295L) | (Float.floatToRawIntBits(composeOffset) << 32));
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long m5801dispatchPreScrollOzD1aCk = nestedScrollDispatcher.m5801dispatchPreScrollOzD1aCk(m4335constructorimpl, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5801dispatchPreScrollOzD1aCk >> 32)));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5801dispatchPreScrollOzD1aCk & 4294967295L)));
        }
    }
    ...
    public final WindowInsetsCompat insetToLayoutPosition(WindowInsetsCompat insets) {
        if (insets.hasInsets()) {
            ...
            if (innerCoordinator$ui_release.isAttached()) {
                ...
                long m7548roundk4lQ0M = IntOffsetKt.m7548roundk4lQ0M(LayoutCoordinatesKt.positionInRoot(nodeCoordinator));
                int m7531getXimpl = IntOffset.m7531getXimpl(m7548roundk4lQ0M);
                if (m7531getXimpl < 0) {
                    m7531getXimpl = 0;
                }
                int m7532getYimpl = IntOffset.m7532getYimpl(m7548roundk4lQ0M);
                if (m7532getYimpl < 0) {
                    m7532getYimpl = 0;
                }
                long mo6057getSizeYbymL2g = LayoutCoordinatesKt.findRootCoordinates(nodeCoordinator).mo6057getSizeYbymL2g();
                int i = (int) (mo6057getSizeYbymL2g >> 32);
                int i2 = (int) (mo6057getSizeYbymL2g & 4294967295L);
                long mo6057getSizeYbymL2g2 = innerCoordinator$ui_release.mo6057getSizeYbymL2g();
                long m7548roundk4lQ0M2 = IntOffsetKt.m7548roundk4lQ0M(innerCoordinator$ui_release.mo6060localToRootMKHz9U(Offset.m4335constructorimpl((Float.floatToRawIntBits((int) (mo6057getSizeYbymL2g2 & 4294967295L)) & 4294967295L) | (Float.floatToRawIntBits((int) (mo6057getSizeYbymL2g2 >> 32)) << 32))));
                int m7531getXimpl2 = i - IntOffset.m7531getXimpl(m7548roundk4lQ0M2);
                if (m7531getXimpl2 < 0) {
                    m7531getXimpl2 = 0;
                }
                int m7532getYimpl2 = i2 - IntOffset.m7532getYimpl(m7548roundk4lQ0M2);
                int i3 = m7532getYimpl2 < 0 ? 0 : m7532getYimpl2;
                if (m7531getXimpl != 0 || m7532getYimpl != 0 || m7531getXimpl2 != 0 || i3 != 0) {
                    return insets.inset(m7531getXimpl, m7532getYimpl, m7531getXimpl2, i3);
                }
            }
        }
        return insets;
    ...
    private final <T> T insetValue(T value, Function4<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> block) {
        ...
        if (innerCoordinator$ui_release.isAttached()) {
            ...
            int i2 = (int) (mo6057getSizeYbymL2g & 4294967295L);
            long mo6057getSizeYbymL2g2 = innerCoordinator$ui_release.mo6057getSizeYbymL2g();
            long m7548roundk4lQ0M2 = IntOffsetKt.m7548roundk4lQ0M(innerCoordinator$ui_release.mo6060localToRootMKHz9U(Offset.m4335constructorimpl((4294967295L & Float.floatToRawIntBits((int) (mo6057getSizeYbymL2g2 & 4294967295L))) | (Float.floatToRawIntBits((int) (mo6057getSizeYbymL2g2 >> 32)) << 32))));
            int m7531getXimpl2 = i - IntOffset.m7531getXimpl(m7548roundk4lQ0M2);
            if (m7531getXimpl2 < 0) {
                m7531getXimpl2 = 0;
            }
            int m7532getYimpl2 = i2 - IntOffset.m7532getYimpl(m7548roundk4lQ0M2);
            int i3 = m7532getYimpl2 >= 0 ? m7532getYimpl2 : 0;
            if (m7531getXimpl != 0 || m7532getYimpl != 0 || m7531getXimpl2 != 0 || i3 != 0) {
                return block.invoke(Integer.valueOf(m7531getXimpl), Integer.valueOf(m7532getYimpl), Integer.valueOf(m7531getXimpl2), Integer.valueOf(i3));
            }
        }
        return value;
    }
    ...
    public final WindowInsetsAnimationCompat.BoundsCompat insetBounds(WindowInsetsAnimationCompat.BoundsCompat bounds) {
        ...
        if (innerCoordinator$ui_release.isAttached()) {
            ...
            int i3 = m7532getYimpl2 >= 0 ? m7532getYimpl2 : 0;
            if (m7531getXimpl != 0 || m7532getYimpl != 0 || m7531getXimpl2 != 0 || i3 != 0) {
                int i4 = m7531getXimpl;
                int i5 = i3;
                return new WindowInsetsAnimationCompat.BoundsCompat(inset(bounds.getLowerBound(), i4, m7532getYimpl, m7531getXimpl2, i5), inset(bounds.getUpperBound(), i4, m7532getYimpl, m7531getXimpl2, i5));
            }
        }
        return bounds;
    }
