...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ContextCompat$$ExternalSyntheticApiModelOutline0.m7665m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 36 && str.equals(ContextCompat$$ExternalSyntheticApiModelOutline0.m$1().getName())) {
                return new ProgressStyle();
            }
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(ContextCompat$$ExternalSyntheticApiModelOutline0.m$2().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(ContextCompat$$ExternalSyntheticApiModelOutline0.m7676m().getName())) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(ContextCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(ContextCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(ContextCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(ContextCompat$$ExternalSyntheticApiModelOutline0.m((Object) createMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            build = Person.fromAndroidPerson(ContextCompat$$ExternalSyntheticApiModelOutline0.m7665m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(ContextCompat$$ExternalSyntheticApiModelOutline0.m7665m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class ProgressStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 36) {
                ...
                Notification.ProgressStyle m = ContextCompat$$ExternalSyntheticApiModelOutline0.m();
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            if (!ContextCompat$$ExternalSyntheticApiModelOutline0.m7676m().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m7660clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m7661clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ContextCompat$$ExternalSyntheticApiModelOutline0.m7665m(it.next())));
                }
            }
        } else {
