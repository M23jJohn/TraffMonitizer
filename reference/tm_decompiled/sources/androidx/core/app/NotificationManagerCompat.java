...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel m7663m = ContextCompat$$ExternalSyntheticApiModelOutline0.m7663m((Object) it.next());
                if (!collection.contains(Api26Impl.getId(m7663m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(m7663m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(m7663m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup m7664m = ContextCompat$$ExternalSyntheticApiModelOutline0.m7664m((Object) it.next());
                if (Api26Impl.getId(m7664m).equals(str)) {
                    return m7664m;
                }
            }
        }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(ContextCompat$$ExternalSyntheticApiModelOutline0.m7663m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup m7664m = ContextCompat$$ExternalSyntheticApiModelOutline0.m7664m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m7664m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m7664m, notificationChannels));
                    }
                }
                return arrayList;
            }
