...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo build;
        ContextCompat$$ExternalSyntheticApiModelOutline0.m$3();
        shortLabel = ContextCompat$$ExternalSyntheticApiModelOutline0.m(this.mContext, this.mId).setShortLabel(this.mLabel);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ContextCompat$$ExternalSyntheticApiModelOutline0.m7666m((Object) it.next())).build());
        }
        return arrayList;
    }
