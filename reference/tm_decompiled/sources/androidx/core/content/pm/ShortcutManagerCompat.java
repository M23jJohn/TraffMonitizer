...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            isRequestPinShortcutSupported = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).isRequestPinShortcutSupported();
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            requestPinShortcut = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent createShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            shortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).getShortcuts(i);
            return ShortcutInfoCompat.fromShortcuts(context, shortcuts);
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager m = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m()));
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            addDynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).addDynamicShortcuts(arrayList);
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        maxShortcutCountPerActivity = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).getMaxShortcutCountPerActivity();
    ...
    public static boolean isRateLimitingActive(Context context) {
        ...
        isRateLimitingActive = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).isRateLimitingActive();
    ...
    public static int getIconMaxWidth(Context context) {
        ...
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            iconMaxWidth = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).getIconMaxWidth();
            return iconMaxWidth;
        }
    ...
    public static int getIconMaxHeight(Context context) {
        ...
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            iconMaxHeight = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).getIconMaxHeight();
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            dynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).setDynamicShortcuts(arrayList);
            if (!dynamicShortcuts) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        List dynamicShortcuts;
        if (Build.VERSION.SDK_INT >= 25) {
            dynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, ContextCompat$$ExternalSyntheticApiModelOutline0.m7666m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            updateShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).updateShortcuts(arrayList);
            if (!updateShortcuts) {
                return false;
            }
        }
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(removeShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
