...
public final class Profiling {
    ...
    public static final void registerForAllProfilingResults(Context context, Executor executor, Consumer<ProfilingResult> listener) {
        ...
        HalfKt$$ExternalSyntheticApiModelOutline0.m7756m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m7767m())).registerForAllProfilingResults(executor, listener);
    }

    public static final void unregisterForAllProfilingResults(Context context, Consumer<ProfilingResult> listener) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(listener, "listener");
        HalfKt$$ExternalSyntheticApiModelOutline0.m7756m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m7767m())).unregisterForAllProfilingResults(listener);
    }
    ...
    public static final void requestProfiling(Context context, ProfilingRequest profilingRequest, Executor executor, Consumer<ProfilingResult> consumer) {
        ...
        HalfKt$$ExternalSyntheticApiModelOutline0.m7756m(context.getSystemService(HalfKt$$ExternalSyntheticApiModelOutline0.m7767m())).requestProfiling(profilingRequest.getProfilingType(), profilingRequest.getParams(), profilingRequest.getTag(), profilingRequest.getCancellationSignal(), executor, consumer);
    }
}
