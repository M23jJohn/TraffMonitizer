...
public final class SplashScreen {
    ...
    static class Impl {
        ...
        public static final boolean m7746splashScreenWaitPredicate$lambda0() {
            return false;
        }
        ...
        public Impl(Activity activity) {
            ...
            this.splashScreenWaitPredicate = new KeepOnScreenCondition() { // from class: androidx.core.splashscreen.SplashScreen$Impl$$ExternalSyntheticLambda0
                ...
                public final boolean shouldKeepOnScreen() {
                    boolean m7746splashScreenWaitPredicate$lambda0;
                    m7746splashScreenWaitPredicate$lambda0 = SplashScreen.Impl.m7746splashScreenWaitPredicate$lambda0();
                    return m7746splashScreenWaitPredicate$lambda0;
                }
            };
        }
        ...
        public final void dispatchOnExitAnimation(final SplashScreenViewProvider splashScreenViewProvider) {
            ...
            splashScreenViewProvider.getView().postOnAnimation(new Runnable() { // from class: androidx.core.splashscreen.SplashScreen$Impl$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    SplashScreen.Impl.m7745dispatchOnExitAnimation$lambda3(SplashScreenViewProvider.this, onExitAnimationListener);
                }
            });
        }
        ...
        public static final void m7745dispatchOnExitAnimation$lambda3(SplashScreenViewProvider splashScreenViewProvider, OnExitAnimationListener finalListener) {
            Intrinsics.checkNotNullParameter(splashScreenViewProvider, "$splashScreenViewProvider");
    ...
    static final class Impl31 extends Impl {
        ...
        public Impl31(final Activity activity) {
            ...
            this.hierarchyListener = new ViewGroup.OnHierarchyChangeListener() { // from class: androidx.core.splashscreen.SplashScreen$Impl31$hierarchyListener$1
                ...
                public void onChildViewAdded(View parent, View child) {
                    if (HalfKt$$ExternalSyntheticApiModelOutline0.m7776m((Object) child)) {
                        SplashScreen.Impl31 impl31 = SplashScreen.Impl31.this;
                        impl31.setMDecorFitWindowInsets(impl31.computeDecorFitsWindow(HalfKt$$ExternalSyntheticApiModelOutline0.m7766m((Object) child)));
        ...
        public final boolean computeDecorFitsWindow(SplashScreenView child) {
            ...
            build = HalfKt$$ExternalSyntheticApiModelOutline0.m7764m().build();
        ...
        public void setOnExitAnimationListener(final OnExitAnimationListener exitAnimationListener) {
            ...
            splashScreen.setOnExitAnimationListener(new SplashScreen.OnExitAnimationListener() { // from class: androidx.core.splashscreen.SplashScreen$Impl31$$ExternalSyntheticLambda6
                ...
                public final void onSplashScreenExit(SplashScreenView splashScreenView) {
                    SplashScreen.Impl31.m7747setOnExitAnimationListener$lambda0(SplashScreen.Impl31.this, exitAnimationListener, splashScreenView);
                }
            });
        }
        ...
        public static final void m7747setOnExitAnimationListener$lambda0(Impl31 this$0, OnExitAnimationListener exitAnimationListener, SplashScreenView splashScreenView) {
