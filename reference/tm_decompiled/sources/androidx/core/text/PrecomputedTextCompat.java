...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = HalfKt$$ExternalSyntheticApiModelOutline0.m7757m(textPaint).setBreakStrategy(i);
    ...
    public PrecomputedText getPrecomputedText() {
        if (HalfKt$$ExternalSyntheticApiModelOutline0.m$1(this.mText)) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m7758m((Object) this.mText);
        }
        return null;
    }
