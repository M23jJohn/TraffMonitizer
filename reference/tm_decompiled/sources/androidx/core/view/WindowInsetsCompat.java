...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m7764m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m7764m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m7764m = Utf8Old$$ExternalSyntheticApiModelOutline0.m7799m(windowInsets);
            } else {
                m7764m = HalfKt$$ExternalSyntheticApiModelOutline0.m7764m();
            }
            this.mPlatBuilder = m7764m;
        }
