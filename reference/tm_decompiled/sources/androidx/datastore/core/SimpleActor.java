...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m9644getOrNullimpl = ChannelResult.m9644getOrNullimpl(((SimpleActor) this).messageQueue.mo9633tryReceivePtdJZtk());
                        if (m9644getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m9644getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo9628trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable m9643exceptionOrNullimpl = ChannelResult.m9643exceptionOrNullimpl(obj);
            if (m9643exceptionOrNullimpl != null) {
                throw m9643exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m9649isSuccessimpl(obj)) {
