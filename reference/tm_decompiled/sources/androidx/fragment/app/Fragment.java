...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void performConfigurationChanged(Configuration configuration) {
        ...
        this.mChildFragmentManager.m7828lambda$new$0$androidxfragmentappFragmentManager(configuration);
    }
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m7827lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m7827lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m7827lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m7827lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
