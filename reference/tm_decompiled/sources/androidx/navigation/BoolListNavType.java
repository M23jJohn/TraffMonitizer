...
public final class BoolListNavType extends CollectionNavType<List<? extends Boolean>> {
    ...
    public void put(Bundle bundle, String key, List<Boolean> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7981putBooleanArrayimpl(m7974constructorimpl, key, CollectionsKt.toBooleanArray(value));
        } else {
    ...
    public List<Boolean> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7898getBooleanArrayimpl(m7888constructorimpl, key));
    }
}
