...
public final class FloatListNavType extends CollectionNavType<List<? extends Float>> {
    ...
    public void put(Bundle bundle, String key, List<Float> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7990putFloatArrayimpl(m7974constructorimpl, key, CollectionsKt.toFloatArray(value));
        } else {
    ...
    public List<Float> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7916getFloatArrayimpl(m7888constructorimpl, key));
    }
}
