...
public final class FloatNavType extends NavType<Float> {
    ...
    public void put(Bundle bundle, String key, float value) {
        ...
        SavedStateWriter.m7989putFloatimpl(SavedStateWriter.m7974constructorimpl(bundle), key, value);
    }
    ...
    public Float get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return Float.valueOf(SavedStateReader.m7915getFloatimpl(SavedStateReader.m7888constructorimpl(bundle), key));
    }
}
