...
public final class IntListNavType extends CollectionNavType<List<? extends Integer>> {
    ...
    public void put(Bundle bundle, String key, List<Integer> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7992putIntArrayimpl(SavedStateWriter.m7974constructorimpl(bundle), key, CollectionsKt.toIntArray(value));
        }
    }
    ...
    public List<Integer> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7920getIntArrayimpl(m7888constructorimpl, key));
    }
}
