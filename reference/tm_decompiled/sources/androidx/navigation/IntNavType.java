...
public final class IntNavType extends NavType<Integer> {
    ...
    public void put(Bundle bundle, String key, int value) {
        ...
        SavedStateWriter.m7991putIntimpl(SavedStateWriter.m7974constructorimpl(bundle), key, value);
    }
    ...
    public Integer get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return Integer.valueOf(SavedStateReader.m7919getIntimpl(SavedStateReader.m7888constructorimpl(bundle), key));
    }
}
