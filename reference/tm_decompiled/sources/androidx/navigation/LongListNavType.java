...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7996putLongArrayimpl(m7974constructorimpl, key, CollectionsKt.toLongArray(value));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7930getLongArrayimpl(m7888constructorimpl, key));
    }
}
