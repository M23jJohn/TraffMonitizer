...
public final class LongNavType extends NavType<Long> {
    ...
    public void put(Bundle bundle, String key, long value) {
        ...
        SavedStateWriter.m7995putLongimpl(SavedStateWriter.m7974constructorimpl(bundle), key, value);
    }
    ...
    public Long get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return Long.valueOf(SavedStateReader.m7929getLongimpl(SavedStateReader.m7888constructorimpl(bundle), key));
    }
}
