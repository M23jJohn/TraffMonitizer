...
public final class NavDeepLinkBuilder {
    ...
    public final PendingIntent createPendingIntent() {
        ...
        int m7891contentDeepHashCodeimpl = bundle != null ? SavedStateReader.m7891contentDeepHashCodeimpl(SavedStateReader.m7888constructorimpl(bundle)) : 0;
        for (DeepLinkDestination deepLinkDestination : this.destinations) {
            m7891contentDeepHashCodeimpl = (m7891contentDeepHashCodeimpl * 31) + deepLinkDestination.getDestinationId();
            Bundle arguments = deepLinkDestination.getArguments();
            Integer valueOf = arguments != null ? Integer.valueOf(SavedStateReader.m7891contentDeepHashCodeimpl(SavedStateReader.m7888constructorimpl(arguments))) : null;
            if (valueOf != null) {
                m7891contentDeepHashCodeimpl = (m7891contentDeepHashCodeimpl * 31) + valueOf.intValue();
            }
        }
        PendingIntent pendingIntent = createTaskStackBuilder().getPendingIntent(m7891contentDeepHashCodeimpl, 201326592);
