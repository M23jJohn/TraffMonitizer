...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    private final void navigate(NavBackStackEntry entry, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (startDestinationRoute != null) {
            if (!Intrinsics.areEqual(startDestinationRoute, navDestination.getRoute())) {
                ...
                if (matchingArgs != null && !SavedStateReader.m7966isEmptyimpl(SavedStateReader.m7888constructorimpl(matchingArgs))) {
                    ...
                    SavedStateWriter.m7978putAllimpl(m7974constructorimpl, matchingArgs);
    ...
    public static final boolean navigate$lambda$6(Ref.ObjectRef objectRef, String key) {
        ...
        return objectRef.element == 0 || !SavedStateReader.m7889containsimpl(SavedStateReader.m7888constructorimpl((Bundle) objectRef.element), key);
    }
}
