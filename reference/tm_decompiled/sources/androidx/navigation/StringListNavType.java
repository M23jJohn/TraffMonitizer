...
public final class StringListNavType extends CollectionNavType<List<? extends String>> {
    ...
    public void put(Bundle bundle, String key, List<String> value) {
        ...
        if (value != null) {
            SavedStateWriter.m8008putStringArrayimpl(m7974constructorimpl, key, (String[]) value.toArray(new String[0]));
        } else {
    ...
    public List<String> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7960getStringArrayimpl(m7888constructorimpl, key));
    }
}
