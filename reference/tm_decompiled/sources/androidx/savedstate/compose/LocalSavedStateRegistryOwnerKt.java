...
public final class LocalSavedStateRegistryOwnerKt {
    ...
    static {
        ...
        try {
            ...
            m8075constructorimpl = Result.m8075constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<SavedStateRegistryOwner> providableCompositionLocal2 = (ProvidableCompositionLocal) (Result.m8081isFailureimpl(m8075constructorimpl) ? null : m8075constructorimpl);
