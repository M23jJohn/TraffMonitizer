...
public final class SavedStateRegistryImpl {
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        Bundle m7945getSavedStateimpl = SavedStateReader.m7889containsimpl(m7888constructorimpl, key) ? SavedStateReader.m7945getSavedStateimpl(m7888constructorimpl, key) : null;
        SavedStateWriter.m8010removeimpl(SavedStateWriter.m7974constructorimpl(bundle), key);
        if (SavedStateReader.m7966isEmptyimpl(SavedStateReader.m7888constructorimpl(bundle))) {
            this.restoredState = null;
        }
        return m7945getSavedStateimpl;
    }
    ...
    public final void performRestore$savedstate_release(Bundle savedState) {
        ...
        Bundle bundle = null;
        if (savedState != null) {
            Bundle m7888constructorimpl = SavedStateReader.m7888constructorimpl(savedState);
            if (SavedStateReader.m7889containsimpl(m7888constructorimpl, SAVED_COMPONENTS_KEY)) {
                bundle = SavedStateReader.m7945getSavedStateimpl(m7888constructorimpl, SAVED_COMPONENTS_KEY);
            }
        }
    ...
    public final void performSave$savedstate_release(Bundle outBundle) {
        ...
        synchronized (this.lock) {
            for (Map.Entry entry2 : this.keyToProviders.entrySet()) {
                SavedStateWriter.m8001putSavedStateimpl(m7974constructorimpl, (String) entry2.getKey(), ((SavedStateRegistry.SavedStateProvider) entry2.getValue()).saveState());
            }
            Unit unit = Unit.INSTANCE;
        }
        if (SavedStateReader.m7966isEmptyimpl(SavedStateReader.m7888constructorimpl(bundleOf))) {
            return;
        }
        SavedStateWriter.m8001putSavedStateimpl(SavedStateWriter.m7974constructorimpl(outBundle), SAVED_COMPONENTS_KEY, bundleOf);
    }
}
