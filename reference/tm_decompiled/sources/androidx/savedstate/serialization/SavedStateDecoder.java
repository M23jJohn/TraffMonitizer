...
public final class SavedStateDecoder extends AbstractDecoder {
    ...
    public int decodeElementIndex(SerialDescriptor descriptor) {
        ...
        if (Intrinsics.areEqual(descriptor.getKind(), StructureKind.LIST.INSTANCE) || Intrinsics.areEqual(descriptor.getKind(), StructureKind.MAP.INSTANCE)) {
            m7968sizeimpl = SavedStateReader.m7968sizeimpl(SavedStateReader.m7888constructorimpl(this.savedState));
        } else {
            m7968sizeimpl = descriptor.getElementsCount();
        }
        while (true) {
            int i = this.index;
            if (i >= m7968sizeimpl || !descriptor.isElementOptional(i) || decodeElementIndex$presentInEncoding(this, descriptor, this.index)) {
                break;
            }
            this.index++;
        }
    ...
    private static final boolean decodeElementIndex$presentInEncoding(SavedStateDecoder savedStateDecoder, SerialDescriptor serialDescriptor, int i) {
        return SavedStateReader.m7889containsimpl(SavedStateReader.m7888constructorimpl(savedStateDecoder.savedState), serialDescriptor.getElementName(i));
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public boolean decodeBoolean() {
        return SavedStateReader.m7897getBooleanimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public byte decodeByte() {
        return (byte) SavedStateReader.m7919getIntimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public short decodeShort() {
        return (short) SavedStateReader.m7919getIntimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public int decodeInt() {
        return SavedStateReader.m7919getIntimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public long decodeLong() {
        return SavedStateReader.m7929getLongimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public float decodeFloat() {
        return SavedStateReader.m7915getFloatimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public double decodeDouble() {
        return SavedStateReader.m7911getDoubleimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public char decodeChar() {
        return SavedStateReader.m7901getCharimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public String decodeString() {
        return SavedStateReader.m7959getStringimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }
    ...
    private final List<Integer> decodeIntList() {
        return SavedStateReader.m7922getIntListimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final List<String> decodeStringList() {
        return SavedStateReader.m7962getStringListimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final boolean[] decodeBooleanArray() {
        return SavedStateReader.m7898getBooleanArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final char[] decodeCharArray() {
        return SavedStateReader.m7902getCharArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final double[] decodeDoubleArray() {
        return SavedStateReader.m7912getDoubleArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final float[] decodeFloatArray() {
        return SavedStateReader.m7916getFloatArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final int[] decodeIntArray() {
        return SavedStateReader.m7920getIntArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final long[] decodeLongArray() {
        return SavedStateReader.m7930getLongArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }

    private final String[] decodeStringArray() {
        return SavedStateReader.m7960getStringArrayimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }
    ...
    public CompositeDecoder beginStructure(SerialDescriptor descriptor) {
        ...
        return new SavedStateDecoder(SavedStateReader.m7945getSavedStateimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key), this.configuration);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public boolean decodeNotNullMark() {
        return !SavedStateReader.m7967isNullimpl(SavedStateReader.m7888constructorimpl(this.savedState), this.key);
    }
