...
public final class SavedStateEncoder extends AbstractEncoder {
    ...
    private final void checkDiscriminatorCollisions(Bundle savedState, String elementName) {
        if (this.configuration.getClassDiscriminatorMode() == 1) {
            boolean m7889containsimpl = SavedStateReader.m7889containsimpl(SavedStateReader.m7888constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            boolean areEqual = Intrinsics.areEqual(elementName, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            if (m7889containsimpl && areEqual) {
                throw new IllegalArgumentException("SavedStateEncoder for " + SavedStateReader.m7959getStringimpl(SavedStateReader.m7888constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY) + " has property '" + elementName + "' that conflicts with the class discriminator. You can rename a property with @SerialName annotation.");
            }
        }
    }
    ...
    public void encodeBoolean(boolean value) {
        SavedStateWriter.m7980putBooleanimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeByte(byte value) {
        SavedStateWriter.m7991putIntimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }
    ...
    public void encodeLong(long value) {
        SavedStateWriter.m7995putLongimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeFloat(float value) {
        SavedStateWriter.m7989putFloatimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeDouble(double value) {
        SavedStateWriter.m7987putDoubleimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeChar(char value) {
        SavedStateWriter.m7982putCharimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeString(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        SavedStateWriter.m8007putStringimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeEnum(SerialDescriptor enumDescriptor, int index) {
        Intrinsics.checkNotNullParameter(enumDescriptor, "enumDescriptor");
        SavedStateWriter.m7991putIntimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, index);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeNull() {
        SavedStateWriter.m7997putNullimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key);
    }

    private final void encodeIntList(List<Integer> value) {
        SavedStateWriter.m7993putIntListimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeStringList(List<String> value) {
        SavedStateWriter.m8009putStringListimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeBooleanArray(boolean[] value) {
        SavedStateWriter.m7981putBooleanArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeCharArray(char[] value) {
        SavedStateWriter.m7983putCharArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeDoubleArray(double[] value) {
        SavedStateWriter.m7988putDoubleArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeFloatArray(float[] value) {
        SavedStateWriter.m7990putFloatArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeIntArray(int[] value) {
        SavedStateWriter.m7992putIntArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeLongArray(long[] value) {
        SavedStateWriter.m7996putLongArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeStringArray(String[] value) {
        SavedStateWriter.m8008putStringArrayimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, value);
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        SavedStateWriter.m8001putSavedStateimpl(SavedStateWriter.m7974constructorimpl(this.savedState), this.key, bundleOf);
    ...
    private final void putClassDiscriminatorIfRequired(SavedStateConfiguration configuration, SerialDescriptor descriptor, Bundle savedState) {
        if (configuration.getClassDiscriminatorMode() == 1 && !SavedStateReader.m7889containsimpl(SavedStateReader.m7888constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY)) {
            if (Intrinsics.areEqual(descriptor.getKind(), StructureKind.CLASS.INSTANCE) || Intrinsics.areEqual(descriptor.getKind(), StructureKind.OBJECT.INSTANCE)) {
                SavedStateWriter.m8007putStringimpl(SavedStateWriter.m7974constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, descriptor.getSerialName());
            }
        }
    }
