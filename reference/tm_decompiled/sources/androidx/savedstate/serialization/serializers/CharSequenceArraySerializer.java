...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    public void serialize(Encoder encoder, CharSequence[] value) {
        ...
        SavedStateWriter.m7985putCharSequenceArrayimpl(SavedStateWriter.m7974constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7906getCharSequenceArrayimpl(SavedStateReader.m7888constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
