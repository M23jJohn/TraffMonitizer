...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m7986putCharSequenceListimpl(SavedStateWriter.m7974constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7908getCharSequenceListimpl(SavedStateReader.m7888constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
