...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m7979putBinderimpl(SavedStateWriter.m7974constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public IBinder deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7895getBinderimpl(SavedStateReader.m7888constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
