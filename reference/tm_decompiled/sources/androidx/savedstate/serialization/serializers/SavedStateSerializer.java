...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public void serialize(Encoder encoder, Bundle value) {
        ...
        if (Intrinsics.areEqual(savedStateEncoder.getKey(), "")) {
            SavedStateWriter.m7978putAllimpl(SavedStateWriter.m7974constructorimpl(savedStateEncoder.getSavedState()), value);
        } else {
            SavedStateWriter.m8001putSavedStateimpl(SavedStateWriter.m7974constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
        }
    }
    ...
    public Bundle deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7945getSavedStateimpl(SavedStateReader.m7888constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
