...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m8005putSizeFimpl(SavedStateWriter.m7974constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7952getSizeFimpl(SavedStateReader.m7888constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
