...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m8074boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m8075constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m8076equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m8077equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m8080hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public int hashCode() {
        return m8080hashCodeimpl(this.value);
    }
    ...
    public static final boolean m8082isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m8081isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m8079getOrNullimpl(Object obj) {
        if (m8081isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m8078exceptionOrNullimpl(Object obj) {
    ...
    public static String m8083toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m8075constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m8075constructorimpl(ResultKt.createFailure(exception));
        }
    }
