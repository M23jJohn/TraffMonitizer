...
public final class UStringsKt {
    ...
    public static final String m9462toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m9464toStringolVBNx4(short s, int i) {
    ...
    public static final String m9463toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m9461toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m8173constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m8087boximpl(UByte.m8093constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m8173constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m8353boximpl(UShort.m8359constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m8173constructorimpl = UInt.m8173constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m(-1, m8173constructorimpl);
            ...
            int m8173constructorimpl2 = UInt.m8173constructorimpl(i3 * m8173constructorimpl);
            int m8173constructorimpl3 = UInt.m8173constructorimpl(UInt.m8173constructorimpl(digitOf) + m8173constructorimpl2);
            compare2 = Integer.compare(m8173constructorimpl3 ^ Integer.MIN_VALUE, m8173constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m8173constructorimpl3;
        }
        return UInt.m8167boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m8252constructorimpl = ULong.m8252constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m8252constructorimpl);
            ...
            long m8252constructorimpl2 = ULong.m8252constructorimpl(j * m8252constructorimpl);
            long m8252constructorimpl3 = ULong.m8252constructorimpl(ULong.m8252constructorimpl(UInt.m8173constructorimpl(r13) & 4294967295L) + m8252constructorimpl2);
            compare2 = Long.compare(m8252constructorimpl3 ^ Long.MIN_VALUE, m8252constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m8252constructorimpl3;
        }
        return ULong.m8246boximpl(j);
    }
}
