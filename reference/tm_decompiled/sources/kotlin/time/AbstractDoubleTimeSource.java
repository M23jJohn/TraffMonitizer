...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo9465elapsedNowUwyO8pc() {
            return Duration.m9503minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo9468plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m9504plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo9467minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m9480equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m9500isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m9566getZEROUwyO8pc();
                    }
                    long m9503minusLRDsOJo = Duration.m9503minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m9480equalsimpl0(duration, Duration.m9519unaryMinusUwyO8pc(m9503minusLRDsOJo)) ? Duration.INSTANCE.m9566getZEROUwyO8pc() : Duration.m9504plusLRDsOJo(duration, m9503minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m9480equalsimpl0(mo9467minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m9566getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m9496hashCodeimpl(Duration.m9504plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m9515toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m9566getZEROUwyO8pc(), null);
    }
}
