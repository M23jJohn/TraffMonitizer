...
final class AdjustedTimeMark implements TimeMark {
    ...
    public /* bridge */ TimeMark mo9466minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m9586minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo9465elapsedNowUwyO8pc() {
        return Duration.m9503minusLRDsOJo(this.mark.mo9465elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo9468plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m9504plusLRDsOJo(this.adjustment, duration), null);
    }
}
