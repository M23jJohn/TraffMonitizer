...
public final class DurationKt {
    ...
    private static final long m9572timesmvk6XK0(int i, long j) {
        return Duration.m9506timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m9571timeskIfJnKk(double d, long j) {
        return Duration.m9505timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m9566getZEROUwyO8pc = Duration.INSTANCE.m9566getZEROUwyO8pc();
        ...
        if (str.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m9504plusLRDsOJo = Duration.m9504plusLRDsOJo(m9566getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m9566getZEROUwyO8pc = Duration.m9504plusLRDsOJo(m9504plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m9566getZEROUwyO8pc = Duration.m9504plusLRDsOJo(m9566getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, max, true)) {
                m9566getZEROUwyO8pc = Duration.INSTANCE.m9564getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m9504plusLRDsOJo2 = Duration.m9504plusLRDsOJo(m9566getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m9566getZEROUwyO8pc = Duration.m9504plusLRDsOJo(m9504plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m9566getZEROUwyO8pc = Duration.m9504plusLRDsOJo(m9566getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m9519unaryMinusUwyO8pc(m9566getZEROUwyO8pc) : m9566getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m9475constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m9475constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m9475constructorimpl((j << 1) + i);
    }
