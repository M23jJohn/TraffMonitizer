...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m9573minusLRDsOJo(long duration) {
        return m9575plusLRDsOJo(Duration.m9519unaryMinusUwyO8pc(duration));
    }

    /* renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m9574minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m9504plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m9575plusLRDsOJo(long duration) {
        long m9489getInWholeSecondsimpl = Duration.m9489getInWholeSecondsimpl(duration);
        int m9491getNanosecondsComponentimpl = Duration.m9491getNanosecondsComponentimpl(duration);
        if (m9489getInWholeSecondsimpl == 0 && m9491getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + m9489getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (m9489getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + m9491getNanosecondsComponentimpl);
        }
        return Duration.m9502isPositiveimpl(duration) ? MAX : MIN;
    }
}
