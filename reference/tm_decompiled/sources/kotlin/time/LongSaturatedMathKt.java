...
public final class LongSaturatedMathKt {
    ...
    public static final long m9578saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long m9514toLongimpl = Duration.m9514toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m9577checkInfiniteSumDefinedPjuGub4(j, j2, m9514toLongimpl);
        }
        if (((m9514toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m9579saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + m9514toLongimpl;
        return ((j ^ j3) & (m9514toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m9577checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m9500isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m9579saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long m9478divUwyO8pc = Duration.m9478divUwyO8pc(j2, 2);
        long m9514toLongimpl = Duration.m9514toLongimpl(m9478divUwyO8pc, durationUnit);
        return (1 | (m9514toLongimpl - 1)) == Long.MAX_VALUE ? m9514toLongimpl : m9578saturatingAddNuflL3o(m9578saturatingAddNuflL3o(j, durationUnit, m9478divUwyO8pc), durationUnit, Duration.m9503minusLRDsOJo(j2, m9478divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m9565getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m9564getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m9519unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m9504plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m9519unaryMinusUwyO8pc(infinityOfSign(j3));
        }
