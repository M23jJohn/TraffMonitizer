...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m9589boximpl(m9583markNowz9LOYto());
    }
    ...
    public long m9583markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m9592constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m9582elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m9581differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m9580adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m9592constructorimpl(LongSaturatedMathKt.m9578saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
