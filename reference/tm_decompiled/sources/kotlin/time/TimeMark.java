...
public interface TimeMark {
    ...
    TimeMark mo9466minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo9468plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m9587plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m9586minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo9468plusLRDsOJo(Duration.m9519unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m9501isNegativeimpl(timeMark.mo9465elapsedNowUwyO8pc());
        }
