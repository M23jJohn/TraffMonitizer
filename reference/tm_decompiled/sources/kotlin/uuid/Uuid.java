...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m8246boximpl(ULong.m8252constructorimpl(getMostSignificantBits())), ULong.m8246boximpl(ULong.m8252constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m9612toUByteArrayTcUX1vc() {
        return UByteArray.m8149constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m8252constructorimpl(j) ^ Long.MIN_VALUE, ULong.m8252constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m8252constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m8252constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m9614fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m9613fromUByteArrayGBYM_sE(byte[] ubyteArray) {
