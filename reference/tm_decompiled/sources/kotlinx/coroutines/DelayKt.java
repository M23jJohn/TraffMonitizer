...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo9685scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m9616delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9617toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9617toDelayMillisLRDsOJo(long j) {
        boolean m9502isPositiveimpl = Duration.m9502isPositiveimpl(j);
        if (m9502isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m9486getInWholeMillisecondsimpl(Duration.m9504plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m9502isPositiveimpl) {
