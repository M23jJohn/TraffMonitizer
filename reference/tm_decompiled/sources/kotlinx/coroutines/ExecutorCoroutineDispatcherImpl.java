...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo9684dispatch(CoroutineContext context, Runnable block) {
        Runnable runnable;
        try {
            ...
            Dispatchers.getIO().mo9684dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo9685scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long j;
        Executor executor = getExecutor();
        ...
        if (scheduledExecutorService != null) {
            j = timeMillis;
            scheduledFuture = scheduleBlock(scheduledExecutorService, new ResumeUndispatchedRunnable(this, continuation), continuation.getContext(), j);
        } else {
            j = timeMillis;
        }
        if (scheduledFuture != null) {
            ...
            DefaultExecutor.INSTANCE.mo9685scheduleResumeAfterDelay(j, continuation);
        }
    }
