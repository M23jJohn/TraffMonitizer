...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m8075constructorimpl = Result.m8075constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m8081isFailureimpl(m8075constructorimpl) ? null : m8075constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo9684dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
