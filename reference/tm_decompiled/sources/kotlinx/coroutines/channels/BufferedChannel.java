...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo9632receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m9630receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(sendException)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo9628trySendJP2dKIU(E element) {
        Object obj;
        ChannelSegment channelSegment;
        int i;
        BufferedChannel<E> bufferedChannel;
        if (shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            return ChannelResult.INSTANCE.m9653failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegment != null) {
                    ...
                    return ChannelResult.INSTANCE.m9652closedJP2dKIU(getSendException());
                }
            } else {
                channelSegment = channelSegment2;
                i = i2;
            ...
            if (updateCellSend == 0) {
                ...
                return ChannelResult.INSTANCE.m9654successJP2dKIU(Unit.INSTANCE);
            }
            if (updateCellSend == 1) {
                return ChannelResult.INSTANCE.m9654successJP2dKIU(Unit.INSTANCE);
            }
    ...
    protected final Object m9634trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegment;
        int i;
        BufferedChannel<E> bufferedChannel;
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult m9639boximpl = ChannelResult.m9639boximpl(ChannelResult.INSTANCE.m9654successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m9639boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
            return tryResume02;
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    static /* synthetic */ <E> Object m9630receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof BufferedChannel$receiveCatching$1) {
            ...
            if ((bufferedChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (updateCellReceive != symbol) {
                        ...
                        if (updateCellReceive != symbol2) {
                            ...
                            if (updateCellReceive == symbol3) {
                                ...
                                Object m9631receiveCatchingOnNoWaiterSuspendGKJJFZk = r7.m9631receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$12);
                                return m9631receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : m9631receiveCatchingOnNoWaiterSuspendGKJJFZk;
                            }
                            channelSegment.cleanPrev();
                            return ChannelResult.INSTANCE.m9654successJP2dKIU(updateCellReceive);
                        }
                ...
                return ChannelResult.INSTANCE.m9652closedJP2dKIU(bufferedChannel.getCloseCause());
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m9631receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        int i2;
        Symbol symbol;
        Symbol symbol2;
        ChannelResult m9639boximpl;
                                ...
                                if (updateCellReceive != symbol) {
                                    ...
                                    if (updateCellReceive == symbol2) {
                                        ...
                                        while (true) {
                                            ...
                                            updateCellReceive = updateCellReceive(channelSegment2, i3, andIncrement, receiveCatching);
                                            ...
                                            if (updateCellReceive != symbol3) {
                                                ...
                                                if (updateCellReceive == symbol4) {
                                                    ...
                                                    channelSegment2.cleanPrev();
                                                    m9639boximpl = ChannelResult.m9639boximpl(ChannelResult.INSTANCE.m9654successJP2dKIU(updateCellReceive));
                                        ...
                                        if (function1 != null) {
                                            context = orCreateCancellableContinuation.getContext();
                                            function12 = OnUndeliveredElementKt.bindCancellationFun(function1, updateCellReceive, context);
                                        }
                                        orCreateCancellableContinuation.resume(m9639boximpl, function12);
                                    }
                                } else {
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m8075constructorimpl(ChannelResult.m9639boximpl(ChannelResult.INSTANCE.m9652closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo9633tryReceivePtdJZtk() {
        Object obj;
        ChannelSegment channelSegment;
        Symbol symbol;
        Symbol symbol2;
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m9652closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m9639boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m9652closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m9654successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m8075constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object m9675constructorimpl$default = InlineList.m9675constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        ...
                        if (state$kotlinx_coroutines_core == symbol2 || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                m9675constructorimpl$default = InlineList.m9680plusFjFbRPM(m9675constructorimpl$default, waiter);
        ...
        if (m9675constructorimpl$default != null) {
            if (!(m9675constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) m9675constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(m9675constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) m9675constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core != null) {
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m9675constructorimpl$default = InlineList.m9680plusFjFbRPM(m9675constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                ...
                                if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m9675constructorimpl$default = InlineList.m9680plusFjFbRPM(m9675constructorimpl$default, state$kotlinx_coroutines_core);
                                    lastSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            }
        ...
        if (m9675constructorimpl$default != null) {
            if (!(m9675constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) m9675constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(m9675constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) m9675constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m8075constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m8075constructorimpl(ChannelResult.m9639boximpl(ChannelResult.INSTANCE.m9652closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m9692isClosedimpl(findSegmentInternal)) {
                Segment m9690getSegmentimpl = SegmentOrClosed.m9690getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= m9690getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!m9690getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, m9690getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m9690getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m9690getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m9690getSegmentimpl(findSegmentInternal);
    ...
    */
            ...
            while (true) {
                ...
                if (state$kotlinx_coroutines_core instanceof CancellableContinuation) {
                    ...
                    if (areEqual) {
                        ...
                        if (areEqual6 ? z3 : Intrinsics.areEqual(state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            i4++;
                            z2 = z3;
                        } else {
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            try {
                ...
                cancellableContinuationImpl.resumeWith(Result.m8075constructorimpl(unit));
                result = orCreateCancellableContinuation.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                }
                if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00b1, code lost:
        ...
        r1.resumeWith(kotlin.Result.m8075constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuationImpl2.resumeWith(Result.m8075constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
        ...
        try {
            ...
            if (updateCellReceive != symbol) {
                ...
                if (updateCellReceive == symbol2) {
                    ...
                    orCreateCancellableContinuation.resume(updateCellReceive, function12);
                }
            } else {
