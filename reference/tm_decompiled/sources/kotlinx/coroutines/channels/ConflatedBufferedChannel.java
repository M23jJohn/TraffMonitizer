...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m9656trySendImplMj0NB7M = conflatedBufferedChannel.m9656trySendImplMj0NB7M(e, true);
        if (m9656trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m9643exceptionOrNullimpl(m9656trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m9656trySendImplMj0NB7M = conflatedBufferedChannel.m9656trySendImplMj0NB7M(e, true);
        if (!(m9656trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo9628trySendJP2dKIU(E element) {
        return m9656trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m9656trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m9655trySendDropLatestMj0NB7M(element, isSendOp) : m9634trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m9655trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo9628trySendJP2dKIU = super.mo9628trySendJP2dKIU(element);
        if (ChannelResult.m9649isSuccessimpl(mo9628trySendJP2dKIU) || ChannelResult.m9647isClosedimpl(mo9628trySendJP2dKIU)) {
            return mo9628trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo9628trySendJP2dKIU = mo9628trySendJP2dKIU(element);
        if (!(mo9628trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo9628trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m9643exceptionOrNullimpl(mo9628trySendJP2dKIU);
