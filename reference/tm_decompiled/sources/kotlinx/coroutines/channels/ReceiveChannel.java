...
public interface ReceiveChannel<E> {
    ...
    Object mo9632receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo9633tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo9633tryReceivePtdJZtk = receiveChannel.mo9633tryReceivePtdJZtk();
            if (ChannelResult.m9649isSuccessimpl(mo9633tryReceivePtdJZtk)) {
                return (E) ChannelResult.m9645getOrThrowimpl(mo9633tryReceivePtdJZtk);
            }
            Throwable m9643exceptionOrNullimpl = ChannelResult.m9643exceptionOrNullimpl(mo9633tryReceivePtdJZtk);
            if (m9643exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m9643exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo9632receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo9632receiveCatchingJP2dKIU = receiveChannel.mo9632receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo9632receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo9632receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    return ChannelResult.m9644getOrNullimpl(mo9632receiveCatchingJP2dKIU);
                }
            }
