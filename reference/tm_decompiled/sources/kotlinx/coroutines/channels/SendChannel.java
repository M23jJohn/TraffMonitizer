...
public interface SendChannel<E> {
    ...
    Object mo9628trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo9628trySendJP2dKIU = sendChannel.mo9628trySendJP2dKIU(e);
            if (ChannelResult.m9649isSuccessimpl(mo9628trySendJP2dKIU)) {
                return true;
            }
            Throwable m9643exceptionOrNullimpl = ChannelResult.m9643exceptionOrNullimpl(mo9628trySendJP2dKIU);
