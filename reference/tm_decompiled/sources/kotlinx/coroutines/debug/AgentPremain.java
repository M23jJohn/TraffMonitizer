...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m8075constructorimpl = Result.m8075constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m8081isFailureimpl(m8075constructorimpl) ? null : m8075constructorimpl);
