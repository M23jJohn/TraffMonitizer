...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, obj, null));
        ...
        /* JADX WARN: Code restructure failed: missing block: B:21:0x0079, code lost:
            ...
            if (kotlin.concurrent.atomics.AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getValues(), r0, r6, r7) == false) goto L50;
         */
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (hashedWeakRef != null) {
                    ...
                    if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), index, null, weakKey0)) {
                        break;
                    }
                } else {
                    return null;
            ...
            while (true) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    while (true) {
                        ...
                        if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(values, i2, obj, mark)) {
                            break;
                        }
                    }
