...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            m8075constructorimpl = Result.m8075constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
        }
        return (Function1) (Result.m8081isFailureimpl(m8075constructorimpl) ? null : m8075constructorimpl);
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        if (Intrinsics.areEqual(state, DebugCoroutineInfoImplKt.RUNNING) && thread != null) {
            try {
                Result.Companion companion = Result.INSTANCE;
                DebugProbesImpl debugProbesImpl = this;
                m8075constructorimpl = Result.m8075constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
            }
            ...
            StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m8075constructorimpl;
