    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            this.I$1 = b;
            this.label = 1;
            obj2 = channel.mo9632receiveCatchingJP2dKIU(this);
        ...
        if (i4 != 1) {
            ...
            if (obj2 != coroutine_suspended) {
                ...
                objArr2 = objArr;
                bArr2 = bArr3;
                indexedValue = (IndexedValue) ChannelResult.m9644getOrNullimpl(obj2);
                if (indexedValue == null) {
                    while (true) {
                        ...
                        if (bArr2[index] != i3) {
                            bArr2[index] = (byte) i3;
                            indexedValue = (IndexedValue) ChannelResult.m9644getOrNullimpl(channel.mo9633tryReceivePtdJZtk());
                            if (indexedValue != null) {
                            }
                        }
                        if (i2 == 0) {
