    ...
    */
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m8075constructorimpl(result));
            return;
        }
        CompletionException m9775m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m9779m((Object) exception) ? NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m9775m((Object) exception) : null;
        if (m9775m != null && cause != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m8075constructorimpl(ResultKt.createFailure(exception)));
    }
}
