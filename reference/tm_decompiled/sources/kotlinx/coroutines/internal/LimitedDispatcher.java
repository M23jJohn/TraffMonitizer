...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo9685scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo9685scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo9684dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo9684dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo9684dispatch(this, new Worker(obtainTaskOrDeallocateWorker));
    }
