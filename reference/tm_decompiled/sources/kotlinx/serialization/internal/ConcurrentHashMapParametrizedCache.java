...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo9702getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                m8075constructorimpl = Result.m8075constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object putIfAbsent2 = concurrentHashMap2.putIfAbsent(arrayList2, m8074boximpl);
            obj = putIfAbsent2 == null ? m8074boximpl : putIfAbsent2;
        }
