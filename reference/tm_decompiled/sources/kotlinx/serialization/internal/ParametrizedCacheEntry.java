...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m9707computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m8075constructorimpl = Result.m8075constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m8075constructorimpl = Result.m8075constructorimpl(ResultKt.createFailure(th));
            }
            Result m8074boximpl = Result.m8074boximpl(m8075constructorimpl);
            Object putIfAbsent = concurrentHashMap.putIfAbsent(arrayList2, m8074boximpl);
            obj = putIfAbsent == null ? m8074boximpl : putIfAbsent;
        }
