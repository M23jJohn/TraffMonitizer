...
public final class C0231SegmentedByteString extends ByteString {
    ...
    public C0231SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0231SegmentedByteString c0231SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0231SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && resolveDefaultParameter == size()) {
            return c0231SegmentedByteString;
        }
